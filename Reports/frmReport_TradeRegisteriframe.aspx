<%@ page language="C#" autoeventwireup="true" inherits="Reports_New_frmReport_TradeRegisteriframe, App_Web_c6bgvp9x" enableeventvalidation="false" %>
...
<head id="Head1">
    ...
    <!--Generic Loading Part-->
    <script type="text/javascript" src="../CentralData/JSScript/jquery-1.8.3.min.js"></script>
    <link href="../CentralData/CSS/GenericLoading.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript">
        ...
        $('form').live("submit", function () {
            if (document.activeElement.getAttribute != undefined && document.activeElement.getAttribute('id') == "BtnExport")
                ShowProgress();
        });

        function HideLoading(exp) {
            var modal = document.getElementById("myModal");
            modal.style.display = "none";
            if (exp == 'E') document.getElementById("BtnExcel").click();
            if (exp == 'P') document.getElementById("BtnPDF").click();
        }
    </script>
    <!--End Generic Loading Part-->
    ...
    function FnCTCL(obj)
    {
     ...
     function  FnddlGroupBy(obj)
     {
        ...
        //New Work
        if(obj=='Custodians')  cmb.value='Custodians';
        //End of New Work
    ...
    function FnOtherGroupBy(obj)
    {
       if(obj=="a")
         ...
         else
         {
             ...
             //New Work
             if(document.getElementById('ddlGroupBy').value=='Custodians')
             {
                 var cmb=document.getElementById('cmbsearchOption');
...
function FunClient(objID,objListFun,objEvent)
{
       ...
       //New Work
       else if(document.getElementById('ddlGroupBy').value=="Custodians")///////Custodians wise
        {
               cmbVal='ClientsCustodians'+'~'+'ALL';
        }
       //End of New Work
   ...
   { 
                            ...
                            <tr>
                                        ...
                                        <tr id="Tr_Group">
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlGroupBy" runat="server" Width="120px" Font-Size="10px" onchange="FnddlGroupBy(this.value)">
                                                    ...
                                                    <%--New Work--%>
                                                    <asp:ListItem Value="Custodians">Custodians</asp:ListItem>
                                                    <%--End of New Work--%>
                                                </asp:DropDownList>
                                            </td>
                                ...
                                <td valign="top">
                                    <table id="Tab_showFilter" border="10" cellpadding="1" cellspacing="1">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:ListBox ID="lstSlection" runat="server" Font-Size="10px" Height="115px" Width="400px">
                                                </asp:ListBox>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlEmail" runat="server" Width="150px" Font-Size="10px" onchange="FnddlEmail(this.value)">
                                                    ...
                                                    <%--New Work--%>
                                                    <asp:ListItem Value="Client">Custodians</asp:ListItem>
                                                    <%--End of New Work--%>
                                                </asp:DropDownList></td>
                                            <td>
                                    ...
                                    <div id="divgrid" runat="server" style="width: 990px; max-height: 500px; overflow: auto;">
                                        <asp:GridView ID="grdContractRegister" runat="server" BorderColor="CornflowerBlue"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Taxes & Cess" SortExpression="TotalTax_Sorting">
                                                    <ItemStyle Wrap="false" BorderWidth="1px" HorizontalAlign="Right"></ItemStyle>
                                                    <HeaderStyle HorizontalAlign="Center" Wrap="false" Font-Bold="False"></HeaderStyle>
                                                    <ItemTemplate>
        ...
        <div style="display: none">
            ...
            <asp:Button ID="BtnPDF" runat="server" CssClass="btnUpdate" Height="20px" Text="Export To PDF"
                Width="101px" OnClick="btnPDF_Click" />
        </div>
        <!--End Generic Loading Part-->
    </form>
</body>
