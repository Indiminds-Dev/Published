<%@ page language="C#" autoeventwireup="true" inherits="management_BSECADetail, App_Web_kqhq1k1d" %>
            ...
            <tbody>
                <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports BSE's CADETAILS_YYYYMMDD File
                        </h5>
                    </td>
                </tr>
                                                         ...
                                                         <asp:Label id="lblMessage" runat="server" Width="270px"></asp:Label><br />
                                                           <asp:Label ID="Label2" runat="server" Font-Bold="True" Text=""
                                                               Width="177px"></asp:Label>
                                                                    ...
                                                                    <strong>Files Available At : EQ\COMMON Folder of BSE'S Member ExtraNet Server</strong></td>
                                                         </tr>
