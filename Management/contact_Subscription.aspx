<%@ page language="C#" autoeventwireup="true" inherits="management_contact_Subscription, App_Web_dw8rtpla" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    <form id="form1" runat="server" autocomplete="off">
        <table>
            <tr>
                <td>
                    <dxtc:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="13" ClientInstanceName="page"
                        Width="100%">
