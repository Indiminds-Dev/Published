<%@ page language="C#" autoeventwireup="true" inherits="Reports_TurnoverReportCM, App_Web_7htzac9n" %>
...
<head id="Head1">
    <title>Turnover & TOT Reports</title>
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Report For :</td>
                                        <td>
                                            <asp:DropDownList ID="DdlRptFor" runat="server" Width="250px" Font-Size="10px" onchange="FnConsolidated(this.value)">
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Report View :</td>
                                        <td>
                                            <asp:DropDownList ID="DdlrptViewClient" runat="server" Width="250px" Font-Size="10px" onchange="FnrptViewClient(this.value)">
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Report View :</td>
                                        <td>
                                            <asp:DropDownList ID="DdlrptViewExchange" runat="server" Width="250px" Font-Size="10px" onchange="FnrptViewExchange(this.value)">
                                                <asp:ListItem Value="1">Date Wise</asp:ListItem>
                                                <asp:ListItem Value="2">Asset Wise</asp:ListItem>
                                                <asp:ListItem Value="3">Consolidated</asp:ListItem>
