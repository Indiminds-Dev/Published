<%@ page language="C#" autoeventwireup="true" inherits="management_Process_SpreadOffSetTrades, App_Web_akbpwr7y" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE">
   ...
   { 
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 22px;">
                    <strong><span id="SpanHeader" style="color: #000099">Spread Trade Generation</span></strong>
                </td>
            </tr>
        </table>
        ...
        <table style="width: 306px" border="1">
            <tr>
                <td valign="top" style="font-weight: bold; vertical-align: top; height: 11px; background-color: #b7ceec; text-align: left">
                   For </td>
            ...
            <tr>
                ...
                <td valign="top">
                    <asp:DropDownList ID="ddlGenerateOrDelete" runat="server" Width="100%">
