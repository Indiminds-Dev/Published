<%@ page language="C#" autoeventwireup="true" inherits="management_frm_IFSCClosingRates, App_Web_0payuukt" %>
    ...
    function ShowDate(objval)
       ...
       function setfile()
               ...
               if(document.getElementById('cmbTrade').value=='3')
                    filepath='http://www.bseindia.com/bsedata/CIML_bhavcopy/CurrencyBhavCopy_'+seldt.split('-')[2]+seldt.split('-')[1]+seldt.split('-')[0]+'.zip';
               else
    ...
    <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 22px;">
                        <strong><span id="SpanHeader" style="color: #000099">Imports IFSC Closing Rates</span></strong>
                    </td>
                </tr></table>
            ...
            <tr>
                ...
                <td style="padding-left:4px" align=left>
                    <select id="cmbTrade" onchange="Javascript:ShowDate(this.value)" runat="server">
                        ...
                        <option value="1">G_CN01_ddMMyyyy.CSV</option>
                        <option value="2">G_T_DSP(Settlement Price) files (WEB)</option>
                        <option value="3">G_T_UL(Underlying Price) files (WEB)</option>
