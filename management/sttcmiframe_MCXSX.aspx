<%@ page language="C#" autoeventwireup="true" inherits="management_sttcmiframe_MCXSX, App_Web_kqhq1k1d" %>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports MCX-SX-EQ_STT_CMID_DDMMYYYY.csv Available through FTP's MEMBER Folder
                        </h5>
                    </td>
                </tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="gridcellleft">
                                            <span style="color: #000099; text-align: right">EQ STT File</span></td>
