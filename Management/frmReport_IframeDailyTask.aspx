<%@ page language="C#" autoeventwireup="true" inherits="management_frmReport_IframeDailyTask, App_Web_sjbhlkdr" %>
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" style="text-align:center">
                        <span style="color: Blue"><strong>Daily Tash Sheet For Sales</strong></span>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:GridView ID="grdReports" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333"
                                    GridLines="None" BorderWidth="1px" BorderColor="#507CD1" ShowFooter="True" CssClass="gridcellleft"
