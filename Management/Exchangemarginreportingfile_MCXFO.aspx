<%@ page language="C#" autoeventwireup="true" inherits="management_exchangemarginreportingfile_MCXFO, App_Web_s3wzohpw" %>
...
<head runat="server">
    <title>Exchange Margin Reporting Files For FO Segment</title>
                ...
                <table class="TableMain100">
                    <tr>
                        <td class="EHEADER" style="text-align: center;" colspan="2">
                            <strong><span style="color: #000099">Exchange Margin Reporting Files For FO Segment</span></strong>
                        </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddltype" runat="server" Width="150px" Font-Size="10px">
                                                        <asp:ListItem Value="TM">TM Margin Reporting</asp:ListItem>
                                                        <asp:ListItem Value="CM">CM Margin Reporting</asp:ListItem>
                                                    </asp:DropDownList>
                                    </td>
                                    <td>
                                    </td>
                        ...
                        <td>
                            <table border="10" cellpadding="1" cellspacing="1">
                                <tr id="tr_UnApprovedShares">
                                    <td class="gridcellleft" bgcolor="#B7CEEC">
                                        <asp:CheckBox ID="chkUnApprovedShares" runat="server" onclick="fnchkUnApprovedShares(this)"
                                            Checked="True" />
                                    ...
                                    <asp:GridView ID="grdmarginreporting" runat="server" BorderColor="CornflowerBlue"
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Initial Margin">
                                                ...
                                                <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                                <ItemTemplate>
                                                    <asp:Label ID="lblInitialMargin" runat="server" Text='<%# Eval("InitialMargin")%>'
