<%@ page language="C#" autoeventwireup="true" inherits="Reports_frm_DatewiseClientMarginReport, App_Web_h4pnmg8n" %>
                            ...
                            <td>
                             ...
                             <td>
                                <dxe:ASPxDateEdit ID="dtToDate" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                    Font-Size="10px" Width="108px" EditFormatString="dd-MM-yyyy" ClientInstanceName="dtToDate1">
                                    <DropDownButton Text="For">
                                    </DropDownButton>
                                    <ClientSideEvents ValueChanged="function(s, e) {dateassign(s);}" />
                                </dxe:ASPxDateEdit>
