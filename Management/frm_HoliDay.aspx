<%@ page language="C#" autoeventwireup="true" inherits="management_frm_HoliDay, App_Web_8qixh_8w" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
	...
	LastCall(s.cpHeight);
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues"
                        ConnectionString="<%$ ConnectionStrings:crmConnectionString %>" DeleteCommand="DELETE FROM [tbl_master_holiday] WHERE [hol_id] = @original_hol_id "
                                    ...
                                    <tr>
                                        <td style="vertical-align: top; text-align:left">
                                            <dxwgv:ASPxGridView ID="GridExchange" ClientInstanceName="gridExchange" runat="server"
                                                ...
                                                <Columns>
                                                    <dxwgv:GridViewDataTextColumn FieldName="exh_name" VisibleIndex="0">
                                                        <HeaderTemplate>
