<%@ page language="C#" autoeventwireup="true" inherits="Reports_PositionFileGreekBSEFO_Net, App_Web_0payuukt" %>
...
<head id="Head1" runat="server">
    <title>Position File For Greek [Only Open Position]</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Position File For Greek [Only Open Position]</span></strong></td>
