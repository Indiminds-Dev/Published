<%@ page language="C#" autoeventwireup="true" inherits="management_POATransferForMarginPledge, App_Web_alid8jfz" %>
...
<head id="Head1">
    <title>Poa/DDPI Account Transfer For Margin Pledge</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Poa/DDPI Account Transfer For Margin Pledge</span></strong>
                </td>
                <%--New Work--%>
