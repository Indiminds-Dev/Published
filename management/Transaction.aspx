<%@ page language="C#" autoeventwireup="true" inherits="management_Transaction, App_Web_udicbieo" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function PageLoad()
        {
            //document.getElementById("txtproductid").disabled = true;
            document.getElementById("txtproductid").value="";
            document.getElementById("txtproductid_hidden").value="";
        }
    ...
    <!--
        ...
        function genericCallAjax(obj1, obj2, obj3, Query) {
        ...
        function OnPrdTypeChanged()
        {
            var text = ddlPrdType.GetText().toString();
            if(text=="Any"){
                document.getElementById("txtproductid").disabled = true;
                document.getElementById("txtproductid").value="";
                document.getElementById("txtproductid_hidden").value="";
                ...
                document.getElementById("txtproductid").disabled = false;
        }
                                ...
                                <td>
                                    <table style="width: 100px; z-index: 101">
                                        ...
                                        <tr>
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left; height: 37px;">
                                                <dxe:ASPxLabel ID="ASPxLabel50" runat="server" Text="Cal.Basis:">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="height: 37px">
                                                <dxe:ASPxComboBox runat="server" Width="150px" ID="ddlCalBasis" DropDownStyle="DropDown"
                                                    EnableSynchronization="False" EnableIncrementalFiltering="True">                                                    
                                                    <items>
                                                        <dxe:ListEditItem Text="Market Value" Value="M" ></dxe:ListEditItem>
                                                        <dxe:ListEditItem Text="Number Of Trades" Value="T"></dxe:ListEditItem>
                                                        <dxe:ListEditItem Text="Per Lot" Value="L"></dxe:ListEditItem>
                                                    </items>
                                                </dxe:ASPxComboBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="Ecoheadtxt" style="text-align: left; height: 37px;">
                                                <dxe:ASPxLabel ID="ASPxLabel51" runat="server" Text="Prd.Type:">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="height: 37px">
                                                <dxe:ASPxComboBox runat="server" Width="150px" ID="ddlPrdType" DropDownStyle="DropDown"
                                                    EnableSynchronization="False" EnableIncrementalFiltering="True">                                                    
                                                    <items>
                                                        <dxe:ListEditItem Text="Any" Value="ALL" ></dxe:ListEditItem>
                                                        <dxe:ListEditItem Text="Equity Stocks" Value="STK"></dxe:ListEditItem>
                                                        <dxe:ListEditItem Text="Exchange Indices" Value="IDX"></dxe:ListEditItem>
                                                        <dxe:ListEditItem Text="Volatility Indices" Value="IVX"></dxe:ListEditItem>
                                                        <dxe:ListEditItem Text="Curency Pairs" Value="CUR"></dxe:ListEditItem>
                                                        <dxe:ListEditItem Text="Interest Rates/Bonds" Value="IRD"></dxe:ListEditItem>
                                                        <dxe:ListEditItem Text="SLBM Trades" Value="SLB"></dxe:ListEditItem>
                                                    </items>
                                                    <%--<clientsideevents selectedindexchanged="function(s, e) { OnPrdTypeChanged(s); }"></clientsideevents>--%>
                                                </dxe:ASPxComboBox>
                                            </td>
                                            <td id="tdlblpro" class="Ecoheadtxt" style="text-align: left; height: 37px;" runat="server">
                                                <dxe:ASPxLabel ID="ASPxLabel7" runat="server" Text="Assets:">
                                                </dxe:ASPxLabel>
                                            </td>
                                        ...
                                        <tr runat="server" id="trrate" style="display: none">
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left; height: 37px;">
                                                <dxe:ASPxLabel ID="LblChargeGroup" runat="server" Text="Security Group:">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td class="Ecoheadtxt" style="text-align: left; height: 37px;">
                                                <dxe:ASPxTextBox runat="server" Width="100px" ID="TxtChargeGroup" MaxLength="3">
                                                </dxe:ASPxTextBox>
                                            </td>
                                            <%---------------- Security Group End -----------------%>
                                            <td class="Ecoheadtxt" style="text-align: left;">
                                        ...
                                        <tr id="tab1" style="display: none">
                                            <td colspan="8">
                                                <table style="border-top: solid 1px Gray; border-left: solid 1px Gray; border-right: solid 1px Gray;
                                                    border-bottom: solid 1px Gray" width="100%">
                                                    <tr>
                                                        <td style="width: 310px; text-align: left; color: Blue; border-right: solid 1px Gray;
                                                            border-bottom: solid 1px Gray">
                                                            <dxe:ASPxLabel ID="ASPxLabel89" Font-Size="12px" Font-Bold="true" runat="server"
                                                                Text="Rate For Futures:">
                                                            </dxe:ASPxLabel>
                                                        </td>
                                                        <td style="text-align: left; color: Blue; width: 305px; border-right: solid 1px Gray;
                                                            border-bottom: solid 1px Gray">
                                                            <dxe:ASPxLabel ID="ASPxLabel49" runat="server" Font-Size="12px" Font-Bold="true"
                                                                Text="Rates For Option:">
                                                            </dxe:ASPxLabel>
                                                        </td>
                                                        <td>
                                                        </td>
                                                        ...
                                                        <td style="border-right: solid 1px Gray">
                                                            <table width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="67px" ID="txtindexfuturerate" onkeypress="return noNumbers(event)">
                                                                            <masksettings mask="<0..99g>.<00..999999>" />
                                                                            <validationsettings errordisplaymode="None">
                                                    </validationsettings>
                                                                        </dxe:ASPxTextBox>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="67px" ID="txtindexfutureratePO" onkeypress="return noNumbers(event)">
                                                                            <masksettings mask="<0..99g>.<00..999999>" />
                                                                            <validationsettings errordisplaymode="None">
                                                    </validationsettings>
                                                                        </dxe:ASPxTextBox>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="67px" ID="txtratefutureexpiry" onkeypress="return noNumbers(event)">
                                                                            <masksettings mask="<0..99g>.<00..999999>" />
                                                                            <validationsettings errordisplaymode="None">
                                                    </validationsettings>
                                                                        </dxe:ASPxTextBox>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="67px" ID="txtratefutureexpiryPO" onkeypress="return noNumbers(event)">
                                                                            <masksettings mask="<0..99g>.<00..999999>" />
                                                                            <validationsettings errordisplaymode="None">
                                                    </validationsettings>
                                                                        </dxe:ASPxTextBox>
                                                    ...
                                                    <asp:ListItem Value="Premium And Strike">Premium And Strike</asp:ListItem>
                                                                        ...
                                                                        <dxe:ASPxComboBox ClientInstanceName="ddlbasis" runat="server" ID="ddlbasis" Width="150px"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="67px" ID="txtallrateoption" onkeypress="return noNumbers(event)">
                                                                            <masksettings mask="<0..99g>.<00..999999>" />
                                                                            <validationsettings errordisplaymode="None">
                                                    </validationsettings>
                                                                        </dxe:ASPxTextBox>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="67px" ID="txtallrateoptionPO" onkeypress="return noNumbers(event)">
                                                                            <masksettings mask="<0..99g>.<00..999999>" />
                                                                            <validationsettings errordisplaymode="None">
                                                    </validationsettings>
                                                                        </dxe:ASPxTextBox>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="67px" ID="txtallindexrateoption" onkeypress="return noNumbers(event)">
                                                                            <masksettings mask="<0..99g>.<00..999999>" />
                                                                            <validationsettings errordisplaymode="None">
                                                    </validationsettings>
                                                                        </dxe:ASPxTextBox>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="67px" ID="txtallindexrateoptionPO" onkeypress="return noNumbers(event)">
                                                                            <masksettings mask="<0..99g>.<00..999999>" />
                                                                            <validationsettings errordisplaymode="None">
                                                    </validationsettings>
                                                                        </dxe:ASPxTextBox>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="67px" ID="txtratestockoption" onkeypress="return noNumbers(event)">
                                                                            <masksettings mask="<0..99g>.<00..999999>" />
                                                                            <validationsettings errordisplaymode="None">
                                                    </validationsettings>
                                                                        </dxe:ASPxTextBox>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="67px" ID="txtratestockoptionPO" onkeypress="return noNumbers(event)">
                                                                            <masksettings mask="<0..99g>.<00..999999>" />
                                                                            <validationsettings errordisplaymode="None">
                                                    </validationsettings>
                                                                        </dxe:ASPxTextBox>
                                                    ...
                                                    <asp:ListItem Value="Difference">Difference</asp:ListItem>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="67px" ID="txtratefinalallstatement" onkeypress="return noNumbers(event)">
                                                                            <masksettings mask="<0..99g>.<00..999999>" />
                                                                            <validationsettings errordisplaymode="None">
                                                    </validationsettings>
                                                                        </dxe:ASPxTextBox>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="67px" ID="txtratefinalallstatementPO" onkeypress="return noNumbers(event)">
                                                                            <masksettings mask="<0..99g>.<00..999999>" />
                                                                            <validationsettings errordisplaymode="None">
                                                    </validationsettings>
                                                                        </dxe:ASPxTextBox>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="67px" ID="txtratefinalindexstatement" onkeypress="return noNumbers(event)">
                                                                            <masksettings mask="<0..99g>.<00..999999>" />
                                                                            <validationsettings errordisplaymode="None">
                                                    </validationsettings>
                                                                        </dxe:ASPxTextBox>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="67px" ID="txtratefinalindexstatementPO" onkeypress="return noNumbers(event)">
                                                                            <masksettings mask="<0..99g>.<00..999999>" />
                                                                            <validationsettings errordisplaymode="None">
                                                    </validationsettings>
                                                                        </dxe:ASPxTextBox>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="67px" ID="txtratefinalstockstatement" onkeypress="return noNumbers(event)">
                                                                            <masksettings mask="<0..99g>.<00..999999>" />
                                                                            <validationsettings errordisplaymode="None">
                                                    </validationsettings>
                                                                        </dxe:ASPxTextBox>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="67px" ID="txtratefinalstockstatementPO" onkeypress="return noNumbers(event)">
                                                                            <masksettings mask="<0..99g>.<00..999999>" />
                                                                            <validationsettings errordisplaymode="None">
                                                    </validationsettings>
                                                                        </dxe:ASPxTextBox>
