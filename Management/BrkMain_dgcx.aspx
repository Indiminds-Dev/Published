<%@ page language="C#" autoeventwireup="true" inherits="management_BrkMain_dgcx, App_Web_yq8u0p-o" %>
 ...
 function PopulateGrid(obj)
 {
   grid.PerformCallback(obj);
    ...
    else    
    {
      ...
      var URL="BrkDetail_dgcx.aspx?id="+keyValue;
...
//alert (id);
      ...
      {
        bid=id;
        var str = "BrkDetail_dgcx.aspx?id=" + 'ADD'+'/'+ bid+'/'+segname;
...
function disp_prompt(name)
    {
           ...
           if ( name == "tab0")
        {
          ...
          document.location.href="BrkMain_dgcx.aspx"; 
        ...
        else if ( name == "tab1")
        {
         ...
         if(document.getElementById('ASPxPageControl1_testhdd').value=='0')
         {
          ...
          document.location.href="BrkCharges_dgcx.aspx?id="+'ADD'+'/'+ mid; 
          ...
          else
          {
            ...
            document.location.href="BrkCharges_dgcx.aspx?id="+g; 
...
<dxw:ContentControl runat="server"><TABLE class="TableMain100"><TBODY><TR><TD style="HEIGHT: 63px"><TABLE style="WIDTH: 100%" border=1><TBODY><TR><asp:HiddenField runat="server" ID="testhdd"></asp:HiddenField>
...
<TD style="VERTICAL-ALIGN: top; WIDTH: 150px; HEIGHT: 11px; BACKGROUND-COLOR: #b7ceec; TEXT-ALIGN: left">&nbsp;Brkg Set up of</TD><TD style="WIDTH: 30%; HEIGHT: 39px"><asp:Label runat="server" Font-Size="X-Small" ForeColor="Brown" Width="100%" ID="lbl52"></asp:Label>
 </TD><TD style="VERTICAL-ALIGN: top; WIDTH: 87px; HEIGHT: 11px; BACKGROUND-COLOR: #b7ceec; TEXT-ALIGN: left">&nbsp;In</TD><TD style="WIDTH: 30%; HEIGHT: 39px"><asp:Label runat="server" Font-Size="X-Small" ForeColor="Brown" Width="100%" ID="lbl54"></asp:Label>
 </TD><TD style="VERTICAL-ALIGN: top; WIDTH: 87px; HEIGHT: 11px; BACKGROUND-COLOR: #b7ceec; TEXT-ALIGN: left">&nbsp;Date</TD><TD style="WIDTH: 20%; HEIGHT: 39px"><dxe:ASPxDateEdit runat="server" DateOnError="Today" UseMaskBehavior="True" EditFormat="Custom" Width="150px" ClientInstanceName="cDateedit" ID="Dateedit">
<ClientSideEvents DateChanged="function(s,e){CompareDateToControl(cDateedit);}"></ClientSideEvents>

<ButtonStyle Width="13px"></ButtonStyle>
</dxe:ASPxDateEdit>
 </TD></TR></TBODY></TABLE></TD></TR><TR><TD><TABLE border=1><TBODY><TR><TD style="VERTICAL-ALIGN: top; WIDTH: 87px; HEIGHT: 11px; BACKGROUND-COLOR: #b7ceec; TEXT-ALIGN: left">&nbsp;Brkg Decimals</TD><TD><dxe:ASPxSpinEdit runat="server" MaxValue="6" NumberType="Integer" Number="2" Width="50px" ID="txtbrkgdecimals"></dxe:ASPxSpinEdit>
...
<dxe:ListEditItem Text="Similar Price" Value="4"></dxe:ListEditItem>
 ...
 </TD></TR><TR><TD style="VERTICAL-ALIGN: top; WIDTH: 87px; HEIGHT: 11px; BACKGROUND-COLOR: #b7ceec; TEXT-ALIGN: left">&nbsp;Brkg. Rd-Off</TD><TD><dxe:ASPxComboBox runat="server" DropDownStyle="DropDown" EnableSynchronization="False" EnableIncrementalFiltering="True" ValueType="System.String" Width="100px" ID="ddlbrhkroundoff"><Items>
...
<dxe:ListEditItem Text="Higher 5 Paisa" Value="7"></dxe:ListEditItem>
 ...
 </TD><TD style="VERTICAL-ALIGN: top; HEIGHT: 11px; BACKGROUND-COLOR: #b7ceec; TEXT-ALIGN: left">&nbsp;Mkt. Rd-Off&nbsp;</TD><TD><dxe:ASPxComboBox runat="server" DropDownStyle="DropDown" EnableSynchronization="False" EnableIncrementalFiltering="True" ValueType="System.String" Width="100px" ClientInstanceName="ddlmktroundoff" ID="ddlmktroundoff"><Items>
<dxe:ListEditItem Text="Nearest" Value="1"></dxe:ListEditItem>
<dxe:ListEditItem Text="Higher" Value="2"></dxe:ListEditItem>
<dxe:ListEditItem Text="Lower" Value="3"></dxe:ListEditItem>
<dxe:ListEditItem Text="Truncate" Value="4"></dxe:ListEditItem>
...
<dxe:ListEditItem Text="Higher 5 Paisa" Value="7"></dxe:ListEditItem>
 ...
 </TD><TD style="VERTICAL-ALIGN: top; HEIGHT: 11px; BACKGROUND-COLOR: #b7ceec; TEXT-ALIGN: left">&nbsp;Net Rd-Off&nbsp;</TD><TD><dxe:ASPxComboBox runat="server" DropDownStyle="DropDown" EnableSynchronization="False" EnableIncrementalFiltering="True" ValueType="System.String" Width="100%" ID="ddlnetamtroundoff"><Items>
<dxe:ListEditItem Text="None" Value="1"></dxe:ListEditItem>
...
<dxe:ListEditItem Text="None" Value="5"></dxe:ListEditItem>
 ...
 </TD></TR><TR><TD style="VERTICAL-ALIGN: top; WIDTH: 87px; HEIGHT: 11px; BACKGROUND-COLOR: #b7ceec; TEXT-ALIGN: left">&nbsp;Min Daily Brkg&nbsp;</TD><TD><dxe:ASPxTextBox runat="server" Width="100px" HorizontalAlign="Right" ID="txtmindailybrkg" onkeypress="return noNumbers(event)">
<MaskSettings Mask="&lt;0..999999999999g&gt;.&lt;00..99&gt;" IncludeLiterals="DecimalSymbol"></MaskSettings>

<ValidationSettings ErrorDisplayMode="None"></ValidationSettings>
</dxe:ASPxTextBox>
 </TD><TD style="VERTICAL-ALIGN: top; HEIGHT: 11px; BACKGROUND-COLOR: #b7ceec; TEXT-ALIGN: left">&nbsp;Max Daily Brkg&nbsp;</TD><TD><dxe:ASPxTextBox runat="server" Width="100px" HorizontalAlign="Right" ID="txtmaxdailybrkg" onkeypress="return noNumbers(event)">
<MaskSettings Mask="&lt;0..999999999999g&gt;.&lt;00..99&gt;" IncludeLiterals="DecimalSymbol"></MaskSettings>

<ValidationSettings ErrorDisplayMode="None"></ValidationSettings>
</dxe:ASPxTextBox>
 </TD><TD runat="server" ID="tdmin" style="VERTICAL-ALIGN: top; HEIGHT: 11px; BACKGROUND-COLOR: #b7ceec; TEXT-ALIGN: left">&nbsp;Min Del Brkg/Shr&nbsp;</TD>
...
</TR><TR><TD style="VERTICAL-ALIGN: top; WIDTH: 87px; HEIGHT: 11px; BACKGROUND-COLOR: #b7ceec; TEXT-ALIGN: left">&nbsp;Min Sqr Brkg/Shr&nbsp;</TD><TD style="WIDTH: 125px"><dxe:ASPxTextBox runat="server" Width="100px" HorizontalAlign="Right" ID="txtminsqrbrkg" onkeypress="return noNumbers(event)">
<MaskSettings Mask="&lt;0..9999g&gt;.&lt;00..99&gt;" IncludeLiterals="DecimalSymbol"></MaskSettings>
...
<ValidationSettings ErrorDisplayMode="None"></ValidationSettings>
 ...
 </TD></TR><TR><TD style="BORDER-TOP-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-RIGHT-WIDTH: 0px"><STRONG><SPAN style="FONT-SIZE: 13px; COLOR: #000099">Brokerage Detail</SPAN></STRONG> </TD><TD style="DISPLAY: none" colSpan=10><asp:HiddenField runat="server" ID="cmpid"></asp:HiddenField>
 ...
 </TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE><TABLE class="TableMain100"><TBODY><TR><TD><dxwgv:ASPxGridView runat="server" ClientInstanceName="grid" KeyFieldName="BrokerageDetail_ID" AutoGenerateColumns="False" DataSourceID="BrokerageDetailDataSource" Width="100%" ID="BrokerageDetailGrid" OnCustomCallback="BrokerageDetailGrid_CustomCallback"><Columns>
...
<dxwgv:GridViewDataTextColumn FieldName="BrokerageDetail_MktSegment" Width="15%" Caption="Asset Type" VisibleIndex="1">
<EditFormSettings Visible="False"></EditFormSettings>
...
<dxwgv:GridViewDataTextColumn FieldName="BrokerageDetail_BrkgType" Width="12%" Caption="Brkg.Type" VisibleIndex="2">
<EditFormSettings Visible="False"></EditFormSettings>
...
<dxwgv:GridViewDataTextColumn FieldName="BrokerageDetail_BrkgFor" Width="15%" Caption="Brokerage For" VisibleIndex="3">
<EditFormSettings Visible="False"></EditFormSettings>
...
<dxwgv:GridViewDataTextColumn FieldName="BrokerageDetail_TranType" Width="6%" Caption="Trn.Type" VisibleIndex="4">
<EditFormSettings Visible="False"></EditFormSettings>
...
<dxwgv:GridViewDataTextColumn FieldName="BrokerageDetail_InstrType" Width="9%" Caption="Instr.Type" VisibleIndex="5">
<EditFormSettings Visible="False"></EditFormSettings>
...
<dxwgv:GridViewDataTextColumn FieldName="BrokerageDetail_FlatRate" Width="7%" Caption="Flat Amt" VisibleIndex="6">
<EditFormSettings Visible="False"></EditFormSettings>
...
<dxwgv:GridViewDataTextColumn FieldName="BrokerageDetail_Rate" Width="7%" Caption="Rate" VisibleIndex="7">
<EditFormSettings Visible="False"></EditFormSettings>
...
<dxwgv:GridViewDataTextColumn FieldName="BrokerageDetail_MinAmount" Width="5%" Caption="Min Amt" VisibleIndex="8">
<EditFormSettings Visible="False"></EditFormSettings>
...
<dxwgv:GridViewDataTextColumn Width="5%" Caption="Details" VisibleIndex="9">
<EditFormSettings Visible="False"></EditFormSettings>
<DataItemTemplate>
