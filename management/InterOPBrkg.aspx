<%@ page language="C#" autoeventwireup="true" inherits="management_InterOPBrkg, App_Web_fbvamflg" %>
...
<head id="Head1" runat="server">
    <title>InterOP Brokerage Generation</title>
    ...
    function btnAddsubscriptionlist_click()
      ...
      function height()
        ...
        function Disable(obj)
        {
            ...
            var gridview = document.getElementById('grdIntOpgenerate'); 
            ...
            if(obj=='P')
            {
                document.getElementById("grdIntOpgenerate_ctl08_FirstPage").style.display='none';
                document.getElementById("grdIntOpgenerate_ctl08_PreviousPage").style.display='none';
                document.getElementById("grdIntOpgenerate_ctl08_NextPage").style.display='inline';
                document.getElementById("grdIntOpgenerate_ctl08_LastPage").style.display='inline';
            }
            else
            {
                document.getElementById("grdIntOpgenerate_ctl"+rCount+"_NextPage").style.display='none';
                document.getElementById("grdIntOpgenerate_ctl"+rCount+"_LastPage").style.display='none';
            }
        }
        ...
        function Nodisplay()
        {
                ...
                document.getElementById('TdFilter').style.display='none';
                document.getElementById('tddisplay').style.display='none';
                alert('InterOp Brokerage Generated Successfully');
                height();
      ...
      // if (postBackElement.id == 'ctl00_ContentPlaceHolder3_btnShow') 
       ...
       <tr>
                    <td class="EHEADER" style="text-align: center;">
                        <strong><span style="color: #000099">InterOp Brokerage Generation</span></strong>
                    </td>
                </tr></table>
         <table class="TableMain100">
                <tr id="TdAll1">
                                        ...
                                        <tr valign="top">
                                            ...
                                            <td class="gridcellleft">
                                                <dxe:ASPxDateEdit ID="dtFrom" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                    Font-Size="10px" Width="150px" ClientInstanceName="dtfrom" EditFormatString="dd-MM-yyyy" >
             ...
             <tr id="tddisplay">
                  <td colspan="2" style="text-align: left; vertical-align:top;background-color:Silver;" >
                     <asp:Label ID="lblerror" runat="server" Text="Following Clients Stamp Duty Generation Pattern is set to 'Contract Number Wise'.However Contract Number is not generated for the given day.Hence Stamp Duty not generated.Please generate Contract Number and generate Stamp Duty."></asp:Label>
                 </td>
             </tr>
                 <tr id="Tr1">
                ...
                <tr>
                    <td colspan="2" style="text-align: left; vertical-align: bottom;">
                     ...
                     <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="grdIntOpgenerate" runat="server" Width="100%" BorderColor="CornflowerBlue"
                                    ShowFooter="True" AllowSorting="true"
                                    AutoGenerateColumns="False" BorderStyle="Solid" BorderWidth="2px" 
                                     AllowPaging="True" PageSize="5" ForeColor="#0000C0" OnRowCreated="grdIntOpgenerate_RowCreated"  >
