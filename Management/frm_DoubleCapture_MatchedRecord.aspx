<%@ page language="C#" autoeventwireup="true" inherits="management_frm_DoubleCapture_MatchedRecord, App_Web_njtlujlb" %>
...
<body  style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    <form id="form1" runat="server" autocomplete="off">
         ...
         <table class="TableMain100">
           ...
           <strong><span id="SpanHeader" style="color: #000099">Verify Delivery Instruction (Matched)</span></strong>&nbsp;</div>
                                 </td>
                             </tr>
                             <tr>
                     ...
                     <dxe:ASPxDateEdit ID="dtentrydate" runat="server" ClientInstanceName="dtexec1" DateOnError="Today"
                         ...
                         <dropdownbutton text="Enter Date">
                                 ...
                                 <td style="width: 20%; height: 11px; vertical-align: top; background-color: #b7ceec; text-align: left;" valign="top">
                 <asp:Button ID="btnshow1" Text="Show" runat="server" OnClick="btnshow1_Click" CssClass="btn" /></td>
                                 <td style="width: 20%; height: 11px; text-align: left; vertical-align: top; background-color: #b7ceec;" valign="top">
                ...
                <tr>
                    <td>
                        <dxtc:ASPxPageControl runat="server" ID="pageControl" ActiveTabIndex="0" ClientInstanceName="page" Width="95%" BackColor="#B7CEEC">
                            <ContentStyle>
                            ...
                            <TabPages>
                                        ...
                                        <dxw:ContentControl runat="server">
                                         <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                 <table border="1">
                                        <tr>
                                        <td colspan="2" style="width: 20%; height: 11px; vertical-align: top; background-color: #b7ceec; text-align: left;" valign="top">
                                         <dxe:ASPxComboBox ID="CmbSlip" ClientInstanceName="cCmbSlip" runat="server" Width="335px" DropDownWidth="335px" ValueType="System.String" TextFormatString="{0}" EnableCallbackMode="True" IncrementalFilteringMode="StartsWith"
                                                CallbackPageSize="30" EnableAnimation="False">
                                                    <listboxstyle horizontalalign="Justify" wrap="False" cssclass=".forceInline"></listboxstyle>
                                                    <dropdownbutton text="Select Slip to Verify"></dropdownbutton>
                                                <ClientSideEvents SelectedIndexChanged="function(s, e) { OnComboSlipIndexChange(s); }"></ClientSideEvents>
                                             <ItemStyle BackColor="White" />
                                                </dxe:ASPxComboBox>
                                         </td>
                                            <td style="vertical-align: top; width: 20%; text-align: left; height: 11px; background-color: #b7ceec;">
                                                <dxe:ASPxButton ID="abtnverifyall" runat="server" Height="15px" Text="Verify All">
                                                    <ClientSideEvents Click="function(s, e) { VerifyAll(); }" />
                                                </dxe:ASPxButton>
                                            </td>
                                            <td style="vertical-align: top; width: 20%; text-align: left; height: 11px; background-color: #b7ceec;">
                                           <dxe:ASPxComboBox ID="CmbRecordChoser" runat="server" ClientInstanceName="cCmbRecordChoser" EnableIncrementalFiltering="True"
                                                    EnableSynchronization="False" SelectedIndex="0" TabIndex="1" ValueType="System.String"
                                                    Width="184px" AutoPostBack="True" OnSelectedIndexChanged="CmbRecordChoser_SelectedIndexChanged">
                                                    <items>
                                            ...
                                            <td style="vertical-align: top; width: 20%; height: 11px; text-align: left; background-color: #b7ceec;">
                                                <div>
                                          ...
                                          <dxwgv:ASPxGridView ID="GvMatchedRecord" ClientInstanceName="cGvMatchedRecord" runat="server"
                                                KeyFieldName="id" AutoGenerateColumns="False" Width="1076px" OnHtmlEditFormCreated="GvMatchedRecord_HtmlEditFormCreated"
                                                OnRowUpdating="GvMatchedRecord_RowUpdating" OnCustomCallback="GvMatchedRecord_CustomCallback"  
                                                OnCancelRowEditing="GvMatchedRecord_CancelRowEditing" OnHtmlRowCreated="GvMatchedRecord_HtmlRowCreated" 
                                                EnableCallbackCompression="True" OnRowUpdated="GvMatchedRecord_RowUpdated">
                                        ...
                                        <td>
                                            <dxwgv:ASPxGridViewTemplateReplacement ID="CancelButton" ReplacementType="EditFormCancelButton"
                                                ...
                                                <Columns>
                                                    ...
                                                    <dxwgv:GridViewDataTextColumn FieldName="AcceptReject" VisibleIndex="1" FixedStyle="Left" Width="75px" Visible="False">
                                                    ...
                                                    <dxwgv:GridViewDataColumn FieldName="MarketType" VisibleIndex="4" Width="130px">
                                                        <CellStyle Wrap="False">
                                                        </CellStyle>
                                                    </dxwgv:GridViewDataColumn>
                                                    <dxwgv:GridViewDataColumn FieldName="SettlementNumber" VisibleIndex="5" Width="100px">
                                                        <CellStyle Wrap="False">
                                                        </CellStyle>
                                                    </dxwgv:GridViewDataColumn>
                                                    <dxwgv:GridViewDataColumn FieldName="OtherDPID" VisibleIndex="6" Width="350px">
                                                        <CellStyle Wrap="False">
                                                        </CellStyle>
                                                    </dxwgv:GridViewDataColumn>
                                                    <dxwgv:GridViewDataColumn FieldName="OtherBenIDName" VisibleIndex="7" Width="200px">
                                                        <CellStyle Wrap="False">
                                                        </CellStyle>
                                                    </dxwgv:GridViewDataColumn>
                                                    <dxwgv:GridViewDataColumn FieldName="OtherCMBPID" VisibleIndex="8" Width="200px">
                                                        <CellStyle Wrap="False">
                                                        </CellStyle>
                                                    </dxwgv:GridViewDataColumn>
                                                    <dxwgv:GridViewDataColumn FieldName="CCCMID" VisibleIndex="9" Width="250px">
                                                        <CellStyle Wrap="False">
                                                        </CellStyle>
                                                    </dxwgv:GridViewDataColumn>
                                                    <dxwgv:GridViewDataColumn FieldName="OtherMarketType" VisibleIndex="10" Width="130px">
                                                        <CellStyle Wrap="False">
                                                        </CellStyle>
                                                    </dxwgv:GridViewDataColumn>
                                                    <dxwgv:GridViewDataColumn FieldName="OtherSettlementNumber" VisibleIndex="11" Width="100px">
                                                        <CellStyle Wrap="False">
                                                        </CellStyle>
                                                    </dxwgv:GridViewDataColumn>
                                                    <dxwgv:GridViewDataColumn FieldName="ISIN" VisibleIndex="12" Width="200px">
                                                        <CellStyle Wrap="False">
                                                        </CellStyle>
                                                    </dxwgv:GridViewDataColumn>
                                                    <dxwgv:GridViewDataColumn FieldName="Quantity" VisibleIndex="13" Width="50px">
                                                        <CellStyle Wrap="False">
                                                        </CellStyle>
                                                    </dxwgv:GridViewDataColumn>
                                                    <dxwgv:GridViewDataColumn FieldName="Consideration" VisibleIndex="14" Width="60px">
                                                     <CellStyle Wrap="False">
                                                     </CellStyle>
                                                    </dxwgv:GridViewDataColumn>
                                                    <dxwgv:GridViewDataColumn FieldName="TransactionDate" VisibleIndex="15" Width="100px">
                                                        <CellStyle Wrap="False">
                                                        </CellStyle>
                                                    </dxwgv:GridViewDataColumn>
                                                    <dxwgv:GridViewDataColumn FieldName="ExecutionDate" VisibleIndex="16" Width="100px">
                                                        <CellStyle Wrap="False">
                                                        </CellStyle>
                                                        
                                                    </dxwgv:GridViewDataColumn>
                                                    <dxwgv:GridViewDataColumn FieldName="EntryUserRole" VisibleIndex="17" Width="200px">
                                                        <CellStyle Wrap="False">
                                                        </CellStyle>
                                                    </dxwgv:GridViewDataColumn>
                                                    ...
                                                    <dxwgv:GridViewDataColumn FieldName="TransferReasonCode" VisibleIndex="27" Visible="False" Width="100px">
                                                     <CellStyle Wrap="False">
                                                     </CellStyle>
                                                 </dxwgv:GridViewDataColumn>
                                                 <dxwgv:GridViewDataColumn FieldName="TransferReasonPurpose" VisibleIndex="28" Visible="False" Width="100px">
                                                     <CellStyle Wrap="False">
                                                     </CellStyle>
                                                 </dxwgv:GridViewDataColumn>
                                                </Columns>
                                ...
                                <dxtc:TabPage Name="CorresPondence" Text="UnMatchedRecords">
                                    <ContentCollection>
                                        <dxw:ContentControl runat="server">
                                        </dxw:ContentControl>
                                    </ContentCollection>
