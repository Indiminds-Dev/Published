<%@ page language="C#" autoeventwireup="true" inherits="management_SettlementFee_DGCX, App_Web_fbvamflg" %>
...
<head runat="server">
    ...
    function OnMoreInfoClick(keyValue) {
        ...
        var url = 'SettlementTax_DGCX.aspx?id=' + keyValue;
    ...
    function OnAddButtonClick() 
    {
         ...
         var url = 'SettlementTax_DGCX.aspx?id=' + 'ADD';
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center;">
                    <strong><span style="color: #000099">Settlement Fees</span></strong>
                </td>
            </tr>
            <tr>
                <td align="right">
...
--%>               
             <dxwgv:GridViewDataTextColumn Caption="Group" FieldName="r" VisibleIndex="2" Width="15%">
                ...
                <dxwgv:GridViewDataTextColumn Caption="Rate" FieldName="SettlementFee_Rate" VisibleIndex="7"
                    Width="4%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <dxwgv:GridViewDataTextColumn Caption="From Date" FieldName="SettlementFee_DateFrom" VisibleIndex="10"
                    Width="6%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <dxwgv:GridViewDataTextColumn Caption="Untill Date" FieldName="SettlementFee_DateTo" VisibleIndex="11"
                    Width="6%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
            ...
            <SettingsText PopupEditFormCaption="Add/ Modify " GroupPanel="Settlement Fees" />
        ...
        <asp:SqlDataSource ID="ServiceTaxDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
            DeleteCommand="SettlementFeeDG_delete" DeleteCommandType="StoredProcedure">
            <DeleteParameters>
