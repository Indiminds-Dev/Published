<%@ page language="C#" autoeventwireup="true" inherits="Import_PHILIPMargin, App_Web_2wstwz9u" %>
        ...
        <table border="1">
            <tr>
                <td class="EHEADER" colspan="2" align="center" >
                                    <strong><span id="SpanHeader" style="color: #000099">Import Margin from Broker files</span></strong></td>
            </tr>
            <tr>
