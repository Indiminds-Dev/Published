<%@ page language="C#" autoeventwireup="true" inherits="Reports_SRVTAXSTATEMENT, App_Web_wt4jql-z" %>
...
<head id="Head1">
    <title>Service Tax Statement </title>
                                                ...
                                                <table border="10" cellpadding="1" cellspacing="1">
                                                    <tr valign="top">
                                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                                            Report Type :</td>
                                                        <td>
                                                            <asp:DropDownList ID="DdlReportType" runat="server" Width="100px" Font-Size="10px" onchange="ddlReportType_OnChange(this.value);">
                                                ...
                                                <table border="10" cellpadding="1" cellspacing="1">
                                                    <tr valign="top">
                                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                                            As Per :</td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlAsPer" runat="server" Width="150px" Font-Size="10px">
