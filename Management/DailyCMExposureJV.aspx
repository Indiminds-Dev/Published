<%@ page language="C#" autoeventwireup="true" inherits="management_DailyCMExposureJV, App_Web_bfdn6hbr" %>
    ...
    <div>
        <div id="Div_header" style="width: 89%">
            <div id="Div_headername" class="EHEADER" style="width: 97.5%;text-align :center">
                <strong><span id="SpanHeader" style="color: #000099; font-size: small; font-family: Tahoma,Arial, Helvetica, sans-serif;">Daily CM Exposure Journals</span></strong>
            </div>
