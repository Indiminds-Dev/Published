<%@ page language="C#" autoeventwireup="true" inherits="Reports_ClientCashReport_Aud, App_Web_91unyima" enableeventvalidation="false" %>
    ...
    function Page_Load()///Call Into Page Load
            {
                 ...
                 FnddlGeneration('1');
                 //New Work 110/05/2022
//                 ExportBatchSetting('Export');
                 ExportBatchSetting('1');
                 //End of New Work 110/05/2022
                 Hide('tr_BSERow');
                    //New Batch
...
//        }
    ...
    function OnMoreInfoClick()
    {
        ...
        var url ="../GenericRoutines/Batch/GenericBatchMaintenance.aspx?FileType=ClientCash&SqlWhere="+SqlWhere;
    ...
    function GnrcCallBackPanel_EndCallBack()
    {
        ...
        if(cGnrcCallBackPanel.cpIsSpData!=undefined)
        {
            ...
            //New Work 10/05/2022
            else if(cGnrcCallBackPanel.cpIsSpData=="APIFile")
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                        <strong><span id="SpanHeader" style="color: #000099">Client Cash Report
                        </span></strong>
                    </td>
            ...
            <tr>
                ...
                <td>
                    <dxe:ASPxComboBox ID="CmbGenerate" runat="server" ClientInstanceName="cCmbGenerate"
                        ...
                        Width="200px">
                        <Items>
                            <dxe:ListEditItem Text="DetailWorking -Funds" Value="1" />
                            <dxe:ListEditItem Text="DetailWorking -Collaterals" Value="2" />
                            <dxe:ListEditItem Text="Export Report" Value="3" />
                            <dxe:ListEditItem Text="Export Batch" Value="4" />
                            <%--New Work 10/05/2022--%>
                            <dxe:ListEditItem Text="Create API" Value="5" />
                            <%--End of New Work 10/05/2022--%>
                        </Items>
                        ...
                        <tr>
                            <td>
                                <dxe:ASPxButton ID="Abtn_APICreate" runat="server" AutoPostBack="False" ClientInstanceName="cAPICreate"
                                    ...
                                    <ClientSideEvents Click="function(s,e){GnrcCallBackPanel_Methods('APIFile');}" />
                                </dxe:ASPxButton>
                            </td>
                        </tr>
                    </table>
