<%@ page language="C#" autoeventwireup="true" inherits="empState, App_Web_s3wzohpw" %>
...
//                 grid.PerformCallback('updatestate~'+ctxtStateName.GetText()+'~'+ cCmbCountryName.GetText()+'~'+GetObjectID('hiddenedit').value);
    ...
    <style type="text/css">
        ...
        .Top{height: 80px; width: 400px; background-color: Silver;padding-top: 5px;}
    ...
    <form id="form1" runat="server">
        <div class="Main">
            ...
            <div class="GridViewArea">
                <dxwgv:ASPxGridView ID="StateGrid" runat="server" AutoGenerateColumns="False" ClientInstanceName="grid"
                    ...
                    <Columns>
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="State" FieldName="state" Width="8%" FixedStyle="Left"
                            Visible="True" VisibleIndex="1">
                            <EditFormSettings Visible="True" />
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Country Name" FieldName="countryId" Visible="False"
                            Width="8%" VisibleIndex="2">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="NSECode" FieldName="State_NSECode" Visible="True"
                            Width="8%" VisibleIndex="3">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="BSECode" FieldName="State_BSECode" Visible="True"
                            Width="8%" VisibleIndex="4">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="MCXCode" FieldName="State_MCXCode" Visible="True"
                            Width="8%" VisibleIndex="5">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="MCXSXCode" FieldName="State_MCXSXCode" Visible="True"
                            Width="8%" VisibleIndex="6">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="NCDEX" FieldName="State_NCDEXCode" Visible="True"
                            Width="8%" VisibleIndex="7">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="CdslID" FieldName="State_CdslID" Visible="True"
                            Width="8%" VisibleIndex="8">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="NsdlID" FieldName="State_NsdlID" Visible="True"
                            Width="8%" VisibleIndex="9">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="NDMLId" FieldName="State_NDMLId" Visible="True"
                            Width="8%" VisibleIndex="10">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="DotExID" FieldName="State_DotExID" Visible="True"
                            Width="8%" VisibleIndex="11">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="CVLID" FieldName="State_CVLID" Visible="True"
                        ...
                        <dxwgv:GridViewDataTextColumn ReadOnly="True">
                            ...
                            <DataItemTemplate>
                                ...
                                <a href="javascript:void(0);" onclick="fn_DeleteState('<%# Container.KeyValue %>')">
                                    Delete</a>
                            </DataItemTemplate>
                        </dxwgv:GridViewDataTextColumn>
                    </Columns>
            ...
            <%--added by krishnendu--%>
            <div class="PopUpArea">
                <dxpc:ASPxPopupControl ID="Popup_EmpStates" runat="server" ClientInstanceName="cPopup_EmpStates"
