<%@ page language="C#" autoeventwireup="true" inherits="Reports_Form_10DB, App_Web_wqa_thzl" %>
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Calculation Type :</td>
                                        <td>
                                            <asp:DropDownList ID="DLLCalculation" runat="server" Width="220px" Font-Size="10px">
