<%@ page language="C#" autoeventwireup="true" inherits="management_frmnewmessage_popup, App_Web_akbpwr7y" %>
                                                            ...
                                                            <table class="TableMain100">
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2" class="gridcellleft">
                                                                        <asp:TextBox ID="txtShortDescription" runat="server" Width="269px" Font-Size="10px"></asp:TextBox></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="gridcellright" style="width: 26%">
