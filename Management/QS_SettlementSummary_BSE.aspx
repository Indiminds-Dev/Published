<%@ page language="C#" autoeventwireup="true" inherits="Management_QS_SettlementSummary_BSE, App_Web_lgnajdkn" %>
...
<head id="Head1" runat="server">
    <title>Export Batch File For "Submission of summary of settlement of clients funds"</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Export Batch File For "Submission of summary of settlement of clients funds</span></strong></td>
       ...
       <table id="tab2" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                        ...
                        <tr> <td style="width: 175px">
                            <strong>For Settlement Done On :</strong></td><td style="width: 200px">   <dxe:ASPxDateEdit ID="dtDate" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                        Font-Size="10px" Width="185px" ClientInstanceName="dtfor">
                        ...
                        <tr>
                         ...
                         <tr>
                                ...
                                <asp:Button ID="btnGenerate" runat="server" CssClass="btnUpdate" Height="20px" Text="Generate Batch File"
                                      Width="205px" OnClick="btnGenerate_Click" />
                            </td>
