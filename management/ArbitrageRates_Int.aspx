<%@ page language="C#" autoeventwireup="true" inherits="Management_ArbitrageRates_Int, App_Web_xu-hjjp9" %>
        ...
        <div>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtasset"
                ...
                <tr>
                    ...
                    <td style="width: 200px; vertical-align: top;">
                        <dxe:ASPxDateEdit ID="dtExTo" runat="server" EditFormat="Custom" EditFormatString="dd-MM-yyyy"
                            ClientInstanceName="cDtExTo" UseMaskBehavior="True" Font-Size="13px" Width="300px">
                        </dxe:ASPxDateEdit>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 200px; vertical-align: top;">
                        <dxe:ASPxSpinEdit ID="txtRate" ClientInstanceName="ctxtRate" Width="300px" runat="server" DecimalPlaces="2" 
                        MinValue="-9999999999.99" MaxValue="9999999999.99" NullText="0000000000.00">
                    ...
                    <td style="width: 200px; vertical-align: top;">
                        <dxe:ASPxSpinEdit ID="txtHChrg" ClientInstanceName="ctxtHChrg" Width="300px" runat="server" DecimalPlaces="2" 
                        MinValue="-99999.99" MaxValue="99999.99" NullText="00000.00">
                            <SpinButtons ShowIncrementButtons="true" />
                        </dxe:ASPxSpinEdit>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width: 200px; vertical-align: top;">
                        <dxe:ASPxSpinEdit ID="txtPrm" ClientInstanceName="ctxtPrm" Width="300px" runat="server" DecimalPlaces="8" 
                        MinValue="-999999.99999999" MaxValue="999999.99999999" NullText="000000.00000000">
                            <SpinButtons ShowIncrementButtons="true" />
                        </dxe:ASPxSpinEdit>
                    </td>
                    <td class="gridcellleft" style="background-color: #B7CEEC; width: 150px;">
                    ...
                    <td style="width: 200px; vertical-align: top;">
                        <dxe:ASPxSpinEdit ID="txtFPrm" ClientInstanceName="ctxtFPrm" Width="300px" runat="server" DecimalPlaces="8" 
                        MinValue="-999.99999999" MaxValue="999.99999999" NullText="000.00000000">
                            <SpinButtons ShowIncrementButtons="true" />
                        </dxe:ASPxSpinEdit>
                    </td>
                </tr>
