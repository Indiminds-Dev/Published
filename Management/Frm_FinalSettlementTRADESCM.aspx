<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_FinalSettlementTRADESCM, App_Web_bfdn6hbr" %>
   ...
   <script language="javascript" type="text/javascript">
    ...
    function PageLoad()
    {
       ...
       //File Format to Import By Default
        Span_FileFormat.innerText="File : Custom Final Settlement Position CSV Files";
    }
    ...
    function OnComboChooseFileIndexChange()
    {
        ...
        if(SelectedValue==0)
            Span_FileFormat.innerText="File : Custom Final Settlement Position Files";
        else
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports Final Settlement Position File generated from the system
                                </h5>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td style="width: 100px">
                                            <dxe:ASPxComboBox ID="ComboChooseFile" runat="server" ClientInstanceName="cComboChooseFile"
                                                ...
                                                <Items>
                                                    <dxe:ListEditItem Value="0" Text="Final Settlement Position File"></dxe:ListEditItem>
