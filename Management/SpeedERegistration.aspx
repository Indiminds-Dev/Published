<%@ page language="C#" autoeventwireup="true" inherits="Management_SpeedERegistration, App_Web_leuczwkw" %>
...
<head id="Head1" runat="server">
    <title>Generate Batch File For POA/DDPI Client Registration [SpeedE]</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Batch File For SpeedE Registration</span></strong></td>
