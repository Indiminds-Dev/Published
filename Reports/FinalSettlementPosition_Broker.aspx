<%@ page language="C#" autoeventwireup="true" inherits="Reports_FinalSettlementPosition_Broker, App_Web_xpx38is4" %>
...
<head id="Head1" runat="server">
    <title>Export Final Settlement Positions</title>
       ...
       function btnAddsubscriptionlist_click()
            {
                ...
                var cmb=document.getElementById('cmbsearchOption');
                        var userid = document.getElementById('csvSelectionID');
                        if(userid.value != '')
                        {
                            var ids = document.getElementById('csvSelectionID_hidden');
                            ...
                            listBox[tLength]=no;
                            var recipient = document.getElementById('csvSelectionID');
                            recipient.value='';
                        }
                        else
                            alert('Please search name and then Add!')
                        var s=document.getElementById('csvSelectionID');
                        s.focus();
                        s.select();
    ...
    <div>
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Export Final Settlement Positions [Broker Wise]</span></strong></td>
       ...
       <table id="tab2" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                        ...
                        <tr> <td>
                            <strong>Date:</strong></td><td>   <dxe:ASPxDateEdit ID="dtDate" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="gridcellleft" style="vertical-align: top; text-align: right; height: 21px;"
                                            ...
                                            <asp:TextBox ID="csvSelectionID" runat="server" Font-Size="12px" Width="150px" onkeyup="ajaxcall(this,'chkfn',event)"></asp:TextBox>
        ...
        <table>
            <tr>
                <td style="display: none;">
                    <asp:TextBox ID="csvSelectionID_hidden" runat="server" Font-Size="12px" Width="150px"></asp:TextBox>
