<%@ page language="C#" autoeventwireup="true" inherits="management_Insert_IntArbRates, App_Web_mzqu16me" %>
...
<head id="Head1">
    <title>Generate Arbitrage Rates for Next Working Date</title>
...
//            alert('Generate For Remaining Bills...');
        ...
        if(obj=="5")
        {
            ...
            window.location = "../Management/Insert_IntArbRates.aspx";
        }
          ...
          $get('UpdateProgress1').style.display = 'none'; 
            ...
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Create Arbitrage Rates For Next Working Date</span></strong></td>
                        ...
                        <table>
                            ...
                            <tr>
                                <td valign="top" colspan="3">
                                    <asp:Button ID="btnGenerate" runat="server" CssClass="btnUpdate" Height="20px" Text="Create Records"
