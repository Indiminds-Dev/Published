<%@ page language="C#" autoeventwireup="true" inherits="management_GenerateIFSProfitLoss, App_Web_nidspgif" %>
...
<head id="Head1">
    <title>Generate OPTIONS Open Position Market Value Adjustment JVs</title>
...
//            alert('Generate For Remaining Bills...');
        ...
        if(obj=="5")
        {
            ...
            window.location = "../Reports/GenerateIFSProfitLoss.aspx";
        }
          ...
          $get('UpdateProgress1').style.display = 'none'; 
            ...
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">OPTIONS Open Position Market Value Adjustment JVs</span></strong></td>
