<%@ page language="C#" autoeventwireup="true" inherits="management_frmImportNsdlISIN, App_Web_zsukfi_p" %>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2" style="width: auto; height: auto;">
                    <strong>This Routine Imports "NSDL ISIN" file available from NSDL DPM System</strong>
                </td>
            </tr>
            <tr>
                                            ...
                                            <tr>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0">
                                                        ...
                                                        <td>
                                                            ...
                                                            <td style="vertical-align:top; padding-top:2px; padding-left:2px"> Exclude Commodity Type</td>
                                                        </tr>
                                                    </table>
                                                    </td>
                                            </tr>
