<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_SendEmailWithTemplate, App_Web_cvaj-tqf" validaterequest="false" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table class="TableMain100">
                <tr>
                    <td valign="top">
                        <table style="margin: 0px 0px 0px 0px; background-color: #B7CEEC;" width="500px"
                            border="#ffffff">
                            <tr>
                                ...
                                <td class="gridcellleft">
                                    <asp:DropDownList ID="cmbGenerate" runat="server" Width="80px" Font-Size="10px" onchange="ChangeType(this.value)"
                                        TabIndex="2">
                                                ...
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        <td class="gridcellleft" align="left">
                                                            <asp:ListBox ID="lstSuscriptions" runat="server" Font-Size="10px" Height="60px" Width="335px">
                                                            </asp:ListBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                        ...
                        <table style="margin: 0px 0px 0px 0px; background-color: #9EBEF5;" width="500px"
                            ...
                            <tr>
                                <td colspan="3" style="color:Maroon">
                                    [ Please Note: You can only use variable as shown beside the template content.For
                                            ...
                                            <td valign="top" style="padding-top: 110px;">
                                                <table style="background-color: #ffffff; border: solid 1px black;" cellpadding="1"
                                                    cellspacing="1" border="1">
                                                      <tr>
                                                    <td  style=" font-size:10px;font-weight:bold;color:Maroon">
                                                  User Variable
                                                    </td>
                                                    </tr>
