<%@ page language="C#" autoeventwireup="true" inherits="Reports_ACapFileDGCX, App_Web_eozuxu2i" %>
...
<head id="Head1" runat="server">
    <title>Available Capital File For CTCL</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Available Capital File For CTCL</span></strong></td>
