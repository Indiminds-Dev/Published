<%@ page language="C#" autoeventwireup="true" inherits="Reports_RegisterOfTransaction, App_Web_hnkxxmul" %>
...
<head id="Head1">
    <title>Register Of Transaction</title>
  ...
  function heightlight(obj)
   ...
   function FnPopUp(obj,objtype)
   {
        ...
        if(objtype=='PopUp')
        {
            ...
            parent.OnMoreInfoClick(url,'Details For','940px','450px,resize=0','N');
        }
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Report Type :</td>
                                        <td>
                                            <asp:DropDownList ID="DdlRptType" runat="server" Width="250px" Font-Size="10px">
                                            ...
                                            <table>
                                                <tr>
                                                    <td class="gridcellleft" bgcolor="#B7CEEC">
                                                        Pan Details :</td>
                                                    <td>
                                                        <asp:DropDownList ID="DdlPanDetails" runat="server" Width="150px" Font-Size="10px">
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Export :</td>
                                        <td>
                                            <asp:DropDownList ID="ddlExport" runat="server" Width="150px" Font-Size="10px" onchange="fnrpttype(this.value)">
