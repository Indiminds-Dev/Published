<%@ page language="C#" autoeventwireup="true" inherits="NSEFOContractMaster, App_Web_fxnvzv_8" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Import NSE-FO Contract</title>
            ...
            <table id="tbl_main" cellpadding="0" cellspacing="0" class="login" width="410">
               ...
               <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Import F&O Contracts using: "foDDMONYYYYbhav.csv" from NSE's WebSite OR "F_CN01_DDMMYYYY.CSV" From NSE's Extra-net[FTP] server
                        </h5>
                    </td>
                </tr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td align="right" style="width: 278px; height: 22px">
                                            <asp:FileUpload ID="NSEFOSelectFile" runat="server" Height="20px"/>
                                        </td>
                                    </tr>
                                    <tr>
