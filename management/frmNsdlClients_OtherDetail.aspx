<%@ page language="C#" autoeventwireup="true" inherits="management_frmNsdlClients_OtherDetail, App_Web_fbvamflg" %>
...
<dxe:ListEditItem Text="Prepaid Card" Value="3">
                                          ...
                                          <%-- -------------------------- NSDL Investement & Verification  Start---------------------- --%>
                                            <table class="TableMain100">
                        ...
                        <%-- <tr><td colspan="4" style="text-align: right;">
                         <input id="btnSave" type="button" value="Save" class="btnUpdate" onclick="btnSave_Click()"
                                   ...
                                   <tr><td colspan="2" align="left">
                                           ...
                                           <%-- -------------------------- NSDL Investement & Verification  End----------------------------------------------------------------------%>
             ...
             <asp:SqlDataSource ID="sqlBrokerage" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
                ...
                DeleteCommand="DELETE FROM [Trans_DPChargeMembers] WHERE [DPChargeMembers_ID] = @DPChargeMembers_ID"
                InsertCommand="insertDpBrokerage" InsertCommandType="StoredProcedure" UpdateCommand="UPDATE [Trans_DPChargeMembers] SET [DPChargeMembers_BenAccountNumber] = @DPChargeMembers_BenAccountNumber, [DPChargeMembers_CompanyID] = @DPChargeMembers_CompanyID, [DPChargeMembers_SegmentID] = @DPChargeMembers_SegmentID, [DPChargeMembers_GroupType] = @DPChargeMembers_GroupType, [DPChargeMembers_GroupCode] = @DPChargeMembers_GroupCode, [DPChargeMembers_FromDate] = @DPChargeMembers_FromDate, [DPChargeMembers_ModifyUser] = @DPChargeMembers_ModifyUser, [DPChargeMembers_ModifyDateTime] = getdate() WHERE [DPChargeMembers_ID] = @DPChargeMembers_ID">
                <DeleteParameters>
