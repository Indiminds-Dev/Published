<%@ page language="C#" autoeventwireup="true" inherits="Reports_PortfolioPerformanceFO, App_Web_gflohp-r" %>
 ...
 <script language="javascript" type="text/javascript">
  ...
  function Display()
  {
      ...
      Hide('showFilter');
       ...
       if(document.getElementById('ddlmtmcalbasis').value=='0')
        {
       ...
       <table id="tab2" border="0" cellpadding="0" cellspacing="0">
            <tr valign="top">
                ...
                <td class="gridcellleft">
                    <asp:DropDownList ID="ddldate" runat="server" Width="80px" Font-Size="10px" onchange="fn_ddldateChange(this.value)">
            ...
            <tr>
                            ...
                            <td class="gridcellleft" BGCOLOR="#B7CEEC">
                                Report Type :</td>
                            <td colspan="3">
                                <asp:DropDownList ID="ddlrpttype" runat="server" Font-Size="11px" Width="200px"
                                                Enabled="true">
                            ...
                            <td colspan="5" class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        ...
                                        <td>
                                            <%--<asp:TextBox runat="server" Width="250px" Font-Size="10px" ID="txtunderlying" onkeyup="ajax_showOptions(this,'Searchproductandeffectuntil',event,'Product')"></asp:TextBox>
                                            <asp:TextBox ID="txtunderlying_hidden" runat="server" Width="14px" Style="display: none;"> </asp:TextBox>--%>
                                            </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td colspan="5" class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        ...
                                        <td>
                                           <%-- <asp:TextBox runat="server" Width="250px" Font-Size="10px" ID="txtExpiry" onkeyup="fnexpirtycallajax(this,'Searchproductandeffectuntil',event)"></asp:TextBox>
                            ...
                            <td class="gridcellleft" style="width:100px;" BGCOLOR="#B7CEEC">
                               Instrument Type :</td>
                            <td colspan="3">
                                <asp:CheckBoxList ID="chkinstrutype" runat="server" RepeatDirection="Horizontal" Width="150px">
                                    <asp:ListItem Value="F" Selected="True">Future</asp:ListItem>
                                    <asp:ListItem Value="C" Selected="True">Call</asp:ListItem>
                                    <asp:ListItem Value="P" Selected="True">Put</asp:ListItem>
                                    <asp:ListItem Value="Spot" Enabled="False">Spot</asp:ListItem>
                                </asp:CheckBoxList>
                            </td>
                                    ...
                                    <ContentTemplate>
                                        <table runat="server">
                                            <tr valign="top">
                                                ...
                                                <td style="height: 44px">
                                                    <asp:DropDownList ID="cmbgroup" runat="server" Font-Size="10px" Width="300px"
