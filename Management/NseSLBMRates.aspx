<%@ page language="C#" autoeventwireup="true" inherits="management_NseSLBMRates, App_Web_rilo-itm" %>
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports NSE SLBM Segments Bhavcopy "SLBM_BC_ddmmyyyy.DAT" files</h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="lt brdr">
