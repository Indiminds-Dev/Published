<%@ page language="C#" autoeventwireup="true" inherits="management_frm_BankDepositSlip, App_Web__yen2upk" %>
                    ...
                    <td align="Center">
                        <table width="500px">
                            <tr>
                                ...
                                <td class="gridcellleft">
                                    <asp:TextBox ID="txtBankName" runat="server" Font-Size="10px" Width="250px" TabIndex="1"
                            ...
                            <tr>
                                <td class="gridcellleft">
                                    Narration </td>
                                <td class="gridcellleft">
                                  <asp:TextBox ID="txtNarration" runat="server" Font-Size="10px" Width="250px" TabIndex="4" Height="41px" TextMode="MultiLine"></asp:TextBox>
                                </td>
                            </tr>
                            <tr id="trSummary">
                                <td>
