<%@ page language="C#" autoeventwireup="true" inherits="frm_MCXTRADES, App_Web_alid8jfz" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>USE-CDX Trade</title>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            &nbsp;<asp:DropDownList ID="cmbTrade" runat="server" AutoPostBack="True" Font-Bold="True"
                                                OnSelectedIndexChanged="cmbTrade_SelectedIndexChanged1" Width="122px">
                                                <asp:ListItem Value="0">Select </asp:ListItem>
                                                <asp:ListItem Value="1">Final CSV</asp:ListItem>
                                                <asp:ListItem Value="2">Final TXT</asp:ListItem>
                                            </asp:DropDownList></td>
                                    </tr>
                                      <tr>
