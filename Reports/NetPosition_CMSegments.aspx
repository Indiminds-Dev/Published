<%@ page language="C#" autoeventwireup="true" inherits="Reports_NetPosition_CMSegments, App_Web_jaxycpk3" enableeventvalidation="false" %>
...
<head>
    <title>NetPosition CMSegments Page</title>
    <!--External Styles-->
                                    ...
                                    <ContentTemplate>
                                        <div id="C1_Row4_Col4" class="LFloat_Content Box_filter">
                                            <div class="Box_filter_HeaderCont">
                                                Columns Showing :</div>
                                            <span class="clear"></span>
                                            <asp:ListBox ID="lstAllListBox" class="Box_filterCont" runat="Server" SelectionMode="Multiple">
                                            </asp:ListBox>
                                        </div>
                                        ...
                                        <div id="C1_Row4_Col6" class="LFloat_Content Box_filter">
                                            <div class="Box_filter_HeaderNotCont">
                                                Columns Not Showing :</div>
                                            <span class="clear"></span>
                                            <asp:ListBox ID="lstFilteredListBox" runat="Server" class="Box_filterCont" SelectionMode="Multiple">
                                            </asp:ListBox>
                                        </div>
                                    </ContentTemplate>
                                    <Triggers>
