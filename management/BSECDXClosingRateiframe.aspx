<%@ page language="C#" autoeventwireup="true" inherits="management_frm_MCXClosingRates, App_Web_6_wayyot" %>
    ...
    <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 22px;">
                        <strong><span id="SpanHeader" style="color: #000099">Imports BSE-CDX Closing Rates</span></strong>
                    </td>
                </tr></table>
            ...
            <tr>
                ...
                <td style="padding-left:4px" align=left>
                    <select id="cmbTrade" onchange="Javascript:ShowDate(this.value)" runat="server">
                        ...
                        <option value="1">BFX_MS1_YYYYMMDD.CSV (FTP)</option>
                        <option value="2">BFX_MS2_YYYYMMDD.CSV (FTP)</option>
                        <option value="3">CurrencyBhavCopy_YYYYMMDD.CSV (WEB)</option>
