<%@ page language="C#" autoeventwireup="true" inherits="management_frmScriptIsinNSE, App_Web_mzqu16me" %>
                                                    ...
                                                    <td class="lt" >
                                                        ...
                                                        <table>
                                                         ...
                                                         <asp:Label id="lblMessage" runat="server" Width="270px"></asp:Label><br />
                                                           <asp:Label ID="Label2" runat="server" Font-Bold="True" Text=" Select Security.txt file"
                                                               Width="177px"></asp:Label>
                                                            </ContentTemplate>
                                                      
                                                       </asp:UpdatePanel>
                                                                    <strong>Files Avialable At : NTNEAT Folder of NSE's ExtraNet Server</strong></td>
                                                         </tr>
