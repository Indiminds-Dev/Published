<%@ page language="C#" autoeventwireup="true" inherits="management_CashBankEntry, App_Web_cvaj-tqf" %>
...
<head >
    ...
    <script language="javascript" type="text/javascript">
        /**************************************Revision Detail**************************************/
        //Changes_20181224 [Add Settlment Number Type,Purpose,Other Pupose]
        ...
        function PageLoad()
        {
            ...
            cAtxtOthrPrps.SetEnabled(false);
           ...
           //Changes_20181224
            ...
            //New Work 24/06/2024
//            if (SegmentName == "NSDL" || SegmentName == "CDSL" || SegmentName=="Accounts")
            if (SegmentName == "NSDL" || SegmentName == "CDSL" || SegmentName=="Accounts" || SegmentName=="InvestPool")
            //End of New Work 24/06/2024
            {
                Hide('tr_SettNoPrps');
            }
            else 
...
//            alert(cCbpChoosenCurrency.cpChangeCurrencyParam);
        ...
        function keyVal(obj)
        {
            ...
            else if(obj.split('~')[7]=="SETTLEMENTS")
            {
                //Nothing to do but added cuase 'else section' execute if this section is not here for settlement selection
            }
            else 
            {
                document.getElementById('hdn_Brch_NonBrch').value='NAB';
        ...
        function OnComboInstTypeSelectedIndexChanged()
        {
            ...
            if(VoucherType=="R")
            {
                if(InstType=="C" || InstType=="E")
                {
                    ...
                    //New Work 24/06/2024
//                    if(SubLedgerType.toUpperCase().trim()=='CUSTOMERS')
                    if(SubLedgerType.toUpperCase().trim()=='CUSTOMERS' || SubLedgerType.toUpperCase().trim()=='INVESTORS' || SubLedgerType.toUpperCase().trim()=='FUND MANAGERS')
                    //End of New Work 24/06/2024
                    //End of New Work 17/05/2022
                    {
        ...
        {
            var Mode=document.getElementById("hdn_Mode").value;
            if(Mode=="Entry") //Disable Add Detail in Editing
            {
                var txtSubAccountText=document.getElementById("txtSubAccount").value;
...
//                        if(SubLedgerType.toUpperCase().trim()=='CUSTOMERS' && CashBankType.toUpperCase().trim() != 'CASH')
                        if((SubLedgerType.toUpperCase().trim()=='CUSTOMERS' || SubLedgerType.toUpperCase().trim()=='INVESTORS' || SubLedgerType.toUpperCase().trim()=='FUND MANAGERS') && CashBankType.toUpperCase().trim() != 'CASH')
                        //End of New Work 24/06/2024
                        {
                            document.getElementById("tdCBankLable").style.display = 'inline';
                            document.getElementById("tdCBankValue").style.visibility = 'visible';
                ...
                {
                    //Adding CashType-->Cash .For Contra Entry
                    AddRemove_InstTypeItem("SetTypeForContra","","");
                    document.getElementById("tdContraEntry").style.display = 'inline'
            ...
            else alert('You Can Not Add More Entry in Edit Mode!!!.');
...
//           var strQuery_WhereClause = " (MainAccount_Name like (\'%RequestLetter%\') or MainAccount_AccountCode like (\'%RequestLetter%\')) and isnull(MainAccount_BankCashType,'abc') not in('Cash','Bank')";
           if(SegmentName=="InvestPool")
            {
                var strQuery_WhereClause = " (MainAccount_Name like (\'%RequestLetter%\') or MainAccount_AccountCode like (\'%RequestLetter%\')) and isnull(MainAccount_BankCashType,'abc') not in('Cash','Bank') and MainAccount_SubLedgerType in('Employees','Fund Managers','Investors','None')";
            }
            else
            {
                var strQuery_WhereClause = " (MainAccount_Name like (\'%RequestLetter%\') or MainAccount_AccountCode like (\'%RequestLetter%\')) and isnull(MainAccount_BankCashType,'abc') not in('Cash','Bank') and MainAccount_SubLedgerType not in('Fund Managers','Investors')";
            }
           //End of New Work 24/06/2024
           var strQuery_OrderBy='';
           var strQuery_GroupBy='';
...
//           var strQuery_WhereClause = " (MainAccount_Name like (\'%RequestLetter%\') or MainAccount_AccountCode like (\'%RequestLetter%\')) and MainAccount_BankCashType not in('Cash','Bank')";
           if(SegmentName=="InvestPool")
            {
                var strQuery_WhereClause = " (MainAccount_Name like (\'%RequestLetter%\') or MainAccount_AccountCode like (\'%RequestLetter%\')) and MainAccount_BankCashType not in('Cash','Bank') and MainAccount_SubLedgerType in('Employees','Fund Managers','Investors','None')";
            }
            else
            {
                var strQuery_WhereClause = " (MainAccount_Name like (\'%RequestLetter%\') or MainAccount_AccountCode like (\'%RequestLetter%\')) and MainAccount_BankCashType not in('Cash','Bank') and MainAccount_SubLedgerType not in('Fund Managers','Investors')";
            }
           //End of New Work 24/06/2024
           var strQuery_OrderBy='';
           var strQuery_GroupBy='';
        ...
        {
           var strQuery_Table = "tbl_master_Bank";
        ...
        function CallBankAccount(obj1,obj2,obj3)
        {
           ...
           var strQuery_Table = "(Select MainAccount_AccountCode+\'-\'+Case When CHARINDEX('~',MainAccount_Name)>0 then Substring(MainAccount_Name,0,CHARINDEX('~',MainAccount_Name)) else MainAccount_Name end+\' [ \'+MainAccount_BankAcNumber+\' ]\'+\' ~ \'+MainAccount_BankCashType as IntegrateMainAccount,MainAccount_AccountCode+\'~\'+MainAccount_BankCashType+\'~CASHBANK\' as MainAccount_AccountCode,Case When CHARINDEX('~',MainAccount_Name)>0 then Substring(MainAccount_Name,0,CHARINDEX('~',MainAccount_Name)) else MainAccount_Name end MainAccount_Name,MainAccount_BankAcNumber from Master_MainAccount where (MainAccount_BankCashType=\'Bank\' or MainAccount_BankCashType=\'Cash\') and (MainAccount_BankCompany=\'" + '<%=Session["LastCompany"] %>' + "\' Or IsNull(MainAccount_BankCompany,'')='')" + strPutSegment + ") as t1";
        ...
        function OnCancelButtonClick()
        {
            ...
            ctxtInstNo.SetText("");
            cInstDate.SetDate(cdtTDate.GetDate());
            ...
            //Changes_20181224
            document.getElementById('<%=txtSettNoType.ClientID%>').value='';
            document.getElementById('<%=txtSettNoType_hidden.ClientID%>').value='';
            cAtxtOthrPrps.SetText("");
            cCmbPurpose.SetSelectedIndex(0); 
            //End Changes_20181224
           ...
           if(strUndefined != "undefined")
            ...
            if(strUndefined != "undefined")
            {
                ...
                else if(strUndefined=="Success")
                {
                    ...
                    if (Mode == "Entry")
                    {
                        var answer = confirm ("Do You Want To Print Entry/Entries?");
                        if (answer)
                        {
                    ...
                    { 
                    ////Change by Subhadeep for temporary reason (print voucher for editing purpose)
                        var answer = confirm ("Do You Want To Print Entry/Entries?");
                        if (answer)
                        {
                            document.getElementById('btnPrint').click();
            ...
            {
                ClearHiddenField();
                if(cGvAddRecordDisplay.cpClearHiddenField.split('~')[1]=="Start") location.reload(true);
                if(cGvAddRecordDisplay.cpClearHiddenField.split('~')[1]=="Search") document.getElementById("hdn_Mode").value="Edit";
            }
            if(cGvAddRecordDisplay.cpExit!=undefined)
            {
                BackSearchResult_linkClick();
            }
            ...
            if(cGvAddRecordDisplay.cpShowDetailPopUpDirectlyForContra!=undefined)
            {
//                 alert('call');
//                ShowInstTypePopUpE();
            }
...
//                        }
            ...
            if(cInstrumentDetail_CallbackPanel.cpBindCustBank!=undefined)
            {
         ...
         function SetValueOnEdit(VoucherType,ParameterString)
         {
            ...
            //Changes_20181224
            var SettlementNumber=ParameterString.split('~')[19];
            var SettlementType=ParameterString.split('~')[20];
            var Purpose=ParameterString.split('~')[21];
            var OtherPurpose=ParameterString.split('~')[22];
            //End Changes_20181224
...
////////            SubAccountID +'~ 19: '+SettlementNumber+'~ 20: '+SettlementType+'~21: '+Pupose+'~22: '+OtherPurpose);
            ////----------------------------------------------------
            if(VoucherType=="P")
            {
                OnSwitchingBetweenEditing_RefreshField();
            ...
            //Changes_20181224
            document.getElementById('<%=txtSettNoType.ClientID%>').value=SettlementNumber+SettlementType;
            document.getElementById('<%=txtSettNoType_hidden.ClientID%>').value=SettlementNumber+"~"+SettlementType;;
            cAtxtOthrPrps.SetText(OtherPurpose);
            cCmbPurpose.PerformCallback("SetOtherPurpose~"+Purpose);
            //End Changes_20181224
        }
        function OnUpdateButtonClick()
        {
        
            var SubAccountBranch; ///SubAccountBranch tell us that entry is for any Branch Item or NonBranch Item 
            //and SubaccountBranch value will be BranchId for BranchItem or 'NAB' for Non Branch Item
            var DefaultBranch;
            var Mode=document.getElementById("hdn_Mode").value;
            if(Mode=="Entry") 
            {
        ...
        function ComboInstType_EndCallBack()
        {
            ...
            if(document.getElementById("hdn_CashBankType_InstTypeE").value.toUpperCase()=="CASH") //Contra Change
            {
                cComboInstType.SetSelectedIndex(0);
                document.getElementById("tdINoLable").style.visibility = 'hidden'
                document.getElementById("tdINoValue").style.visibility = 'hidden'
            ...
            if(cComboInstType.cpSetValue!=undefined)
            {
                ...
                else if(cComboInstType.cpSetValue=="Cash")//Contra Change
                    cComboInstType.SetValue('CH');
                else
...
//            alert(VoucherTypeV+'~'+InstTypeV+'~'+SubLedgerType);
        ...
        function SaveButtonClick()
         ...
         function ResetPageOnSave()
         {
            ...
            document.getElementById('<%=B_ImgSymbolAcBal.ClientID %>').innerHTML = '';
            document.getElementById('<%=B_AcBalance.ClientID %>').innerHTML = '';
            //document.getElementById('<%=B_ChoosenCurrency.ClientID %>').innerHTML = '';
            IsSubAccountChange="False";
            Param_SubAccountID=''
            SubLedgerType='';
            MainAcCode='';
...
//             "\n LineNarration :"+LineNarration);
            ...
            cGvCBSearch.PerformCallback("Search~"+SelectedValue+'~'+document.getElementById("A1").innerText+"#"+SearchParam);
         }
         function GvCBSearch_EndCallBack()
         {

            var strUndefined=new String(cGvCBSearch.cpIsEmptyDsSearch);
            ...
            if(cGvCBSearch.cpCBE_FileAlreadyUsedBy!=undefined)
            {
                ...
                if(WhichUser=="Other")
                {
                    ...
                    cGvCBSearch.cpCBE_FileAlreadyUsedBy = null;
                }
                else
                {
            ...
            if(cGvCBSearch.cpCBDelete!=undefined)
            {
                alert(cGvCBSearch.cpCBDelete);
                var PageNo=document.getElementById("B_PageNo").innerText;
                cGvCBSearch.PerformCallback('PCB_BindAfterDelete~'+PageNo+'~~~~~#~');
            }
            if(cGvCBSearch.cpClearHiddenField!=undefined)
            {
                ...
                if(cGvCBSearch.cpClearHiddenField.split('~')[1]=="SearchByLink") 
                {
                    ...
                    document.getElementById("hdn_Mode").value="Edit";
                    cGvCBSearch.PerformCallback("SearchByLink~");
                }
            }
             height();
         }
         ...
         function OnLeftNav_Click()
         {
           ...
           if(parseInt(i)>1)
            {   
                ...
                cGvCBSearch.PerformCallback("SearchByNavigation~"+document.getElementById("A1").innerText);
            }
            else
            {
         ...
         function OnPageNo_Click(obj)
         {
            ...
            cGvCBSearch.PerformCallback("SearchByNavigation~"+i);
         }
         ...
         function CustomButtonClick(s, e) {
            ...
            function OnGetRowValuesOnEdit(values) {
                ...
                var MaxLockDate=new Date(values[2]);
                monthnumber = MaxLockDate.getMonth();
                monthday    = MaxLockDate.getDate();
                year        = MaxLockDate.getYear();
                var MaxLockDateNumeric=new Date(year, monthnumber, monthday).getTime();
//                alert('TransactionDate='+TransactionDate+'\n'+'MaxLockDate= '+MaxLockDate);
                ...
                {
                    alert('This Entry has been Locked.Contact Your System Administrator!!!.');
                    return;
                }
...
//                alert('TransactionDate='+TransactionDate+'\n'+'MaxLockDate= '+MaxLockDate);
         ...
         function btnOkClick()
         {
            cGvCBSearch.PerformCallback('PCB_BtnOkE~'+VisibleIndexE);
         }
         function DeletebtnOkClick()
         {
            cGvCBSearch.PerformCallback('PCB_DeleteBtnOkE~'+VisibleIndexE+"~#~~");
         }
         function btnContinueClick()
         {
            cGvCBSearch.PerformCallback('PCB_ContinueWith~'+VisibleIndexE);
         }
         function btnFreshEntryClick()
         {
            cGvCBSearch.PerformCallback('PCB_FreshEntry~'+VisibleIndexE);
         }
         function btnCloseClick()
         {
            cGvCBSearch.PerformCallback('PCB_CloseEntry~'+VisibleIndexE);
         }
         function btnCancleClick()
        {
           cGvCBSearch.PerformCallback('PCB_Cancle~'+VisibleIndexE); 
        }
        function ReSetUp_Page_OnEdit(VoucherValue,VoucherText,BranchID,BranchName,CashBankID,CashBankName,TransactionDate,Narration,SegmentID_Name)
        {
            ...
            document.getElementById('<%=B_ChoosenCurrency.ClientID %>').innerHTML="Voucher Currency : ";
            document.getElementById('<%=bSegmentName.ClientID %>').innerHTML="Voucher Segment : "+SegmentID_Name.split('~')[1];
            document.getElementById("hdn_SegID_SegmentName").value=SegmentID_Name;
        ...
        function SetInstDate_OnGotFocus()
        {
            if(ctxtInstNo.GetText().trim()=="")
            {
                cInstDate.SetDate(cdtTDate.GetDate());
        ...
        {
            cGvAddRecordDisplay.PerformCallback('Exit~~~~');
        }
        //Changes_20181224
        function OnCmbPurposeSelectedIndexChanged()
        {
            if(cCmbPurpose.GetValue()=="Others")
                cAtxtOthrPrps.SetEnabled(true);
            else
                cAtxtOthrPrps.SetEnabled(false);
        }
        
        function CmbPurpose_EndCallback()
        {
            if(cCmbPurpose.cpSetPurpose!=null)
                cCmbPurpose.SetValue(cCmbPurpose.cpSetPurpose);
        }
        //End Changes_20181224
    </script>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onunload="ClearPageSession();">
    ...
    <table border="1" width="98%">
                    <tr>
                            <td class="EHEADER" align="center" colspan="6" style="width: 777px">
                                    ...
                                    <td colspan="2" class="EHEADER" style="text-align: right">
                                    <ul class="bubblewrap">
                                    <li><a onclick="BtnBack_Click();" href="#"><img src="../images/Cash_Home.jpeg" title="Go To Start" /></a></li>
                                    <li><a onclick="Search_linkClick();" href="#"><img src="../images/Cash_Search-icon.jpg"title="Go To Search" style="background-color: transparent" /></a></li>
                                    <li><a onclick="BackSearchResult_linkClick();" href="#"><img src="../images/Cash_BackSearch.jpg" title="Go To Search Result" /></a>&nbsp;</li>
                               </ul>
                               </td>
    ...
    <div id="divChangable" runat="server">
                    ...
                    <table border="1" width="98%">
                        ...
                        <tr>
                            <td style="height: 11px; background-color: #b7ceec; vertical-align: top; text-align: left;">
                                Type
                            </td>
                            <td style="width: 115px; height: 20px;">
                            <b id="bTypeText" runat="server" style="width:20%;font-size:12px"></b>
                            </td>
                            <td style="height: 11px; background-color: #b7ceec; vertical-align: top; text-align: left;">
                                Branch</td>
                            <td style="width: 255px; height: 20px;">
                            <b id="bBranchText" runat="server" style="width:20%;font-size:12px"></b>
                            </td>
                            <td style="height: 11px; background-color: #b7ceec; vertical-align: top; text-align: left;">
                                Trans.Date</td>
                            <td style="width: 11%; height: 20px">
                                <dxe:ASPxDateEdit id="dtTDate" runat="server" ClientInstanceName="cdtTDate" EditFormat="Custom"
                                    Font-Size="10px" UseMaskBehavior="True" Width="100px" EditFormatString="dd-MM-yyyy">
                            ...
                            <b id="bSegmentName" runat="server" style="width:20%;color:Blue;"></b>
                            </td>
                        </tr>
                    </table>
        <table border="1" id="TblChangable" width="98%">
            <tr>
                <td id="tdCashBankLabel" style="background-color: #b7ceec; vertical-align: top; text-align: left; width: 40%; height: 23px;">
                    Cash/Bank Accounts</td>
                <td style="background-color: #b7ceec; vertical-align: top; text-align: left; width: 30%; height: 23px;">
                    Main Narration</td>
                <td id="tdCBankBalLable" style=" background-color: #b7ceec; vertical-align: top; text-align: left;width: 15%; height: 23px;">
                    Current Bank Balance</td>
                <td id="tdAcBalanceLable" style=" background-color: #b7ceec; vertical-align: top; text-align: left;width: 13%; height: 23px;">
                    Account Balance</td>
            </tr>
            <tr>
                ...
                <td id="tdCBankBalValue" style="width: 15%">
                    <dxcp:ASPxCallbackPanel ID="CbpBankBalance" runat="server" ClientInstanceName="cCbpBankBalance" OnCallback="CbpBankBalance_Callback" BackColor="White">
                        <PanelCollection>
                            <dxp:panelcontent runat="server">
    ...
    <table id="TblAccountDetail" border="1" style="width: 98%">
            <tr>
                <td style="width: 154px">
                </td>
                <td>
                </td>
                <td style="font-weight:bold;font-size:10px;width: 40%;display:none;" id="tdAcBal">
                 A/C Balance : <b id="lblAcBalance" runat="server" style="width:100px"></b>&nbsp;
                                <blink><b style="color:Blue;font-size:10px;" id="bDrCrStatus" runat="server"></b></blink></td>
                <td>
                </td>
            </tr>
            <tr>
                <td id="tdMainAccountLabel" style="background-color: #b7ceec; vertical-align: top; height: 11px; text-align: left;">
                    Main Account</td>
                <td id="tdSubAccountLabel"style="background-color: #b7ceec; vertical-align: top; height: 11px; text-align: left;">
                    SubAccount</td>
            ...
            <tr>
                ...
                <td>
                <a id="aAddDetail" runat="server" href="javascript:void(0);" onclick="ShowInstTypePopUp()"
            ...
            <tr>
                <td id="tddiscard" style="width: 244px">
                    <dxe:ASPxButton ID="btnDiscardEntry" runat="server" AccessKey="X" AutoPostBack="false"
                        TabIndex="0" Text="Discard Entered Records[x]" Width="200px" UseSubmitBehavior="False">
                ...
                <td>
                    <dxe:ASPxButton ID="btnBack" runat="server" AccessKey="B" AutoPostBack="false"
                        TabIndex="0" Text="[B]ack To Start " Width="200px" UseSubmitBehavior="False">
        ...
        <dxwgv:ASPxGridView ID="GvAddRecordDisplay" runat="server" AutoGenerateColumns="False"
            ClientInstanceName="cGvAddRecordDisplay" Font-Size="10px" KeyFieldName="RecordID"
            Width="98%" OnCustomCallback="GvAddRecordDisplay_CustomCallback" OnRowDeleting="GvAddRecordDisplay_RowDeleting" 
            OnHtmlEditFormCreated="GvAddRecordDisplay_HtmlEditFormCreated" OnCancelRowEditing="GvAddRecordDisplay_CancelRowEditing" 
            OnCustomUnboundColumnData="GvAddRecordDisplay_CustomUnboundColumnData" 
            OnCommandButtonInitialize="GvAddRecordDisplay_CommandButtonInitialize">
            ...
            <Columns>
                <dxwgv:GridViewDataTextColumn Caption="Main Account" FieldName="MainAccountName"
                    VisibleIndex="0" Width="21%">
                    <CellStyle CssClass="gridcellleft" Wrap="False">
                    </CellStyle>
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="WithDraw From" FieldName="WithFromName" VisibleIndex="1"
                    Width="21%">
                    <CellStyle CssClass="gridcellleft" Wrap="False">
                    </CellStyle>
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Sub Account" FieldName="SubAccountName" VisibleIndex="2"
                    Width="34%">
                    <CellStyle CssClass="gridcellleft" Wrap="False">
                    </CellStyle>
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Deposit Into" FieldName="DepositIntoName"
                    VisibleIndex="3" Width="34%">
                    <CellStyle CssClass="gridcellleft" Wrap="False">
                    </CellStyle>
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Inst.Type" FieldName="InstrumentTypeName"
                    VisibleIndex="4">
                    <CellStyle CssClass="gridcellleft" Wrap="False">
                    </CellStyle>
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Inst.No" FieldName="InstrumentNumber" VisibleIndex="5">
                    <CellStyle CssClass="gridcellleft" HorizontalAlign="Right" Wrap="False">
                    </CellStyle>
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Inst.Date" FieldName="FormatedInstrumentDate" VisibleIndex="6" >
                    <CellStyle CssClass="gridcellleft" Wrap="False">
                    </CellStyle>
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Payment" FieldName="PaymentAmount" VisibleIndex="7">
                    <CellStyle CssClass="gridcellleft" Wrap="False" HorizontalAlign="Right">
                    </CellStyle>
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Reciept" FieldName="ReceiptAmount" VisibleIndex="8">
                    <CellStyle CssClass="gridcellleft" Wrap="False" HorizontalAlign="Right">
                    </CellStyle>
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Amount" FieldName="Amount" VisibleIndex="9">
                    <CellStyle CssClass="gridcellleft" Wrap="False" HorizontalAlign="Right">
                    </CellStyle>
                </dxwgv:GridViewDataTextColumn>
                 <dxwgv:GridViewDataTextColumn FieldName="ValueDate" VisibleIndex="10" Visible="False">
                </dxwgv:GridViewDataTextColumn>
                ...
                <dxwgv:GridViewDataTextColumn FieldName="TotalRecPay" Caption="." VisibleIndex="11" UnboundType="Decimal" Width="0px">
                </dxwgv:GridViewDataTextColumn>
                ...
                <EditForm>
                    <table id="tblDetailE" border="1" width="98%">
                        <tr>
                            ...
                            <td style="font-weight: bold; font-size: 10px; width: 40%; display: none;" id="td1">
                                A/C Balance : <b id="B1" runat="server" style="width: 100px"></b>&nbsp;
                        ...
                        <tr>
                            <td id="tdMainAccountLableE" style="color: #ffffff; background-color: gray; width: 154px;">
                                Main Account</td>
                            <td id="tdSubAcountLableE" style="color: #ffffff; background-color: gray">
                                SubAccount</td>
                            <td style="color: #ffffff; background-color: gray">
                                Other Detail
                            </td>
                            <td style="color: #ffffff; background-color: gray">
                                #</td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a id="a1" runat="server" href="javascript:void(0);" onclick="ShowInstTypePopUpE()">
                                    Update Detail</a>
                            </td>
                            <%--<td>
            ...
            <TotalSummary>
                <dxwgv:ASPxSummaryItem FieldName="PaymentAmount" ShowInColumn="PaymentAmount" SummaryType="Sum" />
                <dxwgv:ASPxSummaryItem FieldName="ReceiptAmount" ShowInColumn="ReceiptAmount" SummaryType="Sum" />
                <dxwgv:ASPxSummaryItem FieldName="Amount" ShowInColumn="Amount" SummaryType="Sum" />
            </TotalSummary>     
        ...
        <dxpc:ASPxPopupControl ID="PopUp_InstrumentDetail"  runat="server"  ClientInstanceName="cPopUp_InstrumentDetail"
            ...
            <ContentCollection>
                <dxpc:PopupControlContentControl runat="server">
                    <dxcp:ASPxCallbackPanel ID="InstrumentDetail_CallbackPanel" runat="server" Width="400px" ClientInstanceName="cInstrumentDetail_CallbackPanel" OnCallback="InstrumentDetail_CallbackPanel_Callback">
                        <PanelCollection>
                            <dxp:panelcontent runat="server">
                                <table style="width: 746px; font-weight: normal;" border="1" id="TABLE1" >
                        <tr>
                            <td valign="top" id="tdITypeLable" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                                Instrument Type</td>
                            <td style="width: 63px;" valign="top" id="tdITypeValue">
                                <dxe:ASPxComboBox ID="ComboInstType" runat="server" ClientInstanceName="cComboInstType" Font-Size="10px"
                            ...
                            <td  valign="top" id="tdINoLable" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                                Instrument No</td>
                            ...
                            <td id="tdIDateValue" style="width: 5px;" valign="top">
                                <dxe:ASPxDateEdit ID="InstDate" runat="server" EditFormat="Custom" ClientInstanceName="cInstDate"
                                        ...
                                        <ClientSideEvents DateChanged="function(s,e){ }" /><ButtonStyle Width="13px">
                                        </ButtonStyle>
                                    </dxe:ASPxDateEdit>
                            </td>
                        </tr>
                        <tr>
                            <td  valign="top" id="tdCBankLable" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                                Customer Bank</td>
                        ...
                        <tr>
                            <td valign="top" id="tdIBankLable" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                                Issuing Bank</td>
                            <td colspan="5" id="tdIBankValue" valign="top" >
                                    <asp:TextBox ID="txtIssuingBank" runat="server" Font-Size="10px" Width="365px" onkeyup="CallListBank(this,'GenericAjaxList',event)"></asp:TextBox>
                                                <asp:HiddenField ID="txtIssuingBank_hidden" runat="server" />
                             
                            </td>
                        </tr>
                        <tr>
                            <td  valign="top" id="tdAuthLable" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                                            Auth. Letter Ref</td>
                        ...
                        <tr>
                            <td colspan="6" valign="top" id="tdContraEntry" style="display:none"  >
                                <table border="1" style="width: 809px">
                                    <tr>
                                        <td style="color: #ffffff; background-color: darkgray" valign="top">
                                            </td>
                                        <td valign="top">
                                            <dxcp:ASPxCallbackPanel ID="CbpWithBankBalance" runat="server" ClientInstanceName="cCbpWithBankBalance"
                                        ...
                                        <td valign="top">
                                            <dxcp:ASPxCallbackPanel ID="CbpDepstBankBalance" runat="server" ClientInstanceName="cCbpDepstBankBalance" OnCallback="CbpDepstBankBalance_Callback" Width="300px" >
                                                <clientsideevents endcallback="function(s, e) {
                                    ...
                                    <tr>
                                        <td style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;" valign="top">
                                            WithDraw From</td>
                                        <td  valign="top">
                                        <asp:TextBox ID="txtWithFrom" runat="server" Font-Size="10px" Width="300px" onkeyup="CallContraAccount(this,'GenericAjaxList',event,'From')"></asp:TextBox>
                                                <asp:HiddenField ID="txtWithFrom_hidden" runat="server" />
                                        </td>
                                        <td style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;" valign="top">
                                            Deposit Into</td>
                                        <td valign="top">
                                         <asp:TextBox ID="txtDepositInto" runat="server" Font-Size="10px" Width="300px" onkeyup="CallContraAccount(this,'GenericAjaxList',event,'To')"></asp:TextBox>
                        ...
                        <tr>
                            <td id="tdPayeeLable" valign="top" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                                Payee</td>
                            <td id="tdPayeeValue" colspan="5" valign="top">
                                <dxcp:ASPxCallbackPanel ID="CbpPayee" runat="server" ClientInstanceName="cCbpPayee" OnCallback="CbpPayee_Callback">
                                  <%--  <clientsideevents endcallback="function(s, e) {
	                                                    CbpPayee_EndCallBack(); }" />--%>
                                    <panelcollection>
                                <dxp:PanelContent runat="server">
                            <dxe:ASPxComboBox runat="server" Width="103px" ID="CmbPayee" ValueType="System.String" ClientInstanceName="cCmbPayee" Font-Size="10px" __designer:wfdid="w187" OnCallback="CmbPayee_Callback">
                        ...
                        <%--//Changes_20181224--%>
                        <tr id="tr_SettNoPrps">
                            <td valign="top" id="td2" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                                SettNo.Type</td>
                            <td style="width: 63px;" valign="top" id="td3">
                                <asp:TextBox ID="txtSettNoType" runat="server" CssClass="EcoheadCon" Width="121px"></asp:TextBox>
                                <asp:TextBox  ID="txtSettNoType_hidden" runat="server" Width="14px" style="display:none;"> </asp:TextBox>
                            </td>
                            <td  valign="top" id="td4" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                                Purpose</td>
                            <td  valign="top" id="td5">
                                <dxe:ASPxComboBox ID="CmbPurpose" runat="server" ClientInstanceName="cCmbPurpose" Font-Size="10px"
                                    SelectedIndex="0" ValueType="System.String" Width="130px" EnableIncrementalFiltering="True"
                                    OnCallback="CmbPurpose_Callback">
                                    <Items>
                                        <dxe:ListEditItem Text="Payin" Value="Payin" />
                                        <dxe:ListEditItem Text="Payout" Value="Payout" />
                                        <dxe:ListEditItem Text="Receipt-Client" Value="Receipt-Client" />
                                        <dxe:ListEditItem Text="Payment-Client" Value="Payment-Client" />
                                        <dxe:ListEditItem Text="Settlement-Payment" Value="Settlement-Payment" />
                                        <dxe:ListEditItem Text="Charges-Recovery" Value="Charges-Recovery" />
                                        <dxe:ListEditItem Text="Own-A/c" Value="Own-A/c" />
                                        <dxe:ListEditItem Text="Third-Party" Value="Third-Party" />
                                        <dxe:ListEditItem Text="Margin-Payment" Value="Margin-Payment" />
                                        <dxe:ListEditItem Text="Margin-Release" Value="Margin-Release" />
                                        <dxe:ListEditItem Text="FDR-Created" Value="FDR-Created" />
                                        <dxe:ListEditItem Text="FDR-Released" Value="FDR-Released" />
                                        <dxe:ListEditItem Text="Cheque-Reversal" Value="Cheque-Reversal" />
                                        <dxe:ListEditItem Text="Inter-Client-Bank" Value="Inter-Client-Bank" />
                                        <dxe:ListEditItem Text="Auction-close-out" Value="Auction-close-out" />
                                        <dxe:ListEditItem Text="Opening-Balance" Value="Opening-Balance" />
                                        <dxe:ListEditItem Text="Closing-Balance" Value="Closing-Balance" />
                                        <dxe:ListEditItem Text="Others" Value="Others" />
                                    </Items>
                                    <ClientSideEvents EndCallback="CmbPurpose_EndCallback" SelectedIndexChanged="OnCmbPurposeSelectedIndexChanged"/>
                                </dxe:ASPxComboBox>
                            </td>
                            <td id="td6" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;"
                                valign="top">
                                Other Purpose</td>
                            <td id="td7" style="width: 5px;" valign="top">
                                <dxe:aspxtextbox runat="server" id="AtxtOthrPrps" clientinstancename="cAtxtOthrPrps" Width="150px"></dxe:aspxtextbox>
                            </td>
                        </tr>
                        <%--//End Changes_20181224--%>
                        <tr>
                            <td  valign="top" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                    Line Narration</td>
                            <td colspan="5" valign="top">
                             <asp:TextBox ID="txtNarration1" runat="server" Font-Names="Arial" Font-Size="10px"
                             onkeydown="checkTextAreaMaxLength(this,event,'500');"
                             onkeyup="OnlyNarration(this,'Narration',event)" 
                             onfocus="this.select()"     
        ...
        <dxpc:ASPxPopupControl ID="PopUp_StartPage" runat="server" ClientInstanceName="cPopUp_StartPage"
            HeaderText="Select Application" ShowSizeGrip="False" Width="387px" CloseAction="None" Modal="True" PopupHorizontalAlign="LeftSides" PopupVerticalAlign="TopSides" ShowOnPageLoad="True">
                    ...
                    <table style="height: 48px" border="1">
                        <tr>
                            ...
                            <td style="width: 100px" valign="top">
                                <dxe:ASPxComboBox ID="ComboMode" runat="server" ClientInstanceName="cComboMode" Font-Size="10px"
                        ...
                        <tr>
                            <td style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;" valign="top">
                                Type</td>
                            <td style="width: 100px" valign="top">
                                <dxe:ASPxComboBox ID="ComboType" runat="server" ClientInstanceName="cComboType" Font-Size="10px"
                            ...
                            <td style="width: 100px" valign="top">
                                <dxe:ASPxComboBox ID="ComboBranch" runat="server" ClientInstanceName="cComboBranch"
                                    Font-Size="10px" ValueType="System.String" Width="303px" EnableIncrementalFiltering="True">
                                </dxe:ASPxComboBox>
                            </td>
                        </tr>
                        <tr>
       ...
       <div id="DivEdit" style="display:none">
        <dxpc:ASPxPopupControl ID="Popup_Search" runat="server" ClientInstanceName="cPopup_Search"
            ...
            <ContentCollection>
                ...
                <asp:Panel ID="Panel_Search" runat="server" DefaultButton="SBtnSearch">
                    <table width="100%" border="1" id="TABLE2" >
                        <tr>
                            <td style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                                Type</td>
                            <td style=" background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                                Branch</td>
                            <td style=" background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                        ...
                        <tr>
                            <td style="width: 255px">
                                <dxe:ASPxComboBox ID="SCmb_Type" runat="server" ClientInstanceName="cSCmb_Type" Font-Size="10px"
                                    SelectedIndex="0" ValueType="System.String" Width="103px" EnableIncrementalFiltering="True">
                                    <Items>
                            ...
                            <td>
                                ...
                                <b style="font-weight:normal;color:Red">* Clear For All &nbsp;Date.</b></td>
                        </tr>
                        <tr>
                            <td style="height: 11px; background-color: gainsboro; vertical-align: top; text-align: left;" valign="top" >
                                Voucher Number</td>
                            <td >
                        ...
                        <tr>
                            <td id="td_SCashBankLabel" style="height: 11px; background-color: gainsboro; vertical-align: top; text-align: left;">
                                CashBank A/c</td>
                            <td style="height: 11px; background-color: gainsboro; vertical-align: top; text-align: left;">
                                Main Narration</td>
                            <td style="height: 8px">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td id="td_SMainAcLabel" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                                Main A/c</td>
                            <td id="td_SSubAcLabel" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                                Sub A/c</td>
                            <td>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td id="td_SSubAcValue">
                                <asp:TextBox ID="StxtSubAccount" runat="server" Font-Size="13px" onfocus="this.select()"
                                    onkeyup="CallSubAccount(this,'GenericAjaxListSP',event)" Width="303px"></asp:TextBox>
                        ...
                        <tr>
                            <td style="width: 255px">
                                <dxe:ASPxComboBox ID="SCmbInstType" runat="server" ClientInstanceName="cSCmbInstType"
                                    Font-Size="10px" SelectedIndex="0" ValueType="System.String" Width="103px" EnableIncrementalFiltering="True"
                        ...
                        <tr>
                            <td id="td_SCustBankLabel" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                                Customer Bank</td>
                            <td id="td_SIssueBankLabel" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                                IssueBank</td>
                            <td>
                            </td>
                        </tr>
                       ...
                       <tr>
                            <td id="td_SWithDrawLabel" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;display:none" valign="top">
                                WithDraw From</td>
                            <td id="td_SDepstIntoLabel" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;display:none" valign="top">
                                Deposit Into</td>
                            <td valign="top">
                            </td>
                        </tr>
                        <tr>
                            <td id="td_SWithDrawValue" valign="top" style="display: none; width: 255px;">
                                <asp:TextBox ID="StxtWithFrom" runat="server" Font-Size="10px" Width="300px" onkeyup="CallContraAccount(this,'GenericAjaxList',event,'From')"></asp:TextBox>
                                <asp:HiddenField ID="StxtWithFrom_hidden" runat="server" />
                            </td>
                            <td id="td_SDepstIntoValue" style="display: none;">
                                <asp:TextBox ID="StxtDepstInto" runat="server" Font-Size="10px" Width="300px" onkeyup="CallContraAccount(this,'GenericAjaxList',event,'To')"></asp:TextBox>
                        ...
                        <tr>
                            <td id="td_sAuthLetterLabel" style="background-color: gainsboro; vertical-align: top; height: 11px; text-align: left;">
                                AuthLetterRef.</td>
                            <td id="td_sPayeeAcLabel" style="font-weight: normal; display: none; color: #ffffff;
           ...
           <table style="width: 60%" border="1">
               <tr>
                   <td valign="top" style="vertical-align: top; width: 34px; height: 11px; background-color: #b7ceec; text-align: left">
                       Page</td>
                   ...
                   <td style="text-align: right" valign="top">
                    <dxe:ASPxButton ID="SbtnBackToSearch" runat="server" AutoPostBack="False" Text="[B]ackToSearch"
                        Width="95px" AccessKey="B">
                        <ClientSideEvents Click="function (s, e) {SbtnBackToSearch_Click();}" />
                    </dxe:ASPxButton>
                   </td>
               </tr>
           </table>
         
            <dxwgv:ASPxGridView ID="GvCBSearch" runat="server" AutoGenerateColumns="False" ClientInstanceName="cGvCBSearch"
                        KeyFieldName="CBID" Width="1100px" Font-Size="10px" OnCustomCallback="GvCBSearch_CustomCallback">
                        ...
                        <Columns>
                            <dxwgv:GridViewCommandColumn VisibleIndex="0" Width="50px">
                                <CustomButtons>
                                    <dxwgv:GridViewCommandColumnCustomButton ID="CustomBtnEdit" Text="Edit">
                                    </dxwgv:GridViewCommandColumnCustomButton>
                                    <dxwgv:GridViewCommandColumnCustomButton ID="CustomBtnDelete" Text="Delete">
                                    </dxwgv:GridViewCommandColumnCustomButton>
                                </CustomButtons>
                            </dxwgv:GridViewCommandColumn>
                            <dxwgv:GridViewDataTextColumn VisibleIndex="1" FieldName="MainAccountID" Width="200px"
                                Caption="MainAc.">
                                <CellStyle Wrap="False">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn VisibleIndex="2" FieldName="SubAccountID" Width="220px"
                                Caption="SubAc.">
                                <CellStyle Wrap="False">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="3" FieldName="CBID" Width="50px">
                                <CellStyle Wrap="False">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn VisibleIndex="3" FieldName="CashBankID" Width="80px"
                                Caption="CashBank">
                                <CellStyle Wrap="False">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn VisibleIndex="4" FieldName="TransactionDate" Width="80px"
                                Caption="TransDate">
                                <CellStyle Wrap="False">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn VisibleIndex="5" FieldName="VoucherNumber" Width="50px"
                                Caption="VoucherNo.">
                                <CellStyle Wrap="False">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn VisibleIndex="6" FieldName="ReceiptAmount" Width="75px"
                                Caption="ReceiptAmount">
                                <CellStyle Wrap="False" HorizontalAlign="Right">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn VisibleIndex="7" FieldName="PaymentAmount" Width="75px"
                                Caption="PaymentAmount">
                                <CellStyle Wrap="False" HorizontalAlign="Right"></CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn VisibleIndex="8" FieldName="InstrumentNumber" Width="75px"
                                Caption="InstNo.">
                                <CellStyle Wrap="False" HorizontalAlign="Right">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn VisibleIndex="9" FieldName="Narration" Width="400px"
                                Caption="Narration">
                                <CellStyle Wrap="False">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="11" FieldName="IBRef">
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="12" FieldName="ExchangeSegmentID">
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="13" FieldName="ValueDate">
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="14" FieldName="MaxLockDate">
                            </dxwgv:GridViewDataTextColumn>
                        </Columns>
                        <SettingsBehavior AllowFocusedRow="True" ConfirmDelete="True" />
           ...
           <dxpc:ASPxPopupControl ID="DeleteMsgPopUp" runat="server" ClientInstanceName="cDeleteMsgPopUp"
               ...
               <ContentCollection>
                   <dxpc:PopupControlContentControl runat="server">
                       <table class="style1">
                           <tr>
                               <td colspan="5">
                                   Are u Sure? Do You Want To Delete This Voucher?</td>
                           </tr>
                           <tr>
                               <td style="width: 3px">
                               </td>
                           ...
                           <tr>
                               ...
                               <td style="width: 3px">
                                   <dxe:ASPxButton ID="btnCancle" runat="server" AutoPostBack="False"
                                       ...
                                       <ClientSideEvents Click="function (s, e) {btnCancleClick(); cFileUsedByPopUp.Hide(); }" />
                                   </dxe:ASPxButton>
                               </td>
                           </tr>
                       </table>
