<%@ page language="C#" autoeventwireup="true" inherits="management_testnn, App_Web_v5pngf_u" %>
 ...
 function onGotFocusLineNarration(s,e)
  {
     if (confirm("Are you sure you want to create the row?")) 
    {
       gridCashbankReportCI.AddNewRow();
            ...
            <dxwgv:ASPxGridView ID="grdCashbankReport" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    <dxwgv:GridViewDataComboBoxColumn Caption="Main A/C" VisibleIndex="1" Width="15%"
                        ...
                        <PropertiesComboBox DataSourceID="MainAccountReport" TextField="MainAccount_Name"
                            ...
                            <ClientSideEvents SelectedIndexChanged="function(s, e) { OnCashBankReportMainAcChange(s); }">
                            </ClientSideEvents>
                        </PropertiesComboBox>
                    ...
                    <dxwgv:GridViewDataComboBoxColumn Caption="Sub A/c" VisibleIndex="2" Width="15%"
                        ...
                        <PropertiesComboBox DataSourceID="SelectSubaccountReport" TextField="SubAccountName"
                            ...
                            <ClientSideEvents GotFocus="function(s, e) { OnCashBankReportSubAcChange(s); }" SelectedIndexChanged="function(s, e) { OnCashBankReportSubAcChange(s); }">
                            </ClientSideEvents>
                        </PropertiesComboBox>
                    ...
                    <dxwgv:GridViewDataComboBoxColumn Caption="Inst. type" FieldName="CashBank_InstrumentType"
                        VisibleIndex="3" Width="10%">
                        <PropertiesComboBox ValueType="System.String" EnableIncrementalFiltering="True">
                            <Items>
                                <dxe:ListEditItem Text="Draft[D]" Value="D">
                                </dxe:ListEditItem>
                                <dxe:ListEditItem Text="Cheque[C]" Value="C">
                                </dxe:ListEditItem>
                                <dxe:ListEditItem Text="Electronic Transfer[E]" Value="E">
                                </dxe:ListEditItem>
                            </Items>
                            <ClientSideEvents SelectedIndexChanged="function(s, e) { OnInstmentTypeChange(s); }">
                            </ClientSideEvents>
                        </PropertiesComboBox>
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Instrument No" FieldName="CashBank_InstrumentNumber"
                    ...
                    <dxwgv:GridViewDataDateColumn Caption="Date" FieldName="CashBank_InstrumentDate"
                    ...
                    <dxwgv:GridViewDataComboBoxColumn Caption="Payee" FieldName="CashBank_PayeeAccountID"
                        VisibleIndex="6" Width="10%">
                        <PropertiesComboBox ValueType="System.String" EnableIncrementalFiltering="True">
                            <Items>
                                <dxe:ListEditItem Text="Amit Kumar" Value="0">
                                </dxe:ListEditItem>
                                <dxe:ListEditItem Text="Mr.Abhishek" Value="1">
                                </dxe:ListEditItem>
                                <dxe:ListEditItem Text="Mr. Asit Kumar" Value="2">
                                </dxe:ListEditItem>
                            </Items>
                        </PropertiesComboBox>
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Payment" FieldName="CashBank_AmountWithdrawl"
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Receipt" FieldName="CashBank_AmountDeposit"
                    ...
                    <dxwgv:GridViewDataMemoColumn Caption="Line Narration" FieldName="CASHBANK_LINENARRATION"
            ...
            <asp:SqlDataSource ID="MainAccountReport" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
                SelectCommand="Select MainAccount_ReferenceID as CashBank_MainAccountID, MainAccount_Name as MainAccount_Name from Master_MainAccount where MainAccount_BankCashType='Other'">
            </asp:SqlDataSource>
