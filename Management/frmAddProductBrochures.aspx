<%@ page language="C#" autoeventwireup="true" inherits="management_frmAddProductBrochures, App_Web_rtil2eyr" %>
    ...
    <div>
        <table class="TableMain">
            ...
            <tr>
                ...
                <td><asp:DropDownList id="drpDocumentEntity" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpDocumentEntity_SelectedIndexChanged" Width="163px">
            ...
            <tr>
                ...
                <td><asp:DropDownList ID="drpDocumentType" runat="Server" Width="163px"></asp:DropDownList>
            ...
            <tr>
                <td colspan="2"><asp:Button ID="btnSearch" runat="Server" Text="Search" CssClass="btnUpdate" OnClick="btnSearch_Click" /></td>
            </tr>
            <tr>
                <td colspan="2">
                    <asp:Panel id="pnlDocuments" runat="Server" visible="True" Width="90%">
                        <table class="TableMain">
                            ...
                            <tr id="ShowButton" runat="server" visible="false">
                                <td><input type="button" id="btnSave" name="btnSave" value="Add Product Brochures" onclick="SaveAddProduct()" class="btnUpdate" />
