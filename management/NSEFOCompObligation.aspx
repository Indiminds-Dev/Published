<%@ page language="C#" autoeventwireup="true" inherits="management_NSEFOCompObligation, App_Web_-k9nslwd" %>
                                                            ...
                                                            <td class="lt">
                                                                <table>
                                                                            ...
                                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                                <ContentTemplate>
                                                                                    <asp:DropDownList ID="ddlFileList" runat="server" Width="210px" AutoPostBack="True"
                                                                                        ...
                                                                                        <asp:ListItem Value="1">PS03 File</asp:ListItem>	
                                                                                    </asp:DropDownList><br />
                                                                    ...
                                                                    Font-Bold="True" ForeColor="blue" />
                                                                            <asp:LinkButton ID="lnkMismatch" Font-Underline="true" runat="server" Font-Size="XX-Small" Font-Names="Arial" Font-Bold="True" ForeColor="Blue" OnClick="lnkMismatch_Click">BO Obligation not tallying with the Exchange File. Click to View the Differences</asp:LinkButton>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
