<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReport_IframeLedgerViewSingleClient, App_Web_yvy99of_" %>
    ...
    function DateChangeForTo()
    {
     ...
     function updateCashBankDetail(objDate,objVouNo,objMainID,objSubID,objCompID,objSegID)
	    {	 
	        ...
	        parent.OnMoreInfoClick(URL,"Update Cash/Bank Book",'940px','450px',"Y");	      
	    ...
	    function updateJournalDetail(objDate,objVouNo,objMainID,objSubID,objCompID,objSegID)
	    {
	        ...
	        parent.OnMoreInfoClick(URL,"Update JournalVoucher",'940px','450px',"Y");	
	    }
	    function ShowObligationBreakUp(objBill,objVouId,objSegment,objTranDate)
	    {
	        ...
	        parent.OnMoreInfoClick(URL,"Show Obligation BreakUp",'940px','450px',"Y");	
	    }
	    function callback()
        {       
