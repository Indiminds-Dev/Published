<%@ page language="C#" autoeventwireup="true" inherits="management_frmImportNsdlCalendar, App_Web_alid8jfz" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    ...
    <div align="center">
    <table id="tbl_main" class="login" cellspacing="0" cellpadding="0" width="450">
        <tbody>
            <tr>
                <td class="lt1" style="height: 40px">
                    <h5>
                        Imports NSDL CC Calendar
                    </h5>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="width:450px">
                    <strong>This Routine Imports "NSDL CC Calendar" file available from NSDL DPM System</strong>
                </td>
            </tr>
            <tr>
                <td class="lt brdr">
                                                ...
                                                <td colspan="2" style="width: auto; height: 14px">
                                                    <table cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            ...
                                                            <td style="padding-left: 2px; height: 14px" valign="top">
                                                                To :</td>
                                                            <td style="height: 14px">
                                                            <dxe:ASPxDateEdit ID="txtendDate" runat="server" ClientInstanceName="e1" 
                                                              Width="130px" EditFormat="Custom" EditFormatString="dd-MM-yyyy" UseMaskBehavior="True" AllowNull="False">
                                                            <ButtonStyle Width="13px">
                                                            </ButtonStyle>
                                                            <ClientSideEvents ValueChanged="OnValueChanged" />
