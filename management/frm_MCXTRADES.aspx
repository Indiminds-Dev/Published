<%@ page language="C#" autoeventwireup="true" inherits="frm_MCXTRADES, App_Web_ptes6n28" %>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <select id="cmbTrade" runat="server" onchange="selectfile();">
                                                ...
                                                <option>ODIN TXT/UDiFF</option>
                                                <option>DELIVERY TRADE CSV</option>
						                        <option>ATC CSV</option>
						                        <option>Opening Trades from Custom File</option>		
						                        <option>Opening Trades from POS File</option>		
						                        <option>RTS Order File</option>
						                        <option>RTS Combined Trade File</option>		
						                        <option>Manual/BO Trade File</option>		
						                        <option>Flex Trade File</option>
                                                <option>ATIN/Class CSV</option>
                                                <option>Bolt Plus CSV</option>
                                                <option>Flash/QT CSV File</option>
                                                <option>A-One CSV File</option>
                                                <option>NOW TXT</option>
                                                <option>MT CSV File</option>
                                                <option>MoneyMaker TXT</option>
                                                <option>NEST TXT</option>
                                                <option>Blitz TXT</option>
                                                <option>Emkay CSV</option>
                                                <option>Greek TXT</option>
                                                <option>XTS TXT</option>
                                            </select>
                                        </td>
