<%@ page language="C#" autoeventwireup="true" inherits="Import_FCStoneMargin, App_Web_jdrimxnc" %>
        ...
        <table border="1">
            <tr>
                <td class="EHEADER" colspan="2" align="center" >
                                    <strong><span id="SpanHeader" style="color: #000099">Import Margin from "YYYYMMDD_balcsv.csv" files</span></strong></td>
            </tr>
            <tr>
