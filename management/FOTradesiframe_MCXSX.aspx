<%@ page language="C#" autoeventwireup="true" inherits="FOTradesiframe_MCXSX, App_Web_cvaj-tqf" %>
                                ...
                                <tbody>
                                    ...
                                    <td>
                                       <asp:DropDownList ID="ddlFileList" runat="server" Width="222px" AutoPostBack="True" Height="30px" OnSelectedIndexChanged="ddlFileList_SelectedIndexChanged">
                                            ...
                                            <asp:ListItem Value="2">TXT File</asp:ListItem>
					    <asp:ListItem Value="3">ODIN TXT File</asp:ListItem>	
