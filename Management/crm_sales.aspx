<%@ page language="C#" autoeventwireup="true" inherits="management_crm_sales, App_Web_lgnajdkn" %>
...
<head runat="server">
    ...
    <script type="text/javascript" language="Javascript">
        ...
        {
            url="ShowHistory_Phonecall.aspx?id1="+obj;
                                        ...
                                        <dxw:ContentControl runat="server">
                                            <div id="GridDiv">
                                                <table width="100%">
                                                    <tr>
                                                        <td>
                                                            <dxwgv:ASPxGridView ID="SalesGrid" runat="server" AutoGenerateColumns="False" ClientInstanceName="grid"
                                                                DataSourceID="SalesDataSource" Width="100%" OnCustomCallback="SalesGrid_CustomCallback">
                                                                <Columns>
                                                                    ...
                                                                    <dxwgv:GridViewDataTextColumn FieldName="ProductType" VisibleIndex="6" Width="18%">
                                                                    </dxwgv:GridViewDataTextColumn>
                                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="7">
                                                                        <DataItemTemplate>
                                                                            <a href="javascript:void(0)" onclick="ShowDetail('<%#Eval("ProductTypePath") %>')">
                                                                                Show</a>
                                                                        </DataItemTemplate>
                                                                        <EditFormSettings Visible="False" />
                                                                    </dxwgv:GridViewDataTextColumn>
                                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="8" Caption="History">
                                                                        <DataItemTemplate>
