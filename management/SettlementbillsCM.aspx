<%@ page language="C#" autoeventwireup="true" inherits="management_SettlementbillsCM, App_Web_nidspgif" %>
                                ...
                                <td>
                                    <table>
                                        ...
                                        <tr id="tr_Clients">
                                            ...
                                            <td>                                                    <asp:RadioButton ID="radPOAClient" runat="server" GroupName="d" onclick="Clients('a')" />POA Client
</td>
                                            <td>
                                       ...
                                       <tr id="tr_Settlementno">
                                            <td>
                                               Settelment No: </td>
                                            <td colspan="5">
                                               <asp:TextBox ID="txtset" runat="server" Width="250px" Font-Size="10px" onkeyup="ajax_showOptions(this,'SearchSettlementWithoutbracket',event)"></asp:TextBox>
                                            </td>
           ...
           <ContentTemplate>
               ...
               <tr id="tr_DIVdisplayPERIOD">
                   ...
                   <tr valign="top">
                       ...
                       <td style="height: 44px">
                           <asp:DropDownList ID="cmbgroup" runat="server" Font-Size="10px" Width="300px" AutoPostBack="True" onchange="btndisplay()">
                           </asp:DropDownList>
                       </td>
                       <td style="height: 44px">
