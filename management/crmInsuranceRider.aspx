<%@ page language="C#" autoeventwireup="true" inherits="management_crmInsuranceRider, App_Web_alid8jfz" %>
            ...
            <td>
                <dxwgv:ASPxGridView ID="ProductMF" runat="server" ClientInstanceName="grid" AutoGenerateColumns="False" KeyFieldName="id"  DataSourceID="SqlProductMF" Width="100%" OnHtmlEditFormCreated="ProductMF_HtmlEditFormCreated" OnHtmlRowCreated="ProductMF_HtmlRowCreated">
                                        ...
                                        <table style="width:100%">
                                          <tr>
                                            <td align="center" style="width:50%">
                                                <span>Add/Modify Insurance Riders.</span>
                                            </td>
                                           <%-- <td align="right">
                                              <table >
                                                <tr>                                                 
                    ...
                    <SettingsEditing Mode="PopupEditForm" PopupEditFormHeight="150px" PopupEditFormHorizontalAlign="Center"
                     ...
                     <SettingsText PopupEditFormCaption="Add/Modify Insurance Riders" ConfirmDelete="Are You Want To Delete This Record ???" />
                    <Columns>
                ...
                <asp:SqlDataSource ID="SqlProductMF" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
                    SelectCommand="select p.prds_id as id,p.prds_description as description,p.prds_productType as ProductType from tbl_master_products p,tbl_master_producttype pt where p.prds_producttype=pt.pty_prefix and p.prds_producttype='IR'"
                    InsertCommand="CRMInsuRiderInsert" InsertCommandType="StoredProcedure"
