<%@ page language="C#" autoeventwireup="true" inherits="Import_EDFMargin, App_Web_udicbieo" %>
        ...
        <table border="1">
            <tr>
                <td class="EHEADER" colspan="2" align="center" >
                                    <strong><span id="SpanHeader" style="color: #000099">Import Margin from EDF_CoreBalances CSV files</span></strong></td>
            </tr>
            <tr>
