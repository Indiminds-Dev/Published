<%@ page language="C#" autoeventwireup="true" inherits="management_HRrecruitmentagent_DPDetails, App_Web_e81qjzgk" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="TableMain100">
                ...
                <tr>
                    <td>
                        <dxtc:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="4" Width="100%"
