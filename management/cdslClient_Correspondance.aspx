<%@ page language="C#" autoeventwireup="true" inherits="management_cdslClient_Correspondance, App_Web_hnfc-rlk" %>
...
<dxtc:TabPage Name="AdditionalDetails" Text="Additional Details">
<ContentCollection>
...
<dxw:ContentControl runat="server"><dxtc:ASPxPageControl runat="server" ActiveTabIndex="0" ID="ASPxPageControl2" ClientInstanceName="page" __designer:wfdid="w5"><TabPages>
<dxtc:TabPage Text="Adress"><ContentCollection>
<dxw:ContentControl runat="server"><dxwgv:ASPxGridView runat="server" Font-Size="10px" Width="100%" ID="AddressGrid" DataSourceID="Address" KeyFieldName="Id" AutoGenerateColumns="False" ClientInstanceName="gridAddress" __designer:wfdid="w6" OnCellEditorInitialize="AddressGrid_CellEditorInitialize">
<Templates><EditForm>
