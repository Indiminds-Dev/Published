<%@ page language="C#" autoeventwireup="true" inherits="management_TradingFee_DGCX, App_Web_sggmuspu" %>
...
<head runat="server">
    ...
    function OnMoreInfoClick(keyValue) {
        ...
        var url = 'TradingTax_DGCX.aspx?id=' + keyValue;
    ...
    function OnAddButtonClick() 
    {
         ...
         var url = 'TradingTax_DGCX.aspx?id=' + 'ADD';
...
--%>               
             <dxwgv:GridViewDataTextColumn Caption="Group" FieldName="r" VisibleIndex="2" Width="15%">
                ...
                <dxwgv:GridViewDataTextColumn Caption="Rate" FieldName="TradingFee_Rate" VisibleIndex="7"
                    Width="4%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <dxwgv:GridViewDataTextColumn Caption="From Date" FieldName="TradingFee_DateFrom" VisibleIndex="10"
                    Width="6%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <dxwgv:GridViewDataTextColumn Caption="Untill Date" FieldName="TradingFee_DateTo" VisibleIndex="11"
                    Width="6%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
        ...
        <asp:SqlDataSource ID="ServiceTaxDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
            DeleteCommand="TradingFeeDG_delete" DeleteCommandType="StoredProcedure">
            <DeleteParameters>
