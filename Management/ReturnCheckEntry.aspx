<%@ page language="C#" autoeventwireup="true" inherits="management_ReturnCheckEntry, App_Web_2wstwz9u" %>
                    ...
                    <td align="center">
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtBankName" Font-Size="11px" runat="server" Width="323px"
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtChequeNumber" Font-Size="11px" runat="server" Width="323px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: right; width: 120px;">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtNarration" runat="server" Height="54px" Font-Size="10px" TextMode="MultiLine" Width="324px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td style="text-align: left">
                                    <asp:Button ID="btnShow" runat="server" Text="Show Original Entry" CssClass="btnUpdate" Width="303px"
                                        Height="21px" OnClick="btnShow_Click" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr id="TrEntry">
                                ...
                                <td style="text-align: left">
                                    <asp:Button ID="btnEntry" runat="server" Text="Generate Return Entry" CssClass="btnUpdate" Width="303px"
                                        Height="22px" OnClick="btnEntry_Click1" />
                                </td>
                            </tr>
                        </table>
                    </td>
