<%@ page language="C#" autoeventwireup="true" inherits="management_CustomMarginRatesCom, App_Web_fbvamflg" %>
       ...
       function OnAddButtonClick() 
        {
             ...
             var url='CustomMarginRatesCompopup.aspx?date='+date2 +'&type='+'Add';
             
             parent.OnMoreInfoClick(url,"Add Margin Rates",'450px','300px',"Y");
        ...
        function OnAddButtonClickMOREINFO(obj) 
        {
             ...
             var url='CustomMarginRatesCompopup.aspx?date='+date2 +'&type='+'info'+'&id='+obj ;
             parent.OnMoreInfoClick(url,"Add Margin Rates",'450px','300px',"Y");
        }
     ...
     <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center;" colspan="2">
                    <strong><span style="color: #000099">Margin Rates Entry</span></strong>
                </td>
            ...
            <tr valign="top">
                ...
                <td>
                    <asp:Button ID="btn_Show" runat="server" Text="Show" CssClass="btnUpdate" Height="20px"
                        Width="100px" OnClick="btn_Show_Click" /></td>
            </tr>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <asp:GridView ID="grdtradeentry" runat="server" Width="100%" BorderColor="CornflowerBlue"
                                    ...
                                    BorderWidth="2px" ForeColor="#0000C0" OnRowCreated="grdtradeentry_RowCreated" DataKeyNames="ComDailyMarginRates_ID" OnRowCommand="grdtradeentry_RowCommand" OnRowDeleting="grdtradeentry_RowDeleting">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Initial Margin">
                                        ...
                                        <asp:TemplateField HeaderText="Exposure Margin">
                                            ...
                                            <HeaderStyle HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblExposureMargin" runat="server" Text='<%# Eval("ExposureMargin")%>' CssClass="gridstyleheight1"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <ItemStyle HorizontalAlign="Left" Wrap="False" />
                                         <ItemTemplate >
                                                <a href="javascript:void(0);" onclick="OnAddButtonClickMOREINFO('<%# Eval("ComDailyMarginRates_ID")%>')">
                                                    </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <asp:LinkButton
                                                        ID="linkbtndel" runat="server" CommandName="Delete" CommandArgument='<%# Eval("ComDailyMarginRates_ID")%>'>Delete</asp:LinkButton>
                                            </ItemTemplate>
