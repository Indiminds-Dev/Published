<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_STRATRADES, App_Web_s3wzohpw" %>
   ...
   <script language="javascript" type="text/javascript">
    ...
    function PageLoad()
    {
       ...
       //File Format to Import By Default
        Span_FileFormat.innerText="File Name : Trades_DDmmYY_AccountID.csv";
    }
    ...
    function OnComboChooseFileIndexChange()
    {
        ...
        if(SelectedValue==0)
            ...
            Span_FileFormat.innerText="File Name : Openpositions_DDmmYY_AccountID.csv";
