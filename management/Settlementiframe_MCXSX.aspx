<%@ page language="C#" autoeventwireup="true" inherits="management_Settlementiframe_MCXSX, App_Web_n2fxndvz" %>
      ...
      <asp:Panel ID="Panelmain" runat="server" Visible="true">
        <table id="tbl_main" class="login" cellspacing="0" cellpadding="0" width="410">
                <tr>
                    <td class="lt1">
                        <h5>
                            Imports Settlement Schedule [MCX-SX-EQ_SETT.csv] Files
                        </h5>
                    </td>
                </tr>
                <tr>
                                    ...
                                    <td class="lt" style="height: 240px">
                                        <table class="width100per" cellspacing="12" cellpadding="0">
                                             <tr>
                                                ...
                                                <tr><td>
                                                FileName: MCX-SX-EQ_SETT.csv
                                                    [FTP - Root Path \Common Folder]
                                                </td></tr>
                                                <tr>
