<%@ page language="C#" autoeventwireup="true" inherits="Reports_RMSFileGreek, App_Web_bfdn6hbr" %>
...
<head id="Head1" runat="server">
    <title>RMS File For Greek</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">RMS File For Greek [ALL Segments]</span></strong></td>
