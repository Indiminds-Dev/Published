<%@ page language="C#" autoeventwireup="true" inherits="management_contact_other, App_Web_4andsqnv" %>
...
//    function SearchByFundManager(objId,objParam,objevent)
    function CallAjaxFundManager(objId,objParam,objevent)
    //End of New Work 10/05/2024
    {
        ajax_showOptions(objId,objParam,objevent);
    }
    ...
    function TmCodeShow(obj)
    {
        ...
        else if(obj=='TM Client')
        {
            document.getElementById('tdTmCode1').style.display='inline';
            document.getElementById('tdTmCode2').style.display='inline';
        }
        else if(obj=='TM Pro-Client')
        {
            document.getElementById('tdTmCode1').style.display='inline';
            document.getElementById('tdTmCode2').style.display='inline';
        }
                ...
                <tr>
                    <td>
                        <dxtc:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="6" ClientInstanceName="page"
                            ...
                            <TabPages>
                                <dxtc:TabPage  Name="General"><TabTemplate >
...
<dxw:ContentControl runat="server">
                                ...
                                <dxtc:TabPage  Name="CorresPondence"><TabTemplate >
...
<dxw:ContentControl runat="server">
                                ...
                                <dxtc:TabPage Name="Bank Details"><TabTemplate >
...
<dxw:ContentControl runat="server">
                                ...
                                <dxtc:TabPage Name="DP Details" ><TabTemplate >
...
<dxw:ContentControl runat="server">
                                ...
                                <dxtc:TabPage Name="Documents" ><TabTemplate >
...
<dxw:ContentControl runat="server">
                                ...
                                <dxtc:TabPage Name="Registration"><TabTemplate >
...
<dxw:ContentControl runat="server">
                                 ...
                                 <dxtc:TabPage Name="Other" ><TabTemplate >
<span style="font-size:x-small">Other</span>&nbsp;<span style="color:Red;">*</span> 
</TabTemplate>
<ContentCollection>
<dxw:ContentControl runat="server"><table width="100%"><tr><td><table style="text-align: left; background-color: #AFDCEC" width="100%"><tr ><td style="text-align: left;">Client Type : </td><td style="text-align: left; width: 178px;"><asp:DropDownList ID="ddlClientType" runat="server" Width="150px" onchange="TmCodeShow(this.value)"><asp:ListItem Value="Retail">Retail</asp:ListItem>
...
<asp:ListItem Value="TM Client">TM Client</asp:ListItem>
<asp:ListItem Value="TM Pro-Client">TM Pro-Client</asp:ListItem>
</asp:DropDownList>
...
<%--New Work 09/03/2024--%>
</td><td style="text-align: left;">Opted for UPI ? : </td><td style="text-align: left;"><asp:DropDownList ID="ddlOptUPI" runat="server" Width="150px" onchange="OptedUPI(this.value)">
<asp:ListItem Value="N">No</asp:ListItem>
<asp:ListItem Value="Y">Yes</asp:ListItem>
<asp:ListItem Value="NA">NA</asp:ListItem>
</asp:DropDownList>
<%--End of New Work 09/03/2024--%>
...
<asp:ListItem Value="S">NSDL</asp:ListItem>
 ...
 <td style="text-align: left;">Fund Manager : </td><td style="text-align: left;"><asp:TextBox ID="txtFundManager" runat="server" Width="300px" onkeyup="CallAjaxFundManager(this,'SearchByFundManager',event)"></asp:TextBox>
 <asp:HiddenField ID="txtFundManager_hidden" runat="server" />
 </td>
 <td style="text-align: left;">FM Sebi No. : </td><td style="text-align: left;"><asp:TextBox ID="txtFMSebiNo" MaxLength="15" runat="server" Width="147px"></asp:TextBox>
 </td>
 <%--End of New Work 10/05/2024--%>
 </tr></table></td></tr><tr><td><table style="text-align: left; background-color: #FFF8C6" width="100%"><tr><td style="text-align: left;">Special Category : </td><td style="text-align: left;"><asp:DropDownList ID="cmbCategory" runat="server" Width="150px"><asp:ListItem Value="None">None</asp:ListItem>
...
<ClientSideEvents EndCallback="function(s,e){ShowMessage(s.cpUpdate);}" />
 ...
 </td></tr></table></td></tr></table></dxw:ContentControl>
</ContentCollection>
</dxtc:TabPage>
                                <dxtc:TabPage Name="Group Member" Text="Group"><ContentCollection>
<dxw:ContentControl runat="server">
                                        </dxw:ContentControl>
</ContentCollection>
</dxtc:TabPage>
                                <dxtc:TabPage Name="Deposit" Text="Deposit"><ContentCollection>
<dxw:ContentControl runat="server">
                                        </dxw:ContentControl>
</ContentCollection>
</dxtc:TabPage>
                                <dxtc:TabPage Name="Remarks" Text="Remarks"><ContentCollection>
<dxw:ContentControl runat="server">
                                        </dxw:ContentControl>
</ContentCollection>
</dxtc:TabPage>
                                <dxtc:TabPage Name="Education" Text="Education"><ContentCollection>
<dxw:ContentControl runat="server">
                                        </dxw:ContentControl>
</ContentCollection>
</dxtc:TabPage>
                                <dxtc:TabPage Name="Trad. Prof." Text="Trad.Prof"><%--<TabTemplate ><span style="font-size:x-small">Trad.Prof</span>&nbsp;<span style="color:Red;">*</span> </TabTemplate>--%>
                                    <ContentCollection>
<dxw:ContentControl runat="server">
                                        </dxw:ContentControl>
</ContentCollection>
</dxtc:TabPage>
                                <dxtc:TabPage Name="FamilyMembers" Text="Family"><ContentCollection>
<dxw:ContentControl runat="server">
                                        </dxw:ContentControl>
</ContentCollection>
</dxtc:TabPage>
                               
                                <dxtc:TabPage Name="Subscription" Text="Subscription"><ContentCollection>
<dxw:ContentControl runat="server">
                                        </dxw:ContentControl>
</ContentCollection>
</dxtc:TabPage>
        ...
        <td align="left">
          ...
          <dxpc:ASPxPopupControl ID="ConfirmPopUp3" runat="server" ClientInstanceName="cConfirmPopUp3"
