<%@ page language="C#" autoeventwireup="true" inherits="management_NseSLBMCLMargin, App_Web_udicbieo" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Detailed Margin Report (S_MG02)</title>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports NSE-CM Trading Members' Detailed Margin Report Files [S_MG02_memcode_DDmmYYYY.csv]
                        </h5>
                    </td>
                </tr>
