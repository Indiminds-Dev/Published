<%@ page language="C#" autoeventwireup="true" inherits="Reports_BankBalances_Daily_Aud, App_Web_c6bgvp9x" enableeventvalidation="false" %>
...
//        }
    ...
    function OnMoreInfoClick()
    {
        ...
        var url ="../GenericRoutines/Batch/GenericBatchMaintenance.aspx?FileType=BankBalance&SqlWhere="+SqlWhere;
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                        <strong><span id="SpanHeader" style="color: #000099">Daily Bank Balances Report [Effective From 16-Jan-2023]
                        </span></strong>
                    </td>
            ...
            <tr>
                ...
                <td>
                    <dxe:ASPxComboBox ID="CmbGenerate" runat="server" ClientInstanceName="cCmbGenerate"
                        ...
                        Width="200px">
                        <Items>
                            <dxe:ListEditItem Text="Export To Excel" Value="1" />
                            <dxe:ListEditItem Text="Export Batch" Value="2" />
                            <%--New Work 10/05/2022--%>
                            <dxe:ListEditItem Text="Create API" Value="3" />
                            <%--End of New Work 10/05/2022--%>
                        </Items>
