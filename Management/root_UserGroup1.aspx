<%@ page language="C#" autoeventwireup="true" inherits="management_root_UserGroup1, App_Web_fxnvzv_8" %>
...
function OnMoreInfoClick(keyValue)
    ...
    function SignOff()
    {
     ...
     function height()
    {
        if(document.body.scrollHeight>11000)
        {
            window.frameElement.height = document.body.scrollHeight;
            }
        else
        {
            window.frameElement.height = '11000px';
            }
                    ...
                    <%-- <td id="trSelect" runat="Server">
                        ...
                        <tr>
                            <td id="td_false2" style="width: 45%; vertical-align: top;"  runat="server">
                                ...
                                <dxwgv:ASPxGridView ID="GridUserGroup" runat="server" width="100%" AutoGenerateColumns="False" OnCustomCallback="GridUserGroup_CustomCallback" 
                            ...
                            Border-BorderStyle="NotSet" OnBeforeGetCallbackResult="GridUserGroup_BeforeGetCallbackResult">
                                    ...
                                    <ClientSideEvents SelectionChanged="function(s, e) { OnGridFocusedRowChanged(); }"/>
                                       ...
                                       <%--<dxwgv:GridViewCommandColumn ShowSelectCheckbox="True" Width="50px" VisibleIndex="0">
                                         ...
                                         <dxwgv:GridViewDataTextColumn VisibleIndex="3" FieldName="grp_name"
                                    Caption="Group Name">
                                  
                                </dxwgv:GridViewDataTextColumn>
                                
                                <dxwgv:GridViewDataTextColumn VisibleIndex="2" FieldName="segname"
                                   ...
                                   <tr>
                                    ...
                                    <table>
                                        ...
                                        <td style="vertical-align: top; text-align: left;" id="ListSection" runat="server">
                                            <dxwtl:ASPxTreeList ID="TLgrid" runat="server" AutoGenerateColumns="False" KeyFieldName="menuID"
                                                ParentFieldName="menuParentID" 
                                                OnHtmlRowPrepared="TLgrid_HtmlRowPrepared" OnCustomJSProperties="TLgrid_CustomJSProperties">
                                                <Columns>
                                                    <dxwtl:TreeListTextColumn Caption="name" FieldName="name" VisibleIndex="0">
                                                    </dxwtl:TreeListTextColumn>
                                                    <dxwtl:TreeListTextColumn Caption="Option" VisibleIndex="1">
                                                        <DataCellTemplate>
                                                    ...
                                                    <%--<dxwtl:TreeListTextColumn FieldName="HaveSubMenu" Caption="#" VisibleIndex="2" Width="5%">
                                                        <DataCellTemplate>
