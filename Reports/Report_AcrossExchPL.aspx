<%@ page language="C#" autoeventwireup="true" inherits="Reports_Report_AcrossExchPL, App_Web_u73waeqe" %>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        { 
           ...
           cCmbReportType.AddItem("Group/Branch+Client Wise", "A");
           cCmbReportType.AddItem("Group/Branch Consolidated", "B");
        ...
        function fn_GroupBy(obj)
        {
            ...
            {  
             ...
             { 
                ...
                cCmbReportType.AddItem("Client Wise", "C");
                cCmbReportType.SetSelectedIndex(0);
    ...
    <form id="form1" runat="server">
        ...
        <div id="MainFull">
            <div id="header" class="Header">
                ...
                Across Exchange P&L In Base Currency
            </div>
