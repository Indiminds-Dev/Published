<%@ page language="C#" autoeventwireup="true" inherits="management_journalPopup, App_Web_lgnajdkn" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="javascript:document.form1.tDate.focus();">
    <form id="form1" runat="server">
        <div>
            ...
            <table class="TableMain100">
                    ...
                    <td>
                        <table class="TableMain100">
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <asp:DropDownList ID="ddlCompany" DataSourceID="dsCompany" TabIndex="1" AutoPostBack="true"
                                        ...
                                        Font-Size="10px" OnSelectedIndexChanged="ddlCompany_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                                <td style="text-align: left;">
                                    Segment :
                                ...
                                <td style="text-align: left; width: 162px;">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddlSegment" runat="server" Width="121px" TabIndex="2" Font-Size="10px">
                                            </asp:DropDownList>
                                        </ContentTemplate>
                                        <Triggers>
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtSettno" runat="server" Width="95px" TabIndex="4" Font-Size="10px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <dxe:ASPxDateEdit ID="tDate" runat="server" EditFormat="Custom" TabIndex="5" ClientInstanceName="tDate"
                                        UseMaskBehavior="True" Font-Size="10px" Width="247px">
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtBillNo" runat="server" Width="120px" TabIndex="8" Font-Size="10px"></asp:TextBox>
                                </td>
                                <td style="text-align: left;">
                                    Voucher No. :
                                </td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <asp:DropDownList ID="ddlIntExchange" runat="server" Font-Size="10px" Width="124px">
                                ...
                                <asp:GridView ID="grdAdd" runat="server" DataKeyNames="CashReportID" CssClass="gridcellleft"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="MainAccount">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtEditMainAccount" TabIndex="9" Font-Size="10px" Text='<%# Eval("MainAccount1") %>'
                                            ...
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtMainAccount" TabIndex="9" Font-Size="10px" Width="180px" onkeyup="CallMainAccount(this,'MainAccountJournal',event)"
                                        ...
                                        <asp:TemplateField HeaderText="SubAccount">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtEditSubAccount" TabIndex="10" Font-Size="10px" Text='<%# Eval("SubAccount1") %>'
                                            ...
                                            <FooterTemplate>
                                                <asp:TextBox ID="txtSubAccount" TabIndex="10" Font-Size="10px" Width="180px" onkeyup="CallSubAccount(this,'SubAccountMod',event)"
                                        ...
                                        <asp:TemplateField Visible="false" HeaderText="Value Date">
                                            ...
                                            <FooterTemplate>
                                                <dxe:ASPxDateEdit ID="dtAspxDate" runat="server" EditFormat="Custom" TabIndex="11"
                                                    EditFormatString="dd-MM-yyyy" UseMaskBehavior="True" Font-Size="10px" Width="100px">
                                                    <ButtonStyle Width="13px">
                                                    </ButtonStyle>
                                                </dxe:ASPxDateEdit>
                                            </FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Edit" ShowHeader="False" ItemStyle-HorizontalAlign="Right">
                                            <EditItemTemplate>
                                                <asp:LinkButton ID="LinkButton3" runat="server" CausesValidation="True" CssClass="btnUpdate"
                                                    OnClientClick="javascript:return SubAccountCheckUpdate(this.id);" CommandName="Update" Text="Update"></asp:LinkButton>|
                                ...
                                <table width="100%">
                                    <tr id="Tdebit" runat="server">
                                        ...
                                        <td style="text-align: right;">
                                            <asp:TextBox ID="txtTDebit" runat="server" ReadOnly="true" Font-Size="10px" Width="79px"></asp:TextBox>
                                        </td>
                                        <td style="text-align: right;">
                                            <asp:TextBox ID="txtTCredit" runat="server" ReadOnly="true" Font-Size="10px" Width="79px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </ContentTemplate>
                ...
                <tr>
                    <td style="text-align: right;">
                         <input id="btnInsert" type="button" value="Save" class="btnUpdate" style="width: 62px;
                            height: 25px" onclick="btnInsert_Click()" />
