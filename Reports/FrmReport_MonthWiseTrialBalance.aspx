<%@ page language="C#" autoeventwireup="true" inherits="Reports_FrmReport_MonthWiseTrialBalance, App_Web_wt4jql-z" %>
    ...
    <form id="form1" runat="server" autocomplete="off">
        <div>
            ...
            <table class="TableMain100">
                ...
                <tr id="TrButton">
                    <td id="TrBtn">
                        <asp:Button ID="btnShow" runat="server" Text="Export To Excel" CssClass="btnUpdate"
                            Height="23px" OnClientClick="selecttion()" OnClick="btnShow_Click" />
