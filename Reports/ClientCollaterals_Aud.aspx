<%@ page language="C#" autoeventwireup="true" inherits="Reports_ClientCollaterals_Aud, App_Web_1vatjdzx" enableeventvalidation="false" %>
...
//            window.frameElement.width = document.body.scrollwidth;
  ...
  function FnCorpAc(obj)
  {
    ...
    {
     var url="ClientCollaterals_Audpopup.aspx?id="+KeyValue;
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                        <strong><span id="SpanHeader" style="color: #000099">Client Wise Collateral Report
                        </span></strong>
                    </td>
