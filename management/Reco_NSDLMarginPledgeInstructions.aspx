<%@ page language="C#" autoeventwireup="true" inherits="management_Reco_NSDLMarginPledgeInstructions, App_Web_cvaj-tqf" %>
        ...
        <table id="tbl_main" class="login" cellspacing="0" cellpadding="0" width="410">
            <tbody>
                <tr>
                    <td class="lt1">
                        <h5>
                            Imports View_Open_Holdings_DDMMYYYYHHMMSS_TMCM.csv files available From NSDL MarginPledge portal"
                        </h5>
                    </td>
                </tr>
                <tr>
