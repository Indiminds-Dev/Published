<%@ page language="C#" autoeventwireup="true" inherits="Reports_DeliveryCentre, App_Web_sf8qvqgk" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Delivery Centre</title>
    ...
    <script language="javascript" type="text/javascript">
       function selecttion()
	    ...
	    function Transaction(objID,objScrip,objSettNumType,objISIN,objClient)
	    {
            ...
            parent.OnMoreInfoClick(url,"Transaction For : "+objScrip+" ["+objISIN+"],"+objSettNumType+" For : "+objClient+"",'940px','450px',"N");
	    } 
	    function Stock(objScrip,objProductID)
	    {
	        var url="Stock.aspx?id="+objProductID;
            parent.OnMoreInfoClick(url,"Stock Position For : "+objScrip+"",'940px','450px',"N");
	    }
	    function TransactionStock(objSettNumType,objScrip,objISIN)
	    {
	        ...
	        parent.OnMoreInfoClick(url,"Transaction For : "+objScrip+" ["+objISIN+"]",'940px','450px',"N");
	    }
...
//             parent.OnMoreInfoClick(url,"Add Transaction Entries",'985px','450px',"Y");
//	    }
	    ...
	    function MarGinHoldBack(objClient,objBranch,objClientName,UCC)
	    {
	        var url='../management/MarginHoldback.aspx?Client='+objClient+' &Branch='+objBranch;
             parent.OnMoreInfoClick(url,"Show Margin/Holdback Stocks For : "+objClientName+" [ "+UCC+" ]",'985px','450px',"Y");
	    }
	    function callback()
        {
        ...
        function TradeRegister(objCustomer,objProduct,objSettNumber,objSettType,objSegment,objDID,objClientName,objUCC)
        {
            ...
            parent.OnMoreInfoClick(url,"Show Trade Register : "+objClientName+" ["+objUCC+"]",'985px','450px',"N");
        }
    </script>
                    ...
                    <td style="text-align: left; vertical-align: top;" class="gridcellleft">
                        <table border="10" cellpadding="1" cellspacing="1">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlType" runat="server" onchange="TypeChange(this.value)" Width="200px">
                                        <asp:ListItem Value="O">Obligation</asp:ListItem>
                                        <asp:ListItem Value="C">CUSA Positions</asp:ListItem>
                                ...
                                <asp:GridView ID="grdDematCentre" runat="server" Width="100%" BorderColor="CornflowerBlue"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField Visible="false">
                                            ...
                                            <HeaderStyle HorizontalAlign="Right" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblDDPIColourType" runat="server" Text='<%# Eval("DDPIColourType")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
