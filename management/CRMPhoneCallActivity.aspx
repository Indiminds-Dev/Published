<%@ page language="C#" autoeventwireup="true" inherits="management_CRMPhoneCallActivity, App_Web_akbpwr7y" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="TableMain100">
                ...
                <tr>
                    <td id="frmShowCall" runat="Server" style="height: auto">
                        <asp:Panel ID="pnlCall" runat="server" Width="100%" Visible="false">
                            <table class="TableMain100">
                                <tr>
                                    <td class="Ecoheadtxt" style="width: 17%">
                                        Activity Type :
                                    </td>
                                    ...
                                    <td class="Ecoheadtxt" style="width: 8%">
                                        Start Date/Start Time&nbsp;:<%-- <asp:TextBox ID="txtStartDate" runat ="server" ></asp:TextBox>--%>
                                    </td>
                     ...
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TxtStartDate"
                         ErrorMessage="Required" ValidationGroup="a"></asp:RequiredFieldValidator>--%>
                                ...
                                <tr>
                                    ...
                                    <td class="Ecoheadtxt" style="width: 13%; text-align: left;">
                                        <asp:TextBox ID="txtUserList" Font-Size="10px" ForeColor="Blue" runat="server" Width="80%"></asp:TextBox>
                          ...
                          ErrorMessage="Required" ValidationGroup="a"></asp:RequiredFieldValidator>--%>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 13%; text-align: left;">
                                        <asp:TextBox ID="txtDesc" TextMode="MultiLine" Rows="2" runat="server" Width="80%"
                                            Font-Size="10px" ForeColor="blue"></asp:TextBox>
                                    </td>
                                    <td class="Ecoheadtxt" style="width: 8%">
                                        Priority :
                                    </td>
                                ...
                                <tr>
                                    <td class="Ecoheadtxt" colspan="5">
                                        <table class="TableMain100">
                                            <tr>
                                                <td class="Ecoheadtxt" style="width: 28%; height: 25px;">
                                                    Instruction Notes :
                                                </td>
                        ...
                        <table class="TableMain100">
                            <tr>
                                <td>
                                    <table class="TableMain100">
                                        <tr>
                                            <td class="Ecoheadtxt" style="width: 50%; text-align: right">
                                                Genrated Sales Visit
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <table class="TableMain100">
                                                    <tr>
                                                        <td class="Ecoheadtxt" style="width: 10%">
                                                            Select Date Range
                                                        </td>
                                                ...
                                                <asp:Image ID="ImgFrom" runat="server" ImageUrl="~/images/calendar.jpg" />--%>
                                                        ...
                                                        <td class="Ecoheadtxt" style="width: 2%">
                                                            To
                                                        </td>
                                                ...
                                                <asp:Image ID="ImgTo" runat="server" ImageUrl="~/images/calendar.jpg" />--%>
                                                        ...
                                                        <td class="Ecoheadtxt" style="width: 3%">
                                                            Select
                                                        </td>
                                                        <td>
                        ...
                        <table class="TableMain100">
                            <tr>
                                <td>
                                    <table class="TableMain100">
                                        <tr>
                                            <td colspan="7" class="Ecoheadtxt" style="text-align: center">
                                                Show Courtesy Call
                                            </td>
                                        </tr>
                                        <tr>
                                       ...
                                       <asp:Image ID="ImgEndCall" runat="server" ImageUrl="~/images/calendar.jpg" />--%>
                                            ...
                                            <td class="Ecoheadtxt" style="width: 6%">
                                                Select User</td>
                                            <td style="text-align: left;">
                ...
                <tr>
                    <td id="FrmShowGenratedSales" runat="Server" visible="false" style="height: 356px;
                        height: auto">
                        <table class="TableMain100">
                            <tr>
                                <td colspan="3" class="Ecoheadtxt" style="text-align: center" visible="false">
                                    Genrated Sales By Phone Follow Up
