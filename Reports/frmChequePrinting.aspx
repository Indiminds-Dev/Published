<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmChequePrinting, App_Web__-dtd0z2" enableeventvalidation="false" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OnMoreInfoClick()
        {
           ...
           // alert(url);
            parent.OnMoreInfoClick(url,"Cheque Printing",'940px','450px',"Y");
