<%@ page language="C#" autoeventwireup="true" inherits="management_JournalVoucher_ExcelImport, App_Web_6yanuau_" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="PageLoad()">
    <form id="form1" runat="server">
        <div>
            <table border="1">
                        ...
                        <table class="TableMain100" width="100%">
                            <tr>
                                <td class="EHEADER" colspan="2" style="height: 20px; text-align: center">
                                    <strong><span id="SpanHeader" style="color: #000099">IMPORT SALARY JVS FROM PAYROLL
                                        FILE</span></strong></td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="width: 134px; font-weight: bold; background-color: #b7ceec; text-align: left;
                ...
                <tr>
                    ...
                    <td style="font-weight: bold; vertical-align: top; height: 11px; background-color: #b7ceec;
                        text-align: left;">
                        Main Accounts</td>
                    <td style="font-weight: bold; vertical-align: top; height: 11px; background-color: #b7ceec;
                ...
                <tr>
                    ...
                    <td style="width: 40%">
                        <dxe:aspxcombobox id="ComboSalaryAccount" runat="server" clientinstancename="cComboSalaryAccount"
                            Font-Size="10px" SelectedIndex="0" ValueType="System.String" EnableIncrementalFiltering="True"
                            Width="65px">
                ...
                <tr>
                    ...
                    <td style="width: 40%">
                        <dxe:aspxcombobox id="ComboTds" runat="server" clientinstancename="cComboTds" Font-Size="10px"
                ...
                <tr>
                    ...
                    <td style="width: 40%">
                        <dxe:ASPxButton ID="btnImportFile" runat="server" AccessKey="X" AutoPostBack="false"
                            TabIndex="0" Text="Import File" Width="200px" UseSubmitBehavior="False">
                            <clientsideevents click="function(s, e) {ImportFileButtonClick();}"></clientsideevents>
                        </dxe:ASPxButton>
                    </td>
                    <td style="width: 326%">
                        <dxcp:ASPxCallbackPanel ID="CbpImportFile" runat="server" ClientInstanceName="cCbpImportFile"
