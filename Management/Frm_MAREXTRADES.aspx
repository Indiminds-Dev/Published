<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_MAREXTRADES, App_Web_wqpzjxym" %>
   ...
   <script language="javascript" type="text/javascript">
    ...
    function PageLoad()
    {
       ...
       //File Format to Import By Default
        Span_FileFormat.innerText="File Name : Trades_ddMMyyyy.csv";
    }
    ...
    function OnComboChooseFileIndexChange()
    {
        ...
        if(SelectedValue==0)
            ...
            Span_FileFormat.innerText="File Name : Closing_ddmmyyyy.csv";
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports Marex's New Trade file converted in CSV format
                                </h5>
                            </td>
                        </tr>
                        <tr>
