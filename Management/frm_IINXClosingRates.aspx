<%@ page language="C#" autoeventwireup="true" inherits="management_frm_IINXClosingRates, App_Web_i8xxwgwk" %>
    ...
    <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 22px;">
                        <strong><span id="SpanHeader" style="color: #000099">Imports INX Closing Rates</span></strong>
                    </td>
                </tr></table>
            ...
            <tr>
                ...
                <td style="padding-left:4px" align=left>
                    <select id="cmbTrade" onchange="Javascript:ShowDate(this.value)" runat="server">
                        ...
                        <option value="1">INX_MS_YYYYMMDD_n.CSV</option>
                        <%--<option value="2">INX_MS_YYYYMMDD_2.CSV</option>--%>
