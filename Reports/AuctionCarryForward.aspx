<%@ page language="C#" autoeventwireup="true" inherits="Reports_AuctionCarryForward, App_Web_-n9yptcr" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Auction CarryForward</title>
            ...
            <table class="TableMain100">
                <tr>
                    <td colspan="2">
                        <table>
                            <tr>
                                <td class="gridcellleft" style="width: 130px">
                                    Source Settlement
                                </td>
                                <td>
                                ...
                                <asp:GridView ID="grdDematProcessing" runat="server" Width="100%" BorderColor="CornflowerBlue"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="C/F To Auction">
                                            ...
                                            <HeaderStyle Wrap="False" HorizontalAlign="Left" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtStock" Font-Size="10px" Width="60px" runat="server" Text='<%# Eval("Adjust") %>' onKeyUp="javascript:checkNumber(this);"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
