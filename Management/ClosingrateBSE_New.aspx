<%@ page language="C#" autoeventwireup="true" inherits="management_ClosingrateBSE_New, App_Web_bfdn6hbr" %>
            ...
            <tbody>
                <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports BSE's Closing Rate Files
                        </h5>
                    </td>
                </tr>
                                        ...
                                        <table class="width100per" cellspacing="12" cellpadding="0">
                                            ...
                                            <tr id="trYesNo" runat="server">
                                                    ...
                                                    <td class="lt" style="height: 16px">
                                                        <asp:Label ID="importstatus" runat="server" Font-Size="10px" Font-Names="Arial"
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td class="lt" >
                                                        <table>
                                                            <tr>
                                                                <td><B>Select EQddMMyy.csv OR BhavCopy_BSE_CM_0_0_0_yyyyMMdd_F_0000.csv Files </B></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                </td>
