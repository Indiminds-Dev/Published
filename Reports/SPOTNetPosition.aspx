<%@ page language="C#" autoeventwireup="true" inherits="Reports_SPOTNetPosition, App_Web_cnvbs8pk" %>
                        ...
                        <tr>
                            <td class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr valign="top">
                                        <td class="gridcellleft">
                                            <asp:DropDownList ID="ddldate" runat="server" Width="100px" Font-Size="10px" onchange="fn_ddldateChange(this.value)" Enabled="False">
                                        ...
                                        <td id="td_dtfor" class="gridcellleft">
                                            <dxe:ASPxDateEdit ID="dtfor" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                Font-Size="10px" Width="108px" ClientInstanceName="dtfor" EditFormatString="dd-MM-yyyy">
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Report View :</td>
                                        <td class="gridcellleft">
                                            <asp:DropDownList ID="ddlrptview" runat="server" Width="120px" Font-Size="10px" onchange="fn_ddlrptchange(this.value)">
                        ...
                        <tr id="tr_checkselection">
                            <td class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1">
                                    ...
                                    <tr>
                                                    <td class="gridcellleft" bgcolor="#B7CEEC">
                                                        Consider Clients With Net Obligation >=
                                                    </td>
                                                    <td>
                                    ...
                                    <tr id="tr_mail">
                                     ...
                                     <tr id="tr_excel">
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                             File Type :</td>
                                         <td>
                                             <asp:DropDownList ID="cmbExport" runat="server" AutoPostBack="True" Font-Size="10px" Width="100px" OnSelectedIndexChanged="cmbExport_SelectedIndexChanged">
