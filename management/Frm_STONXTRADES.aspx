<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_STONXTRADES, App_Web__yen2upk" %>
                                    ...
                                    <tr>
                                        <td style="width: 100px">
                                            <dxe:ASPxComboBox ID="ComboChooseFile" runat="server" ClientInstanceName="cComboChooseFile"
                                                ...
                                                <Items>
                                                    <dxe:ListEditItem Value="0" Text="Daily Trades & Closing Rates"></dxe:ListEditItem>
                                                </Items>
