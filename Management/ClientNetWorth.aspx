...
<%@ Register Assembly="DevExpress.Web.v9.1" Namespace="DevExpress.Web.ASPxPanel"
    TagPrefix="dxp" %>
<%@ page language="C#" autoeventwireup="true" inherits="Reports_ClientNetWorth, App_Web_im-ehkhh" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE">
    <form id="form1" runat="server" autocomplete="off">
        ...
        <div>
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                        <strong><span id="SpanHeader" style="color: #000099">Client's Net-worth Report</span></strong></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dxe:ASPxDateEdit ID="ToDate" runat="server" ClientInstanceName="cToDate"
                                                    ...
                                                    <dropdownbutton text="Select"></dropdownbutton>
                                                </dxe:ASPxDateEdit>
                                            </td>
                                        </tr>
                                        <tr id="tr_Segment">
                                            ...
                                            <td>
                                                <asp:RadioButton ID="rdbSegmentSelected" runat="server" Checked="true" GroupName="b"/>Selected 
                ...
                <tr>
                    <td>
                        <dxe:ASPxButton ID="btnShow" runat="server" CssClass="btnUpdate" AutoPostBack="False"
                            Height="5px" Text="Show" Width="110px" ClientInstanceName="cShow">
                            <clientsideevents click="function (s, e) {btnShow_Click();}" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="btnExcel" runat="server" CssClass="btnUpdate" AutoPostBack="False"
                            Height="5px" Text="Export To Excel" Width="110px" ClientInstanceName="cbtnExcel">
            ...
            <div id="dvGvw">
                <dxwgv:ASPxGridView ID="GridCntNetWrth" KeyFieldName="ClientCode" Width="1250px" runat="Server"
                    AutoGenerateColumns="False" ClientInstanceName="cGridCntNetWrth" OnCustomCallback="GridCntNetWrth_CustomCallback">
                    <ClientSideEvents EndCallback="function(s, e) {GridCntNetWrth_EndCallBack();}" />
                    <Templates>
                        <TitlePanel>
                            <div style="width: 100%">
                            </div>
                    ...
                    <Columns>
                        <dxwgv:GridViewDataTextColumn Caption="Name" FieldName="ClientName" VisibleIndex="1"
                            Width="200px">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Code" FieldName="ClientCode" VisibleIndex="2"
                            Width="100px">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Trd Bal" FieldName="Trading.Balance" VisibleIndex="3"
                            Width="120px">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Appl.Margin" FieldName="Appl.Margin" VisibleIndex="4"
                            Width="120px">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Net.Deposits" FieldName="Net.Deposits" VisibleIndex="5"
                            Width="120px">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Net Bal" FieldName="Net.Balance" VisibleIndex="6"
                            Width="120px">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Short Funds" FieldName="Short.Funds" VisibleIndex="7"
                            Width="120px">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Excess Funds" FieldName="Excess.Funds" VisibleIndex="8"
                            Width="120px">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Exposure" FieldName="Exposure" VisibleIndex="9"
                            Width="120px">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
