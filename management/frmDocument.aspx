<%@ page language="C#" autoeventwireup="true" inherits="management_frmDocument, App_Web_ko_nrypx" %>
                                        ...
                                        <dxw:ContentControl runat="server">
                                            <div id="GridDiv">
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <dxwgv:ASPxGridView ID="DocumentGrid" runat="server" AutoGenerateColumns="False"
                                                                DataSourceID="DocumentDataSource" Width="100%" OnCustomCallback="DocumentGrid_CustomCallback">
                                                                <Columns>
