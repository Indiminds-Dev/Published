<%@ page language="C#" autoeventwireup="true" inherits="management_frm_ImportCC02, App_Web_xu-hjjp9" %>
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports NSE Trading Members' Client Allocation Reports [C/F/X_CC02_TMCode_DDMMYYYY.csv] From FTP [/TMCODE/REPORTS] Folder..This import will also create corresponding Adjustment Entries in Accounts as per your preference set in Global Settings. </h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="lt brdr">
