<%@ page language="C#" autoeventwireup="true" inherits="management_frm_attendance_employeeWise_iframe, App_Web_s3wzohpw" %>
...
<head runat="server">
	...
	var ajax_list_externalFile = '../management/ajax_list.aspx';	// Path to external file
            ...
            <tr>
                <td>
                    <dxe:ASPxComboBox ID="cmbCompany" runat="server" CssFilePath="~/App_Themes/Office2003 Blue/{0}/styles.css"
                        CssPostfix="Office2003_Blue" Font-Size="10px" ImageFolder="~/App_Themes/Office2003 Blue/{0}/"
                ...
                <td class="gridcellleft" style="width: 50px">
                    <dxe:ASPxComboBox ID="cmbBranch" runat="server" CssFilePath="~/App_Themes/Office2003 Blue/{0}/styles.css"
                        ...
                        ValueType="System.String" Width="130px" Font-Size="10px" EnableIncrementalFiltering="True"
                ...
                <td style="width: 81px; text-align: left">
                    <dxe:ASPxDateEdit ID="cmbFromdate" runat="server" CssFilePath="~/App_Themes/Office2003 Blue/{0}/styles.css"
                        ...
                        Font-Size="10px" ImageFolder="~/App_Themes/Office2003 Blue/{0}/" Width="131px"
