<%@ page language="C#" autoeventwireup="true" inherits="Reports_contractregistercomm, App_Web_dwbygqb3" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
   ...
   <table class="TableMain100">
            ...
            <table>
                <tr>
                    <td colspan="4" valign="top" style="width: 428px">
                        <table border="0">
                        <tr id="tr_date">  <td style="width: 110px">
                            ...
                            <tr id="tr_branchid">
                                <td class="gridcellleft" style="width: 73px">
                                    Branch
                                </td>
                             ...
                             <tr id="tr_branchdisplay">
                                ...
                                <td class="gridcellleft" colspan="1">
                                </td>
                            </tr>
                            <tr id="tr_Clientid">
                                <td class="gridcellleft" style="width: 73px">
                                ...
                                <table>
                                        <tr>
                                            ...
                                            <td style="width: 14px; height: 36px">
                                                All
                                            </td>
                                            <td style="height: 36px">
                        ...
                        <td class="gridcellleft" style="vertical-align: top; text-align: right" id="TdFilter">
                            <table width="100%">
                                        ...
                                        <table cellpadding="0" cellspacing="0" id="showFilter">
                                            <tr>
                                                <td style="width: 291px">
                                                    <asp:ListBox ID="lstSlection" runat="server" Font-Size="10px" Height="90px" Width="358px">
                                                    </asp:ListBox>
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <progresstemplate>
                                    ...
                                    <td style="display:none;">  <asp:TextBox ID="txtSelectionID_hidden" runat="server" Font-Size="12px" Width="1px"></asp:TextBox>
                             ...
                             <div id="divgrid"  runat="Server" >  
                                <asp:GridView ID="grdContractRegister" runat="server"  BorderColor="CornflowerBlue"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="CTT" SortExpression="ContractNotes_STTAmount_Sorting">
                                            <ItemStyle Wrap="false"  BorderWidth="1px" HorizontalAlign="Right"  ></ItemStyle>
                                            <HeaderStyle HorizontalAlign="Center" Font-Bold="False" ></HeaderStyle>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Sebi Fee" SortExpression="ContractNotes_SEBIFee">
                                         ...
                                         <asp:TemplateField HeaderText="Dlvry/Clrng Charge" SortExpression="ContractNotes_DeliveryCharges">
                                            <ItemStyle  Wrap="false"  BorderWidth="1px" HorizontalAlign="Right"  ></ItemStyle>
                                            <HeaderStyle HorizontalAlign="Center" Wrap="false" Font-Bold="False" 
                                                ></HeaderStyle>
                                            <ItemTemplate>
                                       ...
                                       <%-- ------------------- RMS Fee Start ----------------------------------%>
                                          ...
                                          <asp:TemplateField HeaderText="RMS Fee" SortExpression="TotalRMS_Sorting">
                                            <ItemStyle  Wrap="false"  BorderWidth="1px" HorizontalAlign="Right"  ></ItemStyle>
                                            <HeaderStyle HorizontalAlign="Center" Wrap="false" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblRMSTax" runat="server" Text='<%# Eval("RMS")%>'  CssClass="gridstyleheight1" ></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:Label ID="lblRMS_sum" runat="server" Text='<%# Eval("TotalRMS")%>' ForeColor="white" ></asp:Label>
                                            </FooterTemplate>
                                            <FooterStyle HorizontalAlign="Right" VerticalAlign="Top" Font-Bold="True" ForeColor="White" />
                                        </asp:TemplateField>
                                      ...
                                      <%--  ------------------------RMS Fee End----------------------------%>
                                        ...
                                        <asp:TemplateField HeaderText="SrvTax/CGST" SortExpression="TotalTax_Sorting">
                                            <ItemStyle Wrap="false" BorderWidth="1px" HorizontalAlign="Right"></ItemStyle>
                                            <HeaderStyle HorizontalAlign="Center" Wrap="false" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                         ...
                                         <%-- ------------------- Swachh Bharat Cess Start ----------------------------------%>
                                        
                                          <asp:TemplateField HeaderText="SBCess/SGST" SortExpression="TotalSBC_Sorting">
                                            <ItemStyle  Wrap="false"  BorderWidth="1px" HorizontalAlign="Right"  ></ItemStyle>
                                            <HeaderStyle HorizontalAlign="Center" Wrap="false" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblSBCTax" runat="server" Text='<%# Eval("SBC")%>'  CssClass="gridstyleheight1" ></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:Label ID="lblSBC_sum" runat="server" Text='<%# Eval("TotalSBC")%>' ForeColor="white" ></asp:Label>
                                            </FooterTemplate>
                                            <FooterStyle HorizontalAlign="Right" VerticalAlign="Top" Font-Bold="True" ForeColor="White" />
                                        </asp:TemplateField>
                                        
                                        
                                      <%--  ------------------------Swachh Bharat Cess End----------------------------%>
                                      
                                      
                                        <%-- ------------------- Kisan Bharat Cess Start ----------------------------------%>
                                        
                                          <asp:TemplateField HeaderText="KKCess/IGST" SortExpression="TotalKKC_Sorting">
                                            <ItemStyle  Wrap="false"  BorderWidth="1px" HorizontalAlign="Right"  ></ItemStyle>
                                            <HeaderStyle HorizontalAlign="Center" Wrap="false" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblKBCTax" runat="server" Text='<%# Eval("KKC")%>'  CssClass="gridstyleheight1" ></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:Label ID="lblKBC_sum" runat="server" Text='<%# Eval("TotalKKC")%>' ForeColor="white" ></asp:Label>
                                            </FooterTemplate>
                                            <FooterStyle HorizontalAlign="Right" VerticalAlign="Top" Font-Bold="True" ForeColor="White" />
                                        </asp:TemplateField>
                                        
                                        
                                      <%--  ------------------------Kisan Bharat Cess End----------------------------%>
                                      
                                        <%-- ------------------- UTT Start ----------------------------------%>
                                        
                                          <asp:TemplateField HeaderText="UTT" SortExpression="TotalUTT_Sorting">
                                            <ItemStyle  Wrap="false"  BorderWidth="1px" HorizontalAlign="Right"  ></ItemStyle>
                                            <HeaderStyle HorizontalAlign="Center" Wrap="false" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblUTT" runat="server" Text='<%# Eval("UTT")%>'  CssClass="gridstyleheight1" ></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:Label ID="lblUTT_sum" runat="server" Text='<%# Eval("TotalUTT")%>' ForeColor="white" ></asp:Label>
                                            </FooterTemplate>
                                            <FooterStyle HorizontalAlign="Right" VerticalAlign="Top" Font-Bold="True" ForeColor="White" />
                                        </asp:TemplateField>
            ...
            </table><asp:HiddenField ID="hidScreenWd" runat="server" />   
        </div>
    </form>
</body>
</html>
