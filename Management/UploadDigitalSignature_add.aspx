<%@ page autoeventwireup="true" inherits="management_UploadDigitalSignature_add, App_Web_rtil2eyr" language="C#" %>
...
<body onload="loadFocus();" style="background-color: #DDECFE;">
            ...
            <table border="0" style="border: solid 1px white; width: 650px">
                ...
                <tr>
                    ...
                    <td style="width: 10%" class="gridcellleft">
                        <dxe:ASPxDateEdit ID="dtFrom" runat="server" EditFormat="Custom" UseMaskBehavior="True" Font-Size="10px" Width="112px" ClientInstanceName="dtfrom" tabIndex="3">
                            <dropdownbutton text="From"></dropdownbutton>
                        </dxe:ASPxDateEdit>
                    </td>
                    <td style="width: 10%;" class="gridcellleft">
                        <dxe:ASPxDateEdit ID="dtTo" runat="server" EditFormat="Custom" UseMaskBehavior="True" Font-Size="10px" Width="112px" ClientInstanceName="dtto" tabIndex="4">
                ...
                <tr>
                    ...
                    <td class="gridcellleft" colspan="3">
                        ...
                        <asp:ListBox ID="lstSuscriptions" runat="server" Font-Size="10px" Height="70px" Width="220px" TabIndex="10"></asp:ListBox><br />
                ...
                <tr>
                    ...
                    <td colspan="3" class="gridcellleft">
                        <table width="100%">
                            <tr>
                                <td align="left">
                                    <asp:Button ID="btnSave" runat="server" CssClass="btnUpdate" Height="23px" OnClick="btnSave_Click" OnClientClick="javascript:return validation();" TabIndex="13" Text="Upload" Width="101px" />
                                </td>
                                <td align="right">
                                    <asp:Button ID="btnClose" runat="server" CssClass="btnUpdate" Height="23px" OnClientClick="javascript:closeWin();" TabIndex="13" Text="Close" Width="101px" />
                                </td>
                            </tr>
                        </table>
                    </td>
