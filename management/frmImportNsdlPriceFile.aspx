<%@ page language="C#" autoeventwireup="true" inherits="management_frmImportNsdlPriceFile, App_Web_alid8jfz" %>
        ...
        <tbody>
            <tr>
                <td class="lt1" style="height: 40px">
                    <h5>
                        Imports NSDL PriceFile
                    </h5>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="width: auto; height: auto;">
                    <strong>This Routine Imports "NSDL Price" file available from NSDL DPM System</strong>
                </td>
            </tr>
            <tr>
