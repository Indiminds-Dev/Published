<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReport_NsdlTransaction, App_Web_w8tpuxyq" enableeventvalidation="false" %>
...
<head>
    <title>NSDL Transaction Report</title>
    ...
    { 
        ...
        DevE_SetDateTime(dtfrom,FYS);
        DevE_SetDateTime(dtto,FYS);
    }
    function Reset()
    {       
        Hide('divPageFilter'); 
    ...
    {       
     ...
     function DateCompare(DateobjFrm,DateobjTo)
     {
        ...
        //New Work 26/02/2022
        //DevE_CheckForLockDate(DateobjFrm,Lck);
        //End of New Work 26/02/2022
        DevE_CheckForFinYear(DateobjFrm,FYS,FYE,LFY);
        //New Work 26/02/2022
        //DevE_CheckForLockDate(DateobjTo,Lck);
        //End of New Work 26/02/2022
        DevE_CheckForFinYear(DateobjTo,FYS,FYE,LFY);
            ...
            {                
                ...
                else 
                {
                   ...
                   // AjaxList_TextBox.attachEvent('onkeyup', CallGenericAjaxJS);
                    ...
                    var AjaxList_txtSelection = document.getElementById('<%=txtSelection.ClientID%>');
                    AjaxList_txtSelection.value = '';
                    AjaxList_txtSelection.attachEvent('onkeyup', CallGenericAjaxJS);
...
//                AjaxComQuery=AjaxComQuery.replace("\'","'");
                ...
                var AjaxList_txtSelection = document.getElementById('<%=txtSelection.ClientID%>');
                AjaxList_txtSelection.focus();
                AjaxComQuery = AjaxComQuery.replace("\'", "'");
                ajax_showOptions(AjaxList_txtSelection, 'GenericAjaxList', e, replaceChars(AjaxComQuery), 'Main');
            }
        }
                            ...
                            <div class="left">
                                <div class="frmleftContent">
                                    <dxe:ASPxDateEdit ID="dtfrom" runat="server" ClientInstanceName="dtfrom" DateOnError="Today"
                                        ...
                                        <ClientSideEvents LostFocus="function(s,e){DateCompare(dtfrom,dtto);}"></ClientSideEvents>
                                    </dxe:ASPxDateEdit>
                                </div>
                                <div class="frmleftContent">
                        ...
                        <div id="divISIN">
                            ...
                            <div class="frmleftContent">
                                <dxe:ASPxRadioButtonList ID="rbISIN" runat="server" SelectedIndex="0" ItemSpacing="10px"
                                    RepeatDirection="Horizontal" TextWrap="False" Font-Size="10px" TabIndex="0" ClientInstanceName="crbISIN">
                                    <Items>
                        ...
                        <div class="left">
                            ...
                            <div class="left">
                                ...
                                <div id="divGroupByGroup" class="left">
                                 ...
                                 <span class="clear"></span>
                                 <div id="dvUcc" class="frmleftContent">
                                      <div width="500px">
                                        <asp:CheckBox ID="chkUCC" runat="server"  />
                                        <asp:Label ID="lblUCC" runat="server" Text="Show UCC"></asp:Label>
                                      </div>
                                 </div>                                 
