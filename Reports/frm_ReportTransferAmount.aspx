<%@ page language="C#" autoeventwireup="true" inherits="Reports_frm_ReportTransferAmount, App_Web_qrhyroaj" %>
                    ...
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="cmbSourceAc" runat="server" Width="220px" AutoPostBack="true" DataTextField="MainAccount_Name" DataValueField="MainAccount_AccountCode" AppendDataBoundItems="true" 
                                 OnSelectedIndexChanged="cmbSourceAc_SelectedIndexChanged">
                                </asp:DropDownList>
                                <%--End of New Work 30/11/2024--%>
                            </td>
                            <td style="vertical-align: top; height: 11px; background-color: #b7ceec; text-align: left;">
                                &nbsp;Target A/c</td>
                            <td style="width: 218px">
                        ...
                        <tr>
                            <td style="vertical-align: top; height: 11px; background-color: #b7ceec; text-align: left;">
                                &nbsp;Target Currency</td>
                            <td style="width: 218px;">
                                <asp:DropDownList ID="cmbTargetCurrency" runat="server" Width="220px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <%--End of New Work 30/11/2024--%>
                                ...
                                <table>
                                    <tr>
                                        <td class="gridcellleft" style="vertical-align: top; height: 11px; background-color: #b7ceec; text-align: left">
                                            &nbsp;Naration</td>
                                        <td colspan="3">
                                            <asp:TextBox ID="txtNarration" Font-Size="10px" Width="432px" runat="server" TextMode="MultiLine" Height="50px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="grdInterSegmentTransfer" runat="server" Width="100%" BorderColor="CornflowerBlue"
                                ...
                                <Columns>
                                    ...
                                    <%--Logic For Multi Currency - 20240312--%>
                                     <asp:TemplateField Visible="False">
                                        <ItemStyle Font-Size="10px" BorderWidth="1px" HorizontalAlign="Center"></ItemStyle>
                                        <HeaderStyle HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                        <ItemTemplate>
                                            <asp:Label ID="lblCBalance" runat="server" Text='<%# Eval("cBalance")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField Visible="False">
                                        <ItemStyle Font-Size="10px" BorderWidth="1px" HorizontalAlign="Center"></ItemStyle>
                                        <HeaderStyle HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                        <ItemTemplate>
                                            <asp:Label ID="lblSNarr" runat="server" Text='<%# Eval("sNarr")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField Visible="False">
                                        <ItemStyle Font-Size="10px" BorderWidth="1px" HorizontalAlign="Center"></ItemStyle>
                                    ...
                                    <%--End Logic For Multi Currency - 20240312--%>
                                </Columns>
