<%@ page language="C#" autoeventwireup="true" inherits="management_frm_Address_Book, App_Web_yq8u0p-o" enableeventvalidation="false" %>
    ...
    function SearchOpt(obj)
    {
     ...
     else
     {
         ...
         // document.getElementById("tr_cou").style.display="inline";
          document.getElementById("tblBulk").style.display="none";
          document.getElementById("td_type").style.display="inline";
          document.getElementById("Td_branch").style.display="none";
        //alert(ID);
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    <form id="form1" runat="server">
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" style="text-align: center">
                        <strong><span style="color: #000099">Address Book/Label Printing</span></strong></td>
                </tr>
                            ...
                            <tr>
                                ...
                                <td class="gridcellright">
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Button ID="btnSave" runat="server"  Text="Show" CssClass="btnUpdate" 
                                                    OnClick="btnSave_Click"  OnClientClick="btnShow_Click();"/>
                                            </td>
                                            <td>
                                                <asp:Button ID="btnExport" runat="server" Text="Export to Excel" CssClass="btnUpdate"
                                                    OnClick="btnExport_Click" />
                                            </td>
                                            <td id="tblBulk" runat="server">
                                <asp:Button ID="btnPrint" runat="server" Text="Print" Width="150px" CssClass="btnUpdate" OnClick="btnPrint_Click1" />
                            </td>
                                              <td id="td_print" runat="server">
                        ...
                        <table border="10" cellpadding="1" cellspacing="1">
                            <tr id="tr_grp" runat="server">
                                <td class="gridcellleft" bgcolor="#B7CEEC">
                                    Group By</td>
                                <td>
                                    <asp:DropDownList ID="ddlGroupBy" runat="server" Width="180px" Font-Size="10px" onchange="FnddlGroupBy(this.value)">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <table class="TableMain100">
                                    <tr>
                                        <td>
                                            <dxwgv:ASPxGridView ID="gridContract" ClientInstanceName="grid" Width="100%" KeyFieldName="CustomerID"
                                                ...
                                                <Columns>
                                                    <dxwgv:GridViewDataTextColumn Visible="False" FieldName="CustomerID" Caption="ID">
                                                   ...
                                                   <dxwgv:GridViewDataTextColumn VisibleIndex="8" FieldName="pin" Caption="Pin">
                                                        <CellStyle Wrap="True" CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="8" FieldName="type1" Caption="CntType">
                                                        <CellStyle Wrap="True" CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="8" FieldName="AddType" Caption="Addresstype">
                                                        <CellStyle Wrap="True" CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                    ...
                                    <tr>
                                        <td>
                                            <table class="TableMain">
                                                <tr>
                                                    <td>
                                                        <dxe:ASPxComboBox runat="server" ValueType="System.String" Width="120px" Font-Size="10px"
                                                    ...
                                                    <td>
                                                        <dxe:ASPxComboBox runat="server" ValueType="System.String" Width="150px" Font-Size="10px"
                                                    ...
                                                    <td>
                                                        <dxe:ASPxComboBox ID="cmbState" DataSourceID="SDSState" TextField="state" ValueField="id"
                                                            runat="server" Font-Size="10px" ValueType="System.String" Width="120px" EnableCallbackMode="True"
                                                    ...
                                                    <td>
                                                        <dxe:ASPxComboBox runat="server" ValueType="System.String" DataSourceID="SDSCity"
                                                            TextField="city_name" ValueField="city_id" Width="120px" Font-Size="10px" ID="cmbCity"
                                                    ...
                                                    <td>
                                                        <dxe:ASPxComboBox ID="cmbAddressType" runat="server" Font-Size="10px" ValueType="System.String"
        ...
        <asp:SqlDataSource ID="SDSAddMaster" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>">
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="SDSAddDetails" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>">
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="SDSState" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>">
        </asp:SqlDataSource>
