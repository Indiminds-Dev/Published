<%@ page language="C#" autoeventwireup="true" inherits="management_ACEMargin, App_Web_snhbal_j" %>
    ...
    <script language="javascript" type="text/javascript">
     function Page_Load(obj)///Call Into Page Load
      { 
           ...
           Hide('tr_Adhoc');
           Hide('tr_date');
           document.getElementById('lblEg').innerHTML='EG: MARGIN_TMCode_DDMMYYYY.csv';
           selecttion();
      }
   function height()
    {
        ...
        <asp:Panel ID="Panelmain" runat="server" HorizontalAlign="Center" Style="z-index: 100;
            ...
            <table id="tbl_main" cellpadding="0" cellspacing="0" class="login" width="410" style="border: solid 1px blue">
                <tbody>
                    <tr>
                        <td class="EHEADER">
                            <span style="color: blue"><strong>ACE Margin</strong></span></td>
                    </tr>
                    <tr>
                        <td class="lt">
                            <table cellpadding="0" cellspacing="12" class="TableMain100">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:FileUpload ID="ACEMarginSelectFile" runat="server" Height="21px" Width="272px" />
                                        </td>
                                    </tr>
