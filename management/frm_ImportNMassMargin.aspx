<%@ page language="C#" autoeventwireup="true" inherits="management_frm_ImportNMassMargin, App_Web_v5pngf_u" %>
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports NSE Trading Members' Intra-Day Margin Files From NMass Application..These Files Can be Imported Multiple times During the Trading Session so as to get the Latest Collateral Requirement of Clients. </h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="lt brdr">
