<%@ page language="C#" autoeventwireup="true" inherits="Reports_otherchargesstatement, App_Web_u73waeqe" %>
...
<head id="Head1" runat="server">
    <title>Other Charges Statement</title>
                            ...
                            <tr valign="top">
                                <td>
                                    <table>
                                        ...
                                        <tr id="tr_date">
                                            <td colspan="2">
                                               Select Charge Head :</td>
                                            <td>
                                               <asp:DropDownList ID="ddlChargehead" runat="server" Width="250px" Font-Size="10px" >
