<%@ page language="C#" autoeventwireup="true" inherits="management_Import_NSECLAppSTT, App_Web_udicbieo" %>
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports NSE Clearings' "C_STT_DDMMYYYY.csv/C_STT_IND_DDMMYYYY.csv" files available at '/common/clearing' folder of FTP Server </h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="lt brdr">
