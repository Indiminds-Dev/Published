<%@ page language="C#" autoeventwireup="true" inherits="management_CallUserInformation, App_Web_1jeyysc_" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Call User Information</title>
            ...
            <tr>
                ...
                <td valign="top">
                    <table class="TableMain100" style="border: solid 1px blue;">
                        <tr>
                            <td valign="top">
                                <iframe id="iFrmInformation" src="frmProductDetails.aspx" style="vertical-align: top;
                                    overflow: auto;" width="100%" height="200px" frameborder="0" marginheight="0"
