<%@ page language="C#" autoeventwireup="true" inherits="management_crmMutualFund, App_Web_yxggcryg" %>
        ...
        <tr>
            <td>
                ...
                <asp:SqlDataSource ID="SqlProductMF" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
                    SelectCommand="select p.prds_id as id,p.prds_description as description,p.prds_productType as ProductType from tbl_master_products p,tbl_master_producttype pt where p.prds_producttype=pt.pty_prefix and p.prds_producttype='MF'"
                    InsertCommand="CRMInsuMutualFundInsert" InsertCommandType="StoredProcedure"
