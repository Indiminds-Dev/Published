<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReport_SalesPerformance_Target, App_Web_tuwtz_6w" %>
                                                ...
                                                <asp:Panel ID="PnlDate" runat="server" BorderWidth="1px" BorderColor="white" Width="100%">
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td class="gridcellleft" style="text-align: left; width: 125px;">
                                                ...
                                                <td colspan="3" id="TdGrid">
                                                    <dxwtl:ASPxTreeList ID="GridActivitytarget" runat="server" ClientInstanceName="List"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dxwtl:TreeListTextColumn Caption="Total Sales" FieldName="Total Sales" VisibleIndex="1">
                                                                <CellStyle CssClass="gridcellleft">
                                                                </CellStyle>
                                                            </dxwtl:TreeListTextColumn>
                                                            <dxwtl:TreeListTextColumn Caption="Assigned Sales" FieldName="Assigned Sales" VisibleIndex="2">
                                                                <CellStyle CssClass="gridcellleft">
                                                                </CellStyle>
                                                            </dxwtl:TreeListTextColumn>
                                                            <dxwtl:TreeListTextColumn Caption="Activity Sales" FieldName="Activity Sales" VisibleIndex="4">
                                                                <CellStyle CssClass="gridcellleft">
                                                                </CellStyle>
