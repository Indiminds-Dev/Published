<%@ page language="C#" autoeventwireup="true" inherits="Reports_contractregisteriframe, App_Web_qrhyroaj" %>
...
//         alert('test');
        parent.OnMoreInfoClick(url,"Show Trade Register : "+objCustomer+" ["+objSettNumber+"]",'985px','450px',"N");
    }   
   </script>
 <table class="TableMain100">
                                     ...
                                     <asp:TemplateField HeaderText="Date" SortExpression="ContractNotes_TradeDate">
                                      ...
                                      <asp:TemplateField HeaderText="Cnt No." SortExpression="cntNo">
                                        ...
                                        <asp:TemplateField HeaderText="Name" SortExpression="Name">
                                            <ItemStyle Wrap="false"  BorderWidth="1px" HorizontalAlign="Left" >
                                            </ItemStyle>
                                      ...
                                      <%--  ------------------------Swachh Bharat Cess End----------------------------%>
                                        ...
                                        <%-- ------------------- Kisan Bharat Cess Start ----------------------------------%>
                                          ...
                                          <asp:TemplateField HeaderText="KKCess/IGST" SortExpression="TotalTax_Sorting">
                                            <ItemStyle  Wrap="false"  BorderWidth="1px" HorizontalAlign="Right"  ></ItemStyle>
                                            <HeaderStyle HorizontalAlign="Center" Wrap="false" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                      ...
                                      <%--  ------------------------Kisan Bharat Cess End----------------------------%>
                                        ...
                                        <%-- ------------------- UTT Start ----------------------------------%>
                                          ...
                                          <asp:TemplateField HeaderText="UTT" SortExpression="TotalTax_Sorting">
                                            <ItemStyle  Wrap="false"  BorderWidth="1px" HorizontalAlign="Right"  ></ItemStyle>
                                            <HeaderStyle HorizontalAlign="Center" Wrap="false" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
            ...
            <table><tr><td style="display:none;">  <asp:Button ID="btnhide"
                                            runat="server" Text="Button" OnClick="btnhide_Click" />
                                       <asp:HiddenField ID="hidScreenWd" runat="server" />     
                                            </td></tr></table><div id="div1" style="" runat="server"></div>
        </div>
    </form>
</body>
</html>
