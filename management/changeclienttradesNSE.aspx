<%@ page language="C#" autoeventwireup="true" inherits="management_changeclienttradesNSE, App_Web_n2fxndvz" enableeventvalidation="false" %>
 ...
 <style type="text/css">
    ...
    <script language="javascript" type="text/javascript">
        function Page_Load()///Call Into Page Load
        {
            ...
            //#Region Search By Assest Or Scrip(FO)
            var exchSeg = '<%=Session["Segmentname"]%>';
            if (exchSeg.search("FO")>0) {
        ...
        function fn_callajax(objID, objListFun, objEvent) {
            ...
            if (cmbVal != 'ScripsExchange') {
                ...
                criteritype = criteritype.replace('"', "'");
                criteritype = criteritype + '  EXCHANGETRADES_CUSTOMERID="' + document.getElementById('txtClientFrom_hidden').value + '" ';
                criteritype = criteritype.replace('"', "'");
                criteritype = criteritype.replace('"', "'");
