<%@ page language="C#" autoeventwireup="true" inherits="management_ShiftShanghaiTrades, App_Web_lyh0nvfl" %>
...
<head id="Head1">
    <title>Transfer SHFE Trades To/From Next/Previous Working Dates</title>
...
//            alert('Generate For Remaining Bills...');
        ...
        if(obj=="5")
        {
            ...
            window.location = "../Management/ShiftShanghaiTrades.aspx";
        }
          ...
          $get('UpdateProgress1').style.display = 'none'; 
            ...
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Shift SHFE Trades</span></strong></td>
                                    ...
                                    <table border="10" cellpadding="1" cellspacing="1">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" align="left">
                                                <asp:DropDownList ID="dllGenerate" runat="server" Width="200px" Font-Size="10px">
                                                    <asp:ListItem Value="G">Shift To Next Date</asp:ListItem>
                                                    <asp:ListItem Value="D">Revert To Original Date</asp:ListItem>
                                                </asp:DropDownList></td>
                                        </tr>
                                    </table>
                                </td>
