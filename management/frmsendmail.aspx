<%@ page language="C#" autoeventwireup="true" inherits="management_frmsendmail, App_Web_cvaj-tqf" %>
...
//        alert(noofrow);
    ...
    function btnServerAtt_click()
    {
          ...
          parent.OnMoreInfoClick(url,"Add Server Files.",'940px','450px',"Y");
//        document.getElementById("FormServerFile").style.display = 'inline';
//        document.getElementById("FormLocalFile").style.display = 'none';
                    ...
                    <asp:Panel ID="panel1" runat="server" BorderColor="#000099" BorderWidth="1px" Width="100%">
                        <table class="TableMain100">
                            ...
                            <tr style="display: none">
                                ...
                                <td class="gridcellleft">
                                    <asp:TextBox ID="txtlist" runat="server" Width="211px"></asp:TextBox>
                            ...
                            <tr style="display: none" id="trContactWise">
                                ...
                                <td class="gridcellleft">
                                    <asp:DropDownList ID="drpContactWise" runat="server" Width="214px" Font-Size="10px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            ...
                            <tr id="TR1">
                                ...
                                <td class="gridcellleft">
                                   ...
                                   <%--  <asp:ListItem Value="EM">Employees</asp:ListItem>
                                    ...
                                    <asp:TextBox ID="txtUserId" runat="server" Font-Size="12px" Width="200px"></asp:TextBox><asp:TextBox
                            ...
                            <tr>
                                ...
                                <td class="gridcellleft">
                                    <asp:DropDownList ID="cmbFrom" runat="server" Font-Size="10px" Width="304px">
                                    </asp:DropDownList></td>
                            </tr>
                            <tr>
                                <td class="gridcellright" style="width: 111px">
                            ...
                            <tr id="FormServerFile"><td colspan="2">
                               <table width="100%"><tr><td  class="gridcellleft">
                                                        <dxwgv:ASPxGridView ID="GridAttachmentServer" ClientInstanceName="gridServer" runat="server"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <dxwgv:GridViewDataTextColumn Caption="File Name" FieldName="Serverfilename" ReadOnly="True"
                                                                        VisibleIndex="1">
                                ...
                                <td colspan="2">
                                    <%--<table class="TableMain100">
                                        ...
                                        <tr>
                                            ...
                                            <td class="gridcellleft">
                                                <asp:DropDownList ID="drpDocumentType" runat="Server" Width="304px" Font-Size="10px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr id="TRServerGrid">
                                            <td colspan="2" class="gridcellleft">
                                                <table class="TableMain100">
                                                    <tr>
                                                        <td colspan="2">
                                                            <dxwgv:ASPxGridView ID="GridAttachment" ClientInstanceName="gridServer" runat="server"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <dxwgv:GridViewDataTextColumn Caption="Document Type" FieldName="Type" ReadOnly="True"
                                                                        VisibleIndex="1">
                                                                        <CellStyle CssClass="gridcellleft">
                                                                        </CellStyle>
                                                                        <EditFormSettings Visible="False" />
                                                                    ...
                                                                    <dxwgv:GridViewDataHyperLinkColumn Caption="View Doc." VisibleIndex="4" Width="5%">
                            ...
                            <tr id='TR5'>
                                ...
                                <td class="gridcellleft">
                                    <asp:DropDownList ID="cmbTemplate" runat="server" Font-Size="10px" Width="200px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="gridcellleft" style="height:50px;">
                                    <table>
                                        <tr>
                                            <td>
                                                Send On Different Date:</td>
                                            <td> <dxe:ASPxDateEdit ID="ASPxNextDate" runat="server" EditFormat="custom" UseMaskBehavior="True"  ClientInstanceName="ASPxNextDate">
                            ...
                            <tr>
                                ...
                                <td class="gridcellleft">
                                   ...
                                   <%-- <input id="btnCancelMail" type="button" value="Cancel" class="btnUpdate" onclick="btnCancelMail_click();"
                                        style="width: 62px; height: 19px" tabindex="1" />&nbsp;--%>
                                    <asp:Button ID="btnCancelall" runat="server" class="btnUpdate" Text="Cancel" style="width: 62px; height: 19px"  OnClick="btnCancelall_Click" />
                               </td>
                            </tr>
                        </table>
                    </asp:Panel>
