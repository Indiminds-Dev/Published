<%@ page language="C#" autoeventwireup="true" inherits="management_tax, App_Web_jdrimxnc" %>
                            ...
                            <tr>
                                <td style="text-align: center">
                                    <table style="border: solid 1px blue; width: auto">
                                        ...
                                        <tr>
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="STax Rate:" ID="ASPxLabel3">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left" class="Ecoheadtxt">
                                                <dxe:ASPxTextBox runat="server" ID="txttaxrate" onkeypress="return noNumbers(event)"
                                                    Width="130px">
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Hgr Edu Cess:" ID="ASPxLabel5">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left" class="Ecoheadtxt">
                                                <dxe:ASPxTextBox runat="server" ID="txthigheredurate" onkeypress="return noNumbers(event)"
                                                    Width="130px">
                                                    <MaskSettings Mask="&lt;0..99g&gt;.&lt;00..999999&gt;" />
                                                    <ValidationSettings ErrorDisplayMode="None">
                                                    </ValidationSettings>
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Edu Cess:" ID="ASPxLabel4">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left" class="Ecoheadtxt">
                                                <dxe:ASPxTextBox runat="server" ID="txtedurate" onkeypress="return noNumbers(event)"
                                                    Width="130px">
                                                    <MaskSettings Mask="&lt;0..99g&gt;.&lt;00..999999&gt;" />
                                                    <ValidationSettings ErrorDisplayMode="None">
                                                    </ValidationSettings>
                                      ...
                                      <%--  -------------- For Swachh Bharat Start  ----------------%>
                                        
                                         <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Swachh Bharat Cess:" ID="ASPxLabel8">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left" class="Ecoheadtxt">
                                                <dxe:ASPxTextBox runat="server" ID="txtswachhbharat" onkeypress="return noNumbers(event)"
                                                    Width="130px">
                                                    <MaskSettings Mask="&lt;0..99g&gt;.&lt;00..999999&gt;" />
                                                    <ValidationSettings ErrorDisplayMode="None">
                                                    </ValidationSettings>
                                      ...
                                      <%--   -------------For Swachh Bharat End ----------%>
                                        ...
                                        <tr>
                                          ...
                                          <%--  -------------- For Kisan Bharat Start  ----------------%>
                                        
                                         <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Krishi Kalyan Cess:" ID="ASPxLabel9">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left" class="Ecoheadtxt" colspan="5">
                                                <dxe:ASPxTextBox runat="server" ID="TxtKBC" onkeypress="return noNumbers(event)"
                                                    Width="130px">
                                                    <MaskSettings Mask="&lt;0..99g&gt;.&lt;00..999999&gt;" />
                                                    <ValidationSettings ErrorDisplayMode="None">
                                                    </ValidationSettings>
