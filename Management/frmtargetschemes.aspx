<%@ page language="C#" autoeventwireup="true" inherits="management_frmtargetschemes, App_Web_mzqu16me" %>
   ...
   function ReceiveServerData(rValue)
    {
       ...
       if(DATA[0]=="Edit")
        ...
        <table class="TableMain100">
            <tr>
                <td id="TdgrdTarget">
                    <dxwgv:ASPxGridView ID="grd_target" runat="server" KeyFieldName="tgt_masterid" ClientInstanceName="grid"
                        Width="100%" OnCustomCallback="grd_target_CustomCallback">
                        <Columns>
                            <dxwgv:GridViewDataTextColumn FieldName="tgt_masterid" VisibleIndex="0" Visible="False">
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn FieldName="tgt_descripition" Caption="Name" VisibleIndex="0">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn FieldName="tgt_periodicity" Caption="Periodicity" VisibleIndex="1">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn FieldName="Effective date" Caption="Effective Date"
                                VisibleIndex="2">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn FieldName="End Date" Caption="End Date" VisibleIndex="3">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                        </Columns>
            ...
            <tr>
                <td id="TdgrdTargetDetails" style="text-align: left">
                    <dxwgv:ASPxGridView ID="grdtargetdetails" runat="server" Width="100%" KeyFieldName="tgt_id"
                        ClientInstanceName="grid1" OnCustomCallback="grdtargetdetails_CustomCallback">
                        <Columns>
                            <dxwgv:GridViewDataTextColumn FieldName="tgt_id" VisibleIndex="0" Visible="false">
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn FieldName="tgt_descripition" Caption="Name" VisibleIndex="1">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn FieldName="tgt_periodicity" Caption="Periodicity" VisibleIndex="2">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn FieldName="Effective date" Caption="Effective Date"
                            ...
                            <dxwgv:GridViewDataTextColumn FieldName="End Date" Caption="End Date" VisibleIndex="4">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                        </Columns>
            ...
            <tr>
                <td style="text-align: left" id="TdNew">
                    <input id="BtnNew" type="button" value="New" class="btnUpdate" style="width: 81px"
                        onclick="btn_New()" />
                </td>
            </tr>
            <tr>
                <td align="left" id="TdDetails">
                    <asp:Panel ID="Panel2" runat="server" Width="100%" BorderColor="blue" BorderWidth="1px">
                        <table class="TableMain100">
                        
                            <tr>
                                <td colspan="2" align="center">
                                    <asp:Panel ID="Panel1" runat="server" Width="80%" BorderColor="white" BorderWidth="1px">
                                        <table class="TableMain100" id="TABLE1" onclick="return TABLE1_onclick()">
                                                <tr class="EHEADER">
                                <td colspan="4" style="width: 60%; text-align: center;">
                                    <span style="color: #3300cc"><strong>Target Scheme Details</strong></span>
                                </td>
                            </tr>
                                            <tr>
                                                <td class="Ecoheadtxt" style="width: 9%">
                                                    Scheme Name :
                                                </td>
                                                <td class="gridcellleft" style="width: 12%">
                                                    <asp:TextBox ID="txt_schemename" runat="server"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required!"
                                                        ControlToValidate="txt_schemename" ValidationGroup="a"></asp:RequiredFieldValidator></td>
                                                <td class="Ecoheadtxt" style="width: 7%">
                                                    Periodicity :
                                                </td>
                                                <td class="gridcellleft" style="width: 12%">
                                                    <asp:DropDownList ID="lst_periodicity" runat="server" Width="154px">
                                            ...
                                            <tr>
                                                ...
                                                <td class="gridcellleft" style="width: 12%">
                                                    <asp:TextBox ID="TxtEffectiveDate" runat="server" Text="01/01/2007"></asp:TextBox>
                                                </td>
                                                <td class="Ecoheadtxt" style="width: 7%">
                                                    End Date :
                                                </td>
                                                <td class="gridcellleft" style="width: 12%">
                                                    <%-- <asp:TextBox id="TxtEndDate" tabIndex="19" runat="server" Width="100px" Font-Size="10px"></asp:TextBox>&nbsp;<asp:Image id="ImgStartDate" runat="server" ImageUrl="~/images/calendar.jpg"></asp:Image>
                                                ...
                                                <dxe:ASPxDateEdit ID="TxtEndDate" ClientInstanceName="TxtEndDate" runat="server" EditFormat="Custom" UseMaskBehavior="true" Width="154px">
                                            ...
                                            <tr>
                                                <td style="width: 9%; text-align: right;">
                                                    <span style="color: #3300cc"><strong>Broking & Dp Operations</strong></span>
                                                </td>
                                                <td colspan="3">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="gridcellleft" style="width: 12%">
                                                    ...
                                                    <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="*" ControlToValidate="txt_retails"
                                                        MaximumValue="999999" MinimumValue="0" Type="Integer"></asp:RangeValidator></td>
                                                <td class="Ecoheadtxt" style="width: 7%">
                                                    Derivatives :
                                                </td>
                                                <td class="gridcellleft" style="width: 12%">
                                            ...
                                            <tr>
                                                <td style="width: 9%; text-align: right;">
                                                    <span style="color: #3300cc"><strong>Tele Sales & DST</strong></span>
                                                </td>
                                                <td colspan="3">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="Ecoheadtxt" style="width: 9%">
                                                    <strong>A. Tele Calling</strong>
                                                </td>
                                                <td>
                                                </td>
                                                <td class="Ecoheadtxt" style="width: 7%">
                                                    <strong>B. Sales Visit</strong>
                                                </td>
                                                <td>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="gridcellleft" style="width: 12%" colspan="3">
                            ...
                            <tr>
                                <td align="center" colspan="2">
                                    <span style="color: #3300cc"><strong>Distribution</strong></span>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2" style="text-align: center">
                                    <input id="btn_target_save" type="button" value="Save" class="btnUpdate" style="width: 64px"
                                        onclick="Btn_Save()" />
                                    <input id="BtnCancel" type="button" value="Cancel" class="btnUpdate" style="width: 64px"
                                        onclick="TdShow()" />
