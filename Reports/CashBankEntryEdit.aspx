<%@ page language="C#" autoeventwireup="true" inherits="management_CashBankEntryEdit, App_Web_h4pnmg8n" %>
    ...
    <div id="divChangable" runat="server">
                    ...
                    <table border="1" width="98%">
                        ...
                        <tr>
                            ...
                            <td style="height: 11px; background-color: #b7ceec; vertical-align: top; text-align: left; width: 124px;">
                                Trans.Date</td>
        ...
        <dxpc:ASPxPopupControl ID="Popup_Search" runat="server" ClientInstanceName="cPopup_Search"
                       ...
                       <tr>
                        ...
                        <tr>
                            <td id="td_SWithDrawValue" valign="top" style="display: none; width: 255px;">
                                <asp:TextBox ID="StxtWithFrom" runat="server" Font-Size="10px" Width="300px" onkeyup="CallContraAccount(this,'CashBankContraAccount',event,'From')"></asp:TextBox>
                                <asp:HiddenField ID="StxtWithFrom_hidden" runat="server" />
                            </td>
                            <td id="td_SDepstIntoValue" style="display: none;">
                                <asp:TextBox ID="StxtDepstInto" runat="server" Font-Size="10px" Width="300px" onkeyup="CallContraAccount(this,'CashBankContraAccount',event,'To')"></asp:TextBox>
           ...
           <table style="width: 60%;display:none;" border="1">
            ...
            <dxwgv:ASPxGridView ID="GvCBSearch" runat="server" AutoGenerateColumns="False" ClientInstanceName="cGvCBSearch"
                        KeyFieldName="CBID" Width="950px" Font-Size="10px" OnCustomCallback="GvCBSearch_CustomCallback">
