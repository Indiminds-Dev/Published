<%@ page language="C#" autoeventwireup="true" inherits="Reports_QuarterlyStatement, App_Web_w8tpuxyq" %>
...
//                        document.getElementById("test_"+i).innerHTML="Opened";
            ...
            if (strUndefined == "EmailSuccess") {
                alert("Email Created Successfully!!");
                Page_Load();
            }
            if (strUndefined == "EmailFail") {
                alert("Email Creation Failed!!");
                Page_Load();
            }
        }
        function btnSend_Click() {
            document.getElementById("btnSendEmail").disabled=true;
            cCbpGenerateReport.PerformCallback("SendEmail~" + 1);
            height();
        }
    ...
    function CbpSuggestISIN_EndCallBack()
        {
            ...
            {
                alert("AN INTERNAL ERROR OCCURED!! \n ErrorInfo *****\n"+cCbpSuggestISIN.cpGenSuccesssfully);
                cbtnGeneratePDF.SetEnabled(true);
            }
        }
            ...
            <table class="TableMain100">
                <tr>
                    <td valign="top">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td class="gridcellleft" bgcolor="#B7CEEC">
                                                Report Generation Type :</td>
                                            <td>
                                                <asp:DropDownList ID="ddlrptgeneration" runat="server" Width="200px" Font-Size="10px"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dxe:ASPxDateEdit ID="dtTo" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                    Font-Size="10px" Width="108px" EditFormatString="dd-MM-yyyy" ClientInstanceName="dtToDate">
                            ...
                            <tr>
                                <td colspan="2">
                                    <table>
                                        ...
                                        <tr>
                                            <td class="gridcellleft" bgcolor="#B7CEEC">
                                                Report Output Type :</td>
                                            <td>
                                                <asp:DropDownList ID="DdlGeneRationType" runat="server" Width="200px" Font-Size="10px"
                        ...
                        <table>
                            <tr id="trshow">
                                <td>
                                    <asp:RadioButton ID="rbAllMail" runat="server" Checked="True" GroupName="b" />All
                                    mail
                                </td>
                                <td>
                                    <asp:RadioButton ID="rbRemainingMail" runat="server" GroupName="b" />Remaiing mail
                                </td>
                            ...
                            <table class="gridcellleft" cellpadding="0" cellspacing="0" border="1" id="ecndetail"
                                ...
                                <tr style="background-color: white;">
                                    ...
                                    <td id="td_allcontract">
                                        <a href="javascript:excelexport('allcontract_excel');"><span style="color: Blue; text-decoration: underline;
                                    ...
                                    <td>
                                        <a href="javascript:excelexport('releasetotal_excel');"><span style="color: Blue; text-decoration: underline;
                                            vertical-align: bottom; font-size: 12px">View Detail</span></a>
                                    </td>
                                    ...
                                    <td>
                                        <a href="javascript:excelexport('ecnenable_excel');"><span style="color: Blue; text-decoration: underline;
                                            vertical-align: bottom; font-size: 12px">View Detail</span></a>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="javascript:excelexport('deliveryrpt_excel');"><span style="color: Blue; text-decoration: underline;
                                            vertical-align: bottom; font-size: 12px">View Detail</span></a>
                                    </td>
                                </tr>
                                <%--<tr id="tr_openpopup">
                        ...
                        <table >
                            ...
                            <tr id="tr_pdf" runat="server">
                                ...
                                <td>
                                    <a id="btnSendEmail" style="cursor: pointer;" onclick="btnSend_Click()">
                        ...
                        <div id="div_PDF">
                            <dxcp:ASPxCallbackPanel ID="CbpGenerateReport" runat="server" ClientInstanceName="cCbpGenerateReport"
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: top; height: 11px; background-color: #b7ceec; text-align: left"
                                                    ...
                                                    <a id="A_LeftNav" runat="server" href="javascript:void(0);" onclick="OnLeftNav_Click()">
                                                        <img src="../images/LeftNav.gif" style="text-decoration: underline" width="10" /><span
                            ...
                            <dxcp:ASPxCallbackPanel ID="CbpReportViewer" runat="server" ClientInstanceName="cCbpReportViewer">
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            <td style="vertical-align: top; color: #000000; height: 11px; background-color: #b7ceec;
                                                                text-align: left" valign="top">
                                                                <div id="imgA1">
                                                                    <img src="../images/PDFICON.jpg" /></div>
                                                            ...
                                                            <td style="vertical-align: top; height: 11px; background-color: #b7ceec; text-align: left"
                                                                valign="top">
                                                                <div id="imgA3">
                                                                    <img id="A3" src="../images/PDFICON.jpg" /></div>
                                                            ...
                                                            <td style="vertical-align: top; height: 11px; background-color: #b7ceec; text-align: left"
                                                                valign="top">
                                                                <div id="imgA4">
                                                                    <img id="Img1" src="../images/PDFICON.jpg" /></div>
                                                            ...
                                                            <td style="vertical-align: top; height: 11px; background-color: #b7ceec; text-align: left"
                                                                valign="top">
                                                                <div id="imgA5">
                                                                    <img id="Img2" src="../images/PDFICON.jpg" /></div>
                                                        ...
                                                        <tr>
                                                            <td style="vertical-align: top; height: 11px; background-color: #b7ceec; text-align: left"
                                                                valign="top">
                                                                <div id="imgA6">
                                                                    <img id="Img3" src="../images/PDFICON.jpg" /></div>
                                                            ...
                                                            <td style="vertical-align: top; height: 11px; background-color: #b7ceec; text-align: left"
                                                                valign="top">
                                                                <div id="imgA7">
                                                                    <img id="Img4" src="../images/PDFICON.jpg" /></div>
                                                            ...
                                                            <td style="vertical-align: top; height: 11px; background-color: #b7ceec; text-align: left"
                                                                valign="top">
                                                                <div id="imgA8">
                                                                    <img id="Img5" src="../images/PDFICON.jpg" /></div>
                                                            ...
                                                            <td style="vertical-align: top; height: 11px; background-color: #b7ceec; text-align: left"
                                                                valign="top">
                                                                <div id="imgA9">
                                                                    <img id="Img6" src="../images/PDFICON.jpg" /></div>
                                                            ...
                                                            <td style="vertical-align: top; height: 11px; background-color: #b7ceec; text-align: left"
                                                                ...
                                                                <div id="imgA10">
                                                                    <img id="Img7" src="../images/PDFICON.jpg" /></div>
                ...
                <tr>
                    <td style="display: none">
                     ...
                     <td>
                        <span id="spanall">
                            <dxcp:ASPxCallbackPanel ID="Cexcelexportpanel" runat="server" ClientInstanceName="cCbptxtSelectionID"
