<%@ page language="C#" autoeventwireup="true" inherits="management_payoutposition, App_Web_6_wayyot" %>
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Obligation Type :</td>
                                        <td>
                                            <asp:DropDownList ID="DdlObligationType" runat="server" Width="200px" Font-Size="10px">
        ...
        <table>
            <tr>
                <td style="display: none;">
                    ...
                    <asp:DropDownList ID="cmbgrp" runat="server" Font-Size="10px" Width="300px" AutoPostBack="True">
                    </asp:DropDownList>
