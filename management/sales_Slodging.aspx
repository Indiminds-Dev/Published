<%@ page language="C#" autoeventwireup="true" inherits="management_sales_Slodging, App_Web_d3reltht" %>
                                        ...
                                        <dxw:ContentControl runat="server">
                                            <dxwgv:ASPxGridView ID="gridLodging" ClientInstanceName="grid" DataSourceID="SqlLodging"
                                                ...
                                                <Columns>
                                                    ...
                                                    <dxwgv:GridViewDataDateColumn FieldName="expnd_LodgingDateTo" Caption="To" VisibleIndex="2">
                                                    ...
                                                    <dxwgv:GridViewDataTextColumn FieldName="expnd_LodgingExpnseAmount" Caption="Amount"
                                                        VisibleIndex="3">
                                                    ...
                                                    <dxwgv:GridViewDataTextColumn FieldName="expnd_LodgingRefNo" Caption="Reference No"
                                                        VisibleIndex="4">
