<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReport_cdslHolding, App_Web_7htzac9n" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    <form id="form1" runat="server" autocomplete="off">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dxe:ASPxComboBox ID="cmbTime" Width="120px" ClientInstanceName="dateCombo" runat="server"
                                                    Font-Size="10px" ValueType="System.String" Font-Bold="False" OnCallback="cmbTime_Callback">
                                                    <ButtonStyle Width="13px">
                                                    </ButtonStyle>
                                            ...
                                            <td>
                                                <dxe:ASPxComboBox ID="ASPxComboBox1" Width="160px" ClientInstanceName="ClientType"
                                                    runat="server" Font-Size="10px" ValueType="System.String" Font-Bold="False" SelectedIndex="0">
                                                    <Items>
                                     ...
                                     <td id="tdSettlementLabel">
                                            ...
                                            <td id="tdrbSettlement">
                                                <dxe:ASPxRadioButtonList ID="rbSettlement" runat="server" SelectedIndex="0" ItemSpacing="10px"
                                                    RepeatDirection="Horizontal" TextWrap="False" Font-Size="10px" ClientInstanceName="SettClid">
                                                    <Items>
                                                        <dxe:ListEditItem Text="All" Value="A" />
                                                        <dxe:ListEditItem Text="Specific" Value="S" />
                                                    </Items>
	  ...
	  EndCall(s.cpEND);
                                        ...
                                        <Columns>
                                            <dxwgv:GridViewDataTextColumn FieldName="CdslHolding_ISIN" Caption="ISIN No:" VisibleIndex="0">
                                            ...
                                            <dxwgv:GridViewDataTextColumn FieldName="CDSLISIN_ShortName" Caption="Instrument Name (Short)"
                                                VisibleIndex="1">
                                                <Settings FilterMode="DisplayText" AutoFilterCondition="Contains"></Settings>
                                                <CellStyle CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="CdslHolding_SettlementID" Caption="SettlementID"
                                                VisibleIndex="2">
                                                <Settings FilterMode="DisplayText" AutoFilterCondition="Contains"></Settings>
                                                <CellStyle CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="CdslHolding_CurrentBalance" UnboundType="Integer"
                                                Caption="Current Balance" VisibleIndex="3">
                                                <Settings AllowAutoFilter="False"></Settings>
                                                <CellStyle HorizontalAlign="Right" CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="CdslHolding_FreeBalance" UnboundType="Integer"
                                                Caption="Free" VisibleIndex="4">
                                                <Settings AllowAutoFilter="False"></Settings>
                                                <CellStyle HorizontalAlign="Right" CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="CdslHolding_PledgeBalance" UnboundType="Integer"
                                                Caption="Pledged" VisibleIndex="5">
                                                <Settings AllowAutoFilter="False"></Settings>
                                                <CellStyle HorizontalAlign="Right" CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="CdslHolding_EarmarkedBalance" UnboundType="Integer"
                                                Caption="Blocked[Earmark]" VisibleIndex="6">
                                                <Settings AllowAutoFilter="False"></Settings>
                                                <CellStyle HorizontalAlign="Right" CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="CdslHolding_PendingRematBalance" UnboundType="Integer"
                                                Caption="Pending Remat" VisibleIndex="7">
                                                <Settings AllowAutoFilter="False"></Settings>
                                                <CellStyle HorizontalAlign="Right" CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="CdslHolding_PendingDematBalance" UnboundType="Integer"
                                            ...
                                            <dxwgv:GridViewDataTextColumn FieldName="ISINVAlue" Caption="Value" VisibleIndex="10">
                                                <Settings AllowAutoFilter="False"></Settings>
                                                <CellStyle HorizontalAlign="Right" CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
