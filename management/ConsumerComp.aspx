<%@ page language="C#" autoeventwireup="true" inherits="management_ConsumerComp, App_Web__yen2upk" %>
...
<head runat="server">
 ...
 <script type="text/javascript" src="../JSFUNCTION/loaddata1.js"></script>
    ...
    function OnContactInfoClick(keyValue,name)
    {
         ...
         parent.OnMoreInfoClick(url,"Company Name :"+name+"",'940px','450px',"Y");
    }
...
<body  style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    ...
    <tr>
        ...
        <tr>
            <td>
                <dxwgv:ASPxGridView ID="EmployeeGrid" runat="server"   KeyFieldName="cnt_Id"
