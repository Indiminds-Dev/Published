<%@ page language="C#" autoeventwireup="true" inherits="management_ConsumerComp_Correspondence, App_Web_g1t3n0jz" %>
...
OnRowValidating="EmailGrid_RowValidating">
    ...
    else
    {
         ...
         gridEmail.GetEditor(&quot;eml_website&quot;).SetVisible(false);
                                                  ...
                                                  <%--  <dxwgv:GridViewDataTextColumn FieldName="eml_website" Caption="WebURL" Visible="true"
                                                        VisibleIndex="1">
