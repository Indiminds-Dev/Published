<%@ page language="C#" autoeventwireup="true" inherits="management_frm_AddCandidate, App_Web_im-ehkhh" %>
                        ...
                        <td style="text-align: center; width: 100%;">
                            <table style="border: solid 2px white;">
                                <tr>
                                    ...
                                    <td class="gridcellleft">
                                        <asp:TextBox ID="txtLocality" runat="server" Width="200px" Font-Size="10px" TabIndex="2"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="gridcellleft">
                                    ...
                                    <td class="gridcellleft">
                                        <asp:DropDownList ID="drpSourceType" runat="server" Width="203px" Font-Size="10px"
                                            TabIndex="3">
                                        </asp:DropDownList></td>
                                    <td style="width: 17px">
                                    </td>
                                    ...
                                    <td class="gridcellleft">
                                        <asp:DropDownList ID="drpMaritalStatus" runat="server" Width="203px" Font-Size="10px"
                                            TabIndex="4">
                                        </asp:DropDownList></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="gridcellleft">
                                        <asp:TextBox ID="txtReferedBy" runat="server" Width="200px" Font-Size="10px" TabIndex="5"></asp:TextBox>
                                    </td>
                                    <td style="width: 17px">
                                    </td>
                                    <td class="gridcellleft">
                                    ...
                                    <td class="gridcellleft">
                                        <asp:TextBox ID="txtNoofDependent" runat="server" Width="200px" Font-Size="10px"
                                ...
                                <tr>
                                    ...
                                    <td class="gridcellleft">
                                        <asp:DropDownList ID="drpSex" Width="203px" Font-Size="10px" runat="server" TabIndex="7">
                                    ...
                                    <td class="gridcellleft">
                                        <asp:TextBox ID="txtPhone" runat="server" Width="200px" Font-Size="10px" TabIndex="8"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="gridcellleft">
                                    ...
                                    <td class="gridcellleft">
                                        <asp:TextBox ID="txtEmailId" runat="server" Width="200px" Font-Size="10px" TabIndex="9"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="gridcellleft">
                                    ...
                                    <td class="gridcellleft">
                                        <asp:DropDownList ID="drpQualification" Width="203px" Font-Size="10px" runat="server"
                                            TabIndex="10">
                                        </asp:DropDownList>
                                    </td>
                                    <td style="width: 17px">
                                    ...
                                    <td class="gridcellleft">
                                        <asp:DropDownList ID="drpProfQualification" Width="203px" Font-Size="10px" runat="server"
                                            TabIndex="11">
                                        </asp:DropDownList></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="gridcellleft">
                                        <asp:TextBox ID="txtCertification" runat="server" Width="200px" Font-Size="10px"
                                    ...
                                    <td class="gridcellleft">
                                        <asp:TextBox ID="txtCurrentEmployer" runat="server" Width="200px" Font-Size="10px"
                                ...
                                <tr>
                                    ...
                                    <td class="gridcellleft">
                                        <asp:TextBox ID="txtExpYrs" runat="server" Width="200px" Font-Size="10px" TabIndex="14"></asp:TextBox></td>
                                    <td style="width: 17px">
                                    </td>
                                    <td class="gridcellleft">
                                    ...
                                    <td class="gridcellleft">
                                        <asp:DropDownList ID="drpCurrentJobProfile" Width="203PX" Font-Size="10px" runat="server"
                                            TabIndex="15">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="gridcellleft">
                                        <asp:TextBox ID="txtCurrentCTC" runat="server" Width="200px" Font-Size="10px" TabIndex="16"></asp:TextBox></td>
                                    <td style="width: 17px">
                                    </td>
                                    <td class="gridcellleft">
                                    ...
                                    <td class="gridcellleft">
                                        <asp:TextBox ID="txtDesiredCTC" runat="server" Width="200px" Font-Size="10px" TabIndex="17"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="gridcellleft">
                                    ...
                                    <td class="gridcellleft">
                                        <asp:TextBox ID="txtPreviousCTC" runat="server" Width="200px" Font-Size="10px" TabIndex="18"></asp:TextBox>
                                    </td>
                                    <td style="width: 17px;">
                                    </td>
                                    <td class="gridcellleft">
                                    ...
                                    <td class="gridcellleft">
                                        <asp:TextBox ID="txtPreviousEmployer" runat="server" Width="200px" Font-Size="10px"
                                ...
                                <tr>
                                    ...
                                    <td class="gridcellleft">
                                        <asp:DropDownList ID="drpPreviousJobProfile" Width="203PX" Font-Size="10px" runat="server"
                                            TabIndex="21">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="gridcellleft">
                                        <asp:TextBox ID="txtReasonforChange" runat="server" TextMode="MultiLine" Width="198px"
                                            Font-Size="10px" TabIndex="22"></asp:TextBox>
                                    </td>
                                    <td style="width: 17px">
                                    </td>
                                    <td class="gridcellleft">
                                    ...
                                    <td class="gridcellleft">
                                        <%--<asp:TextBox ID="TextBox21" runat="server" Width="200px" Font-Size="10px"></asp:TextBox>--%>
                                    </td>
                                </tr>
                                <tr>
