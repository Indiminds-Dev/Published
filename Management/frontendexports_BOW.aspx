<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="management_frontendexports_BOW, App_Web_njtlujlb" %>
...
<head id="Head1">
    <title>Front-End Exports For BOW</title>
...
//                 End of New Work 04/08/2022
            ...
            function setparam()
            {
                 document.getElementById('DDLformat').setvalue='BOW';
...
//                var optn7 = document.createElement("OPTION");
                ...
                optn.text = "Offline User Addition"; 
                optn.value = "1";
                new2.add(optn);
                optn8.text = "Trading Rights upload"; 
                optn8.value = "2";
                new2.add(optn8);
                optn2.text = "IBT User Addition Upload"; 
                optn2.value = "0";
                new2.add(optn2);
                optn3.text = "Client Deposits Upload"; 
                optn3.value = "3";
                new2.add(optn3);
                optn4.text = "Holding & DP Stocks Upload"; 
                optn4.value = "4";
                new2.add(optn4);
                optn5.text = "Location ID/NNF Uploads"; 
                optn5.value = "5";
                new2.add(optn5);
   ...
   { 
          $get('UpdateProgress1').style.display = 'none'; 
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 22px;">
                        <strong><span id="SpanHeader" style="color: #000099">Front-End Exports For BOW</span></strong>
                    </td>
                ...
                <tr valign="top" id="Tr1">
                    ...
                    <td>
                        <asp:DropDownList ID="DDLformat" runat="server" Width="150px" Font-Size="10px" onchange="Fn_DDLformat(this.value)" Enabled="false">
                            <asp:ListItem Value="BOW">BOW</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr valign="top" id="Tr2">
                    ...
                    <td>
                        <asp:DropDownList ID="DDLexport" runat="server" Width="250px" Font-Size="10px" onchange="Fn_DDLexport(this.value)">
                            <asp:ListItem Value="0">IBT User Addition Upload</asp:ListItem>
                            <asp:ListItem Value="1">Offline User Addition Upload</asp:ListItem>
                            <asp:ListItem Value="2">Trading Rights Upload</asp:ListItem>
                            <asp:ListItem Value="3">Client Deposits Upload</asp:ListItem>
                            <asp:ListItem Value="4">Holding & DP Stocks Upload</asp:ListItem>
                            <asp:ListItem Value="5">Location ID/NNF Uploads</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
            </table>
                            ...
                            <tr valign="top">
                                <td>
                                    <table border="1" bordercolor="#1">
                                        ...
                                        <tr id="tr_Category">
                                            <td style="vertical-align: top; height: 11px; background-color: #b7ceec; text-align: left">
                                                Exp.Multiplier|Product :</td>
                                            <td colspan="5">
                                                <asp:TextBox ID="TxtCategory" runat="server"></asp:TextBox><span style="color:red">Use '|' Define Multiplier and Product..like "3|Delivery"</span>
                                            </td>
            ...
            <table border="1">
                <tr id="tr_sapn">
                    <td colspan="2">
                        <span id="spanshow1" style="color: Blue; font-weight: bold">Client Deposits For :</span>&nbsp;&nbsp;<span
                            id="spanshow2"></span>
