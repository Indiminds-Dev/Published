<%@ page language="C#" autoeventwireup="true" inherits="management_TransactionDeleteCommCurrency, App_Web_-k9nslwd" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function Page_Load()
        {
            document.getElementById('td_deletebtn').style.display='none';
            height();
        }
        function height()
        {
        ...
        function Validate()
        {
            ...
            if(obj.value=='')
            {
                ...
                obj.select();
                document.getElementById('td_deletebtn').style.display='none';
                document.getElementById('td_showbtn').style.display='inline';
                return false;
            }
            else    
            {
                obj.focus();
                obj.select();
                document.getElementById('td_deletebtn').style.display='inline';
                document.getElementById('td_showbtn').style.display='none';
                return true;
               
            }
        }
       function AlertResult(obj,obj1)
       {
                alert(obj);
                if(obj1=='NO')
                   document.getElementById('tr_displayresult').style.display='none';
                else
                   document.getElementById('tr_displayresult').style.display='inline';
                                        ...
                                        <tr>
                                            <td id="td_showbtn">
                                                <asp:Button ID="btnShowTran" runat="server" Text="Show Transaction" CssClass="btnUpdate"
                                                    Height="20px" OnClick="btnShowTran_Click" Width="112px" OnClientClick="javascript:return Validate();" /></td>
                                            <td id="td_deletebtn">
                                                <asp:Button ID="btnDeleteTran" runat="server" Text="Delete Transaction" CssClass="btnUpdate"
                                                    Height="20px"  Width="112px" OnClick="btnDeleteTran_Click"/></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                    ...
                    <td>
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                ...
                                <asp:GridView ID="grdTransaction" runat="server" Width="100%" BorderColor="CornflowerBlue"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Customer Name">
                                            ...
                                            <HeaderStyle HorizontalAlign="Left" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblCustomerName" runat="server" Text='<%# Eval("ClientName")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                            ...
                            <Triggers>
                                ...
                                <asp:AsyncPostBackTrigger ControlID="btnDeleteTran" EventName="Click" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </td>
                </tr>
