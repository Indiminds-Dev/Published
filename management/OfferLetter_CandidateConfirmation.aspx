<%@ page language="C#" autoeventwireup="true" inherits="management_OfferLetter_CandidateConfirmation, App_Web_d3reltht" %>
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" style="text-align: center;">
                        <strong><span style="color: #000099">Confirm Candidate</span></strong>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table cellspacing="1" cellpadding="2" style="background-color: #B7CEEC; border: solid 1px  #ffffff"
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:Button ID="btnAdd" runat="server" Text="Add Employee" CssClass="btnUpdate" OnClick="btnAdd_Click" /></td>
                            </tr>
                            <%-- <tr>
                                <td valign="top">
...
<dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="1" FieldName="rde_Name" Width="10px" Caption="Cand. Name" >
<CellStyle CssClass="gridcellleft"></CellStyle>

<EditFormSettings Visible="False"></EditFormSettings>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataTextColumn Visible="False" ReadOnly="True" VisibleIndex="2" Width="10px" FieldName="rde_ResidenceLocation" Caption="Address">
<CellStyle CssClass="gridcellleft"></CellStyle>
