<%@ page language="C#" autoeventwireup="true" inherits="Reports_AccountConfirmationSummary, App_Web_hnkxxmul" %>
...
<head id="Head1">
    <title>Brokerage Statement</title>
                    ...
                    <table>
                        ...
                        <td class="gridcellleft">
                          <table border="10" cellpadding="1" cellspacing="1">
                            <tr>
                            <td bgcolor="#B7CEEC">
                                Margin Marked Up To :</td>
                            <td style="width: 97px" >
                                <dxe:ASPxTextBox ID="txtmarkupappmrgn" runat="server" HorizontalAlign="Right" Width="100px" text="225%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="gridcellleft">
                                            <dxe:ASPxDateEdit ID="DtPrintDate" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                Font-Size="10px" Width="108px" ClientInstanceName="DtPrintDate">
                        ...
                        <tr>
                            <td class="gridcellleft">
                                ...
                                <asp:Button ID="btnSend" runat="server" CssClass="btnUpdate" Height="20px" Text="Send Email"
                                    Width="101px" OnClick="btnSendEmail_Click" />
                            </td>
                        </tr>
