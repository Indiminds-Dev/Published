<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_FinalSettlementTRADES_Broker, App_Web_n2fxndvz" %>
   ...
   <script language="javascript" type="text/javascript">
    ...
    function PageLoad()
    {
       ...
       //File Format to Import By Default
        Span_FileFormat.innerText="File : Custom Final Settlement Position CSV Files [Broker Wise]";
    }
    ...
    function OnComboChooseFileIndexChange()
    {
        ...
        if(SelectedValue==0)
            Span_FileFormat.innerText="File : Custom Final Settlement Position Files [Broker Wise]";
        else
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports Final Settlement Position [Broker Wise] File generated from the system
                                </h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="lt brdr">
                                    ...
                                    <tr>
                                        <td style="width: 100px">
                                            <dxe:ASPxComboBox ID="ComboChooseFile" runat="server" ClientInstanceName="cComboChooseFile"
                                                ...
                                                <Items>
                                                    <dxe:ListEditItem Value="0" Text="Final Settlement Position File [Broker Wise]"></dxe:ListEditItem>
                                                    <%--<dxe:ListEditItem Value="1" Text="Opening Trades From Position File"></dxe:ListEditItem>--%>
                                                </Items>
                                ...
                                <div id="DvMissingProduct_Lable" class="Lable"> </div>
                                ...
                                <div id="DvMissingClient_Lable" class="Lable"> </div>
