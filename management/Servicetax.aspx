<%@ page language="C#" autoeventwireup="true" inherits="management_Servicetax, App_Web_v5pngf_u" %>
    ...
    <form id="form1" runat="server">
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center;">
                    <strong><span style="color: #000099">Service tax and cess</span></strong>
                </td>
            </tr>
            <tr>
                <td align="right">
        ...
        <dxwgv:ASPxGridView ID="ServiceTaxGrid" runat="server" KeyFieldName="ServTax_ID"
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataTextColumn FieldName="ServTax_Rate" Caption="STax.Rate " VisibleIndex="3"
                    Width="8%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <dxwgv:GridViewDataTextColumn Caption="Edu.Cess" FieldName="ServTax_EduCess" VisibleIndex="4"
                    Width="6%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <dxwgv:GridViewDataTextColumn Caption="HEdu.Cess" FieldName="ServTax_HgrEduCess"
              ...
              <%--  ------------------ SBC Start ---------------------------%>
                    ...
                    <dxwgv:GridViewDataTextColumn FieldName="ServTax_SBC" Caption="SB.Cess " VisibleIndex="5"
                    Width="7%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <%--  ------------------ SBC End ---------------------------%>
                 ...
                 <%--  ------------------ KKC Start ---------------------------%>
                    ...
                    <dxwgv:GridViewDataTextColumn FieldName="ServTax_KKC" Caption="KK.Cess " VisibleIndex="6"
                    Width="7%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
