<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_ARBMTRADES, App_Web_s3wzohpw" %>
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports Daily Trade Files in CSV Format
                                </h5>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <td style="width: 100px">
                                            <dxe:ASPxComboBox ID="ComboChooseFile" runat="server" ClientInstanceName="cComboChooseFile"
                                                ...
                                                <Items>
                                                    ...
                                                    <dxe:ListEditItem Value="1" Text="Pull Trades Of ExpiryProducts PL Position"></dxe:ListEditItem>
                                                </Items>
