<%@ page language="C#" autoeventwireup="true" inherits="frm_ACEContracts, App_Web_6_wayyot" %>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td align="right" style="width: 278px; height: 22px">
                                            <asp:FileUpload ID="ACESelectFile" runat="server" Height="20px"/>
                                        </td>
                                    </tr>
                                    <tr>
