<%@ page language="C#" autoeventwireup="true" inherits="Reports_Export_ExpiryProductsPL, App_Web_cnvbs8pk" %>
...
<head id="Head1" runat="server">
    <title>Export Client Wise Expired Contracts Profit Loss CSV Files</title>
    ...
    <div>
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Export Client Wise Expired Contracts Profit Loss CSV Files</span></strong></td>
       ...
       <table id="tab2" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                        ...
                        <tr> <td>
                            <strong>Upto Expiry Date:</strong></td><td>   <dxe:ASPxDateEdit ID="dtDate" runat="server" EditFormat="Custom" UseMaskBehavior="True"
