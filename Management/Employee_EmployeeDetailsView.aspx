<%@ page language="C#" autoeventwireup="true" inherits="management_Employee_EmployeeDetailsView, App_Web_6yanuau_" %>
                ...
                <tr>
                    <td class="EHEADER" style="text-align: center;">
                        <div style="float: right" id="TdExport">
                            ...
                            <a href="javascript:void(0);" onclick="Filter()"><span style="color: #009900; text-decoration: underline;
                                font-size: 10pt;">Filter</span></a>
                        </div>
                                                                ...
                                                                <tr>
                                                                    <td id="TdFilter" style="height: 23px">
                                                                        <asp:TextBox ID="txtsubscriptionID" runat="server" Font-Size="12px" Width="253" onkeyup="FunClientScrip(this,'ShowEmployeeByFilter',event)"></asp:TextBox><a
                                                                            href="javascript:void(0);" onclick="btnAddsubscriptionlist_click()"><span style="color: #009900;
                                                                ...
                                                                <tr>
                                                                    <td style="text-align: center">
                                                                        <table cellpadding="0" cellspacing="0">
                                                                            <tr>
                                                                                <td>
                                                                                    <a href="javascript:void(0);" onclick="clientselectionfinal()"><span style="color: #000099;
                            ...
                            <tr>
                                <td>
                                    <table style="width: 60%" border="1">
                                        <tr>
                                            <td valign="top" style="vertical-align: top; width: 34px; height: 11px; background-color: #b7ceec;
                                                text-align: left">
                                                Page</td>
                                            <td valign="top" style="width: 4px">
                                                <b style="text-align: right" id="B_PageNo" runat="server"></b>
                                            </td>
                                            <td valign="top" style="vertical-align: top; height: 11px; background-color: #b7ceec;
                                                text-align: left;">
                                                Of
                                            </td>
                                            <td valign="top">
                                    ...
                                    <div style="width: 970px; overflow: scroll;">
                                        <dxwgv:ASPxGridView ID="EmployeeGrid" runat="server" KeyFieldName="cnt_shortName"
                                            ...
                                            <columns>
                                                        <dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="0" FieldName="Name" Width="250px">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn VisibleIndex="1" FieldName="cnt_shortName" Width="75px"
                                                            Caption="Employee Code">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn VisibleIndex="2" FieldName="CompName" Width="150px"
                                                            Caption="Company Name">
                                                            <CellStyle Wrap="False" HorizontalAlign="Left">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn VisibleIndex="3" FieldName="BranchName" Width="150px"
                                                            Caption="Branch">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="4" FieldName="DOJ" Width="75px"
                                                            Caption="Date Of Joining">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn VisibleIndex="5" FieldName="DateOfLeaving" Width="150px"
                                                            Caption="Date Of Leaving">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn VisibleIndex="6" FieldName="cost_description" Width="150px"
                                                            Caption="Department">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="7" FieldName="deg_designation"
                                                            Width="75px" Caption="Designation">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn VisibleIndex="8" FieldName="EmpTypeName" Width="150px"
                                                            Caption="Employee Type">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn VisibleIndex="9" FieldName="ReportTo" Width="150px"
                                                            Caption="Report To">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="10" FieldName="emp_currentCTC"
                                                            Width="80px" Caption="Current CTC">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="11" FieldName="phone"
                                                            Width="80px" Caption="Phone">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="12" FieldName="Email"
                                                            Width="80px" Caption="Email">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="13" FieldName="PanCard"
                                                            Width="80px" Caption="PAN">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="14" FieldName="ContactAddress"
                                                            Width="250px" Caption="Address">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataDateColumn ReadOnly="True" VisibleIndex="15" FieldName="FatherName"
                                                            Width="150px" Caption="Father Name">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataDateColumn>
                                                        <dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="16" FieldName="DOB" Width="150px"
                                                            Caption="Date Of Birth">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="17" FieldName="BankName"
                                                            Width="75px" Caption="Bank Name">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="18" FieldName="BranchAdres"
                                                            Width="75px" Caption="Branch Address">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="19" FieldName="AccountType"
                                                            Width="75px" Caption="Account type">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="20" FieldName="AccountNumber"
                                                            Width="75px" Caption="Account Number">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="21" FieldName="CREATEDBY"
                                                            Width="75px" Caption="Created By">
                                                            <CellStyle Wrap="False" CssClass="gridcellleft">
                                                            </CellStyle>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="22" FieldName="CMPID"
