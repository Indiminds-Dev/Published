<%@ page language="C#" autoeventwireup="true" inherits="management_frmSalesMutualFund1, App_Web_d3reltht" %>
                            ...
                            <tr>
                                <td colspan="2">
                                    <table>
                                        ...
                                        <tr>
                                            <td id="TdPlace" runat="server">
                                                &nbsp;<asp:Label ID="Label11" runat="server" CssClass="mylabel1" Text="Visit Place"
