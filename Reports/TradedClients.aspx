<%@ page language="C#" autoeventwireup="true" inherits="Reports_TradedClients, App_Web_u73waeqe" %>
...
<head id="Head1" runat="server">
    ...
    <title>Clients Having Trades In A Period</title>
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            ...
                                            <asp:DropDownList ID="ddllist" runat="server" Width="160px" Font-Size="10px" onchange="fn_ddllist(this.value)">
