<%@ page language="C#" autoeventwireup="true" inherits="management_frmClosingRatelist, App_Web_rtil2eyr" %>
...
//        var url='frmClosingRatesAdd.aspx?id='+'ADD'+'&dtfor='+ dat;
//         parent.OnMoreInfoClick(url,"Add New Closing Rates",'700px','350px',"Y");
     var dat=document.getElementById('dtTo_hidden').value;
     var GetDate = (CcmbForDate.GetValue() != null) ? CcmbForDate.GetValue() : "";
     var currentDate=convert(GetDate);
     var url='frmClosingRatesAdd.aspx?id='+'ADD'+'&dtfor='+ dat+'&dtupto='+ currentDate;
         parent.OnMoreInfoClick(url,"Add New Closing Rates",'700px','350px',"Y");
     //End of New Work 28/02/2022
    }
...
//       parent.OnMoreInfoClick(url,"Edit Closing Rates",'700px','350px',"Y");
      var GetDate = (CcmbForDate.GetValue() != null) ? CcmbForDate.GetValue() : "";
      var currentDate=convert(GetDate);
      var url='frmClosingRatesAdd.aspx?id='+ keyValue +'&dtfor='+ dat+'&dtupto='+ currentDate;
       parent.OnMoreInfoClick(url,"Edit Closing Rates",'700px','350px',"Y");
      //End of New Work 28/02/2022
    }
    //New Work 28/02/2022
...
//            parent.OnMoreInfoClick(url,"Add New Var Rates",'700px','350px',"Y");
            var dat=document.getElementById('dtTo_hidden').value;
            var GetDate = (CcmbForDate.GetValue() != null) ? CcmbForDate.GetValue() : "";
            var currentDate=convert(GetDate);
            var url='frmVarRateAdd.aspx?id='+'ADD'+'&dtfor='+ dat+'&dtupto='+ currentDate;
            parent.OnMoreInfoClick(url,"Add New Var Rates",'700px','350px',"Y");
            //End of New Work 28/02/2022
        }
...
//           parent.OnMoreInfoClick(url,"Edit Var Rates",'700px','350px',"Y");
           var GetDate = (CcmbForDate.GetValue() != null) ? CcmbForDate.GetValue() : "";
           var currentDate=convert(GetDate);
           var url='frmVarRateAdd.aspx?id='+ keyValue +'&dtfor='+ dat+'&dtupto='+ currentDate;
           parent.OnMoreInfoClick(url,"Edit Var Rates",'700px','350px',"Y");
          //End of New Work 28/02/2022
        }
       function CancelFilter()
        ...
        height();
         ...
         function DeleteVarRow(keyValue)
            {
                     conf=confirm('Are You Want To Delete This Record ???');
                    if(conf)
                        {
                            ...
                            <tr id="ShowAll">
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <dxe:ASPxDateEdit ID="cmbForDate" runat="server" EditFormat="Custom" UseMaskBehavior="True" ClientInstanceName="CcmbForDate">
                                    ...
                                    <table id="showFilter">
                                        <tr>
                                            <td class="gridcellleft" style="vertical-align: top; text-align: left" id="TdFilter">
                                                <span id="spanall">
                                                    <dxcp:ASPxCallbackPanel ID="CbptxtSelectionID" runat="server" ClientInstanceName="cCbptxtSelectionID" 
                    ...
                    <td>
                        <asp:UpdatePanel ID="updatepanel_trprevnext" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <table width="100%">
                                    ...
                                    <tr id="trGridClosing">
                                        <td align="center">
                                            <dxwgv:ASPxGridView ID="gridClosing" ClientInstanceName="gridClosing" Width="100%"
                                                ...
                                                <Columns>
                                                    <dxwgv:GridViewDataTextColumn Visible="False" FieldName="DailyStat_ID" Caption="ID">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="0" FieldName="Dailystat_DateTime1" Width="50px"
                                                        Caption="Date For">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="1" FieldName="instruments" Width="100px"
                                                        Caption="Instruments">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="2" FieldName="DailyStat_Open" Width="50px"
                                                        Caption="Open">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="3" FieldName="DailyStat_High" Width="50px"
                                                        Caption="High">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="4" FieldName="DailyStat_Low" Width="50px"
                                                        Caption="Low">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="5" FieldName="DailyStat_Close" Width="50px"
                                                        Caption="Close">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="6" FieldName="DailyStat_SettlementPrice"
                                                        Width="50px" Caption="Settlement Price">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="7" FieldName="DailyStat_AssetPrice" Width="50px"
                                                        Caption="Underlying">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                       ...
                       InsertCommand=" ">--%>
                                ...
                                <table width="100%">
                                    ...
                                    <tr id="trGridVar">
                                        <td align="center">
                                            <dxwgv:ASPxGridView ID="gridVarRate" ClientInstanceName="gridVarRate" Width="100%"
                                                ...
                                                <Columns>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="0" FieldName="DailyVar_Date" Width="50px"
                                                        Caption="Date For">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="1" FieldName="Equity_TickerSymbol" Width="50px"
                                                        Caption="Instruments">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="2" FieldName="DailyVar_SecurityVar" Width="50px"
                                                        Caption="Security Var">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="3" FieldName="DailyVar_IndexVar" Width="50px"
                                                        Caption="IndexVar">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="4" FieldName="DailyVar_VarMargin" Width="50px"
                                                        Caption="VarMargin">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="5" FieldName="DailyVar_ExtremeLossRate"
                                                        Width="50px" Caption="ExtremeLossRate">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="6" FieldName="DailyVar_AdhocMargin" Width="50px"
                                                        Caption="AdhocMargin">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="7" FieldName="DailyVar_SpecialMargin"
                                                        Width="50px" Caption="SpecialMargin">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="8" FieldName="DailyVar_AppMargin" Width="50px"
                                                        Caption="AppMargin">
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="9" Width="60px" Caption="Details">
                                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                        <DataItemTemplate>
