<%@ page language="C#" autoeventwireup="true" inherits="management_ConfigBrokeragemaint, App_Web_dw8rtpla" %>
...
//          ddlsegment.SetText('');
   ...
   function CallBrokerageMain(keyValue)
   {
     ...
     var url='BrokerageMain.aspx?id='+keyValue;
     //New Work 14/03/2022
     //parent.OnMoreInfoClick(url,"Edit BrokerageMain Details",'980px','470px',"N");     
     parent.OnMoreInfoClick(url,"Edit BrokerageMain Details",'1350px','630px',"N");
...
//             url='BrokerageBridge.aspx?id='+ch+' &Cid='+cmbc+' &Sid='+cmbs+' &Addurl='+AddUrl;
AddUrl='AADD'+'|'+ch +'|'+cmbc+'|'+cmbs+'|'+och +'|'+cc+'|'+ss+'|'+type;
         ...
         AddUrl='ADD'+'|'+ch +'|'+cmbc+'|'+cmbs+'|'+och +'|'+cc+'|'+ss+'|'+type;
             url='BrokerageBridge.aspx?id='+ch+' &Cid='+cmbc+' &Sid='+cmbs+' &Addurl='+AddUrl; 
           parent.OnMoreInfoClick(url,"Add BrokerageMain Details-General",'470px','250px',"Y");    
             //url='BrokerageBridge.aspx?id='+ch+' &Cid='+cmbc+' &Sid='+cmbs;  
...
//           parent.OnMoreInfoClick(url,"Add BrokerageMain Details-General",'370px','200px',"Y");      
    ...
    function FillValues(objVal,objCusID,objCompID,objSegID)
    {
        ...
        if(Grp=='')
            ...
            Grp='G'
        var objCharge='T'
        var url='BrokerageMain.aspx?id='+objVal+' &charge='+objCharge+' &CusID='+objCusID+' &CompID='+objCompID+' &SegID='+objSegID+' &Grp='+Grp+' &clName='+och;
        //New Work 14/03/2022
        //parent.OnMoreInfoClick(url,"Edit BrokerageMain Details",'980px','470px',"Y");
        parent.OnMoreInfoClick(url,"Edit BrokerageMain Details",'1350px','630px',"Y");
        //End of New Work 14/03/2022
    }
    function FillValuesWithAdd(objVal)
    {
        parent.editwin.close();
        var cmbs=document.getElementById('ddlsegment_VI').value;
        var url='BrokerageMain.aspx?id='+AddUrl;
        //New Work 14/03/2022
        //parent.OnMoreInfoClick(url,"Edit BrokerageMain Details",'980px','470px',"Y");      
        parent.OnMoreInfoClick(url,"Edit BrokerageMain Details",'1350px','630px',"Y");
        //End of New Work 14/03/2022
