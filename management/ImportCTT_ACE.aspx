<%@ page language="C#" autoeventwireup="true" inherits="management_ImportCTT_ACE, App_Web_cvaj-tqf" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>ACE CTT FILES</title>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports CTT_TMCode_DDMMYYYY_nnnnnn.csv Files Available through Extranet
                        </h5>
                    </td>
                </tr>
