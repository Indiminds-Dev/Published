<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_SelectMultiCurrency, App_Web_5uqmplyf" %>
...
<%--    <script type="text/javascript" src="../JSFUNCTION/ajax-dynamic-list.js"></script>--%>
    ...
    <script type="text/javascript" language="javascript">
      ...
      // txtSettNo_hidden
            ...
            var data = 'Save~' + comp.value + '~' + selectedOption.text ;
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                                        ...
                                                                        <table width="100%" border="0" cellpadding="0">
                                                                            <tr>
                                                                                <td class="headfont" style="text-align: left;">
                                                                                    <strong>Select Active Currency</strong></td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr class="maintablerow" style="display:none;">
                                                                    <td style="text-align: left; width: 57px;">
                                                                        Fin. Year:
                                                                    </td>
                                                                    <td style="text-align: left; width: 175px;">
