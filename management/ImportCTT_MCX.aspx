<%@ page language="C#" autoeventwireup="true" inherits="management_ImportCTT_MCX, App_Web_kqhq1k1d" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>MCX Closing Rates</title>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports MCX_CTT_CM/TM_YYYYMMDD.csv OR CTT_MCXCCL_CO_0_TM_memCode_YYYYmmDD_F_nnnn.csv files
                        </h5>
                    </td>
                </tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="gridcellleft">
                                            <span style="color: #000099; text-align: right">CM/TM's CTT File</span></td>
