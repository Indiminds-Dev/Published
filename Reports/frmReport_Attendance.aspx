<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReport_Attendance, App_Web_sf8qvqgk" %>
                            ...
                            <td valign="bottom" class="gridcellleft">
                                <table>
                                    <tr>
                                        ...
                                        <td class="gridcellleft" style="width: 50px;" valign="top">
                                            <dxe:ASPxComboBox ID="cmbCompany" Width="120px" runat="server" Font-Size="10px" ValueType="System.String"
                                        ...
                                        <td class="gridcellleft" style="width: 50px;" valign="top">
                                            <dxe:ASPxComboBox ID="cmbBranch" Width="120px" runat="server" ValueType="System.String"
                                                Font-Size="10px" ClientInstanceName="Branch" EnableIncrementalFiltering="True" EnableTheming="False" Font-Overline="False">
                                                <ButtonStyle Width="13px">
                                                </ButtonStyle>
