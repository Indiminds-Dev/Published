<%@ page language="C#" autoeventwireup="true" inherits="Management_SPICERegistration, App_Web_jdrimxnc" %>
...
<head id="Head1" runat="server">
    <title>Generate Batch File For POA Client Registration [SPICE]</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Batch File For SPICE Registration</span></strong></td>
