<%@ page language="C#" autoeventwireup="true" inherits="DP_User_DB_Cdsl_TableMapping_New, App_Web_kyynie8n" %>
                ...
                <div id="AccordionContainer" class="AccordionContainer">
                                        ...
                                        <div id="divCdslResult">
                                            ...
                                            <div id="divCdslright" class="leftPanel">
                                                ...
                                                <div class="left" style="margin-left: 5px;">
                                                    <dx:ASPxTextBox ID="txtCdslCode" runat="server" ClientInstanceName="ctxtCdslCode"
                    ...
                    <div id="Accordion2Content" class="AccordionContent">
                        ...
                        <div id="divKRAPanel" class="left PanelContainer">
                            <dxcp:ASPxCallbackPanel ID="CbpKRAContainer" runat="server" ClientInstanceName="cCbpKRAContainer"
                                    ...
                                    <dxp:panelcontent runat="server">
                                        ...
                                        <div id="divKRAResult">
                                            ...
                                            <div id="divKRAright" class="leftPanel">
                                                ...
                                                <div class="left" style="margin-left: 5px;">
                                                    <dx:ASPxTextBox ID="txtKRACode" runat="server" ClientInstanceName="ctxtKRACode" Width="40px"
                                                        Enabled="false">
                                                    </dx:ASPxTextBox>
                                                </div>
                                                <br class="clear" />
