<%@ page language="C#" autoeventwireup="true" inherits="management_Marginfoiframe_MCXSX, App_Web_wqpzjxym" %>
    ...
    <script language="javascript" type="text/javascript">
     function Page_Load(obj)///Call Into Page Load
      { 
           ...
           Hide('tr_Adhoc');
           Hide('tr_date');
           document.getElementById('lblEg').innerHTML='EG: MCX-SX-EDS_MARGIN_TMCode_YYYYMMDD.csv';
           selecttion();
      }
   function height()
    {
    ...
    function fnddlGeneration(obj)
     {
       if(obj=='0')
       {
         Hide('tr_Adhoc');
         Hide('tr_date');
         document.getElementById('lblEg').innerHTML='EG: MCX-SX_MARGIN_TMCode_YYYYMMDD.csv';
       }
       else
       {
        Show('tr_Adhoc');
        ...
        <asp:Panel ID="Panelmain" runat="server" HorizontalAlign="Center" Style="z-index: 100;
            ...
            <table id="tbl_main" cellpadding="0" cellspacing="0" class="login" width="410" style="border: solid 1px blue">
                <tbody>
                    <tr>
                        <td class="EHEADER">
                            <span style="color: blue"><strong>MCXSX-FO Client's Daily Margin </strong></span></td>
                    </tr>
                    <tr>
                        <td class="lt">
