<%@ page language="C#" autoeventwireup="true" inherits="management_fee, App_Web_n3rnr3dz" %>
                                ...
                                <td>
                                    <table style="width: 100px; z-index: 101">
                                        <tr>
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left;">
                                                <asp:TextBox ID="txtGroup" runat="server" TabIndex="1" Font-Size="11px" Width="160px"></asp:TextBox><asp:TextBox
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left;">
                                                <dxe:ASPxComboBox runat="server" TabIndex="2" EnableSynchronization="False" EnableIncrementalFiltering="True"
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left;" id="tdsegment" runat="server">
                                                <dxe:ASPxComboBox runat="server" TabIndex="3" DropDownStyle="DropDown" EnableSynchronization="False"
                                        ...
                                        <tr>
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <asp:TextBox runat="server" Width="120px" ID="txtdate" Visible="False"></asp:TextBox>
                                                <asp:Image runat="server" ImageUrl="~/images/calendar.jpg" ID="Image1" Visible="False">
                                                </asp:Image>
                                                <dxe:ASPxDateEdit runat="server" TabIndex="4" UseMaskBehavior="True" DateOnError="Today" EditFormat="Custom"
                                                     Width="130px" 
                                                     ID="Dateedit">
                                            ...
                                            <td id="td_fo" runat="server" class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel ID="ASPxLabel97" runat="server" Width="150px" Text="Rate For Equity/Future:">
                                                </dxe:ASPxLabel>
                                            </td>
                                            ...
                                            <td id="td_old" runat="server" class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel ID="ASPxLabel3" runat="server" Text="Fee Rate:">
                                                </dxe:ASPxLabel>
                                            </td>
                                            
                                            <td class="Ecoheadtxt" style="text-align: left;">
                                                <dxe:ASPxTextBox ID="txtrate" runat="server" Width="100px" TabIndex="5"  onkeypress="return noNumbers(event)">
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel ID="ASPxLabel4" runat="server" Text="ServTax/GST Applicable:" Width="90px">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td class="Ecoheadtxt" style="text-align: left;">
                                                <dxe:ASPxComboBox runat="server" TabIndex="6" Width="100px" ID="ddltaxapp" DropDownStyle="DropDown"
                                        ...
                                        <tr>
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxComboBox runat="server" TabIndex="7" Width="93px" ID="cmbcharge" DropDownStyle="DropDown"
                                                    EnableSynchronization="False" EnableIncrementalFiltering="True">
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left;">
                                                <dxe:ASPxTextBox ID="txtrate1" runat="server" Width="100px" TabIndex="8" onkeypress="return noNumbers(event)">
                                                    <MaskSettings Mask="<0..99g>.<00..999999>" />
                                                    <ValidationSettings ErrorDisplayMode="None">
                                                    </ValidationSettings>
                                                </dxe:ASPxTextBox>
                                        ...
                                        <tr id="accfor" runat="server" style="display:none">
                                            <td colspan="6" class="Ecoheadtxt" style="text-align: left;">
                                                <dxe:ASPxLabel ID="ASPxLabel40" runat="server" Text="Accounts for SEBI Fee:">
                                                </dxe:ASPxLabel>
                                            </td>
                                        </tr>
                                        <tr id="trtranclient" runat="server" style="display:none">
                                            ...
                                            <td style="text-align: left" class="Ecoheadtxt" colspan="2">
                                                <dxe:ASPxComboBox runat="server" TabIndex="9" EnableSynchronization="False" EnableIncrementalFiltering="True"
                                        ...
                                        <tr id="trtrancharge" runat="server" style="display:none">
                                            ...
                                            <td style="text-align: left" class="Ecoheadtxt" colspan="2">
                                                <dxe:ASPxComboBox runat="server" TabIndex="10" EnableSynchronization="False" EnableIncrementalFiltering="True"
                                                    ValueType="System.String" DataSourceID="AccessDataSourceaccount" TextField="MainAccount_Name"
