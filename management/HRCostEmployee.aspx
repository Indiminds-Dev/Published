<%@ page language="C#" autoeventwireup="true" inherits="management_HRCostEmployee, App_Web_v5pngf_u" %>
...
<head runat="server">
    <title>Cost Center Employee</title>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="TableMain100">
                <tr>
                    <td>
                        <dxtc:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="2" Width="90%"
                            ...
                            <TabPages>
                                ...
                                <dxtc:TabPage Name="Employee" Text="Employee">
                                    <ContentCollection>
                                        <dxw:ContentControl runat="server">
                                            <dxwgv:ASPxGridView ID="EmployeeGrid" runat="server" AutoGenerateColumns="False"
            ...
            <asp:SqlDataSource ID="EmployeeSource" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
                SelectCommand="select cnt_internalId as id,cnt_firstName  as Costcenter,cost_costCenterType as CostCenterType from tbl_master_contact ,tbl_master_costCenter where cnt_internalId=cost_description">
            </asp:SqlDataSource>
        </div>
    </form>
</body>
