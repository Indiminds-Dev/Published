<%@ page language="C#" autoeventwireup="true" inherits="management_exchangemarginreportingfile_NSECL, App_Web_2wstwz9u" %>
                    ...
                    <table border="10" cellpadding="1" cellspacing="1">
                        <tr valign="top">
                            <td class="gridcellleft" bgcolor="#B7CEEC">
                             ...
                             <td class="gridcellleft" bgcolor="#B7CEEC">
                                <asp:CheckBox ID="chkfosegment" runat="server"  />
                                Consider FO Segment Trading A/c Balance
                            </td>
                            <td>
                                <table>
                                    <tr>
                        ...
                        <ContentTemplate>
                            <asp:GridView ID="grdmarginreporting" runat="server" BorderColor="CornflowerBlue"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Min.Margin">
                                        <ItemStyle BorderWidth="1px" Wrap="False" HorizontalAlign="right"></ItemStyle>
                                        <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                        <ItemTemplate>
                                            <asp:Label ID="lblSpanMargin" runat="server" Text='<%# Eval("VARMargin")%>' CssClass="gridstyleheight1"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
 						            ...
 						            <asp:TemplateField HeaderText="Peak.margin">
                                        ...
                                        <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                        <ItemTemplate>
                                            <asp:Label ID="lblPeakMargin" runat="server" Text='<%# Eval("PeakMargin")%>' CssClass="gridstyleheight1"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Ledger Balnc.">
                                        <ItemStyle BorderWidth="1px" Wrap="False" HorizontalAlign="right"></ItemStyle>
                                        <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Collaterals">
                                        <ItemStyle BorderWidth="1px" Wrap="False" HorizontalAlign="right"></ItemStyle>
                                        <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Min.Excess/Short" SortExpression="minexcessshortage">
                                        <ItemStyle BorderWidth="1px" Wrap="False" HorizontalAlign="right"></ItemStyle>
                                        <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                        <ItemTemplate>
                                            <asp:Label ID="lblminexcessshortage" runat="server" Text='<%# Eval("minexcessshortage")%>'
                                                CssClass="gridstyleheight1"></asp:Label>
                                                <asp:Label ID="lblminexcessshortageformat" Visible="false" runat="server" Text='<%# Eval("minexcessshortageformat")%>'
                                                CssClass="gridstyleheight1"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
