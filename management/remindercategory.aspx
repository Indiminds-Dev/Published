<%@ page language="C#" autoeventwireup="true" inherits="management_remindercategory, App_Web_0jwcfgzk" %>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center" colspan="4">
                    <strong><span style="color: #000099">Reminder Categories</span></strong>
                </td>
            </tr>
            <tr>
                <td colspan="4">
                                ...
                                <table>
                                    ...
                                    <table>
                                        ...
                                        <td style="width:100px;">
                                            Shortname :</td>
                                       <td>
                                            <asp:TextBox ID="txt_description" runat="server" Width="520px" MaxLength="100"></asp:TextBox></td>
                                            ...
                                            Description :</td>
                                        <td>
                                            <asp:TextBox ID="txtcat_desc" runat="server" Width="520px" Height="50px" TextMode="MultiLine"></asp:TextBox></td>
                ...
                <td>
                    <dxwgv:ASPxGridView ID="gridCategory" runat="server" ClientInstanceName="grid" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <dxwgv:GridViewDataTextColumn FieldName="cat_description" Caption="Description"
                                VisibleIndex="0">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                           <dxwgv:GridViewDataTextColumn FieldName="cat_applicablefor" Caption="Shortname"
