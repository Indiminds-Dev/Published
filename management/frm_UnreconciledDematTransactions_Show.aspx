<%@ page language="C#" autoeventwireup="true" inherits="management_frm_UnreconciledDematTransactions_Show, App_Web_1jeyysc_" %>
                                ...
                                <dxtc:TabPage Text="CustomerID">
                                    <ContentCollection>
                                        ...
                                        <table>
                                            <tr>
                                                <td >
                                                    <a href="javascript:ShowHideFilter('cust','s');"><span style="color: #000099; text-decoration: underline">
                                                        Show Filter</span></a>
                                                </td>
                                                <td >
                                                    <a href="javascript:ShowHideFilter('cust','All');"><span style="color: #000099; text-decoration: underline">
                                                        All Records</span></a>
                                                </td>
                                            </tr>
                                        </table>
                                        <dxwgv:aspxgridview id="gridCustomer" runat="server" width="100%" ClientInstanceName="gridCust"
