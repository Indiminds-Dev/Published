<%@ page language="C#" autoeventwireup="true" inherits="management_MCXMargin, App_Web_yq8u0p-o" %>
    ...
    <script language="javascript" type="text/javascript">
     function Page_Load(obj)///Call Into Page Load
      { 
           ...
           Hide('tr_Adhoc');
           Hide('tr_date');
           document.getElementById('lblEg').innerHTML='EG: MCX_MARGIN_TMCode_YYYYMMDD.csv';
           selecttion();
      }
   function height()
    {
    ...
    function fnddlGeneration(obj)
     {
       ...
       else if(obj=='1')
       {
         Show('tr_Adhoc');
         Show('tr_date');
         document.getElementById('lblEg').innerHTML='Daily Margin CSV Files';
       }
       else
       {
        Show('tr_Adhoc');
        Show('tr_date');
        document.getElementById('lblEg').innerHTML='Peak Margin CSV Files';
       }
     }  
        ...
        <asp:Panel ID="Panelmain" runat="server" HorizontalAlign="Center" Style="z-index: 100;
            ...
            <table id="tbl_main" cellpadding="0" cellspacing="0" class="login" width="410" style="border: solid 1px blue">
                <tbody>
                    <tr>
                        <td class="EHEADER">
                            <span style="color: blue"><strong>MCX-COMM Margin</strong></span></td>
                    </tr>
                    <tr>
                        <td class="lt">
                                     ...
                                     <tr>
                                        <td>
                                            <asp:DropDownList ID="cmbFileType" runat="server" Width="265px" onchange="fnddlGeneration(this.value)">
                                                <asp:ListItem Value="0">Exchange Margin File/UDiFF </asp:ListItem>
                                                <asp:ListItem Value="1">FT Margin File</asp:ListItem>
                                                <asp:ListItem Value="2">Protector Peak Margin File</asp:ListItem>
                                            </asp:DropDownList></td>
                                    </tr>
                                    <tr><td>
                                        <div id="lblEg">
