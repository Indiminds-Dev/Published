<%@ page language="C#" autoeventwireup="true" inherits="Reports_Report_StockMeasurement, App_Web_yvy99of_" %>
...
<head runat="server">
    <title>Stock Measurement Page</title>
     <!--External Style-->
    <!--Internal Style-->
                    ...
                    <div id="C1_Row1" class="Row">
                        ...
                        <div id="C1_Row1_Col2" class="LFloat_Content ContentWidth">
                         ...
                         <div id="C1_Row1_Col3" class="LFloat_Content ContentWidth">
                            <dxe:ASPxDateEdit ID="dtTo" runat="server" ClientInstanceName="cdtFor" DateOnError="Today"
                                EditFormat="Custom" EditFormatString="dd-MM-yyyy" UseMaskBehavior="True" Width="125px"
                                Font-Size="11px" TabIndex="0">
