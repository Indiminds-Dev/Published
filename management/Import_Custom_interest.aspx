<%@ page language="C#" autoeventwireup="true" inherits="management_Closingrateiframe, App_Web_e158i_8t" %>
...
<head id="Head1" runat="server">
   ...
   <script type="text/javascript" src="../JSFUNCTION/GenericJScript.js"></script>
    <title>Import Interest JVs</title>
                                                ...
                                                <table class="width100per" cellspacing="12" cellpadding="0">
                                                    <tbody>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <%--<asp:HyperLink ID="HyperLink1" runat="server" ForeColor="Blue" Width="266px"  NavigateUrl="~/C:/SAMPLE_interest.csv" Target="_blank">View File Format</asp:HyperLink>--%>
                                                            </td>
                                                        </tr>
