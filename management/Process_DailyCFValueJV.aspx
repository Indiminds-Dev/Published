<%@ page language="C#" autoeventwireup="true" inherits="management_Process_DailyCFValueJV, App_Web_d3reltht" %>
...
<head>
    <title>Daily CF To JV Generate Value</title>
        ...
        <div>
            <div class="TableMain100">
                <div class="EHEADER" style="text-align: center;">
                    <strong><span style="color: #000099">Generate Daily Market Value JV for Open Positions
                        in Options/Cash Instruments</span></strong>
                </div>
            </div>
                ...
                <center>
                    ...
                    <div style="width: 62%; padding: 2px" class="frmContent">
                        ...
                        <div id="ddlGenerate" class="frmleftContent">
                            <dxe:ASPxComboBox runat="server" ID="ForGenOrDel" ClientInstanceName="cForGenOrDel"
                                ...
                                ValueType="System.String" SelectedIndex="0" Font-Size="Small" Width="125px">
                        ...
                        <div class="left" style="margin: 4px">
                            <dxe:ASPxButton ID="BtnGnDl" runat="server" Text="Generate" TabIndex="0" ClientInstanceName="cBtnGnDl"
                    ...
                    <div id="divGvwDateDtl" style="display: none; text-align: center">
                        <dxwgv:ASPxGridView ID="GvDateDtl" runat="server" AutoGenerateColumns="False" KeyFieldName="ID"
                            ...
                            <Columns>
                                <dxwgv:GridViewDataTextColumn Caption="ID" FieldName="Id" VisibleIndex="0" Width="30%">
                                    <CellStyle CssClass="gridcellleft">
                                    </CellStyle>
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="Position Date" FieldName="PositionDate" VisibleIndex="1"
                                    Width="65%">
