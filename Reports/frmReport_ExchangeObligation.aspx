<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReport_ExchangeObligation, App_Web__-dtd0z2" %>
...
<head id="Head1" runat="server">
    <title>Exchange Obligation</title>
    ...
    <script type="text/javascript" src="../JSFUNCTION/ajax-dynamic-list1.js"></script>
                                    ...
                                    <tr>
                                        <td class="gridcellleft">
                                            <dxe:ASPxRadioButtonList ID="rbSettlement" ClientInstanceName="rbbtnset" runat="server"
                                                Font-Size="10px" SelectedIndex="0" TextWrap="False" RepeatDirection="Horizontal"
                                                ItemSpacing="10px">
                                                <items>
                                        ...
                                        <td id="tdsetValue" style="width: 94px" class="gridcellleft">
                                            &nbsp;<asp:TextBox ID="txtset" runat="server" Width="80px" Font-Size="10px" Height="21px"></asp:TextBox>
                                        ...
                                        <td id="tddatefromValue" class="gridcellleft">
                                            <dxe:ASPxDateEdit ID="txtfromDate" runat="server" ClientInstanceName="e1" EditFormat="Custom"
                                                EditFormatString="dd-MM-yyyy" UseMaskBehavior="True" AllowNull="False" Font-Size="10px">
                                        ...
                                        <td class="gridcellleft">
                                            <dxe:ASPxComboBox ID="ASPxComboBox1" runat="server" Font-Size="10px" ValueType="System.String"
...
bindrid();
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; vertical-align: top; height: 134px;">
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            &nbsp;&nbsp;<asp:ListBox ID="lstSlection" runat="server" Font-Size="10px" Height="90px"
            ...
            <tr id="TRObligation_Set">
                <td>
                    <dxwgv:ASPxGridView ID="Settelment_Grid" ClientInstanceName="Settelment_Grid" runat="server"
                        ...
                        <columns>
                        <dxwgv:GridViewDataTextColumn Caption="Product" ReadOnly="True" VisibleIndex="0"
                          ...
                          <dxwgv:GridViewDataTextColumn Caption="Series" ReadOnly="True" VisibleIndex="1"
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Total Buy" VisibleIndex="2" FieldName="totalbuy"
                            Width="13%">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                            <EditFormCaptionStyle HorizontalAlign="Right">
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Value" VisibleIndex="3" FieldName="buyvalue"
                            Width="13%">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                            <EditFormCaptionStyle HorizontalAlign="Right">
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Total Sell" VisibleIndex="4" FieldName="sell"
                            Width="13%">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                            <EditFormCaptionStyle HorizontalAlign="Right">
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Value" VisibleIndex="5" FieldName="sellvalue"
                            Width="13%">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                            <EditFormCaptionStyle HorizontalAlign="Right">
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Net Quantity" FieldName="netvalue" VisibleIndex="6"
                            Width="13%">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                            <EditFormCaptionStyle HorizontalAlign="Right">
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Obligation" FieldName="obligance" VisibleIndex="7">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                            <EditFormCaptionStyle HorizontalAlign="Right">
                            </EditFormCaptionStyle>
	...
	ShowHeight(s.cpHeight);
            ...
            <tr id="TRObligation_date">
                <td>
                    <dxwgv:ASPxGridView ID="Obligation_date" ClientInstanceName="Obligation_date" runat="server"
                        ...
                        <columns>
                        <dxwgv:GridViewDataTextColumn Caption="Settelment No" ReadOnly="True" VisibleIndex="0" Width="10%"
                         ...
                         <dxwgv:GridViewDataTextColumn Caption="Trade Date" ReadOnly="True" VisibleIndex="1" Width="10%"
                            FieldName="tradedate">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                            <EditFormCaptionStyle HorizontalAlign="Right">
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Buy Value" VisibleIndex="2" FieldName="buyvalue" Width="20%">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                            <EditFormCaptionStyle HorizontalAlign="Right">
                            </EditFormCaptionStyle>
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Sell Value" VisibleIndex="3" FieldName="sellvalue" Width="20%">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                            <EditFormCaptionStyle HorizontalAlign="Right">
                            </EditFormCaptionStyle>
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Nd Obligation" FieldName="NdObligance" VisibleIndex="4" Width="20%">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                            <EditFormCaptionStyle HorizontalAlign="Right">
                            </EditFormCaptionStyle>
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Obligation" FieldName="obligance" VisibleIndex="5">
                            <CellStyle CssClass="gridcellleft">
                            </CellStyle>
                            <EditFormCaptionStyle HorizontalAlign="Right">
                            </EditFormCaptionStyle>
