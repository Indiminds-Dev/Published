<%@ page language="C#" autoeventwireup="true" inherits="management_BSECDXMargin, App_Web_itibbj7j" %>
    ...
    <script language="javascript" type="text/javascript">
     function Page_Load(obj)///Call Into Page Load
      { 
           ...
           Hide('tr_Adhoc');
           Hide('tr_date');
           document.getElementById('lblEg').innerHTML='Files: BFX_MGTM Or BFX_MG02';
           selecttion();
      }
   function height()
    {
    ...
    function fnddlGeneration(obj)
     {
       if(obj=='0')
       {
         Hide('tr_Adhoc');
         Hide('tr_date');
         document.getElementById('lblEg').innerHTML='EG: BFX_MGTM_TMCode_DDMMYYYY.CSV';
       }
       else
       {
        Show('tr_Adhoc');
        ...
        <asp:Panel ID="Panelmain" runat="server" HorizontalAlign="Center" Style="z-index: 100;
            ...
            <table id="tbl_main" cellpadding="0" cellspacing="0" class="login" width="410" style="border: solid 1px blue">
                <tbody>
                    <tr>
                        <td class="EHEADER">
                            <span style="color: blue"><strong>BSE-CDX Margin</strong></span></td>
                    </tr>
                    <tr>
                        <td class="lt">
                            <table cellpadding="0" cellspacing="12" class="TableMain100">
                                <tbody>
                                     <tr>
                                        <td>
                                            <asp:DropDownList ID="cmbFileType" runat="server" Width="265px" onchange="fnddlGeneration(this.value)">
                                                <asp:ListItem Value="0">Exchange Margin Files [MGTM/MG02] </asp:ListItem>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:FileUpload ID="BSECDXMarginSelectFile" runat="server" Height="21px" Width="272px" />
                                        </td>
                                    </tr>
