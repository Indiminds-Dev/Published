<%@ page language="C#" autoeventwireup="true" inherits="Reports_ApprovedIlliquidSecurities, App_Web_-n9yptcr" %>
...
<head id="Head1">
    <title>Approved / Illiquid Securities</title>
   ...
   { 
    ...
    <div>
       ...
       <table border="0" cellpadding="0" cellspacing="0" id="TabSelection">
                              ...
                              <table><tr><td>  <table border="10" cellpadding="1" cellspacing="1">
                                    <tr valign="top">
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Report View :</td>
                                        <td>
                                            <asp:DropDownList ID="DdlRptView" runat="server" Width="150px" Font-Size="10px"  onchange="FnReportView(this.value)">
                                        ...
                                        <td>
                                            <table border="10" cellpadding="1" cellspacing="1">
                                                <tr valign="top">
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="DdlYear" runat="server" Width="150px" Font-Size="10px">
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                            </table>
        ...
        <table>
            <tr>
               <td style="display:none;">    <asp:HiddenField ID="hiddencount" runat="server" /></td>
                <td>
