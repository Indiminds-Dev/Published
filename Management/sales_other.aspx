<%@ page language="C#" autoeventwireup="true" inherits="management_sales_other, App_Web_amufh4kc" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    ...
    <div>
        ...
        <tr>
            <td>
                <dxtc:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="6" ClientInstanceName="page"    Font-Size="10px"><TabPages>
                            ...
                            <dxw:ContentControl runat="server">
                                <dxwgv:ASPxGridView ID="gridLodging" ClientInstanceName="grid" DataSourceID="SqlLodging" runat="server" KeyFieldName="expnd_internalId"   Width="100%" AutoGenerateColumns="False" OnInitNewRow="gridLodging_InitNewRow">
                                    <Columns>
                                        ...
                                        <dxwgv:GridViewDataMemoColumn Caption="Description" FieldName="expnd_otherExpnseDescrip" VisibleIndex="0"
                                            Width="40%">
                                        ...
                                        <dxwgv:GridViewDataTextColumn Caption="Amount" FieldName="expnd_otherExpnseAmount"
                                    ...
                                    <SettingsText PopupEditFormCaption="Add/Modify Others" ConfirmDelete="Are You Want To Delete This Record ???" />
