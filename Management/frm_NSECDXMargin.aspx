<%@ page language="C#" autoeventwireup="true" inherits="management_MCXMargin, App_Web_6yanuau_" %>
    ...
    function fnddlGeneration(obj)
     {
       ...
       if(obj=='2')
       {
         Hide('tr_Adhoc');
         Hide('tr_date');
         document.getElementById('lblEg').innerHTML='EG: X_MG17_TMCode_DDMMYYYY.lis';
       }
       else
       {
        Show('tr_Adhoc');
        Show ('tr_date');
        document.getElementById('lblEg').innerHTML='EG: TermialWisePeakMarginUtilizationReportDD-MM-YYYY.csv';
       }
     }  
                                 ...
                                 <tr>
                                        <td>
                                            <asp:DropDownList ID="cmbFileType" runat="server" Width="265px" onchange="fnddlGeneration(this.value)">
                                                ...
                                                <asp:ListItem Value="2">Exchange Mg17 File</asp:ListItem>
                                                <asp:ListItem Value="3">Protector Peak Margin File</asp:ListItem>
                                            </asp:DropDownList></td>
                                    </tr>
                                    <tr><td>
                                        <div id="lblEg">
