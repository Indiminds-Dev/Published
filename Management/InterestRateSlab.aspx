<%@ page language="C#" autoeventwireup="true" inherits="management_InterestRateSlab, App_Web_gflohp-r" %>
...
<head id="Head1" runat="server">
    <title>Interest Rate Slab</title>
     ...
     function OnAddButtonClick() 
    {
         ...
         parent.OnMoreInfoClick(url,"Add Interest Rate Slab",'500px','350px',"Y");
    }
    function SignOff()
    {
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    <form id="form1" runat="server">
        ...
        <dxwgv:ASPxGridView ID="GridIntSlabSlab" runat="server" KeyFieldName="IntSlab_ID"
	  ...
	  EndCall(s.cpEND);
            ...
            <Columns>
                <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="0" FieldName="IntSlab_ID"
                    Caption="ID">
                ...
                <dxwgv:GridViewDataTextColumn VisibleIndex="0" FieldName="IntSlab_Code" Width="10%"
                    Caption="Code">
                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                ...
                <dxwgv:GridViewDataTextColumn VisibleIndex="1" FieldName="IntSlab_AmountFrom"
                ...
                <dxwgv:GridViewDataTextColumn VisibleIndex="2" FieldName="IntSlab_AmountTo"
                ...
                <dxwgv:GridViewDataTextColumn VisibleIndex="3" FieldName="IntSlab_Rate"
 ...
 <HeaderTemplate>
        ...
        <asp:SqlDataSource ID="IntSlabDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
