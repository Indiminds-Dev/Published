<%@ page language="C#" autoeventwireup="true" inherits="Management_Export_BSEFO_Trades, App_Web_mzqu16me" %>
...
<head id="Head1" runat="server">
    <title>Export Market Trades in UDiFF Format</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Export Market Trades in UDiFF Format </span></strong></td>
