<%@ page language="C#" autoeventwireup="true" inherits="management_Closingrateiframe_MCXSX, App_Web_6yanuau_" %>
            ...
            <tbody>
                <tr>
                    <td class="lt1" style="width: 437px">
                        <h5>
                            Imports Market Statistics [MCX-SX-EQ_MSYYYYMMDD.csv] Files
                        </h5>
                    </td>
                </tr>
                <tr>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <asp:DropDownList ID="ddlFiles" runat="server" Width="269px" OnSelectedIndexChanged="ddlFiles_SelectedIndexChanged" AutoPostBack="True">
                                                                        ...
                                                                        <asp:ListItem Value="1">CSV FILES</asp:ListItem>
                                                                        </asp:DropDownList></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
