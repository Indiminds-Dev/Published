<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_INRXTRADES, App_Web_sjbhlkdr" %>
   ...
   <script language="javascript" type="text/javascript">
    ...
    function PageLoad()
    {
       ...
       //File Format to Import By Default
        Span_FileFormat.innerText="File Name : AccountCodeOvernightTrades2_YYYYMMDD.csv";
    }
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports RJO Brien's Trade CSV Files
                                </h5>
                            </td>
                        </tr>
                        <tr>
