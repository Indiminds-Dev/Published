<%@ page language="C#" autoeventwireup="true" maintainscrollpositiononpostback="true" inherits="management_display_signature_nsdl, App_Web_d3reltht" %>
            ...
            function DateChangeForFrom(s)
           {
             ...
             function CallAjax(obj1,obj2,obj3)
                { 
                    ...
                    var ddlmkt1 = e.options[e.selectedIndex].value; 
                ...
                {
                    document.getElementById('hiddensettleto').value='';
                  ...
                  if(trantype!=4)
                   {
                      if(vall=='')
                      {
                       ...
                       if(document.getElementById('txtdpid').value.substr(0,8)!='<%= dpId %>')
                       {
                          if(vall.length!=8)
                          {
...
//                       return false;
//                      }
                      var setfrom=document.getElementById('hiddensettlefrom').value;
                      //alert(document.getElementById('hiddensettlefrom').value);
                      if(setfrom=='')
                      {
                       alert('Settlement from can not be blank or it is wrong');
                       return false;
                      }
                  }
                     ...
                     if(trantype!=4 || document.getElementById('txtcmb').value!='')
                       {
                          ...
                          var setto=new String(document.getElementById('hiddensettleto').value);
                          if(setto=='')
                          {
                           alert('Settlement to can not be blank or it is wrong');
                           return false;
                          }
                        }
                  }
        ...
        <ContentTemplate>
         <div align="center">
            <table id="Table2" border="0" style="width: 90%; background-color: #ddecfe">
                ...
                <tr>
                    <td style="text-align: left">
                        DPID<asp:TextBox id="txtdpid3" runat="server" Width="50px" ReadOnly="True"></asp:TextBox></td>
                ...
                <tr>
                    <td style="text-align: left" id="re1">
                        Instruction type:</td>
                    <td style="text-align: left" id="re">
