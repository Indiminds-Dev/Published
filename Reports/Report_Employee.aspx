<%@ page language="C#" autoeventwireup="true" inherits="reports_report_employee, App_Web_a2csyl5x" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE">
    <form id="form1" runat="server">
        <div>
                            ...
                            <tr>
                                <td>
                                    <table border="1" cellpadding="2" cellspacing="1">
                                        <tr id="trEmployee">
                                            <td class="gridcellleft" style="border-right: #ffffff 1px solid; border-top: #ffffff 1px solid;
                                                border-left: #ffffff 1px solid; border-bottom: #ffffff 1px solid; background-color: #b7ceec">
                                                Select Employee
                                            </td>
                                            <td align="left">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: center">
                                                            <table cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td>
                                                                        <a href="javascript:void(0);" onclick="clientselectionfinal()"><span style="font-size: 10pt;
                            ...
                            <tr>
                                <td style="vertical-align: top; background-color: #b7ceec; text-align: left" valign="top">
                                    <a id="A_LeftNav" runat="server" href="javascript:void(0);" onclick="OnLeftNav_Click()">
                                        <img src="../images/LeftNav.gif" alt="" width="10" />
                                    </a>
                                </td>
                                <td style="vertical-align: top; background-color: #b7ceec; text-align: left" valign="top">
                                ...
                                <td style="vertical-align: top; background-color: #b7ceec; text-align: right" valign="top">
                                    <asp:DropDownList ID="ddlExport" runat="server" Font-Size="10px" Onchange="ddlExport_OnChange()"
                                        Width="100px">
                                        <asp:ListItem Selected="True" Value="Ex">Export</asp:ListItem>
                                        <asp:ListItem Value="1">Excel</asp:ListItem>
                                    </asp:DropDownList>&nbsp;
                                </td>
                                <td id="TdShowFilter" style="display:none;vertical-align: top; background-color: #b7ceec; text-align: right"
                                    valign="top">
            ...
            <br />
            <dxwgv:ASPxGridView ID="GrdEmployee" runat="server" AutoGenerateColumns="False" ClientInstanceName="cGrdEmployee"
                ...
                <SettingsBehavior AllowFocusedRow="True" AutoFilterRowInputDelay="100000"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="EmpCode" FieldName="EmpCode" FixedStyle="Left" VisibleIndex="3"
                        Width="150px">
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Father's Name" FieldName="FatherName" VisibleIndex="4"
                        Width="150px">
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                     <dxwgv:GridViewDataTextColumn Caption="DOB" FieldName="DOB" VisibleIndex="5"
                        Width="75px">
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="DOJ" FieldName="DOJ" VisibleIndex="6" Width="75px">
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="DOL" FieldName="DOL" VisibleIndex="7" Width="75px">
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Department" FieldName="Department" VisibleIndex="8"
                        Width="120px">
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Branch" FieldName="BranchName" VisibleIndex="9"
                        Width="75px">
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="CTC" FieldName="CTC" VisibleIndex="10" Width="75px">
                        <CellStyle CssClass="gridcellleft" HorizontalAlign="Right" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="ReportTo" FieldName="ReportTo" VisibleIndex="11"
                        Width="150px">
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Designation" FieldName="Designation" VisibleIndex="12"
                        Width="150px">
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Company" FieldName="Company" VisibleIndex="13"
                        Width="150px">
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="EmpType" FieldName="EmpType" VisibleIndex="14"
                        Width="120px">
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="EmailId(s)" FieldName="Email_Ids" VisibleIndex="15"
                        Width="150px">
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="PanCard" FieldName="PanCardNumber" VisibleIndex="17"
                        Width="75px">
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                     <dxwgv:GridViewDataTextColumn Caption="Address" FieldName="Address" VisibleIndex="18"
                        Width="200px">
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Ac[BankName][Branch][AcType]" FieldName="Bank" VisibleIndex="19"
                        Width="200px">
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="CreatedBy" FieldName="CreatedBy" VisibleIndex="20">
                        <CellStyle CssClass="gridcellleft" Wrap="False">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
