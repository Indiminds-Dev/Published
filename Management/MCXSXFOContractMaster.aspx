<%@ page language="C#" autoeventwireup="true" inherits="MCXSXFOContractMaster, App_Web_i8xxwgwk" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    ...
    <div>
        <asp:Panel ID="Panelmain" runat="server" HorizontalAlign="Center" Style="z-index: 100;
            left: 280px; position: absolute; top: 28px" Visible="true">
            <table id="tbl_main" cellpadding="0" cellspacing="0" class="login" width="410">
                <tbody>
               <tr>
                    <td class="lt1" style="height: 28px">
                        <h5>
                            Imports MCX-SX-EDS_ProductMaster.csv Available through FTP's COMMON Folder
                        </h5>
                    </td>
                </tr>
