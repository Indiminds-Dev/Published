<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_INAXTRADES, App_Web_sjbhlkdr" %>
   ...
   <script language="javascript" type="text/javascript">
    ...
    function PageLoad()
    {
       ...
       //File Format to Import By Default
        Span_FileFormat.innerText="File Name : YYYYmmDD ADM POS DATA.csv / YYYYmmDD ADM P&S DATA.csv";
    }
    ...
    function OnComboChooseFileIndexChange()
    {
        ...
        if(SelectedValue==0)
            ...
            Span_FileFormat.innerText="File Name : ";
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports ADM's 'YYYYmmDD ADM POS DATA.csv / YYYYmmDD ADM P&S DATA.csv' Files
                                </h5>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td style="width: 100px">
                                            <dxe:ASPxComboBox ID="ComboChooseFile" runat="server" ClientInstanceName="cComboChooseFile"
                                                ...
                                                <Items>
                                                    <dxe:ListEditItem Value="0" Text="All Trades From POS/P&S DATA Files"></dxe:ListEditItem>
                                                    <dxe:ListEditItem Value="1" Text="AOne/X-Trader CSV Files"></dxe:ListEditItem>
                                                </Items>
