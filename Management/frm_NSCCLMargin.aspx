<%@ page language="C#" autoeventwireup="true" inherits="management_frm_NSCCLMargin, App_Web_jdrimxnc" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>NSCCL Consolidated Margin Reports [C_MG01]</title>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports NSCCL's Consolidated Margin Reports [C_MG01_MemberCode_DDMMYYYY.LIS]
                        </h5>
                    </td>
                </tr>
