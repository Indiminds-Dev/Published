<%@ page language="C#" autoeventwireup="true" inherits="Reports_portfolioperformancecm, App_Web_-n9yptcr" %>
...
//      End of New Work 02/08/2024        
  ...
  function Display()
  {
      ...
      //New Work 26/09/2022
      else if(document.getElementById('ddlrpttype').value=="5" || document.getElementById('ddlrpttype').value=="6")
      {
        Hide("tr_group");
        document.getElementById('display').className="grid_scroll";
      }
      //End of New Work 26/09/2022
      height();
	  selecttion();
  }
  function selecttion()
     ...
     function Filter()
      {
        ...
        function OnMoreInfoClick(CUSTOMERID,clienttype,Segment,MASTERPRODUCTID)
        {
            ...
            else
            {
               ...
               parent.OnMoreInfoClick(URL,header,'990px','450px','N');
            ...
            if(obj=="1")
                {
                    Hide('Td_ExcludeSTT');
                    Hide('Td_ShowMTMPL');
                    document.getElementById("chkMTMPL").checked = false;
                }
            else
                {
                    Show('Td_ExcludeSTT');
                                ...
                                <table>
                                    <tr>
                                        <td id="td_dtfor" class="gridcellleft">
                                            <asp:DropDownList ID="ddldate" runat="server" Font-Size="10px">
                                                <asp:ListItem Value="0">Up To Date (Trade Basis)</asp:ListItem>
                                                <asp:ListItem Value="1">Up To Date (Bill Basis)</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td>
                                            <dxe:ASPxDateEdit ID="dtfor" runat="server" EditFormat="Custom" UseMaskBehavior="True" Font-Size="10px" Width="108px" ClientInstanceName="dtfor">
                        ...
                        <tr>
                            <td colspan="5" class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1">
                                    ...
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC" colspan="2">
                                            Closing Stock Valuation Method :</td>
                                        <td colspan="2">
                                    ...
                                    <tr id="Tr_Company" style="display:none">
                                        ...
                                        <td>
                                        [ <span id="Span_SpecificComp" runat="server" style="color: Maroon"></span>]
                                        </td>
                                    </tr>
                            ...
                            <td colspan="5" class="gridcellleft">
                                <table>
                                    <tr>
                                        ...
                                        <%--New Work 25/07/2023--%>
                                        <td bgcolor="#B7CEEC" id="Td_ShowMTMPL">
                                            <asp:CheckBox ID="chkMTMPL" runat="server" />
                                            Show Market P/L
                                        </td> 
                                        <%--End of New Work 25/07/2023--%>
                                    </tr>
