<%@ page language="C#" autoeventwireup="true" inherits="management_splittradespopup, App_Web_0payuukt" %>
            ...
            <tr>
                <td>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="grdsplit" runat="server" DataKeyNames="customertrades_id" CssClass="gridcellleft"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="ClientName">
                                        ...
                                        <FooterTemplate>
                                            ...
                                            <asp:HiddenField ID="txtclient_hidden" runat="server" Value='<%# Eval("CustomerTrades_CustomerID") %>' />
                                            <asp:Label ID="lblID" Visible="false" runat="server" Text='<%# Eval("customertrades_id") %>'></asp:Label>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Scrip">
                                        ...
                                        <FooterTemplate>
                                            ...
                                            <asp:Label ID="lblScripID" Visible="false" runat="server" Text='<%# Eval("CustomerTrades_ProductSeriesID") %>'></asp:Label>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Qty">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblQty" runat="server" Text='<%# Eval("UnitPriceQuantity") %>'></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
<%--                                            <dxe:ASPxTextBox ClientInstanceName="txtqty_Name" ID="txtqty" runat="server" HorizontalAlign="Right"
                                                Width="120px" Text='<%# Eval("UnitPriceQuantity") %>'>
                                                <validationsettings errordisplaymode="None"></validationsettings>
                                                <masksettings mask="&lt;0..9999999999g&gt;.&lt;00..99&gt;" includeliterals="DecimalSymbol" />
                                                <clientsideevents lostfocus="function(s, e) {
	fncheckqty(s.GetValue(),this.id)
}"></clientsideevents>
                                            </dxe:ASPxTextBox>--%>
                                   <asp:TextBox ID="txtqty"  Onkeypress="return isNumberKey(event)" 
                                                Width="120px" Text='<%# Eval("UnitPriceQuantity")%>' 
                                                runat="server" AutoPostBack="true"  
                                                OnTextChanged="txtqty_TextChanged"  style="text-align:right;" ></asp:TextBox>
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                 ...
                                 <asp:TemplateField HeaderText="Net Rate">
                                        ...
                                        <FooterTemplate><asp:TextBox ID="txtNetRatePerUnit" Width="100px" Enabled="false" runat="server"
                                                Text='<%# Eval("NETRATE")%>' TabIndex="2"></asp:TextBox></FooterTemplate>
                            ...
                            <asp:HiddenField ID="lblQty_hidden" runat="server" />
