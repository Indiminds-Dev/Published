<%@ page language="C#" autoeventwireup="true" inherits="Reports_HoldingReport_Daily_Aud, App_Web_sf8qvqgk" enableeventvalidation="false" %>
...
//        }
    ...
    function OnMoreInfoClick()
    {
        ...
        var url="../GenericRoutines/Batch/GenericBatchMaintenance.aspx?FileType=HoldingStatement&SqlWhere="+SqlWhere;
    ...
    function GnrcCallBackPanel_EndCallBack()
    {
        ...
        if(cGnrcCallBackPanel.cpIsSpData!=undefined)
        {
            ...
            else if(cGnrcCallBackPanel.cpIsSpData=="NBatch")
                GetObjectID('btnNBatchExport').click();
           //New Work 10/05/2022
            else if(cGnrcCallBackPanel.cpIsSpData=="APIFiles")
                GetObjectID('btnAPIFileCreate').click();
            //End of New Work 10/05/2022
            else 
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE">
   ...
   { 
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                        <strong><span id="SpanHeader" style="color: #000099">Daily Holding Report [Effective From 16-Jan-2023]
                        </span></strong>
                    </td>
        ...
        <table>
            <tr>
                <td class="gridcellleft" bgcolor="#B7CEEC" id="Td2">
                    <asp:CheckBox ID="chkNSDLCDSLHolding" runat="server" />
                    Consider Holding in NSDL/CDSL side for all OWN Accounts
                </td>
            </tr>
        </table>
        <table>
                ...
                <td>
                    <dxe:ASPxComboBox ID="CmbGenerate" runat="server" ClientInstanceName="cCmbGenerate"
                        ...
                        <Items>
                            ...
                            <dxe:ListEditItem Text="Create Batch (Holding)" Value="Batch" />
                            <dxe:ListEditItem Text="Create Batch (Nil Holding)" Value="NBatch" />
                            <%--New Work 10/05/2022--%>
                            <dxe:ListEditItem Text="Create API" Value="APIFIles" />
                            <%--End of New Work 10/05/2022--%>
                        </Items>
        ...
        <table>
                        ...
                        <tr>
                            <td>
                                <dxe:ASPxButton ID="Abtn_BatchCreate" runat="server" AutoPostBack="False" ClientInstanceName="cBatchCreate"
                                    Text="Create Batch">
                                    <ClientSideEvents Click="function(s,e){GnrcCallBackPanel_Methods(cCmbGenerate.GetValue());}" />
                                </dxe:ASPxButton>
                            </td>
                        </tr>
                        <tr>
            ...
            <%--New Work 10/05/2022--%>
            <tr>
                <td id="Td_API" style="display: none">
                    <table>
                        <tr>
                            <td>
                                <dxe:ASPxButton ID="Abtn_APICreate" runat="server" AutoPostBack="False" ClientInstanceName="cAPICreate"
                                    Text="Create File for API">
                                    <ClientSideEvents Click="function(s,e){GnrcCallBackPanel_Methods('APIFiles');}" />
                                </dxe:ASPxButton>
                            </td>
                        </tr>
                    </table>
        ...
        <div style="display: none">
            ...
            <%--New Work 10/05/2022--%>
            <asp:Button ID="btnAPIFileCreate" runat="server" BackColor="#DDECFE" BorderStyle="None"
                OnClick="btnAPIFileCreate_Click" />
            <%--End of New Work 10/05/2022--%>
        </div>
