<%@ page language="C#" autoeventwireup="true" inherits="management_IPFT, App_Web_wqpzjxym" %>
                                    ...
                                    <table style="width: 100px; z-index: 101">
                                        ...
                                        <tr>
                                            ...
                                            <td id="td_old" runat="server" class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel ID="ASPxLabel3" runat="server" Text="IPFT Rate:">
                                                </dxe:ASPxLabel>
                                            </td>
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel ID="ASPxLabel4" runat="server" Text="GST Applicable:" Width="90px">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td class="Ecoheadtxt" style="text-align: left;">
                                        ...
                                        <tr id="accfor" runat="server" style="display:none">
                                            <td colspan="6" class="Ecoheadtxt" style="text-align: left;">
                                                <dxe:ASPxLabel ID="ASPxLabel40" runat="server" Text="Accounts for IPFT Charges:">
                                                </dxe:ASPxLabel>
                                            </td>
                                        </tr>
