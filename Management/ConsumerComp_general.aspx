<%@ page language="C#" autoeventwireup="true" inherits="management_ConsumerComp_general, App_Web_6yanuau_" %>
...
<script language="javascript" type="text/javascript">
    ...
    <div>
        ...
        <tr>
            <td>
                <dxtc:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="0" ClientInstanceName="page"    Font-Size="10px"><TabPages>
                             ...
                             <table style="width:90%">
                                <tr>
                                    ...
                                    <td class="Ecoheadtxt" style="width: 158px">
                                        &nbsp;<dxe:ASPxLabel ID="ASPxLabel4" runat="server" Text="Code" Width="35px"></dxe:ASPxLabel>
                                    </td>
                                    <td class="Ecoheadtxt" style="text-align: left">
                                ...
                                <tr>
                                    ...
                                    <td class="Ecoheadtxt" style="width: 158px" >
                                        &nbsp;<dxe:ASPxLabel ID="ASPxLabel17" runat="server" Text="Refered By" Width="73px"></dxe:ASPxLabel>
                                    </td>
                                    <td class="Ecoheadtxt" style="text-align: left">
                                ...
                                <tr>
                                    ...
                                    <td class="Ecoheadtxt" style="text-align: right">
                                        <table>
                                            <tr>                            
                                                <td style="height: 43px"><dxe:ASPxButton ID="btnSave" runat="server" Text="Save"   ValidationGroup="a" TabIndex="10"   OnClick="btnSave_Click"></dxe:ASPxButton>
                                                </td>
