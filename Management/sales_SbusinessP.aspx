<%@ page language="C#" autoeventwireup="true" inherits="management_sales_SbusinessP, App_Web_dw8rtpla" %>
                                        ...
                                        <dxw:ContentControl runat="server">
                                            <dxwgv:ASPxGridView ID="gridLodging" ClientInstanceName="grid" DataSourceID="SqlLodging"
                                                ...
                                                <Columns>
                                                    ...
                                                    <dxwgv:GridViewDataMemoColumn Caption="Description" FieldName="expnd_BPDescription"
                                                    ...
                                                    <dxwgv:GridViewDataTextColumn Caption="Amount" FieldName="expnd_BPExpAmount" VisibleIndex="2"
                                                        Width="40%">
