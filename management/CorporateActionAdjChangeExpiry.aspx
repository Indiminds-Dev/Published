<%@ page language="C#" autoeventwireup="true" inherits="management_CorporateActionAdjChangeExpiry, App_Web_npkqnqtr" %>
...
<head id="Head1">
 ...
 <script language="javascript" type="text/javascript">
   ...
   function AlertGenerate()
    {        
        FnGetDateStore();
        var answer = confirm ("Are You Sure You Want To Change The Expiry Date To "+document.getElementById('HiddenField_GetDateStore').value+"  ?");
        if (answer==true)
        {
            var answer1 = confirm ("Are You Really Sure You Want To Change The Expiry Date To "+document.getElementById('HiddenField_GetDateStore').value+"  ?");
            if(answer1==true)
            {
                var answer2 = confirm ("Are You Really Sure You Want To Change The Expiry Date To "+document.getElementById('HiddenField_GetDateStore').value+"  ?");
                if(answer2==true)
                {
    ...
    function dateassign(s)
         {
             ...
             if(date1 != null) 
             {
              ...
              var prevdate2=parseInt(date1.getMonth()+1)+'-'+(date1.getDate())+'-'+ date1.getFullYear();
               ...
               DtFrom.SetDate(new Date(prevdate2));
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center;">
                    <strong><span style="color: #000099">Change In Expiry Date</span></strong>
                </td>
            </tr>
        </table>
                ...
                <td class="gridcellleft">
                    <table width="100%" style="border: solid 1px Black" border="0" cellpadding="0">
                        <tr>
                            ...
                            <td style="color: Red;">
                                Please Make Sure That Before running This Process you have finished Importing all
                                the files for this Date....
                                When changing for a Sepcific Asset, If you need to change expiry date of only one Specific
                                Expiry, always check the check-box <b>"Change Only Sepcific Expiry Date"</b>..
                                
                            </td>
                        </tr>
                        <tr>                            
                        <td style="color: Green;" colspan="2">&nbsp;If Required, After finishing with this routine users should generate <b>'Expiry Trades'</b> from OtherTask option to Settle the open positions.</td>
</tr>
                    </table>
                </td>
            </tr>
                ...
                <td class="gridcellleft">
                    <table border="10" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td class="gridcellleft" bgcolor="#b7ceec" id="Td_AllAssetCheck">
                                Of All Contracts with Expiry Date =
                            </td>
                             <td class="gridcellleft" bgcolor="#b7ceec" id="Td_SpecificAssetCheck">
                                Of All Contracts with Expiry Date >=
                            </td>
                            <td>
                            ...
                            <td>
                                <asp:CheckBox ID="ChkSpecificExpiry" runat="server" />
                                ChangeOnlySpecifcExpiryDate
                            </td>
