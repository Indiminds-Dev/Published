<%@ page language="C#" autoeventwireup="true" inherits="management_amc, App_Web_npkqnqtr" %>
...
function ShowHideFilter(obj)
{
    ...
    function OnContactInfoClick(keyValue,CompName)
    {
        ...
        parent.OnMoreInfoClick(url,"AMC Name : "+CompName+"",'940px','450px',"Y");
    } 
    ...
    function OnEmailClick()
    {
        ...
        else
        {
            ...
            <table class="TableMain100">
                ...
                <tr>
                    <td>
                        <dxwgv:ASPxGridView ID="amcGrid" runat="server" AutoGenerateColumns="False" ClientInstanceName="grid"
                            ...
                            <Columns>
                                <dxwgv:GridViewDataTextColumn Visible="False" ReadOnly="True" VisibleIndex="0" FieldName="amc_id">
                                    <EditFormSettings Visible="False"></EditFormSettings>
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="0" FieldName="amc_amcCode">
                                    <EditFormSettings Visible="False"></EditFormSettings>
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="0" FieldName="amc_nameOfMutualFund" Width="80%"
                                    Caption="AMCName">
                                ...
                                <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="1" FieldName="amc_sebiRegnNo"
                                ...
                                <dxwgv:GridViewDataDateColumn Visible="False" VisibleIndex="1" FieldName="amc_dateOfSetupOfMutualFund"
                                ...
                                <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="1" FieldName="amc_namesOfSponsors"
                                ...
                                <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="1" FieldName="amc_nameOfTrusteeCompany"
                                ...
                                <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="1" FieldName="amc_nameOfAMC"
                                    Caption="Name Of AMC">
                                    <EditFormSettings Visible="True"></EditFormSettings>
                                    <PropertiesTextEdit Width="300px">
                                        <ValidationSettings ErrorDisplayMode="ImageWithText" ErrorTextPosition="Bottom">
                                ...
                                <dxwgv:GridViewDataDateColumn Visible="False" VisibleIndex="1" FieldName="amc_dateOfIncoOfAMC"
                                ...
                                <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="1" FieldName="amc_nameOfDirectors"
                                ...
                                <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="1" FieldName="amc_nameOfHeadOfOperation"
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="Cont.Person" VisibleIndex="2">
                                    <DataItemTemplate>
                                        <a href="javascript:void(0);" onclick="OnContactInfoClick('<%# Container.KeyValue %>','<%#Eval("amc_nameOfMutualFund") %>')">
                                            Show</a>
                                    </DataItemTemplate>
                                    <CellStyle HorizontalAlign="Left" Wrap="False">
                                    </CellStyle>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 80%">
							                     ...
							                     <dxtc:TabPage Text="Adress">
                                                    <ContentCollection>
                                                    <dxw:ContentControl runat="server"> 
                                                                        <dxwgv:ASPxGridView runat="server" Width="100%" ID="AddressGrid" ClientInstanceName="Address"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <dxwgv:GridViewDataTextColumn Visible="False" ReadOnly="True" VisibleIndex="0" FieldName="add_cntId">
                                                                                </dxwgv:GridViewDataTextColumn>
                                                                                ...
                                                                                <dxwgv:GridViewDataComboBoxColumn FieldName="add_addressType" Caption="Type" VisibleIndex="0">
                                                                                    <PropertiesComboBox ValueType="System.String" EnableSynchronization="False" EnableIncrementalFiltering="True"
                                                                                        ...
                                                                                        <Items>
                                                                                            ...
                                                                                            <dxe:ListEditItem Text="Emergence" Value="Emergence">
                                                                                            </dxe:ListEditItem>
                                                                                            <dxe:ListEditItem Text="Correspondance" Value="Correspondance">
                                                                                            </dxe:ListEditItem>
                                                                                            <dxe:ListEditItem Text="Permanent" Value="Permanent">
                                                                                            </dxe:ListEditItem>
                                                                                            <dxe:ListEditItem Text="Contact Person" Value="Contact Person">
                                                                                            </dxe:ListEditItem>
                                                                                        </Items>
                                                                                    </PropertiesComboBox>
                                                                                ...
                                                                                <dxwgv:GridViewDataTextColumn VisibleIndex="7" FieldName="add_pin" Caption="Pin/Zip">
                                                                                    <PropertiesTextEdit Width="300px">
                                                                                ...
                                                                                <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="5" FieldName="add_activityId">
                                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                                </dxwgv:GridViewDataTextColumn>
                                                                                <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="5" FieldName="CreateDate">
                                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                                </dxwgv:GridViewDataTextColumn>
                                                                                <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="5" FieldName="CreateUser">
                                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                                </dxwgv:GridViewDataTextColumn>
                                                                                <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="5" FieldName="LastModifyDate">
                                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                                </dxwgv:GridViewDataTextColumn>
                                                                                <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="5" FieldName="LastModifyUser">
                                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                                </dxwgv:GridViewDataTextColumn>
                                      ...
                                      { %>
                                        ...
                                        <%} %>
                                                            ...
                                                            <dxtc:TabPage Text="Phone">
                                                                <ContentCollection>
                                                                    <dxw:ContentControl runat="server"> 
                                                                        <dxwgv:ASPxGridView runat="server" Width="100%" ID="phoneGrid" ClientInstanceName="PhoneFax"
                                                                            ...
                                                                            <Columns>
                                                                                <dxwgv:GridViewDataTextColumn Visible="False" ReadOnly="True" VisibleIndex="1" FieldName="phf_id">
                                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                                </dxwgv:GridViewDataTextColumn>
                                                                                <dxwgv:GridViewDataTextColumn Visible="False" ReadOnly="True" VisibleIndex="1" FieldName="phf_cntId">
                                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                                </dxwgv:GridViewDataTextColumn>
                                                                                <dxwgv:GridViewDataTextColumn Visible="False" ReadOnly="True" VisibleIndex="1" FieldName="phf_entity">
                                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                                </dxwgv:GridViewDataTextColumn>
         ...
         PhoneFax.GetEditor(&quot;phf_extension&quot;).SetVisible(true);
                                                    ...
                                                    <dxwgv:GridViewDataTextColumn FieldName="phf_areaCode" VisibleIndex="1" Visible="False">
                                                        ...
                                                        <EditFormCaptionStyle HorizontalAlign="Right" VerticalAlign="Top" Wrap="False">
                                                                                ...
                                                                                <dxwgv:GridViewDataTextColumn VisibleIndex="1" FieldName="phf_extension" Width="25%"
                                                                                    Caption="Extension">
                                                                                    <PropertiesTextEdit Width="300px">
                                                                                        <ValidationSettings SetFocusOnError="True" ErrorTextPosition="Bottom" ErrorDisplayMode="ImageWithText">
                                                                                ...
                                                                                <dxwgv:GridViewDataTextColumn VisibleIndex="2" FieldName="phf_phoneNumber" Width="25%"
                                                                                    Caption="Number">
                                                                                    <PropertiesTextEdit Width="300px">
                                                                                        <ValidationSettings SetFocusOnError="True" ErrorTextPosition="Bottom" ErrorDisplayMode="ImageWithText">
                                            ...
                                            <dxe:ASPxButton ID="ASPxButton2" runat="server" Text="ADD" ToolTip="Add New Data"   Height="18px" Width="88px"  AutoPostBack="False" >
                                                <clientsideevents click="function(s, e) {PhoneFax.AddNewRow();}" />
                                                            ...
                                                            <dxtc:TabPage Text="Email">
                                                                <ContentCollection>
                                                                    <dxw:ContentControl runat="server"> 
                                                                        <dxwgv:ASPxGridView runat="server" Width="100%" ID="emailGrid" ClientInstanceName="EmailAdd"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <dxwgv:GridViewDataTextColumn Visible="False" ReadOnly="True" VisibleIndex="0" FieldName="eml_entity">
                                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                                </dxwgv:GridViewDataTextColumn>
                                                                                <dxwgv:GridViewDataTextColumn Visible="False" ReadOnly="True" VisibleIndex="0" FieldName="eml_cntId">
                                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                                </dxwgv:GridViewDataTextColumn>
    ...
    else
    {
         ...
         EmailAdd.GetEditor(&quot;eml_website&quot;).SetVisible(false);
                                                                ...
                                                                <RequiredField ErrorText="Select Type" IsRequired="True" />
                                                                                ...
                                                                                </dxwgv:GridViewDataComboBoxColumn> <dxwgv:GridViewDataTextColumn FieldName="eml_email" Width="40%" Caption="Email" VisibleIndex="1">
<PropertiesTextEdit Width="300px">
<ValidationSettings ErrorDisplayMode="ImageWithText" ErrorTextPosition="Bottom" SetFocusOnError="True">
...
<EditFormCaptionStyle HorizontalAlign="Right" VerticalAlign="Top" Wrap="False"></EditFormCaptionStyle>
                                                                                ...
                                                                                <dxwgv:GridViewCommandColumn VisibleIndex="2">
                                                                                    ...
                                                                                    <%if (Session["PageAccess"].ToString().Trim() == "All" || Session["PageAccess"].ToString().Trim() == "Add" || Session["PageAccess"].ToString().Trim() == "DelAdd")
                                                                                   { %>
                                                                                        <a href="javascript:void(0);" onclick="EmailAdd.AddNewRow();"><span style="color: #000099;
                                                                                            text-decoration: underline">Add New</span> </a>
                                                                                              <%} %>
                                                                                    </HeaderTemplate>
                                                                                </dxwgv:GridViewCommandColumn>
            ...
            <asp:SqlDataSource ID="amc" runat="server" ConnectionString="<%$ ConnectionStrings:CRMConnectionString %>"
            ...
            <asp:SqlDataSource runat="server" ID="amcAddress" SelectCommand="select DISTINCT  tbl_master_address.add_id AS add_id,tbl_master_address.add_entity As add_entity,tbl_master_address.add_cntId As add_cntId, tbl_master_address.add_addressType AS add_addressType,
                        ...
                        from tbl_master_address where add_cntId=@amc_amcCode" OldValuesParameterFormatString="original_{0}"
                ...
                <InsertParameters>
                    <asp:SessionParameter SessionField="KeyVal_InternalID" Type="String" Name="amc_amcCode">
            ...
            <asp:SqlDataSource runat="server" ID="emcPhone" SelectCommand="SELECT * FROM [tbl_master_phonefax] where [phf_cntId]=@amc_amcCode"
                ...
                ConnectionString="<%$ ConnectionStrings:CRMConnectionString %>" UpdateCommand="UPDATE [tbl_master_phonefax] SET [phf_type] = @phf_type, [phf_countryCode] = @phf_countryCode, [phf_areaCode] = @phf_areaCode, [phf_phoneNumber] = @phf_phoneNumber, [phf_extension] = @phf_extension , [LastModifyDate]=getdate(),[LastModifyUser]=@CreateUserPhone WHERE [phf_id] = @original_phf_id">
                <InsertParameters>
                    <asp:SessionParameter SessionField="KeyVal_InternalID" Type="String" Name="amc_amcCode">
                    </asp:SessionParameter>
            ...
            <asp:SqlDataSource runat="server" ID="emcEmail" SelectCommand="SELECT * FROM [tbl_master_email] where [eml_cntId]=@amc_amcCode"
                ...
                ConnectionString="<%$ ConnectionStrings:CRMConnectionString%>" UpdateCommand="UPDATE [tbl_master_email] SET  [eml_type] = @eml_type, [eml_email] = @eml_email, [eml_ccEmail] = @eml_ccEmail ,[LastModifyDate]=getdate(),[LastModifyUser]=@CreateUserEmail WHERE [eml_id] = @original_eml_id">
                <InsertParameters>
                    <asp:SessionParameter SessionField="KeyVal_InternalID" Type="String" Name="amc_amcCode">
                    </asp:SessionParameter>
