<%@ page language="C#" autoeventwireup="true" inherits="Reports_GSTStatementDP, App_Web_pjhew0ax" %>
   ...
   { 
          $get('UpdateProgress1').style.display = 'none'; 
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 22px;">
                        <strong><span id="SpanHeader" style="color: #000099">GST Statement</span></strong>
                    </td>
            ...
            <table>
                <tr valign="top">
                    <td>
                        <table id="tabdisplay" border="10" cellpadding="0" cellspacing="0">
                            <tr valign="top">
                    ...
                    <td> <table id="showFilter" width="100%">
                                        <tr>
                                            <td style="vertical-align: top; height: 134px; text-align: right">
                                                <table cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td id="TdFilter" class="gridcellleft" style="vertical-align: top; height: 21px;
                                                            text-align: right">
