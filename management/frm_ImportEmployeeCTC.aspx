<%@ page language="C#" autoeventwireup="true" inherits="management_frm_ImportEmployeeCTC, App_Web_0jwcfgzk" %>
...
<body style="margin: 0px 0px 0px 0px; background-color:#DDECFE">
    ...
    <table class="TableMain100">
      <tr>
                            <td class="EHEADER">
                                <span style="color: blue"><strong>CTC IMPORT</strong></span></td>
                        </tr>
                        </table>
                        ...
                        <tr>
                            <td class="lt" >
                                <table class="width100per" cellspacing="12" cellpadding="0">
                                    ...
                                    <tr >
                                    <td  colspan="2">
                                    This Routine Imports Employee CTC with Details.Upload only CSV File.
                                    </td>
                                    </tr>
                                        <tr>
                                            <td align="right" style="width: 278px" colspan="2">
                                                <asp:FileUpload ID="NCDEXSelectFile" runat="server" Width="452px" Height="21px" />
                                            </td>
                                        </tr>
                                        <tr>
