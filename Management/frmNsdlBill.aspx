<%@ page language="C#" autoeventwireup="true" inherits="management_frmNsdlBill, App_Web_mzqu16me" %>
...
function ChargeBasketPopUp(obj)
    {
      var url='cdsl_NotAllocaed.aspx?dp=NSDL&value='+obj;
...
function generateBill()
    {
         ...
         { 
            var i=confirm("Do you want to Delete The Bill for '"+monthCombo.GetText()+"' ?");
            if(i)
            {
...
function showResult(s)
    {
     document.getElementById('Div1').style.display="none"; 
       if(s.substring(0,2)=='20')
         {
              if(confirm('Transactions on '+s.substring(2,s.length)+' are not imported.\nWant to proceed ?'))
              {
               document.getElementById('Div1').style.display="inline";
          ...
          if(s.substring(0,2)=='30')
                    {
                       if(confirm('ISIN Rates on '+s.substring(2,s.length)+' are not imported.\nWant to proceed ?'))
                            {
                              document.getElementById('Div1').style.display="inline";
                              cmb.PerformCallback(cmbBillType.GetValue());
        ...
        else if(s.substring(0,2)=='50')
        {
         ...
         else
            {
               ...
               <table class="TableMain100">
                 <tr>
                    <td align="right"  class="EHEADER" style="text-align: center;">
                        <span style="color: #3300cc"><strong>Billing</strong></span><br />
                    </td>
                </tr></table>
            <div id='Div1'  style='position: absolute; font-family: arial; font-size: 30; left: 40%;
                top: 40%; background-color: white;layer-background-color: white; height: 80;
                width: 150;'>
            ...
            <table width="600" style="border:solid 1px white;">
                ...
                <tr>
                    ...
                    <td align="left">
                        <dxe:ASPxDateEdit ID="txtbillDate" runat="server" ClientInstanceName="billdate" 
                ...
                <tr>
                    ...
                    <td align="left">
                        <dxe:ASPxComboBox ID="cmbMonth" ClientInstanceName="monthCombo" Width="150px" runat="server"
                            ValueType="System.String" Font-Bold="False"
                ...
                <tr>
                    ...
                    <td align="left">
                        <dxe:ASPxDateEdit ID="txtDueDate" runat="server" ClientInstanceName="periodDueDate"
                             Width="150px" EditFormat="Custom"
                            EditFormatString="dd-MM-yyyy" UseMaskBehavior="True" AllowNull="False" Height="25px">
                            <ButtonStyle Width="13px">
                            </ButtonStyle>
                        </dxe:ASPxDateEdit>
                    </td>
                    ...
                    <td align="left">
                        <dxe:ASPxComboBox runat="server" EnableSynchronization="False" EnableIncrementalFiltering="True"
                          ValueType="System.String" Width="150px"
                            ID="ddlBillOrder" ClientInstanceName="SlipClient" SelectedIndex="0">
                            <Items>
                ...
                <tr>
                    ...
                    <td align="left">
                        <dxe:ASPxComboBox runat="server" EnableSynchronization="False" EnableIncrementalFiltering="True"
                           ValueType="System.String" Width="150px"
                            ID="cmbBillType" ClientInstanceName="cmbBillType" SelectedIndex="0">
                            <Items>
	...
	generateBill();
                ...
                <tr style="visibility: hidden">
                    ...
                    <td align="left">
                        <dxe:ASPxComboBox ID="cmb" Width="160px" runat="server" Font-Size="10px" 
