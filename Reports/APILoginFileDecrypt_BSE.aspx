<%@ page language="C#" autoeventwireup="true" inherits="Reports_APILoginFileDecrypt_BSE, App_Web_w8tpuxyq" enableeventvalidation="false" %>
...
<head id="Head1">
    <title>Create API Login File Decrypt</title>
 ...
 <script language="javascript" type="text/javascript">
   ...
   {      
    ...
    {
        Show("divLoading");
        cLoginFileCreate.SetEnabled(false);
    ...
    {
        Hide("divLoading");
        cLoginFileCreate.SetEnabled(true);
        if(cGnrcCallBackPanel.cpIsSpData!=undefined)
        {
            if(cGnrcCallBackPanel.cpIsSpData=="LoginFile")
                GetObjectID('btnLoginFileCreate').click();
            else 
...
<body onload="myFocus()" style="margin: 0px 0px 0px 0px; background-color: #DDECFE">
   ...
   { 
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                        <strong><span id="SpanHeader" style="color: #000099">Create API Login File
                        </span></strong>
                    </td>
             ...
             <table>
                <tr>
                    ...
                    <td style="width: 210px; vertical-align: top">
                        ...
                        <asp:TextBox ID="txtPassword_hidden" runat="server" TextMode="password" Width="14px" Style="display: none"></asp:TextBox>
                    </td>
                    <td style="width: 2px;">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorPassword" runat="server" ControlToValidate="txtPassword"
                            ErrorMessage="Please Enter Password" ValidationGroup="a">*</asp:RequiredFieldValidator>
                    </td>
                 </tr>
              </table>
              <table>
                <tr>
                    ...
                    <td style="width: 210px; vertical-align: top">
                        <asp:TextBox ID="txtSecretKey" runat="server" Width="205px"></asp:TextBox>
                        <asp:TextBox ID="txtSecretKey_hidden" runat="server" Width="14px" Style="display: none"></asp:TextBox>
                    </td>
                    <td style="width: 2px;">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorSecretKey" runat="server" ControlToValidate="txtSecretKey"
                            ErrorMessage="Please Enter Secret Key" ValidationGroup="a">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <tr>
                <td id="Td_API">
                    <table>
                        <tr>
                            <td>
                                <dxe:ASPxButton ID="LoginCreate" runat="server" AutoPostBack="False" ClientInstanceName="cLoginFileCreate"
                                    Text="Generate Login File">
                                    <ClientSideEvents Click="function(s,e){GnrcCallBackPanel_Methods('LoginFile');}" />
                                </dxe:ASPxButton>
                            </td>
                        </tr>
                    </table>
        ...
        <div style="display: none">
            <asp:Button ID="btnLoginFileCreate" runat="server" BackColor="#DDECFE" BorderStyle="None"
                OnClick="btnLoginFileCreate_Click" />
        </div>
    </form>
</body>
</html>
