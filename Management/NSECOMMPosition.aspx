<%@ page language="C#" autoeventwireup="true" inherits="management_NSECOMMPosition, App_Web_leuczwkw" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>NSE-COMM Final-Settlement Trades</title>
                                                                            ...
                                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                                <ContentTemplate>
                                                                                    <asp:DropDownList ID="ddlFileList" runat="server" Width="210px" AutoPostBack="True"
                                                                                        ...
                                                                                        <asp:ListItem Value="1">NSECOMM_POSITION File</asp:ListItem>	
                                                                                    </asp:DropDownList><br />
