<%@ page language="C#" autoeventwireup="true" inherits="Reports_AcrossSegmentCOMMCDXFORiskAnalysis, App_Web_pjhew0ax" %>
...
<head>
    <title>Across Segment COMM/CDX/FO Risk Analysis</title>
                ...
                <div id="divPageFilter" style="width: 995px">
                    ...
                    <div id="dvMainFilter" class="frmContent" style="width: 528px">
                        ...
                        <div id="forSegment" class="Row">
                            ...
                            <div id="divSegment" class="frmleftContent" style="width: 125px; padding-top: 3px;
                                font-size: 12px;">
