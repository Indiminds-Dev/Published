<%@ page language="C#" autoeventwireup="true" inherits="Management_NCL_UnpaidMTFRequest, App_Web_bfdn6hbr" %>
...
<head id="Head1" runat="server">
    <title>Create Batch For Reporting Transfer of Client Payout To CUSPA Account</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Batch For Reporting Transfer of Client Payout To CUSPA Account</span></strong></td>
