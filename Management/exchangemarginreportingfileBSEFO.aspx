<%@ page language="C#" autoeventwireup="true" inherits="management_exchangemarginreportingfileBSEFO, App_Web_ng-agpzn" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
 						 ...
 						 <asp:TemplateField HeaderText="Initial Margin">
                                    ...
                                    <asp:TemplateField HeaderText="Sort (%)" SortExpression="sortpercent">
                                        <ItemStyle BorderWidth="1px" Wrap="False" HorizontalAlign="right"></ItemStyle>
                                        <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                        <ItemTemplate>
