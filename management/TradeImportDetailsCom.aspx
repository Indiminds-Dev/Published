<%@ page language="C#" autoeventwireup="true" inherits="management_Exch_Product_Details, App_Web_0jwcfgzk" %>
        ...
        <table  id="tblShowDt" runat="server" width="100%">
            <tr>
               <td class="EHEADER"  style="text-align: center;">
                <strong><span style="color: #000099">Trade Import Details For Commodity/Currency</span></strong></td>
            </tr>
...
<TR><TD><asp:CheckBoxList runat="server" RepeatDirection="Horizontal" RepeatColumns="15" Font-Size="X-Small" Font-Names="Arial Narrow" ID="chkUcc"></asp:CheckBoxList>
...
</TBODY></TABLE></TD><TD style="HEIGHT: 22px"><asp:Button runat="server" ID="btnCust" CssClass="btn" Text="Update" OnClick="btnCust_Click"></asp:Button>
 </TD></TR></TBODY></TABLE></TD>
</TR><TR><TD><asp:Button runat="server" ID="btnUccRemove" CssClass="btn" Text="Remove" OnClick="btnUccRemove_Click"></asp:Button>
 ...
 <td>
  <asp:GridView ID="gridCheque" runat="server" Width="100%" ShowFooter="True" AllowSorting="True" OnPageIndexChanging="gridCheque_PageIndexChanging"
                                                        ...
                                                        DataMember="ComExchangeTrades_CustomerUcc" GridLines="None" Font-Size="Smaller" AllowPaging="True">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Ucc">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCashBankDetailID" runat="server" Text='<%# Eval("ComExchangeTrades_CustomerUcc")%>'></asp:Label>
                                                                </ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Client Name">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblMainAccount" runat="server" Text='<%# Eval("ClientName") %>'
