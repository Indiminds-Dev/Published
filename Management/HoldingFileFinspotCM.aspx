<%@ page language="C#" autoeventwireup="true" inherits="management_HoldingFileFinspotCM, App_Web_i8xxwgwk" %>
...
<head id="Head1" runat="server">
    <title>Holding(ISIN) File For FinSpot</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Holding(ISIN) File For FinSpot</span></strong></td>
