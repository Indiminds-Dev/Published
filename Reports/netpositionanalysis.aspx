<%@ page language="C#" autoeventwireup="true" inherits="Reports_netpositionanalysis, App_Web_pjhew0ax" %>
...
<head id="Head1">
    <title>Daily MTM/Premium Statement</title>
            ...
            <tr valign="top">
                <td>
                    <table>
                       ...
                       <tr><td class="gridcellleft"><table border="10" cellpadding="1" cellspacing="1"> <tr>
                            <td class="gridcellleft" bgcolor="#B7CEEC">
                                Segment :</td>
                            <td>
