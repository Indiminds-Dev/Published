<%@ page language="C#" enableeventvalidation="false" autoeventwireup="true" inherits="Reports_RMSFeeReports, App_Web_arnfzykg" %>
...
<head id="Head1">
    ...
    iframe#IFRAME_ForAllPages { width:100%!important}
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">RMS Fee Reports</span></strong></td>
                ...
                <td>
                    <table>
                        <tr>
                          ...
                          <tr>
                            <td class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1" style="display:none;">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Calculation Type :</td> 
                                        <td>
                                            <asp:DropDownList ID="DLLCalculation" runat="server" Width="220px" Font-Size="10px"  AutoPostBack="true" OnSelectedIndexChanged="DLLCalculation_SelectedIndexChanged">
                                    ...
                                    <tr>
                                        ...
                                        <div style="display:none;">
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="DLLReportView" runat="server" Width="220px" Font-Size="10px"
                                             ...
                                             <asp:DropDownList ID="ddlReportType" runat="server" Width="220px" Font-Size="10px">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlGeneration" runat="server" Width="210px" Font-Size="10px"
                                                ...
                                                <asp:ListItem Value="2">Export Excel</asp:ListItem>
                                                <asp:ListItem Value="3">Export PDF</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                </table>
                                        ...
                                        <td id="td_Screen">
                                         ...
                                         <td id="td_PDF">
                                              <asp:Button ID="btnPDF" runat="server" CssClass="btnUpdate" Height="20px" Text="Export To PDF"
                                                                Width="101px"  OnClientClick="selecttion()" 
                                                  onclick="btnPDF_Click" /></td>                       
