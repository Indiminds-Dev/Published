<%@ page language="C#" autoeventwireup="true" inherits="management_frm_ExportNsdlMarginPledge, App_Web_-k9nslwd" %>
...
//            trNsdlTransType.style.display='none';
            ...
            //End of New Work
            //New Work 27/10/2024
            trBtnExport.style.display='none';
            //End of New Work 27/10/2024
            HideTrTd(trVersion);
        ...
        function keyVal(obj) {   
//            New Work 27/10/2024
//            if (document.getElementById('<%=ddlTrans.ClientID %>').value == '1' || document.getElementById('<%=ddlTrans.ClientID %>').value == '2'  || document.getElementById('<%=ddlTrans.ClientID %>').value == '3' || document.getElementById('<%=ddlTrans.ClientID %>').value == '4' || document.getElementById('<%=ddlTrans.ClientID %>').value == '5' || document.getElementById('<%=ddlTrans.ClientID %>').value == '6') {
            if (document.getElementById('<%=ddlTrans.ClientID %>').value == '1' || document.getElementById('<%=ddlTrans.ClientID %>').value == '3' || document.getElementById('<%=ddlTrans.ClientID %>').value == '6') {
//            End of New Work 27/10/2024
...
//            End of New Work 27/10/2024            
            else if (document.getElementById('<%=ddlTrans.ClientID %>').value == '2'  || document.getElementById('<%=ddlTrans.ClientID %>').value == '4' || document.getElementById('<%=ddlTrans.ClientID %>').value == '5') {
                trEDIS.style.display = 'inline';
                trBtn.style.display = 'none';
                trBtnExport.style.display = 'inline';
            }
//            End of New Work 27/10/2024
            else {
                trEDIS.style.display = 'none';
                ...
                //New Work
                //if (document.getElementById('<%=ddlTrans.ClientID %>').value == '8')
                ...
                //New Work
                //else if (document.getElementById('<%=ddlTrans.ClientID %>').value == '9')
        ...
        function AssignHidType()
        {
            ...
            //New Work
            //if (document.getElementById('<%=ddlTrans.ClientID %>').value=='8') // Normal
            ...
            //New Work
            //else if (document.getElementById('<%=ddlTrans.ClientID %>').value=='9') // POA
...
//            trBatch.style.display='none';
            ...
            //New Work
            //if (document.getElementById('<%=ddlTrans.ClientID %>').value=='9')
            if (document.getElementById('<%=ddlTrans.ClientID %>').value=='2')
            //End of New Work
            {
               // POA Transaction
        ...
        <div>
            ...
            <table class="TableMain100" border="1">
                ...
                <tr>
                    ...
                    <td align="left" style="vertical-align: top" width="28%">
                                    <asp:DropDownList ID="ddlTrans" runat="server" AutoPostBack="false" onchange="OnSelectedValueChanged1();">
                                        <asp:ListItem Text="POA/DDPI Margin Transfers [SpeedE]" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="POA/DDPI Margin Transfers [eDPM]" Value="2"></asp:ListItem>
                                        <asp:ListItem Text="POA Margin Transfers [Easiest]" Value="3"></asp:ListItem>
                                        <asp:ListItem Text="Repledge Transactions [eDPM]" Value="4"></asp:ListItem>
                                        <asp:ListItem Text="Pledge Closure Transactions [eDPM]" Value="5"></asp:ListItem>
                                        <asp:ListItem Text="Request RePledge Release From CC  [NCL]" Value="6"></asp:ListItem>
                                        <asp:ListItem Text="Pledge Closure Transactions [SpeedE]" Value="7"></asp:ListItem>
                                    </asp:DropDownList></td>
                    <%--New Work--%>
                ...
                <tr id="trAcc">
                    ...
                    <td align="left" width="28%" style="vertical-align: top">
                        <asp:TextBox ID="txtAccName" runat="server" TabIndex="0" Width="329px"
                            onkeyup="CallAjax(this,'MarginPledge_DPID_ClientId_CMBPID',event);"></asp:TextBox>
                ...
                <tr id="trDate">
                    ...
                    <td align="left" style="width: 597px">
                ...
                <tr id="trBtnExport">
                    <td colspan="4" align="left">
                        <asp:Button ID="btnExport1" CssClass="btnUpdate" runat="server" Text="Export" OnClientClick="return CheckTypes1();"
