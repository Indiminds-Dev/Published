<%@ page language="C#" autoeventwireup="true" inherits="Reports_inpersonverificationdetail, App_Web_c6bgvp9x" enableeventvalidation="false" %>
                                        ...
                                        <td>
                                            <dxwgv:ASPxGridView ID="gridContract" ClientInstanceName="grid" Width="100%" 
                                                ...
                                                <dxwgv:GridViewDataTextColumn VisibleIndex="1"  Visible="false" FieldName="CustomerID" Caption="CustomerID">
                                                    ...
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="6" FieldName="VerificationRemarks" Caption="Remarks">
                                                        <CellStyle Wrap="True" CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="6" FieldName="VerificationDate" Caption="Verification Date">
                                                        <CellStyle Wrap="True" CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn VisibleIndex="6" FieldName="VerificationName" Caption="Verification By">
                                                        <CellStyle Wrap="True" CssClass="gridcellleft">
                                                        </CellStyle>
                                                        <EditFormSettings Visible="False"></EditFormSettings>
                                                    </dxwgv:GridViewDataTextColumn>
