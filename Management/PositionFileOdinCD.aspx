<%@ page language="C#" autoeventwireup="true" inherits="Reports_PositionFileOdinCD, App_Web_gywepxwc" %>
...
<head id="Head1" runat="server">
    <title>Manual Position File For Odin</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Manual Position File For Odin</span></strong></td>
