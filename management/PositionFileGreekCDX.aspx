<%@ page language="C#" autoeventwireup="true" inherits="Reports_PositionFileGreekCDX, App_Web_x5xbqja1" %>
...
<head id="Head1" runat="server">
    <title>Position File For Greek</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Position File For Greek</span></strong></td>
