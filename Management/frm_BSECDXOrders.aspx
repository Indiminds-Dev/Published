<%@ page language="C#" autoeventwireup="true" inherits="management_frm_BSECDXOrders, App_Web_jdrimxnc" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>BSE-CD Order Logs</title>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports BSE-CDX Order Logs [BFX_ORD_memCode_YYYYMMDD.CSV]
                        </h5>
                    </td>
                </tr>
