<%@ page language="C#" autoeventwireup="true" inherits="management_FundManager_Correspondence, App_Web_im-ehkhh" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE">
    <form id="form1" runat="server">
        <div>
            <table class="TableMain100">
                <tr>
                    <td>
                        <dxtc:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="1" Width="100%"
                                          ...
                                          <dxtc:ASPxPageControl ID="ASPxPageControl2" runat="server" ActiveTabIndex="0" ClientInstanceName="page">
                                            ...
                                            <dxwgv:ASPxGridView ID="AddressGrid" runat="server" DataSourceID="Address" ClientInstanceName="gridAddress"
                                                ...
                                                <Columns>
                                                    ...
                                                    <dxwgv:GridViewDataComboBoxColumn Caption="Address Type" FieldName="Type" Visible="False"
                                                        ...
                                                        <PropertiesComboBox ValueType="System.String">
                                                            <Items>
                                                                ...
                                                                <dxe:ListEditItem Value="Registered" Text="Registered">
                                                                </dxe:ListEditItem>
                                                    ...
                                                    <dxwgv:GridViewDataComboBoxColumn Caption="City" FieldName="City" VisibleIndex="0"
                                                        Visible="False">
                                                    ...
                                                    <dxwgv:GridViewDataComboBoxColumn Caption="Area" FieldName="area" VisibleIndex="8">
    ...
    else
    {
         ...
         gridPhone.GetEditor(&quot;phf_SMSFacility&quot;).SetVisible(false);
                                                    ...
                                                    <dxwgv:GridViewDataCheckColumn Caption="Registered For SMS Service" FieldName="phf_SMSFacility"
                            ...
                            <dxwgv:ASPxGridViewTemplateReplacement runat="server" ReplacementType="EditFormEditors" ColumnID="" ID="Editors">
                                            ...
                                            <dxwgv:ASPxGridView ID="EmailGrid" runat="server" ClientInstanceName="gridEmail"
                                                ...
                                                Font-Size="10px" OnRowValidating="EmailGrid_RowValidating">
                                                <Columns>
