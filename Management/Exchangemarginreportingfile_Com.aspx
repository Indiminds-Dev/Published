<%@ page language="C#" autoeventwireup="true" inherits="management_exchangemarginreportingfile, App_Web_vvdfezxa" %>
...
<head runat="server">
 <title>Exchange Margin Reporting Files For Commodity / Currency</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center;" colspan="2">
                    <strong><span style="color: #000099">Exchange Margin Reporting Files For Commodity / Currency</span></strong>
                </td>
                ...
                <td>
                    <table  border="10" cellpadding="1" cellspacing="1">
                        <tr id="tr_UnApprovedShares">
                            <td class="gridcellleft" bgcolor="#B7CEEC">
                                <asp:CheckBox ID="chkUnApprovedShares" runat="server" onclick="fnchkUnApprovedShares(this)" Checked="True" />
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
 						 ...
 						 <asp:TemplateField HeaderText="Peak Margin">
                                    ...
                                    <asp:TemplateField HeaderText="Peak Deposits">
                                        <ItemStyle BorderWidth="1px" Wrap="False" HorizontalAlign="right"></ItemStyle>
                                        <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                        <ItemTemplate>
                                            <asp:Label ID="lblpeakeffective" runat="server" Text='<%# Eval("peakeffective")%>' CssClass="gridstyleheight1"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Peak Excess Shortage" SortExpression="peakexcessshortage">
                                        <ItemStyle BorderWidth="1px" Wrap="False" HorizontalAlign="right"></ItemStyle>
                                        <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Short (%)" SortExpression="sortpercent">
                                        <ItemStyle BorderWidth="1px" Wrap="False" HorizontalAlign="right"></ItemStyle>
                                        <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                        <ItemTemplate>
