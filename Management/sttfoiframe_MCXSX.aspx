<%@ page language="C#" autoeventwireup="true" inherits="management_sttfoiframe_MCXSX, App_Web_6yanuau_" %>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports MCX-SX-EDS_STT_TM/CMID_YYYYMMDD.csv Available through FTP's MEMBER Folder
                        </h5>
                    </td>
                </tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="gridcellleft">
                                            <span style="color: #000099; text-align: right">CM/TM's STT File</span></td>
