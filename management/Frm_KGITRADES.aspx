<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_KGITRADES, App_Web_d3reltht" %>
                                        ...
                                        <td style="width: 100px">
                                            <dxe:ASPxComboBox ID="ComboChooseFile" runat="server" ClientInstanceName="cComboChooseFile"
                                                ...
                                                <Items>
                                                    ...
                                                    <dxe:ListEditItem Value="1" Text="Trades - AOne"></dxe:ListEditItem>
                                                    <dxe:ListEditItem Value="2" Text="Opening Trades - Position File"></dxe:ListEditItem>
                                                </Items>
