<%@ page language="C#" autoeventwireup="true" inherits="management_export_routine, App_Web_yxggcryg" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <table border="1">
            ...
            <tr>
                <td align="left" style="vertical-align: top; width: 20%; height: 11px; background-color: #b7ceec; text-align: left;" valign="top">
                    Transaction Type</td>
            ...
            <tr>
                <td align="left" style="height: 17px; vertical-align: top; width: 20%; background-color: #b7ceec; text-align: left;" valign="top">
                    Transaction Date</td>
            ...
            <tr>
                <td align="left" style="vertical-align: top; width: 20%; height: 17px; background-color: #b7ceec; text-align: left;">
                    Batch No.</td>
                <td  valign="top" style="text-align: left">
