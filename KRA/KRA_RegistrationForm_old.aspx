<%@ page language="C#" autoeventwireup="true" inherits="KRA_Pages_RegistrationForm, App_Web_g3gsjpud" %>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function AddressValidatnIndividual() {
            if (DevE_Control_Empty(cTxtAddress1, "Please Enter The Correspondence Address"))
                ...
                if (cComboCrpndsAdrs.GetText() != 'Select' && CompareDate_TrueFalse(ToDateMinThreeMnth, ValidDt, "LT")) {
                            ...
                            <PanelCollection>
                                <dxp:PanelContent runat="server">
                                 ...
                                 <div id="Row0_Col3" class="LFloat_Row DivName">
                                    ...
                                    <div id="RowMaiden" class="Row" style="display: none;" runat="server">
