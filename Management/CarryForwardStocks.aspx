<%@ page language="C#" autoeventwireup="true" inherits="management_CarryForwardStocks, App_Web_yq8u0p-o" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Carry Forward of Stocks</title>
   ...
   { 
        ...
        <table><tr><td class="gridcellleft"> <table border="10" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlType" runat="server" Width="150px" Font-Size="10px" onchange="FnDdlType(this.value)">
            ...
            <tr id="Tr_Client">
                ...
                <td>
                    <asp:TextBox ID="txtClient" runat="server" Width="200px" Font-Size="10px" onkeyup="ajax_showOptions(this,'ShowClientFORMarginStocks',event,'ProClients')"></asp:TextBox></td>
            ...
            <tr><td colspan="2" style="display:none;">  <asp:TextBox ID="txtClient_hidden" runat="server" Width="5px" ></asp:TextBox></td></tr>
        </table></td></tr></table>
