<%@ page language="C#" autoeventwireup="true" inherits="management_frm_SalesVisitActivityWithIframe, App_Web_akbpwr7y" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        {   
            ...
            parent.OnMoreInfoClick("frmOfferedProduct_New.aspx","ADD PRODUCT","950px","500px","N");
        ...
        function funAddLead()
          { 
            ...
            {   
                ...
                parent.OnMoreInfoClick("Add_LeadNew.aspx?Call=PhoneCall&user="+val123,"ADD LEAD","950px","500px","Y");
            }
          }
...
//            frmOpenNewWindow1('frmAllot_sales.aspx?id=' + st.value ,500,500)
            ...
            parent.OnMoreInfoClick("frmAllot_new.aspx?Calling=SalesVisit&id=" + st.value,"Allotment","950px","500px","Y");
        }
        function windowopenform1()
        {
            ReturnAccording="Allot";
            var st = document.getElementById("txtLeadId")
            parent.OnMoreInfoClick("frmAllot_sales_new.aspx?Calling=SalesVisit&id=" + st.value,"Allotment","950px","500px","Y");
            
        }
        function CallingExport()
        {
            parent.OnMoreInfoClick("frmmessage_history.aspx","Export Files","950px","500px","N");
        }
   ...
   function UserList()
       {
          ...
          parent.OnMoreInfoClick("UserList.aspx","ADD USER","950px","500px","N");
       }
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnReallocateSalesVisit" runat="server" Text="Alloted Sales Visit"
                                    CssClass="btnUpdate" OnClick="btnReallocateSalesVisit_Click" Height="21px" />
                            </td>
                            <td>
                                <asp:Button ID="btnGenratedSales" runat="server" Text="Generated Sales" CssClass="btnUpdate"
                                    Height="21px" OnClick="btnGenratedSales_Click" />
                            </td>
                            <td>
                                <asp:Button ID="btnReAssign1" runat="server" Text="Reassign Sales Visit" CssClass="btnUpdate"
                                    Height="21px" Visible="False" />
                            </td>
                            <td>
                                <asp:Button ID="btnMainCancel" runat="server" Text="Cancel" CssClass="btnUpdate"
                                    Visible="False" OnClick="btnMainCancel_Click" Height="21px" />
                            </td>
                        </tr>
                    </table>
                </td>
                            ...
                            <tr>
                                ...
                                <td class="mylabel1">
                                    <table>
                                        <tr>
                                            <td>
                                                <input type="button" value="Add Lead" onclick="funAddLead()" id="Button1" class="btnUpdate"
                                                    style="height: 21px" /></td>
                                            <td>
                                                <input type="button" id="btnAddDocument" name="btnAddDocument" class="btnUpdate"
                                    ...
                                    <tr id="Td1" runat="Server" visible="False">
                                        <td colspan="6">
                                            <input type="button" id="Button2" name="btnAllot" value="Allot" onclick="windowopenform1()"
                                                class="btnUpdate" style="height: 21px" />
                                            <asp:Button ID="Button3" runat="server" Text="Cancel" CssClass="btnUpdate" OnClick="btnCancelGenratedSalesVisit_Click"
                                                Height="21px" />
                                        </td>
                                    </tr>
                                </table>
