<%@ page language="C#" autoeventwireup="true" inherits="management_RMSFeeAdd, App_Web_d1rqvttb" %>
                                ...
                                <td style="text-align: center">
                                    <table style="border: solid 1px blue; width: auto">
                                       ...
                                       <%-- ---------------------------%>
                                        ...
                                        <td class="Ecoheadtxt" style="text-align: left;">
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left;">
                                               <%-- <dxe:ASPxComboBox runat="server" Width="100px" ID="ddltaxapp" DropDownStyle="DropDown"
                                                  ...
                                                  <asp:DropDownList runat="server" Width="129px" ID="ddltaxapp">
                                         ...
                                         <td runat="server" id="Td17" style="text-align: left" class="Ecoheadtxt">
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Date:" ID="ASPxLabel6" Height="16px">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left;" class="Ecoheadtxt">
                                        ...
                                        <tr>
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Slab:" ID="ASPxLabel3">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left" class="Ecoheadtxt">
                                                <dxe:ASPxTextBox runat="server" ID="txtSlab" onkeypress="return noNumbers(event)"
                                                    Width="130px">
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Amount:" ID="ASPxLabel5">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left" class="Ecoheadtxt">
                                                <dxe:ASPxTextBox runat="server" ID="txtAmount" onkeypress="return noNumbers(event)"
                                                    Width="130px">
                                                   <%-- <MaskSettings Mask="&lt;0..99g&gt;.&lt;00..999999&gt;" />--%>
                                                    <MaskSettings Mask="<0..999999g>.<00..999999>" />
                                                    <ValidationSettings ErrorDisplayMode="None">
                                                    </ValidationSettings>
                                                </dxe:ASPxTextBox>
                                            </td>
                                            ...
                                            <td style="text-align: left; display:none;" class="Ecoheadtxt">
