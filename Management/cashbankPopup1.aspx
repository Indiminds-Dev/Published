<%@ page language="C#" autoeventwireup="true" enableeventvalidation="true" inherits="management_cashbankPopup1, App_Web_wqpzjxym" %>
...
<body>
                                        ...
                                        <table style="width: 100%; background-color: #ddecfe; border-top-width: thin; border-left-width: thin;
                                            ...
                                            <tr id="">
                                                <td style="text-align: left;">
                                                    Type :</td>
                                                <td style="text-align: left;">
                                                    <asp:DropDownList ID="cmbType" runat="server" Width="100px" Font-Size="10px" AutoPostBack="True" OnSelectedIndexChanged="cmbType_SelectedIndexChanged1">
                                                ...
                                                <td style="text-align: left;">
                                                    <dxe:ASPxDateEdit ID="dteDate" runat="server" EditFormat="Custom" 
                                                        EditFormatString="dd MMMM yyyy" UseMaskBehavior="True" Font-Size="10px" Width="100px" CssFilePath="~/App_Themes/Office2003 Blue/{0}/styles.css" CssPostfix="Office2003_Blue" ImageFolder="~/App_Themes/Office2003 Blue/{0}/">
                                                ...
                                                <td style="text-align: left;">
                                                    Company :</td>
                                                <td style="text-align: left;">
                                                    <asp:DropDownList ID="cmbCompany" runat="server" DataSourceID="dsCompany" DataTextField="CashBank_CompanyName" DataValueField="CashBank_CompanyID" Width="200px" Font-Size="10px" AutoPostBack="True" OnSelectedIndexChanged="cmbCompany_SelectedIndexChanged">
                                                    </asp:DropDownList>   
                                                </td>                                    
                                                <td style="text-align: left;">
                                                    Segment :
                                                ...
                                                <td style="text-align: left;">
                                                    <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                                                        <contenttemplate>
                                                            <asp:DropDownList id="cmbSegment" runat="server" Width="100px" Font-Size="10px">
                                                            </asp:DropDownList> 
                                                        </contenttemplate>
                                                        <triggers>
                                            ...
                                            <tr id="trBankCashType">
                                                ...
                                                <td style="text-align: left;" id="tdBankCashType1">
                                                    <asp:TextBox ID="txtVoucherNo" runat="server" Font-Size="10px" ReadOnly="true" Width="97px"></asp:TextBox>
                                                </td>
                                                <td style="text-align: left;" id="tdBankAccountNo">
                                                    Branch :
                                                </td>
                                                <td style="text-align: left;" id="tdBankAccountNo1">
                                                    <asp:DropDownList ID="cmbBranch" runat="server" DataSourceID="dsBranch" DataTextField="BANKBRANCH_NAME" DataValueField="BANKBRANCH_ID" Width="100px" Font-Size="10px">
                                                    </asp:DropDownList>
                                                </td>
                                                ...
                                                <td style="text-align: left;" id="tdcb1">
                                                    <asp:DropDownList ID="cmbCashBankAc" runat="server" DataSourceID="MainAccount" DataTextField="MainAccount_Name" DataValueField="CashBank_MainAccountID" Width="200px" Font-Size="10px">
                                                    </asp:DropDownList>
                                                </td>
                                                ...
                                                <td style="text-align: left;">
                                                    <asp:TextBox ID="txtSettlementNo" runat="server" Width="100px" Font-Size="10px"></asp:TextBox>
                                            ...
                                            <tr id="tr6" style="background-color: #ddecfe;" align="center">
                                                ...
                                                <td style="text-align: left;">
                                                    Curr. Bank Balan. :</td>
                                                <td style="text-align: left;">
                                                    <asp:Label ID="ASPxLabel4" runat="server" Font-Size="10px" Width="100px"></asp:Label>
                                                </td>
                                                <td style="text-align: left;" id="td13">
                                                    Curr. A/C Balan.:
                                                </td>
                                                <td style="text-align: left;" id="td14">
                                                    <asp:Label ID="ASPxLabel5" runat="server" Font-Size="10px" Width="100px"></asp:Label>
                                                </td>
                                            </tr>
                                ...
                                <tr style="background-color: #a4c6f8">
                                    <td>
                                        <table style="width: 100%; border-top-width: thin; border-left-width: thin;" border="0" id="Table1"
                                            cellspacing="0">
                                            <tr>
                                                <td style="text-align: left;" id="tdmain">
                                                    Main A/C
                                                </td>
                                                <td style="text-align: left; display:none" id="tdmain1">
                                                    Cash/Bank A/C
                                                </td>
                                                <td style="text-align: left;">
                                                    <asp:UpdatePanel id="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                        <contenttemplate>
                                                            <asp:DropDownList ID="cmbMainAc" runat="server" AutoPostBack="True" Width="200px" Font-Size="10px" OnSelectedIndexChanged="cmbMainAc_SelectedIndexChanged">
                                                            </asp:DropDownList>
                                                        </contenttemplate>
                                                        <triggers>
                                                ...
                                                <td style="text-align: left;">
                                                    <asp:UpdatePanel id="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                        <contenttemplate>
                                                            <asp:DropDownList id="cmbSubAc" runat="server" Width="200px" Font-Size="10px">
                                                            </asp:DropDownList>
                                                        </contenttemplate>
                                                        <triggers>
                                                ...
                                                <td style="text-align: left;">
                                                    <asp:DropDownList ID="cmbInstType" runat="server" Width="200px" Font-Size="10px">
                                            ...
                                            <tr>
                                                <td style="text-align: left;" id="tddate">
                                                    Date
                                                </td>
                                                <td style="text-align: left; display:none" id="tddate1">
                                                    Withdrawl
                                                </td>
                                                <td style="text-align: left;">
                                                     <dxe:ASPxDateEdit ID="dtDateWith" runat="server" EditFormat="Custom" 
                                                        EditFormatString="dd MMMM yyyy" UseMaskBehavior="True" Font-Size="10px" Width="200px" CssFilePath="~/App_Themes/Office2003 Blue/{0}/styles.css" CssPostfix="Office2003_Blue" ImageFolder="~/App_Themes/Office2003 Blue/{0}/">
                                                        <ButtonStyle Width="13px">
                                                        </ButtonStyle>
                                                    </dxe:ASPxDateEdit>     
                                                    
                                                </td>
                                                <td style="text-align: left;" id="tdpayee">
                                                    Payee
                                                </td>
                                                <td style="text-align: left; display:none;" id="tdpayee1">
                                                    Deposit
                                                </td>
                                                <td style="text-align: left;">
                                                    <asp:DropDownList ID="cmbPayee" runat="server" Width="200px" Font-Size="10px">
                                                ...
                                                <td style="text-align: left;">
                                                    <asp:TextBox ID="txtInstNo" runat="server" Width="197px" Font-Size="10px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: left;">
                                                ...
                                                <td style="text-align: left;">
                                                    <asp:TextBox ID="txtPayment" runat="server" Width="197px" Font-Size="10px" onkeyup="testDetails();" onkeypress="return AllowNumericOnly(this);"></asp:TextBox>
                                                </td>
                                                <td style="text-align: left;">
                                                    Receipt
                                                </td>
                                                <td style="text-align: left;">
                                                    <asp:TextBox ID="txtReceipt" runat="server" Width="197px" Font-Size="10px" onkeyup="testDetails1();" onkeypress="return AllowNumericOnly(this);"></asp:TextBox>
                                                </td>
                                                <td style="text-align: left;">
                                                    Line Narration:
                                                </td>
    ...
    <asp:SqlDataSource ID="dsCompany" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
        SelectCommand="SELECT COMP.CMP_INTERNALID AS CashBank_CompanyID , COMP.CMP_NAME AS CashBank_CompanyName  FROM TBL_MASTER_COMPANY AS COMP">
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dsBranch" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
        SelectCommand="SELECT BRANCH_id AS BANKBRANCH_ID , BRANCH_DESCRIPTION AS BANKBRANCH_NAME  FROM TBL_MASTER_BRANCH">
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="MainAccount" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
        SelectCommand="Select MainAccount_ReferenceID as CashBank_MainAccountID, MainAccount_Name as MainAccount_Name from Master_MainAccount where MainAccount_BankCashType='Bank' or MainAccount_BankCashType='Cash'">
    </asp:SqlDataSource>
