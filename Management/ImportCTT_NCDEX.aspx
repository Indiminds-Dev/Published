<%@ page language="C#" autoeventwireup="true" inherits="management_ImportCTT_NCDEX, App_Web_amufh4kc" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>NCDEX CTT Files</title>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports NCDEX_CTT01/02_MEMCODE_DDMMYYYY.CSV Available through FTP's MEMBER Folder
                        </h5>
                    </td>
                </tr>
