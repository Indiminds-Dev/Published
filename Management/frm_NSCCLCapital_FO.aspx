<%@ page language="C#" autoeventwireup="true" inherits="management_frm_NSCCLCapital_FO, App_Web_bfdn6hbr" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>NSCCL's Statement Of Capital & Collateral Breakup [F_CL01]</title>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports NSCCL's Statement of Capital and Collateral Breakup
                        </h5>
                    </td>
                </tr>
