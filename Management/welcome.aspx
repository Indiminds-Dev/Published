<%@ page language="C#" autoeventwireup="true" inherits="management_welcome, App_Web_mzqu16me" %>
...
<head>
    ...
    if(document.body.scrollHeight>=1400)
        ...
        {
            window.frameElement.height = '1400px';
...
function OnGridEndCallback(s, e) {
    ...
    function selectsubject()
    {
     ...
     //parent.OnMoreInfoClick(url,"Record not available for  " ,'650px','500px',"Y");
...
function FunCallAjaxList(objID,objEvent,ObjType)
 ...
 function CallAjax(obj1,obj2,obj3)
     ...
     function ShowMissingData(obj)
    {
      ...
      //parent.OnMoreInfoClick(url,"Insert Reply  "  ,'450px','350px',"N");
...
//      parent.OnMoreInfoClick(url,"Change Status  "  ,'450px','350px',"N");
//    }
    ...
    <form id="form1" runat="server">
        <div>
            <table class="TableMain100">
                            ...
                            <tr>
                                <td style="vertical-align: top; text-align: left;">
                                    <div style="float: right; width: 3.5%">
                                        <asp:ImageButton OnClick="test_Click" ImageUrl="../images/refresh1.jpg" ID="test"
                                            runat="server" Width="40px" Height="40px" ToolTip="Refresh" />
                                    </div>
                                    <div style="border: 2px solid Gray; padding: 4px 2px 4px 2px; background-color: #eee;
                                        width: 95.5%">
                                                ...
                                                <asp:Panel ID="pnlForm" runat="server" Width="100%" BorderColor="blue" BorderWidth="1px"
                                                    ...
                                                    <table style="height: 9px">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="cmbTicker" runat="server" Width="50px" Font-Size="10px">
                ...
                <tr id="FormGridM">
                    <td>
                        <dxwgv:ASPxGridView ID="GridMessage" ClientInstanceName="gridM" runat="server" Width="100%"
