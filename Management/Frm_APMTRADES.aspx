<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_APMTRADES, App_Web_n3rnr3dz" %>
   ...
   <script language="javascript" type="text/javascript">
    ...
    function OnComboChooseFileIndexChange()
    {
        ...
        if(SelectedValue==0)
            ...
            Span_FileFormat.innerText="File Name : AOne CSV Files";
        else
            Span_FileFormat.innerText="File Name : fileName_ddMMyyyy.csv";
                                        ...
                                        <td style="width: 100px">
                                            <dxe:ASPxComboBox ID="ComboChooseFile" runat="server" ClientInstanceName="cComboChooseFile"
                                                ...
                                                <Items>
                                                    ...
                                                    <%--<dxe:ListEditItem Value="2" Text="AOne Trades"></dxe:ListEditItem>--%>
