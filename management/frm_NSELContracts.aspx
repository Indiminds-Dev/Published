<%@ page language="C#" autoeventwireup="true" inherits="frm_MCEXContracts, App_Web_alid8jfz" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Import USE-CDX Contract</title>
                    ...
                    <tr>
                        <td class="lt" style="height: 115px">
                            <table cellpadding="0" cellspacing="12" class="width100per" style="width: 100%">
                                <tbody>
                                 <tr>
                                        <td align="left" colspan="1" valign="middle" style="width: 278px">
                                            <asp:Label ID="Label1" runat="server" Font-Bold="True" Text="EXP : NSEL_ProductMaster.CSV Or NSEL_ContractMaster.CSV"></asp:Label></td>
                                    ...
                                    <tr>
                                        <td align="right" colspan="1" valign="middle" style="width: 278px">
