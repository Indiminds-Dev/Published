<%@ page language="C#" autoeventwireup="true" inherits="management_frm_ShowDocument, App_Web_amufh4kc" %>
    ...
    //alert (keyValue);
        ...
        popup.Show();
           ...
           function  fnEntityChange(obj)
           {
               ...
               else if (obj=="Company" || obj=="Building" || obj=="Branches" || obj=="ExchaOther Contacts/Entitiesnges" || obj=="Exchanges")
               {
            ...
            <table class="TableMain100">
                <tr>
                    ...
                    <td colspan="2" class="EHEADER" style="text-align: center;">
                        <strong><span style="color: #000099">Search Document</span></strong>
                    </td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <asp:DropDownList ID="drpDocumentEntity" runat="server" onchange="fnEntityChange(this.value)"
                                        ...
                                        <asp:ListItem>NSDL Clients</asp:ListItem>
                                        <asp:ListItem>CDSL Clients</asp:ListItem>
                                        ...
                                        <asp:ListItem Value="Exchanges">Exchanges</asp:ListItem>
                ...
                <tr>
                    <td colspan="2">
                        <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                <dxwgv:ASPxGridView ID="gridStatus" ClientInstanceName="grid" Width="98%" KeyFieldName="doc_id"
                                    ...
                                    <Columns>
                                        <dxwgv:GridViewDataTextColumn Visible="False" FieldName="doc_id" Caption="ID">
                                            <CellStyle CssClass="gridcellleft">
                                            </CellStyle>
                                            <EditFormSettings Visible="False"></EditFormSettings>
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn VisibleIndex="1" FieldName="CONTACT_NAME" Caption="Name">
                                            <CellStyle CssClass="gridcellleft" Wrap="True">
                                            </CellStyle>
                                            <EditFormSettings Visible="False"></EditFormSettings>
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn VisibleIndex="2" FieldName="CONTACT_UCC" Caption="UCC">
                                            <CellStyle CssClass="gridcellleft" Wrap="True">
                                            </CellStyle>
                                            <EditFormSettings Visible="False"></EditFormSettings>
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Visible="true" FieldName="CONTACT_BRANCH" Caption="Branch"
                                            VisibleIndex="3" >
                                            <CellStyle CssClass="gridcellleft" Wrap="True">
                                            </CellStyle>
                                            <EditFormSettings Visible="False"></EditFormSettings>
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn VisibleIndex="4" FieldName="DOC_TYPE" Caption="Doc.Type">
                                            <CellStyle CssClass="gridcellleft" Wrap="True">
                                            </CellStyle>
                                            <EditFormSettings Visible="False"></EditFormSettings>
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Visible="true" FieldName="doc_documentName" Caption="FileName"
                                            VisibleIndex="5">
                                            <CellStyle CssClass="gridcellleft" Wrap="True">
                                            </CellStyle>
                                            <EditFormSettings Visible="False"></EditFormSettings>
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Visible="true" FieldName="doc_Note1" Caption="Note 1"
                                            VisibleIndex="6">
                                            <CellStyle CssClass="gridcellleft" Wrap="True">
                                            </CellStyle>
                                            <EditFormSettings Visible="False"></EditFormSettings>
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Visible="true" FieldName="doc_Note2" Caption="Note 2"
                                            VisibleIndex="7" >
                                            <CellStyle CssClass="gridcellleft" Wrap="True">
                                            </CellStyle>
                                            <EditFormSettings Visible="False"></EditFormSettings>
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Visible="true" FieldName="filename" Caption="FileNumber"
                                            VisibleIndex="8" >
                                            <CellStyle CssClass="gridcellleft" Wrap="True">
                                            </CellStyle>
                                            <EditFormSettings Visible="False"></EditFormSettings>
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Visible="true" FieldName="blndg" Caption="Building"
                                            VisibleIndex="9" >
                                            <CellStyle CssClass="gridcellleft" Wrap="True">
                                            </CellStyle>
                                            <EditFormSettings Visible="False"></EditFormSettings>
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn VisibleIndex="10" FieldName="DOC_LOCATION" 
                                        Caption="Flr|Rm|Cab" ToolTip="Floor Number | Room Number | Cabinet Number">
                                            <CellStyle CssClass="gridcellleft" Wrap="True">
                                            </CellStyle>
                                            <EditFormSettings Visible="False"></EditFormSettings>
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn VisibleIndex="11" FieldName="createuser" Caption="Upload By">
                                            <CellStyle CssClass="gridcellleft" Wrap="True">
                                            </CellStyle>
                                            <EditFormSettings Visible="False"></EditFormSettings>
                                        </dxwgv:GridViewDataTextColumn>
                                        ...
                                        <dxwgv:GridViewDataTextColumn VisibleIndex="13" FieldName="RecieveDate" Caption="Rcv.Date">
                                            <CellStyle CssClass="gridcellleft" Wrap="True">
                                            </CellStyle>
                                            <EditFormSettings Visible="False"></EditFormSettings>
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn VisibleIndex="14" FieldName="RenewDate" Caption="Renewal Date" >
                                            <CellStyle CssClass="gridcellleft" Wrap="True">
                                            </CellStyle>
                                            <EditFormSettings Visible="False"></EditFormSettings>
                                        </dxwgv:GridViewDataTextColumn>
                                        <%-- <dxwgv:GridViewDataHyperLinkColumn   VisibleIndex="14"
                                            Width="15%">
                                            <DataItemTemplate>
                                ...
                                <dxpc:ASPxPopupControl ID="ASPXPopupControl" runat="server" CloseAction="CloseButton"
