<%@ page language="C#" autoeventwireup="true" inherits="management_frmAllot_new, App_Web_lyh0nvfl" %>
        ...
        <table class="TableMain100">
           <tr>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="TxtInstruction" runat="Server" TextMode="MultiLine" Width="756px" Height="200px"  ></asp:TextBox></td>
            </tr>
            <tr>
