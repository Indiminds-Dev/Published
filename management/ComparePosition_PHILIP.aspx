<%@ page language="C#" autoeventwireup="true" inherits="management_ComparePosition_PHILIP, App_Web_e158i_8t" %>
        ...
        <table id="tbl_main" class="login" cellspacing="0" cellpadding="0" width="410">
            <tbody>
                <tr>
                  <td class="lt1">
                        <h5>
                            Compare BO Position With Brokers Position Files
                        </h5>
                    </td>
                </tr>
                <tr>
                                               ...
                                               <%-- <tr id="trYesNo" runat="server">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4" align="right">
                                                        <asp:FileUpload ID="OFDSelectFile" runat="server"  Width="500px"/>
                                                    </td>
                                                </tr>
                                                <tr>
                                                <td>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td valign="top" align="left" style="height: 19px">
                                                                        <asp:Button ID="BtnSave" runat="server" Text="Compare" CssClass="btn" OnClick="BtnSave_Click"
                                                                            Width="84px" />
                                                                    </td>
                                                                </tr>
                                                            </tbody>
