<%@ page language="C#" autoeventwireup="true" inherits="management_SUBBRKGCOMMISSIONREPORT, App_Web_jdrimxnc" %>
...
<head id="Head1" runat="server">
    <title>Sub Brokerage & Commission Reports</title>
                                                            ...
                                                            <table border="10" cellpadding="1" cellspacing="1">
                                                                <tr>
                                                                    <td class="gridcellleft" bgcolor="#B7CEEC">
                                                                        Report View :</td>
                                                                    <td>
                                                                        <asp:DropDownList ID="ddlReportView" runat="server" Width="180px" Font-Size="10px"
                                                            ...
                                                            <table border="10" cellpadding="1" cellspacing="1">
                                                                <tr>
                                                                    <td class="gridcellleft" bgcolor="#B7CEEC">
                                                                        Commission For :</td>
                                                                    <td>
                                                                        <asp:DropDownList ID="ddlCommissionFor" runat="server" Width="150px" Font-Size="10px">
