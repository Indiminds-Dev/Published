<%@ page language="C#" autoeventwireup="true" inherits="Reports_PortfolioPerformanceFO_Beta, App_Web_wqa_thzl" %>
...
//            Show('td_chkOpenPosition');
        ...
        if(obj=="7") //Send Email as Excel Attachment
        {
            Hide('td_btnshow');
            Hide('td_btnprint');
            Hide('td_opentoexcel');
        ...
        if(obj=="8") //Send Email as Excel Attachment-Group
        {
            Hide('td_btnshow');
            Hide('td_btnprint');
            Hide('td_opentoexcel');
    ...
    <script type='text/javascript'>
        $(function () {
            ...
            $(':button,:submit').click(function () {
                ...
                if (this.id == "btnExcel" || this.id == "btnmail") {
                    HideShow('LoadingDiv', 'S');
                    HideShow('td_opentoexcel', 'H');
                    HideShow('td_sendmail', 'H');
                    setTimeout(function () { HideShow('td_Reset', 'S'); }, 5000);
                }
            });
    ...
    <div>
       ...
       <table id="tab2" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <td class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        ...
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            <asp:CheckBox ID="chkMktValue" runat="server" onclick="selecttion()" />
                                            Consider Market Value
                                        </td>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            <asp:CheckBox ID="chkSpotExp" runat="server" onclick="selecttion()" />
                                            Consider Net SPOT Exposure
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="ddlGeneration" runat="server" Width="150px" Font-Size="10px"
                                                            ...
                                                            <asp:ListItem Value="2">Print</asp:ListItem>
                                                            <asp:ListItem Value="3">Export</asp:ListItem>
                                                            <asp:ListItem Value="4">Excel-Multiple</asp:ListItem>
                                                            <asp:ListItem Value="5">Excel-Multiple-Group</asp:ListItem>
                                                            <asp:ListItem Value="6">Send Email</asp:ListItem>
                                                            <asp:ListItem Value="7">Send Email as Excel Attachment</asp:ListItem>
                                                            <asp:ListItem Value="8">Send Email as Excel Attachment-Group</asp:ListItem>
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                            </table>
        ...
        <div id='LoadingDiv' style='display:none;position: absolute; font-family: arial; font-size: 30; left: 50%; top: 20%; background-color: white; layer-background-color: white; height: 80; width: 150;'>
            <table width='400' height='35' border='1' cellpadding='0' cellspacing='0' bordercolor='#C0D6E4'>
                <tr>
                    <td>
                        <table>
                            <tr>
                                <td height='25' align='center' bgcolor='#FFFFFF'>
                                    <img src='../images/progress.gif' width='18' height='18'></td>
                                <td height='10' width='100%' align='center' bgcolor='#FFFFFF'>
                                    <font size='1' face='Tahoma'><strong align='center'>Please Wait For Excel Generation then Click Reset Button to Continue..</strong></font></td>
                            </tr>
                        </table>
                    </td>
                </tr>
