<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="management_frontendexports_FinSpot, App_Web_amufh4kc" %>
...
<head id="Head1">
    <title>Front-End Exports For FinSpot</title>
...
//                 End of New Work 04/08/2022                 
            ...
            function setparam()
            {
                 document.getElementById('DDLformat').setvalue='FinSpot';
            ...
            function insert()
            {
                ...
                optn2.text = "Investor Client"; 
                optn2.value = "0";
                new2.add(optn2);
                optn7.text = "Investor Segment"; 
                optn7.value = "10";
                new2.add(optn7);
                optn6.text = "Investor Products Enabled"; 
                optn6.value = "9";
                new2.add(optn6);
                optn4.text = "ISIN Holding"; 
                optn4.value = "4";
                new2.add(optn4);
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 22px;">
                        <strong><span id="SpanHeader" style="color: #000099">Front-End Exports For FinSpot</span></strong>
                    </td>
                ...
                <tr valign="top" id="Tr1">
                    ...
                    <td>
                        <asp:DropDownList ID="DDLformat" runat="server" Width="150px" Font-Size="10px" onchange="Fn_DDLformat(this.value)" Enabled="false">
                            <asp:ListItem Value="FinSpot">FinSpot</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr valign="top" id="Tr2">
                    ...
                    <td>
                        <asp:DropDownList ID="DDLexport" runat="server" Width="250px" Font-Size="10px" onchange="Fn_DDLexport(this.value)">
                            <asp:ListItem Value="0">Investor Client</asp:ListItem>
                            <asp:ListItem Value="10">Investor Segment</asp:ListItem>
                            <asp:ListItem Value="9">Investor Products Enabled</asp:ListItem>
                            <asp:ListItem Value="4">ISIN Holding</asp:ListItem>
