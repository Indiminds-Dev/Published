<%@ page language="C#" autoeventwireup="true" inherits="management_frm_SalesVisitActivity, App_Web_6bj03ldo" %>
             ...
             <asp:Panel ID="pnlCall" runat ="server" Width="100%" Visible="false">
              <table class="TableMain100">
               <tr>
                 ...
                 <td class="Ecoheadtxt" style="width:4%">
              ...
              <tr>
                 ...
                 <td style="width:5%; text-align: left;">
                    <asp:TextBox ID="txtDesc" TextMode ="MultiLine" Rows ="2" runat ="server" Width="80%" Font-Size="10px" ForeColor="blue"></asp:TextBox>
                 </td>
                 <td class="Ecoheadtxt" style="width:4%">
                     Priority :
                 </td>
              ...
              <tr>
                 <td class="Ecoheadtxt" colspan="5">
                   <table class="TableMain100">
                     <tr>
                        <td class="Ecoheadtxt" style="width: 25%; height: 25px;">
                             Instruction Notes :
                        </td>
                        <td style="height: 25px; text-align: left;">
                             <asp:TextBox ID="txtInstNote" runat ="server" TextMode ="MultiLine" Rows="5" Width="75%" Font-Size="10px" ForeColor="blue"></asp:TextBox>
                        </td>
                     </tr>
                  </table>
                </td>
               ...
               <table class="TableMain100">
                   <tr>
                      <td>
                        <table class="TableMain100">
                            <tr>
                                <td class="Ecoheadtxt" style="width: 50%; text-align: right; height: 27px;">
                                    ...
                                    <table class="TableMain100">
                                        <tr>
                                            ...
                                            <td class="Ecoheadtxt" style="width: 32%; text-align: left">
                                                <input type="radio" runat="Server" id="Radio1" name="rdr" value="All" checked="True" onclick="javascript:fun(this,true)" /> All Or
                                                <input type="radio" runat="Server" id="Radio2" name="rdr" value="Select" onclick="javascript:fun(this,false)" /> Selective
