<%@ page language="C#" autoeventwireup="true" inherits="Reports_TranscationReport, App_Web_1vatjdzx" %>
    ...
    <form id="form1" runat="server" >
       ...
       <div>
                                 ...
                                 <td valign="top" class="gridcellleft">
                                                <table border="10" cellpadding="1" cellspacing="1">
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                           <%-- <asp:DropDownList ID="DdlReportStyle" runat="server" Width="200px" Font-Size="10px"
                                    ...
                                    <table border="10" cellpadding="1" cellspacing="1">
                                        <tr valign="top">
                                            ...
                                            <td style="height: 23px">
                                              <%--  <asp:DropDownList ID="DdlSettlements" runat="server" Width="100px" Font-Size="10px"
        ...
        <table width="100%" border="1" id="Tab_Records">
         ...
         <div id="Container2" class="paging textLeft" style="width:994px">
            <div class="right" >
                ...
                <div id="ShowFilter" style="width: 69px;float:left">
                    <a id="S" href="javascript:ShowHideFilter('s');"><span style="color: #000099; text-decoration: underline;font-size:12px">
                                                    Show Filter</span></a>
                </div>
               
                <div id="ShowAllRecords" style="width: 72px;float:left">
                    <a  id="H" href="javascript:ShowHideFilter('All');"><span style="color: #000099; text-decoration: underline;font-size:12px;">
                        All Records</span></a>
                 </div>
        ...
        </div> <%--OnLoad="GvTransactionDtl_Load" --%><%--AllowMultiSelection="True" AutoFilterRowInputDelay="100000" --%>
        <%--<dxwgv:ASPxGridView ID="GvTransactionDtl" runat="server" AutoGenerateColumns="False" 
                ...
                <StylesPager EnableDefaultAppearance="False">
                 ...
                 <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn FixedStyle="Left" Caption="Date" FieldName="Date" VisibleIndex="0" Width="190px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px"  Wrap="False">
                        </CellStyle>
                        <HeaderStyle HorizontalAlign="Center" />
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn FixedStyle="Left" Caption="RefID" FieldName="RefID" VisibleIndex="1"
                        Width="70px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px"  Wrap="False">
                        </CellStyle>
                        <HeaderStyle HorizontalAlign="Center" />
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn FixedStyle="Left" Caption="Type" FieldName="Type" VisibleIndex="2"
                        Width="130px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px"  Wrap="False">
                        </CellStyle>
                        <HeaderStyle HorizontalAlign="Center" />
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn FixedStyle="Left" Caption="Isin" FieldName="Isin" VisibleIndex="3"
                        Width="70px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px"  Wrap="False">
                        </CellStyle>
                        <HeaderStyle HorizontalAlign="Center" />
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Description" FieldName="Description" VisibleIndex="4" Width="250px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px"  Wrap="False" >
                        </CellStyle>
                        <HeaderStyle HorizontalAlign="Center" />
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Sett No." FieldName="Sett No." VisibleIndex="5"
                        Width="70px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px"  Wrap="False">
                        </CellStyle>
                        <HeaderStyle HorizontalAlign="Center" />
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="DP Account/Sett" FieldName="DP Account/Sett" VisibleIndex="6"
                        Width="270px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px"  Wrap="False">
                        </CellStyle>
                        <HeaderStyle HorizontalAlign="Center" />
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Client/Code" FieldName="Client/Code" VisibleIndex="7"
                        Width="190px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px"  Wrap="False">
                        </CellStyle>
                        <HeaderStyle HorizontalAlign="Center" />
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="DPRef/Batch" FieldName="DPRef/Batch" VisibleIndex="8"
                        Width="80px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px"  Wrap="False" HorizontalAlign="Right">
                        </CellStyle>
                        <HeaderStyle HorizontalAlign="Center" />
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Remarks" FieldName="Remarks"
                        VisibleIndex="9" Width="150px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px"  Wrap="False">
                        </CellStyle>
                        <HeaderStyle HorizontalAlign="Center" />
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="In Qty" FieldName="In Qty" VisibleIndex="10"
                        Width="60px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px"  Wrap="False" HorizontalAlign="Right">
                        </CellStyle>
                        <HeaderStyle HorizontalAlign="Center" />
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Out Qty" FieldName="Out Qty"
                        VisibleIndex="11" Width="60px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px"  Wrap="False" HorizontalAlign="Right">
                        </CellStyle>
                        <HeaderStyle HorizontalAlign="Center" />
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Balance" FieldName="Balance" VisibleIndex="12"
                        Width="60px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px"  Wrap="False" HorizontalAlign="Right">
                        </CellStyle>
                        <HeaderStyle HorizontalAlign="Center" />
