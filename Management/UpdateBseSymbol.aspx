<%@ page language="C#" autoeventwireup="true" inherits="management_UpdateBseSymbol, App_Web_jdrimxnc" %>
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports ICCLs' "ICCLFinal_VARELMAM_DDMMYY.csv" files available at 'https://www.bseindia.com/markets/equity/EQReports/margin.aspx'  </h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="lt brdr">
