<%@ page language="C#" autoeventwireup="true" inherits="Management_DutyRatesMaster_Int, App_Web_dw8rtpla" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    ...
    {
      var URL="DutyRates_Int.aspx?id="+obj;
                ...
                <tr>
                    <td>
                        <dxwgv:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False"
                            KeyFieldName="IntDutyRates_ID" Width="1250px" OnRowDeleting="grid_RowDeleting"
