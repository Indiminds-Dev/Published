<%@ page language="C#" autoeventwireup="true" inherits="management_InsuranceNonLife, App_Web_rtil2eyr" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
     ...
     <table class="TableMain100"">
        <tr>
            <td class="EHEADER" style="text-align:center;">
                <strong><span style="color: #000099">Insurance-NonLife</span></strong></td>
        </tr>
        <tr>
            <td>
                <table width="100%">
                        ...
                        <EditForm>
                            <div style="padding: 4px 4px 3px 4px">
                                <table style="width: 100%">
                                    <tr>
                                        <td style="width: 99%">
                                            <dxtc:ASPxPageControl runat="server" ID="pageControl" ClientInstanceName="tabs" Width="100%" ActiveTabIndex="0"
                                                TabIndex="1"  
                                                >
                                                <TabPages>
    ...
    <asp:SqlDataSource ID="RiderName" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
        SelectCommand="SELECT insu_internalId, insu_nameOfCompany FROM tbl_master_insurerName WHERE (insu_InsuranceCompType = 'Non-Life Insurers') order by insu_nameOfCompany">
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="RiderMain" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
        InsertCommand="InsuNonLifeInsert" InsertCommandType="StoredProcedure" SelectCommand="InsuNonLifeSelect"
        SelectCommandType="StoredProcedure" UpdateCommand="InsuNonLifeUpdate" UpdateCommandType="StoredProcedure"
        DeleteCommand="InsuNonLifeDelete" DeleteCommandType="StoredProcedure">
        <UpdateParameters>
