<%@ page language="C#" autoeventwireup="true" inherits="management_sales_businessP, App_Web_n2fxndvz" %>
...
<head id="Head1" runat="server">
  <link type="text/css" href="../CSS/style.css" rel="Stylesheet" />
    <title>Business Processing</title>
<link type="text/css" href="../CSS/style.css" rel="Stylesheet" />
                            ...
                            <dxw:ContentControl runat="server">
                                <dxwgv:ASPxGridView ID="gridLodging" ClientInstanceName="grid" DataSourceID="SqlLodging" runat="server" KeyFieldName="expnd_internalId"   Width="100%" AutoGenerateColumns="False" OnInitNewRow="gridLodging_InitNewRow">
                                    <Columns>
                                        ...
                                        <dxwgv:GridViewDataMemoColumn Caption="Description" FieldName="expnd_BPDescription" VisibleIndex="0"
                                            Width="40%">
                                        ...
                                        <dxwgv:GridViewDataTextColumn Caption="Amount" FieldName="expnd_BPExpAmount"
                                    ...
                                    <SettingsText PopupEditFormCaption="Add/Modify Business Processing" ConfirmDelete="Are You Want To Delete This Record ???" />
