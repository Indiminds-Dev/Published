<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReport_ClientTradeDetail, App_Web_hnkxxmul" enableeventvalidation="false" %>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlGeneration" runat="server" Width="130px" Font-Size="12px"
                                                    ...
                                                    <asp:ListItem Value="1" Enabled="false">Excel-Single</asp:ListItem>
                                                    ...
                                                    <asp:ListItem Value="5" Enabled="false">Send Mail</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
