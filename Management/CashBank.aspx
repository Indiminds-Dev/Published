<%@ page language="C#" autoeventwireup="true" inherits="management_CashBank, App_Web_zsukfi_p" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function OnMoreInfoClick(KeyValue)
        {
            <%Session["cashJournal"] = "2";%>
             var url="cashbankPopup.aspx?id="+KeyValue;
              parent.OnMoreInfoClick(url,"Modify CashBank Entries",'940px','450px',"Y");
        ...
        function OnAddButtonClick() 
        {
            <%Session["cashJournal"] = "2";%>
             ...
             parent.OnMoreInfoClick(url,"Add CashBank Entries",'985px','450px',"Y");
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    <form id="form1" runat="server">
        <table class="TableMain100">
                        ...
                        <tr>
                            <td>
                                <dxe:ASPxDateEdit ID="dtTrDate" runat="server" EditFormat="Custom" TabIndex="17"
                                    ClientInstanceName="dtTrDate" UseMaskBehavior="True" Font-Size="10px" Width="120px"
            ...
            <tr>
                <td>
                    <dxwgv:ASPxGridView ID="grdCashbank" runat="server" ClientInstanceName="grid" KeyFieldName="CashBank_ID"
                        ...
                        <Columns>
                            <dxwgv:GridViewDataTextColumn Caption="CashBank_ID" FieldName="CashBank_ID" Visible="False"
                                VisibleIndex="0">
                            ...
                            <dxwgv:GridViewDataDateColumn Caption="Tr.Date" FieldName="cashbank_TransactionDate"
                                VisibleIndex="0">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                            ...
                            <dxwgv:GridViewDataTextColumn Caption="Ref. No." FieldName="VoucherNo" VisibleIndex="1">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                                <EditFormCaptionStyle HorizontalAlign="Right" Wrap="False">
                                </EditFormCaptionStyle>
                            ...
                            <dxwgv:GridViewDataTextColumn Caption="A/C No" FieldName="AccountNumber" VisibleIndex="2">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                                <EditFormCaptionStyle HorizontalAlign="Right" Wrap="False">
                                </EditFormCaptionStyle>
                            ...
                            <dxwgv:GridViewDataTextColumn Caption="Payment" FieldName="PaymentAmount" VisibleIndex="3">
                            ...
                            <dxwgv:GridViewDataTextColumn Caption="Receipt" FieldName="ReceiptAmount" VisibleIndex="4">
                                <CellStyle HorizontalAlign="Right" CssClass="gridcellleft">
                                </CellStyle>
                                <EditFormCaptionStyle HorizontalAlign="Right" Wrap="False">
                                </EditFormCaptionStyle>
                            ...
                            <dxwgv:GridViewDataTextColumn Caption="Date" VisibleIndex="5" FieldName="cashbank_TransactionDate"
                                Visible="False">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                                <EditFormCaptionStyle HorizontalAlign="Right" Wrap="False">
                            ...
                            <dxwgv:GridViewDataTextColumn Caption="Segment" VisibleIndex="6" FieldName="CashBank_ExchangeSegmentID"
                                Visible="False">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                                <EditFormCaptionStyle HorizontalAlign="Right" Wrap="False">
                            ...
                            <dxwgv:GridViewDataTextColumn Caption="Branch" VisibleIndex="7" FieldName="CashBank_BranchID"
                                Visible="False">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                                <EditFormCaptionStyle HorizontalAlign="Right" Wrap="False">
                            ...
                            <dxwgv:GridViewDataTextColumn Caption="Details" Width="5%" VisibleIndex="8">
                                <DataItemTemplate>
                            ...
                            <dxwgv:GridViewCommandColumn VisibleIndex="9" Width="5%">
