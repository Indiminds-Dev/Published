<%@ page language="C#" autoeventwireup="true" inherits="management_sales_travelling, App_Web_yq8u0p-o" %>
                                        ...
                                        <dxw:ContentControl runat="server">
                                            <dxwgv:ASPxGridView ID="GridConveyence" runat="server" KeyFieldName="expnd_internalId"
                                                ...
                                                <Columns>
                                                    ...
                                                    <dxwgv:GridViewDataTextColumn FieldName="expnd_dateTravExpenditure1" Caption="Date"
                                                        VisibleIndex="1">
                                                        <EditFormSettings Visible="False" />
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                    ...
                                                    <dxwgv:GridViewDataTextColumn FieldName="expnd_dtTravJourney1" Caption="Start Journing"
                                                        VisibleIndex="4">
                                                        <EditFormSettings Visible="False" />
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataDateColumn Caption="Travelling Date" FieldName="expnd_dtTravJourney"
                                                        VisibleIndex="1" Visible="False">
                                                        <PropertiesDateEdit DisplayFormatString="" EditFormat="Custom" EditFormatString="dd-MM-yyyy">
                                                        </PropertiesDateEdit>
                                                    ...
                                                    <dxwgv:GridViewDataTextColumn FieldName="expnd_dtTravRetJourney1" Caption="Return Journing"
                                                        VisibleIndex="5">
                                                        <EditFormSettings Visible="False" />
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
