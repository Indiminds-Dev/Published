<%@ page language="C#" autoeventwireup="true" inherits="management_StampGeneration, App_Web_g1t3n0jz" %>
...
<head id="Head1" runat="server">
    <title>Stamp Duty Generation</title>
    ...
    function btnAddsubscriptionlist_click()
      ...
      function height()
        ...
        function Disable(obj)
        {
            ...
            var gridview = document.getElementById('grdStampgenerate'); 
            ...
            if(obj=='P')
            {
                document.getElementById("grdStampgenerate_ctl08_FirstPage").style.display='none';
                document.getElementById("grdStampgenerate_ctl08_PreviousPage").style.display='none';
                document.getElementById("grdStampgenerate_ctl08_NextPage").style.display='inline';
                document.getElementById("grdStampgenerate_ctl08_LastPage").style.display='inline';
            }
            else
            {
                document.getElementById("grdStampgenerate_ctl"+rCount+"_NextPage").style.display='none';
                document.getElementById("grdStampgenerate_ctl"+rCount+"_LastPage").style.display='none';
            }
        }
        ...
        function Nodisplay()
        {
                ...
                document.getElementById('TdFilter').style.display='none';
                document.getElementById('tddisplay').style.display='none';
                alert('Stamp Duty Generated Successfully');
                height();
      ...
      // if (postBackElement.id == 'ctl00_ContentPlaceHolder3_btnShow') 
       ...
       <tr>
                    <td class="EHEADER" style="text-align: center;">
                        <strong><span style="color: #000099">Stamp Duty Generation</span></strong>
                    </td>
                </tr></table>
         <table class="TableMain100">
                <tr id="TdAll1">
                ...
                <tr>
                    <td colspan="2" style="text-align: left; vertical-align: bottom;">
                     ...
                     <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="grdStampgenerate" runat="server" Width="100%" BorderColor="CornflowerBlue"
                                    ShowFooter="True" AllowSorting="true"
                                    AutoGenerateColumns="False" BorderStyle="Solid" BorderWidth="2px" 
                                     AllowPaging="True" PageSize="5" ForeColor="#0000C0" OnRowCreated="grdStampgenerate_RowCreated"  >
