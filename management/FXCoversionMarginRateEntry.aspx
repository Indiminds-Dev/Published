<%@ page language="C#" autoeventwireup="true" inherits="management_FXCoversionMarginRateEntry, App_Web_nidspgif" %>
...
<head id="Head1">
    <title>FX Conversion Margin Rates</title>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    ...
    function PopulateGrid(obj)
 {
   ...
   cGridFXMR.PerformCallback(obj);
 }
    function Changestatus(obj)
    {
      var URL="FXCMRatePopup.aspx?id="+obj;
      editwin=dhtmlmodal.open("Editbox", "iframe", URL, "Add/Edit FX Conversion Margin Rates", "width=1100px,height=200px,center=1,resize=1,top=-1", "recal");                 
      editwin.onclose=function()
         {
            cGridFXMR.PerformCallback();
         }
    }
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" style="text-align: center;">
                        <strong><span style="color: #000099">FX Conversion Margin Rates</span></strong>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <%--Width="100%"--%>
                        <dxwgv:ASPxGridView ID="GridFXMR" runat="server" AutoGenerateColumns="False"
                            KeyFieldName="FxMargin_ID" Width="100%" OnRowDeleting="GridFXMR_RowDeleting"
                            ClientInstanceName="cGridFXMR" OnCustomCallback="GridFXMR_CustomCallback" OnHtmlRowCreated="GridFXMR_HtmlRowCreated">
                            <Templates>
                                <EditForm>
                                </EditForm>
                            </Templates>
                            ...
                            <Columns>
                                ...
                                <dxwgv:GridViewDataTextColumn FieldName="To_Currency" Caption="To Currency" Width="15%" VisibleIndex="4">
                                 ...
                                 <dxwgv:GridViewDataTextColumn FieldName="FxMargin_Rate" Caption="Fx Margin Rate" Width="12%" VisibleIndex="5">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                    <HeaderStyle HorizontalAlign="Right" />
                                </dxwgv:GridViewDataTextColumn>
                                
                                  <dxwgv:GridViewDataTextColumn FieldName="Create_User" Caption="Create User" Width="15%" VisibleIndex="6">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                
                                <dxwgv:GridViewDataTextColumn FieldName="change" Caption="Change Combination" Width="15%" VisibleIndex="7">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                ...
                                <dxwgv:GridViewDataDateColumn FieldName="ToDateChk" VisibleIndex="11" Visible="False">
                                    <PropertiesDateEdit DisplayFormatString="dd-MM-yyyy">
                                    </PropertiesDateEdit>
                                </dxwgv:GridViewDataDateColumn>
                            </Columns>
