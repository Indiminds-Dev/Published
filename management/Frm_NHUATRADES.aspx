<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_NHUATRADES, App_Web_itibbj7j" %>
   ...
   <script language="javascript" type="text/javascript">
    ...
    function OnComboChooseFileIndexChange()
    {
        ...
        if(SelectedValue==0)
            ...
            Span_FileFormat.innerText="File Name : Algo Trade CSV/TXT Files";
                                    ...
                                    <tr>
                                        <td style="width: 100px">
                                            <dxe:ASPxComboBox ID="ComboChooseFile" runat="server" ClientInstanceName="cComboChooseFile"
                                                ...
                                                <Items>
                                                    <dxe:ListEditItem Value="0" Text="Daily Trade Files"></dxe:ListEditItem>
                                                    <dxe:ListEditItem Value="1" Text="Algo Trade Files"></dxe:ListEditItem>
                                                </Items>
