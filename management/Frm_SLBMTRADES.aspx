<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_SLBMTRADES, App_Web_0jwcfgzk" %>
   ...
   <script language="javascript" type="text/javascript">
    ...
    function PageLoad()
    {
       ...
       //File Format to Import By Default
        Span_FileFormat.innerText="File Name : SLBM_DDmmYYYY_mmmmm.txt";
    }
    ...
    function OnComboChooseFileIndexChange()
    {
        ...
        if(SelectedValue==0)
            Span_FileFormat.innerText="File Name : DailyTrades.csv";
        else if(SelectedValue==1)
            Span_FileFormat.innerText="File Name : ATINTrades.csv";
        else
            Span_FileFormat.innerText="File Name : NetPosition_YYYYmmDD.csv";
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports NSE's SLBM Trade Files
                                </h5>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td style="width: 100px">
                                            <dxe:ASPxComboBox ID="ComboChooseFile" runat="server" ClientInstanceName="cComboChooseFile"
                                                ...
                                                <Items>
                                                    <dxe:ListEditItem Value="0" Text="From NSE's Txt Files"></dxe:ListEditItem>
                                                    <%--<dxe:ListEditItem Value="1" Text="ATIN CSV Files"></dxe:ListEditItem>--%>
                                                    <%--<dxe:ListEditItem Value="2" Text="Opening Trades From Position File"></dxe:ListEditItem>--%>
                                                </Items>
