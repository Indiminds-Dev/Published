<%@ page language="C#" autoeventwireup="true" inherits="Management_Export_NSDLClientModificationBatch, App_Web_4andsqnv" %>
...
<head id="Head1" runat="server">
    <title>Create Batch For Updating BSDA Flag in NSDL </title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Create Batch For Updating BSDA Flag in NSDL</span></strong></td>
