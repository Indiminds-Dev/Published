<%@ page language="C#" autoeventwireup="true" inherits="Reports_InterestPenaltyStatement, App_Web_arnfzykg" %>
...
<head runat="server">
    <title>Interest And Penalty Statement</title>
                    ...
                    <td>
                        <table cellspacing="1" cellpadding="2" style="background-color: #B7CEEC; border: solid 1px  #ffffff"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlGenerateFor" runat="server" Width="158px" Font-Size="10px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlStatementType" runat="server" Width="154px" Font-Size="10px">
