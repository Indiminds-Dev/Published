<%@ page language="C#" autoeventwireup="true" inherits="management_cfslabspopup, App_Web_i8xxwgwk" %>
                                    ...
                                    <td align="center">
                                        <table style="width:100px; z-index:101;border:solid 1px white">
                                            ...
                                            <asp:HiddenField id="hd1" runat="server"/>
                                                ...
                                                <td class="Ecoheadtxt"  >
                                                    <dxe:ASPxLabel ID="ASPxLabel5" runat="server" Text="Slab Mode:"></dxe:ASPxLabel>
                                                </td>
                                                <td class="Ecoheadtxt" style="text-align: left;padding:3px;">
                                                                   
                                                   <dxe:ASPxComboBox runat="server" Width="160px" ID="ddlMode" DropDownStyle="DropDown" EnableSynchronization="False" EnableIncrementalFiltering="True">
                                                                                                            
                                                                   <Items>
                                                                        <dxe:ListEditItem Text="Price" Value="P">
                                                                         </dxe:ListEditItem>
                                                                         <dxe:ListEditItem Text="Value" Value="V">
                                                                         </dxe:ListEditItem>
                                           ...
                                           <tr>
                                              ...
                                              <tr>
                                                 ...
                                                 <td class="Ecoheadtxt" >
                                                    <dxe:ASPxLabel ID="ASPxLabel30" runat="server" Text="Flat" Width="93px"></dxe:ASPxLabel>
                                                </td>
                                                <td class="Ecoheadtxt" style="text-align: left">
                                             
                                                <asp:TextBox runat="server" Width="150px"  ID="txtflat" onkeypress="return noNumbers(event)" MaxLength="19"></asp:TextBox>
                                                </td>
                                                <td class="Ecoheadtxt" >
