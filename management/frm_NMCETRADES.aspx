<%@ page language="C#" autoeventwireup="true" inherits="frm_NMCETRADES, App_Web_d3reltht" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>NMCE Trade</title>
                    ...
                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <select id="cmbTrade" runat="server" onchange="selectfile();">
                                                ...
                                                <option>ODIN Backup File</option>
						<option>ODIN Online File</option>		
						<option>Manual Trade File</option>		
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:FileUpload ID="NMCETradeSelectFile" runat="server" Height="21px" Width="272px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
