<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReport_dailyBillingFO, App_Web_1vatjdzx" enableeventvalidation="false" %>
                        ...
                        <table>
                           ...
                           <%-- ---------------Colleterate Valuation Date End----------------------------%>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="ddlAppMargin" runat="server" Width="187px" Font-Size="10px">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="ddlCalType" runat="server" Width="108px" Font-Size="10px">
                            ...
                            <ContentTemplate>
                                <table id="clientFilter" runat="server">
                                    <tr id="tr_ddl">
                                        ...
                                        <td style="height: 44px">
                                            <asp:DropDownList ID="cmbgroupPager" runat="server" Width="300px" Font-Size="10px"
