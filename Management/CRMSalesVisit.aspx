<%@ page language="C#" autoeventwireup="true" inherits="management_CRMSalesVisit, App_Web_fmcnshmw" %>
                    ...
                    <td style="text-align: left; width: 10px">
                        <table style="width: 8px">
                            <tr id="btntbl" runat="server">
                                <td>
                                    <asp:Button ID="BtnPending" runat="server" Text="Pending/New Visit" CssClass="btnUpdate"
                                        OnClick="BtnPending_Click" Height="21px" />
                                </td>
                                <td>
                                    ...
                                    <asp:Panel ID="pnlData" Visible="False" Enabled="false" runat="server" Width="100%">
                                        <table width="100%" cellpadding="2" cellspacing="3">
                                            ...
                                            <asp:Image ID="Image2" runat="server" ImageUrl="~/images/calendar.jpg" />--%>
                                                ...
                                                <td class="Ecoheadtxt" id="tdVisitPlace1" runat="server" style="width: 13%; text-align: left;
                                                    height: 12px">
                                                ...
                                                <td id="Td1" runat="server" class="Ecoheadtxt" style="width: 8%; height: 12px">
                                                    <a href="sales_conveyence.aspx" onclick="window.open(this.href,'popupwindow','left=120,top=170,height=450,width=900,scrollbars=no,toolbar=no,location=center,menubar=no'); return false;">
                                                        Expenses</a>
                                                </td>
                                                <td id="Td2" runat="server" class="Ecoheadtxt" style="text-align: left; height: 12px">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="Ecoheadtxt" style="width: 14%; height: 12px">
