<%@ page language="C#" autoeventwireup="true" inherits="management_ctt, App_Web_rtil2eyr" %>
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" align="center" >
                                    <strong><span id="SpanHeader" style="color: #000099">CTT Rates Detail</span></strong>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                                ...
                                <td>
                                    <table style="width: 99%; z-index: 101" border="1">
                                        <tr>
                                            ...
                                            <td style="text-align: left; vertical-align: top; background-color: #b7ceec; " id="tdlevelsegment"
                                                runat="server">
                                                &nbsp;Segment</td>
                                        ...
                                        <tr id="trdel" runat="server" style="display: none">
                                            ...
                                            <td style="text-align: left; vertical-align: top; background-color: #b7ceec; ">
                                                Delivary &nbsp;Purchase(ETF)</td>
                                            <td  style="text-align: left; "><dxe:ASPxTextBox ID="txtdelpurchaseETF" runat="server" Width="100px" onkeypress="return noNumbers(event)">
                                                <ValidationSettings ErrorDisplayMode="None">
                                                </ValidationSettings>
                                                <MaskSettings Mask="&lt;0..99g&gt;.&lt;00..999999&gt;" />
                                            </dxe:ASPxTextBox>
                                            ...
                                            <td  style="text-align: left; vertical-align: top; background-color: #b7ceec;">
                                                &nbsp;Delivery &nbsp;Sales</td>
                                            <td  style="text-align: left"><dxe:ASPxTextBox ID="txtdelsale" runat="server" Width="100px" onkeypress="return noNumbers(event)">
                                                <MaskSettings Mask="<0..99g>.<00..999999>" />
                                                <ValidationSettings ErrorDisplayMode="None">
                                                </ValidationSettings>
                                            </dxe:ASPxTextBox>
                                            ...
                                            <td style="vertical-align: top; background-color: #b7ceec; text-align: left">
                                                &nbsp;Delivery &nbsp;Sales(ETF)</td>
                                            <td ><dxe:ASPxTextBox ID="txtdelsaleETF" runat="server" Width="100px" onkeypress="return noNumbers(event)">
                                                <ValidationSettings ErrorDisplayMode="None">
                                                </ValidationSettings>
                                                <MaskSettings Mask="&lt;0..99g&gt;.&lt;00..999999&gt;" />
                                            </dxe:ASPxTextBox>
                                        ...
                                        <tr id="trsqoff" runat="server" style="display: none">
                                            ...
                                            <td style="text-align: left; vertical-align: top; background-color: #b7ceec; ">
                                                Sqaure-Off(ETF)</td>
                                            <td  style="text-align: left; "><dxe:ASPxTextBox ID="txtsoffETF" runat="server" Width="100px" onkeypress="return noNumbers(event)">
                                                <ValidationSettings ErrorDisplayMode="None">
                                                </ValidationSettings>
                                                <MaskSettings Mask="&lt;0..99g&gt;.&lt;00..999999&gt;" />
                                            </dxe:ASPxTextBox>
                                        ...
                                        <tr id="tab1" style="display: none" runat="server">
                                            <td style="text-align: left; vertical-align: top; background-color: cornflowerblue; color: white;">
                                                Rate For Future&nbsp;</td>
                                            <td>
                                                </td>
                                            <td  style="text-align: left; vertical-align: top; background-color: cornflowerblue; color: white;">
                                            ...
                                            <td style="vertical-align: top; background-color: cornflowerblue; text-align: left; color: white;">
                                                &nbsp;Rate For Finaly Settlemnt</td>
                                            <td>
                                            </td>
                                            <td>
                                            </td>
                                        ...
                                        <tr id="trtranclient"  style="display:none">
                                            ...
                                            <td style="text-align: left; display: none; "  id="tdrsubacc" runat="server">
                                            </td>
                                            <td>
                                            </td>
                                            <td >
                                        ...
                                        <tr id="trtrancharge"  style="display:none">
                                            ...
                                            <td style="text-align: left; display: none; "  runat="server" id="tdunsubacc">
                                            </td>
                                            <td>
                                            </td>
                                            <td >
                                        ...
                                        <tr id="trpro"  style="display:none">
                                            ...
                                            <td style="text-align: left; "  >
                                                <dxe:ASPxComboBox runat="server" EnableSynchronization="False" EnableIncrementalFiltering="True"
                                                    ...
                                                    <ClientSideEvents SelectedIndexChanged="function(s, e) { OnAccountProChanged(s); }">
                                                    </ClientSideEvents>
                                                </dxe:ASPxComboBox>
                                            </td>
                                            <td style="text-align: left; display: none; "  runat="server" id="td1">
                                            </td>
                                            <td>
                                            </td>
                                            <td >
                                    ...
                                    <span style="width:98%;text-align:center">
                                                <asp:Button ID="btnSave" runat="server"   Text="Save" OnClick="btnSave_Click"
                                                     CssClass="btnUpdate" Width="130px" /></td>
                                                     </span>
                            </tr>
                        </table>
                    </td>
