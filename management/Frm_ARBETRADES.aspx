<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_ARBETRADES, App_Web_cvaj-tqf" %>
   ...
   <script language="javascript" type="text/javascript">
    ...
    function PageLoad()
    {
       ...
       //File Format to Import By Default
        Span_FileFormat.innerText="File Name : Trades.csv";
    }
    ...
    function OnComboChooseFileIndexChange()
    {
        ...
        if(SelectedValue !=10)
            ...
            Span_FileFormat.innerText="File Name : Openpositions.csv";
    ...
    function OnComboReImpOrDelIndexChange()
    {
        ...
        {
            if(ComboChooseFile_SelectedValue!="1")
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports Trades using supported CSV Format Files
                                </h5>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <td style="width: 100px">
                                            <dxe:ASPxComboBox ID="ComboChooseFile" runat="server" ClientInstanceName="cComboChooseFile"
                                                ...
                                                <Items>
                                                    ...
                                                    <dxe:ListEditItem Value="1" Text="Aarna Trades CSV File"></dxe:ListEditItem>
                                                    <dxe:ListEditItem Value="2" Text="Berkeley Trades CSV File"></dxe:ListEditItem>
                                                    <dxe:ListEditItem Value="3" Text="DGCX Trades CSV File"></dxe:ListEditItem>
                                                    <dxe:ListEditItem Value="4" Text="Orient Trades CSV File"></dxe:ListEditItem>
                                                    <dxe:ListEditItem Value="5" Text="EDF/Marex Trades CSV File"></dxe:ListEditItem>
                                                    <dxe:ListEditItem Value="6" Text="MCX ODIN Txt File"></dxe:ListEditItem>
                                                    <dxe:ListEditItem Value="7" Text="CQG Trade Files"></dxe:ListEditItem>
                                                    <dxe:ListEditItem Value="8" Text="STONX/FCStone CSV(286 cols)"></dxe:ListEditItem>
                                                    <dxe:ListEditItem Value="9" Text="Iress Equity Trades CSV Files(31 Cols)"></dxe:ListEditItem>
                                                    <dxe:ListEditItem Value="10" Text="Opening Trades From Position File"></dxe:ListEditItem>
                                                </Items>
