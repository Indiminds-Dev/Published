<%@ page language="C#" autoeventwireup="true" inherits="management_MCXMargin, App_Web_6_wayyot" %>
    ...
    <script language="javascript" type="text/javascript">
     function Page_Load(obj)///Call Into Page Load
      { 
           ...
           Hide('tr_Adhoc');
           Hide('tr_date');
           document.getElementById('lblEg').innerHTML='EG: NCDEX_MG13_TMCODE_DDMMYYYY.LIS';
           selecttion();
      }
   function height()
    {
        ...
        <asp:Panel ID="Panelmain" runat="server" HorizontalAlign="Center" Style="z-index: 100;
            ...
            <table id="tbl_main" cellpadding="0" cellspacing="0" class="login" width="410" style="border: solid 1px blue">
                <tbody>
                    <tr>
                        <td class="EHEADER">
                            <span style="color: blue"><strong>NCDEX Margin</strong></span></td>
                    </tr>
                    <tr>
                        <td class="lt">
                            <table cellpadding="0" cellspacing="12" class="TableMain100">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:FileUpload ID="NCDEXMarginSelectFile" runat="server" Height="21px" Width="272px" />
                                        </td>
                                    </tr>
