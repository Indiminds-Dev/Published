<%@ page language="C#" autoeventwireup="true" inherits="Reports_PositionFileSpanNSEFO, App_Web_icax4mdl" %>
                                ...
                                <td colspan="5">
                                    <table border="10">
                                        <tr>
                                            ...
                                            <td class="gridcellleft">
                                                <dxe:ASPxDateEdit ID="dtFrom" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                    Font-Size="10px" Width="108px" ClientInstanceName="dtFrom" EditFormatString="dd-MM-yyyy">
                                            ...
                                            <td>
                                                <dxe:ASPxDateEdit ID="dtTo" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                    Font-Size="10px" Width="108px" ClientInstanceName="dtTo" EditFormatString="dd-MM-yyyy">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                 <asp:DropDownList ID="ddlType" AutoPostBack="false" runat="server" Width="100px" Font-Size="10px" onchange="ReportType(this.value)">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlGeneration" AutoPostBack="false" runat="server" Width="80px" Font-Size="10px" onchange="GenerationType(this.value)">
                                         ...
                                         <tr id="pdfvalidation1">
                                            ...
                                            <td id="tdHeader">
                                             <asp:TextBox ID="txtHeader" runat="server" Width="220px" Font-Size="10px" onkeyup="FunHeaderFooter(this,'GetHeaderFooter',event,'H')"></asp:TextBox>
                                         ...
                                         <tr id="pdfvalidation2">
                                            ...
                                            <td id="tdfooter">
                                             <asp:TextBox ID="txtFooter" runat="server" Width="220px" Font-Size="10px" onkeyup="FunHeaderFooter(this,'GetHeaderFooter',event,'F')"></asp:TextBox>
