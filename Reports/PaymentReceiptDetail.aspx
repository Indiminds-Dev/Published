<%@ page language="C#" autoeventwireup="true" inherits="Reports_PaymentReceiptDetail, App_Web_wqa_thzl" %>
...
<head id="Head1">
    <title>Query Payment/Receipt Transactions</title>
    ...
    <form id="form1" runat="server" autocomplete="off">
        ...
        <div>
            <table class="TableMain100">
                <tr>
                    ...
                    <td class="EHEADER" width="15%" id="Td_Filter" style="height: 22px">
                        <a href="javascript:void(0);" onclick="Page_Load();"><span style="color: Blue;
                                                            ...
                                                            <table border="10" cellpadding="1" cellspacing="1">
                                                                <tr>
                                                                    <td class="gridcellleft" bgcolor="#B7CEEC">
                                                                        Account Type :</td>
                                                                    <td>
                                                                        <asp:DropDownList ID="DdlAccountType" runat="server" Width="100px" Font-Size="10px"
                                                            ...
                                                            <table border="10" cellpadding="1" cellspacing="1">
                                                                <tr>
                                                                    ...
                                                                    <td style="display: none;" id="Td_MainAcSpecific">
                                                                        <asp:TextBox ID="txtMainAccount" TabIndex="0" runat="server" Width="250px" Font-Size="10px"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <dxe:ASPxDateEdit ID="DtFromDate" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                                Font-Size="10px" Width="120px" ClientInstanceName="DtFromDate">
                                                        ...
                                                        <td>
                                                            <dxe:ASPxDateEdit ID="DtToDate" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                                Font-Size="10px" Width="120px" ClientInstanceName="DtToDate">
                                                ...
                                                <table border="10" cellpadding="1" cellspacing="1">
                                                    <tr>
                                                        ...
                                                        <td style="width: 255px">
                                                            <asp:DropDownList ID="DdlSortOrder" runat="server" Width="250px" Font-Size="10px">
            ...
            <table id="Tab_Grid">
                                ...
                                <td valign="top">
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td align="right"><asp:DropDownList ID="cmbExport" runat="server" AutoPostBack="True" Font-Size="10px" Width="100px" OnSelectedIndexChanged="cmbExport_SelectedIndexChanged">
                ...
                <tr>
                    <td>
                        <dxwgv:ASPxGridView ID="GridPaymentReceiptQuery" runat="server" AutoGenerateColumns="False"
                            ClientInstanceName="cGridPaymentReceiptQuery" Width="1200px" Font-Size="10px"  KeyFieldName="Srl. No"
                            ...
                            <Columns>
                             <dxwgv:GridViewDataTextColumn VisibleIndex="0" FieldName="Srl. No" Width="25px"
                                    Caption="Srl.No">
                                  
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="0" FieldName="Branch ID" Width="150px"
                                    Caption="Branch ID">
                                  
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="1" FieldName="Main A/c (Code)" Width="200px"
                                    Caption="Main A/c (Code)">
                                   
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="2" FieldName="Sub A/c (Code)" Width="200px"
                                    Caption="Sub A/c (Code)">
                                   
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="3" FieldName="Bank Name (Code)"
                                    Width="200px" Caption="Bank Name (Code)">
                                   
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="4" FieldName="Segment" Width="45px"
                                    Caption="Segment">
                                   
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="5" FieldName="Instr.Type" Width="45px"
                                    Caption="Instr Type">
                                  
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="6" FieldName="Instr.No." Width="45px"
                                    Caption="Instr.No">
                                    
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="7" FieldName="Tran. Date" Width="50px"
                                    Caption="Tran.Date">
                                  
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="8" FieldName="Voucher No." Width="50px"
                                    Caption="Voucher No">
                                  
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="9" FieldName="Payment" Width="100px"
                                    Caption="Payment">
                                    <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="10" FieldName="Receipt" Width="100px"
                                    Caption="Receipt">
                                    <CellStyle HorizontalAlign="Right">
                                    </CellStyle>
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="11" FieldName="Value Date" Width="50px"
                                    Caption="Value Date">
                                   
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="12" FieldName="Client Bnk" Width="100px"
                                    Caption="Client Bnk">
                                   
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="13" FieldName="Third Party" Width="100px"
                                    Caption="Third Party">
                                  
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="14" FieldName="Age(Days)" Width="45px"
                                    Caption="Age(Days)">
