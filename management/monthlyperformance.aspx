<%@ page language="C#" autoeventwireup="true" inherits="Reports_monthlyperformance, App_Web_5uqmplyf" %>
       ...
       <table id="tab2" border="0" cellpadding="0" cellspacing="0">
            <tr valign="top">
                <td>
                    <table>
                    <tr valign="top">
                <td style="width: 110px" class="gridcellleft">
                ...
                <td id="td_dtfor" style="width: 130px;" class="gridcellleft">
                ...
                <td id="td_dtfrom" style="width: 130px;" class="gridcellleft">
                ...
                <td id="td_dtto" style="width: 130px;" class="gridcellleft">
            ...
            <tr>
                       ...
                       <tr>
                            <td style="height: 22px" id="td_btnshow" class="gridcellleft">
                                <asp:Button ID="btnshow" runat="server" CssClass="btnUpdate" Height="20px" Text="Show" OnClientClick="selecttion()"
                                    Width="101px" OnClick="btnshow_Click" />
                            </td>
                            <td colspan="3" style="height: 22px" id="td_btnprint">
                                <asp:Button ID="btnprint" runat="server" CssClass="btnUpdate" Height="20px" Text="Print" OnClientClick="selecttion()"
                                    ...
                                    <ContentTemplate>
                                        <table id="brokerFilter" runat="server">
                                            <tr valign="top">
                                                ...
                                                <td style="height: 44px">
                                                    <asp:DropDownList ID="cmbsubbroker" runat="server" Font-Size="10px" Width="300px"
