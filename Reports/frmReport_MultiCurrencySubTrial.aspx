<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="Reports_frmReport_MultiCurrencySubTrial, App_Web_eozuxu2i" %>
...
<head runat="server">
    <title>Multi Currency Sub-Trial Balance For Clients/Brokers</title>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:DropDownList ID="ddlSubLedger" runat="server" Width="130px" Font-Size="12px">
                                                ...
                                                <asp:ListItem Value="Dealers~Client~Wise">Dealers~Client~Wise</asp:ListItem>
                                                <asp:ListItem Value="Family~Client~Wise">Family~Client~Wise</asp:ListItem>
                                                <asp:ListItem Value="Sub Broker~Client~Wise">Sub Broker~Client~Wise</asp:ListItem>
                                                <asp:ListItem Value="Dealers~Wise">Dealers~Wise</asp:ListItem>
                                                <asp:ListItem Value="Family~Wise">Family~Wise</asp:ListItem>
                                                <asp:ListItem Value="Sub Broker~Wise">Sub Broker~Wise</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                </table>
