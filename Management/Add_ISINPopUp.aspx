<%@ page language="C#" autoeventwireup="true" inherits="management_Add_ISINPopUp, App_Web_vvdfezxa" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function FunCallAjaxList(objID, objEvent, ObjType) {
            ...
            if (ObjType == 'Digital') {
                ...
                var vCheckValue = document.getElementById('HiddenField2').value;
                ...
                if (vCheckValue == "9") {
                    ...
                    strQuery_Table = "Master_NSDLISIN";
                    strQuery_FieldName = "distinct top 10 NSDLISIN_Number+' ['+isnull(NSDLISIN_CompanyName,'')+'-'+isnull(NSDLISIN_ShortName,'')+']' AS loginid,NSDLISIN_Number user_id";
                    strQuery_WhereClause = " NSDLISIN_Number not in (select DPExemptISIN_ISIN from Config_DPExemptISIN where DPExemptISIN_MainID=('" + document.getElementById('HiddenField1').value + "')) and ( NSDLISIN_Number like (\'%RequestLetter%') or NSDLISIN_CompanyName+'-'+NSDLISIN_ShortName like (\'%RequestLetter%'))";
                    // strQuery_WhereClause = " user_group not like ('" + document.getElementById('HiddenField1').value + "') and ( USER_NAME like (\'%RequestLetter%') or user_loginId like (\'%RequestLetter%'))";
                }

                else if (vCheckValue == "10") {

              
                    strQuery_Table = "Master_CDSLISIN";
                    strQuery_FieldName = "distinct top 10 CDSLISIN_Number +' [' + isnull(CDSLISIN_ShortName,'')+']' AS loginid,CDSLISIN_Number user_id";
                    strQuery_WhereClause = " CDSLISIN_Number not in (select DPExemptISIN_ISIN from Config_DPExemptISIN where DPExemptISIN_MainID=('" + document.getElementById('HiddenField1').value + "')) and ( CDSLISIN_Number like (\'%RequestLetter%') or CDSLISIN_ShortName like (\'%RequestLetter%'))";
                    // strQuery_WhereClause = " user_group not like ('" + document.getElementById('HiddenField1').value + "') and ( USER_NAME like (\'%RequestLetter%') or user_loginId like (\'%RequestLetter%'))";
                }
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE">
    ...
    <div>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center;">
                    <strong><span style="color: #000099">Add ISIN Number</span></strong>
                </td>
            </tr>
        </table>
        <%-- <div id='Div1' style='position:absolute; font-family:arial; font-size:30; left:40%; top:25%; background-color:white; layer-background-color:white; height:80; width:50;'>
                    <table class="TableMain100"> 
                      <tr><td><table><tr> 
        ...
        <table width="600px" align="center" style="border: solid 1px white;">
            <tr>
                <td>
                    <table>
                        ...
                        <td style="width: 60%" align="left">
                            <asp:TextBox ID="txtReportTo" runat="server" Width="500px" onkeyup="FunCallAjaxList(this,event,'Digital')"></asp:TextBox>
                            <asp:TextBox ID="txtReportTo_hidden" runat="server" Width="100px" Style="display: none"></asp:TextBox>
