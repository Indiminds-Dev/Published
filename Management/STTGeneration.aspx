<%@ page language="C#" autoeventwireup="true" inherits="management_STTGeneration, App_Web_njtlujlb" %>
    ...
    function btnAddsubscriptionlist_click()
      ...
      function height()
        ...
        function Disable(obj)
        {
            ...
            var gridview = document.getElementById('grdsttgenerate'); 
            ...
            if(obj=='P')
            {
                document.getElementById("grdsttgenerate_ctl08_FirstPage").style.display='none';
                document.getElementById("grdsttgenerate_ctl08_PreviousPage").style.display='none';
                document.getElementById("grdsttgenerate_ctl08_NextPage").style.display='inline';
                document.getElementById("grdsttgenerate_ctl08_LastPage").style.display='inline';
            }
            else
            {
                document.getElementById("grdsttgenerate_ctl"+rCount+"_NextPage").style.display='none';
                document.getElementById("grdsttgenerate_ctl"+rCount+"_LastPage").style.display='none';
            }
        }
        ...
        function Nodisplay()
        {
                ...
                document.getElementById('TdFilter').style.display='none';
                document.getElementById('tddisplay').style.display='none';
                alert('STT Generated Successfully');
                height();
      ...
      // if (postBackElement.id == 'ctl00_ContentPlaceHolder3_btnShow') 
       ...
       <tr>
                    <td class="EHEADER" style="text-align: center;">
                        <strong><span style="color: #000099">STT Generation</span></strong>
                    </td>
                </tr></table>
         <table class="TableMain100">
                <tr id="TdAll1">
             ...
             <tr id="tddisplay">
                  <td colspan="2" style="text-align: left; vertical-align:top;background-color:Silver;" >
                     <asp:Label ID="lblerror" runat="server" Text="Following Clients STT Generation Pattern is set to 'Contract Number Wise'.However Contract Number is not generated for the given day.Hence Stt not generated.Please generate Contract Number and generate Stt."></asp:Label>
                 </td>
             </tr>
                 <tr id="Tr1">
                ...
                <tr>
                    <td colspan="2" style="text-align: left; vertical-align: bottom;">
                     ...
                     <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="grdsttgenerate" runat="server" Width="100%" BorderColor="CornflowerBlue"
                                    ShowFooter="True" AllowSorting="true"
                                    AutoGenerateColumns="False" BorderStyle="Solid" BorderWidth="2px" 
                                     AllowPaging="True" PageSize="5" ForeColor="#0000C0" OnRowCreated="grdsttgenerate_RowCreated"  >
