<%@ page language="C#" autoeventwireup="true" inherits="Reports_DeliveryCentreCommCurrency, App_Web_-n9yptcr" %>
 ...
 <script language="javascript" type="text/javascript">
   ...
   function Fn_ddlSelectaType(selectiontype,clientid,productid,settno,qty) 
   {
        if(selectiontype=='E')
        {
            ...
            parent.OnMoreInfoClick(url,"Add Transaction Entries",'950px','450px',"Y");
        }
        if(selectiontype=='T')
        {
            var url='ShowTransactionCommCurrency.aspx?clientid='+clientid +'&productid='+productid +'&settno='+settno;
            parent.OnMoreInfoClick(url,"Transactions",'950px','450px',"Y");
        }
        if(selectiontype=='S')
        {
            var url='ShowStocksCommCurrency.aspx?productid='+productid;
            parent.OnMoreInfoClick(url,"Stocks",'950px','450px',"Y");
        }
   }
  function callback()
  {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         <td style="display: none;" id="Td_SettNo">
                                            <asp:TextBox runat="server" Width="200px" Font-Size="10px" ID="txtSettNo" onkeyup="ajax_showOptions(this,'ShowClientFORMarginStocks',event,'CommDeliveryPositionSettlementNumber')"></asp:TextBox>
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        ...
                                        <td style="display: none;" id="Td_SettType">
                                            <asp:TextBox runat="server" Width="200px" Font-Size="10px" ID="txtSettType" onkeyup="ajax_showOptions(this,'ShowClientFORMarginStocks',event,'FetchSettlementTypeSpot')"></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="PayOut">
                                     ...
                                     <asp:TemplateField HeaderText="Qty To Recv">
                                        ...
                                        <asp:TemplateField HeaderText="Select">
                                            ...
                                            <HeaderStyle HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:DropDownList ID="ddlSelectaType" runat="server" Width="130px" Font-Size="10px" AutoPostBack="true"
