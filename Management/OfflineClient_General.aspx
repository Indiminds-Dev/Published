<%@ page language="C#" autoeventwireup="true" inherits="management_OfflineClient_General, App_Web_e81qjzgk" %>
                            ...
                            <tr>
                                <td align="right">
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Button ID="btnSave" runat="server" Text="Save" OnClick="btnSave_Click" ValidationGroup="a" TabIndex="62">
                                                </asp:Button>
                                            </td>
                                            <td>
                                                <dxe:ASPxButton ID="btnSaveDB" runat="server" Text="Save Data To DataBase" OnClick="btnSaveDB_Click" ValidationGroup="a" Enabled="false" TabIndex="63">
                                                </dxe:ASPxButton>
                                            </td>
                                            <td>
