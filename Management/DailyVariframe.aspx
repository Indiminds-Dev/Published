<%@ page language="C#" autoeventwireup="true" inherits="management_DailyVariframe, App_Web_sjbhlkdr" %>
    ...
    <div align="center">
      <asp:Panel ID="Panelmain" runat="server" Visible="true">
        <table id="tbl_main" class="login" cellspacing="0" cellpadding="0" width="410">
            <tbody>
                <tr>
                    <td class="lt1" style="height: 82px">
                        <h5 style="color: navy; height: 60px; background-color: white">
                            Imports DailyVar CSV Files. First import C_VAR1_ddmmyyyy_nn.DAT,Then MF_VAR_DDmmYYYY.CSV and then APPSEC_COLLVAL_ddmmyyyy.CSV. All files are available at https://www1.nseindia.com/products/dynaContent/equities/equities/htms/CM_homepage_1.htm</h5>
                        <p style="font-size: 12pt; color: red">
                            <strong>*</strong> <strong style="color: green; background-color: white">This will also import the list Of Approved Securities using
                                the APPSEC_COLLVAL files</strong></p>
                    </td>
                </tr>
                <tr>
                    <td class="lt brdr">
                                    ...
                                    <td class="lt">
                                        <table class="width100per" cellspacing="12" cellpadding="0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="right">
                                                        <asp:FileUpload ID="OFDSelectFile" runat="server" Width="680px" />
                                                    </td>
                                                </tr>
                                                <tr>
