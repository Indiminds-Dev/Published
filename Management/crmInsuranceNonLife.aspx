<%@ page language="C#" autoeventwireup="true" inherits="management_crmInsuranceNonLife, App_Web_0payuukt" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="TableMain100">
                <tr>
                    <td>
                        <dxwgv:ASPxGridView ID="ProductMF" runat="server" ClientInstanceName="grid" AutoGenerateColumns="False"
                            KeyFieldName="id" DataSourceID="SqlProductMF" Width="100%" OnHtmlEditFormCreated="ProductMF_HtmlEditFormCreated"
                            OnHtmlRowCreated="ProductMF_HtmlRowCreated">
                            <Columns>
                                <dxwgv:GridViewDataTextColumn FieldName="description" Caption="Product Name" VisibleIndex="0"
                                    Width="80%">
                                ...
                                <dxwgv:GridViewDataComboBoxColumn FieldName="ProductType" Visible="False" VisibleIndex="1">
                                    <PropertiesComboBox DataSourceID="SqlPType" TextField="pty_productType" ValueField="pty_prefix"
                            ...
                            <SettingsEditing Mode="PopupEditForm" PopupEditFormHeight="150px" PopupEditFormHorizontalAlign="Center"
                                PopupEditFormModal="True" PopupEditFormVerticalAlign="WindowCenter" PopupEditFormWidth="800px"
                        ...
                        <asp:SqlDataSource ID="SqlProductMF" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
                            SelectCommand="select p.prds_id as id,p.prds_description as description,p.prds_productType as ProductType from tbl_master_products p,tbl_master_producttype pt where p.prds_producttype=pt.pty_prefix and p.prds_producttype='IG'"
                            InsertCommand="CRMInsuNonlifeInsert" InsertCommandType="StoredProcedure" UpdateCommand="update tbl_master_products set prds_description=@description,prds_productType=@ProductType,LastModifyDate=getdate(),LastModifyUser=@CreateUser where prds_id=@id"
