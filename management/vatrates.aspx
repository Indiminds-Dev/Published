<%@ page language="C#" autoeventwireup="true" inherits="management_vatrates, App_Web_n2fxndvz" %>
...
<head runat="server">
    ...
    function OnMoreInfoClick(keyValue)
    {
     ...
     var url='vat.aspx?id='+keyValue;
      parent.OnMoreInfoClick(url,"Add VAT Details",'940px','450px',"Y");
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    <form id="form1" runat="server">
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center;">
                    <strong><span style="color: #000099">VAT Rates</span></strong>
                </td>
            </tr>
            <tr>
                <td align="right">
        ...
        <dxwgv:ASPxGridView ID="ServiceTaxGrid" runat="server" KeyFieldName="ServTax_ID"
            ...
            <Columns>
                <dxwgv:GridViewDataTextColumn FieldName="ServTax_ID" Caption="ID" VisibleIndex="0"
                    Visible="False">
                ...
                <dxwgv:GridViewDataTextColumn FieldName="ServTax_Rate" Caption="VAT.Rate " VisibleIndex="3"
                    Width="8%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <dxwgv:GridViewDataTextColumn Caption="Vat.Cess1" FieldName="ServTax_EduCess" VisibleIndex="4"
                    Width="6%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <dxwgv:GridViewDataTextColumn Caption="VAT.Cess2" FieldName="ServTax_HgrEduCess"
              ...
              <%--  ------------------ SBC Start ---------------------------%>
                    ...
                    <dxwgv:GridViewDataTextColumn FieldName="ServTax_SBC" Caption="VAT.Cess3 " VisibleIndex="5"
                    Width="7%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <%--  ------------------ SBC End ---------------------------%>
                 ...
                 <%--  ------------------ KKC Start ---------------------------%>
                    ...
                    <dxwgv:GridViewDataTextColumn FieldName="ServTax_KKC" Caption="VAT.Cess4 " VisibleIndex="6"
                    Width="7%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <dxwgv:GridViewDataTextColumn Caption="From Date" FieldName="ServTax_DateFrom" VisibleIndex="7"
                    Width="12%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <dxwgv:GridViewDataTextColumn Caption="Untill Date" FieldName="ServTax_DateTo" VisibleIndex="8"
                    Width="12%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
            ...
            <SettingsText PopupEditFormCaption="Add/ Modify VAT Rates" GroupPanel="VAT Rates" />
