<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="management_TradingTax, App_Web_lyh0nvfl" %>
                            ...
                            <tr>
                                <td style="text-align: center">
                                    <table style="border: solid 1px blue; width: auto">
                                        <tr>
                                            <td class="Ecoheadtxt" style="text-align: left; width: 43%;">
                                                <dxe:ASPxLabel ID="lbl6" runat="server" Width="40px" Text="Group:">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td class="Ecoheadtxt" style="text-align: left; width: 84%;">
                                       ...
                                       <%-- ----- Row 1-------%>
                                        ...
                                        <tr id="tr_1">
                                            ...
                                            <td style="text-align: left; width: 84%;" class="Ecoheadtxt">
                                        ...
                                        <%------------ Row 3 --------%>
                                         ...
                                         <%------------ Row 4 --------%>
                                          ...
                                          <tr id="tr_5">
                                            <td id="td_Decimal_l" class="Ecoheadtxt" style="text-align: left; width: 43%;">
                                                <dxe:ASPxLabel runat="server" Text="Decimals:" ID="ASPxLabel26">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td id="td_Decimal_v" style="text-align: left; width: 84%;" class="Ecoheadtxt">
                                            ...
                                            <td id="td_Min_v" style="text-align: left" class="Ecoheadtxt">
                                             ...
                                             <td id="td2" class="Ecoheadtxt" style="text-align: left; width: 135%;">
                                ...
                                <td class="Ecoheadtxt" style="text-align: left; display: none; width: 84%;"  >
