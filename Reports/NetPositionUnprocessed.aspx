<%@ page language="C#" autoeventwireup="true" inherits="Reports_NetPositionUnprocessed, App_Web_yvy99of_" %>
...
<head id="Head1">
    <title>Net Position (Unprocessed Trades)</title>
...
//   else
  ...
  function FnddlGeneration(obj)
  {
    ...
    //New Work
    fnddlview(document.getElementById('ddlviewby').value);
    //End of New Work
      height();
  }
        ...
        <table class="TableMain100">
            <tr>
              ...
              <td class="EHEADER" width="15%" id="td_filter" style="height: 22px">
                    <a href="javascript:void(0);" onclick="fnNoRecord(4);"><span style="color: Blue; text-decoration: underline;
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Report View :</td> 
                                        <td>
                                            <asp:DropDownList ID="DLLRptView" runat="server" Width="250px" Font-Size="10px">
                     ...
                     <table  border="10" cellpadding="1" cellspacing="1" id="showFilter">
                                    <tr>
                                        <td class="gridcellleft" style="vertical-align: top; text-align: right; height: 21px;"
                                            ...
                                            <asp:DropDownList ID="cmbsearchOption" runat="server" Font-Size="11px" Width="80px"
                                                Enabled="false">
