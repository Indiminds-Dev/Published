<%@ page language="C#" autoeventwireup="true" inherits="management_frm_Account_Transfer, App_Web_yq8u0p-o" %>
                ...
                <td colspan="6">
                    <dxwgv:ASPxGridView ID="DetailsGrid" runat="server" AutoGenerateColumns="False" ClientInstanceName="settlegrid"
                        ...
                        <Columns>
                            ...
                            <dxwgv:GridViewDataTextColumn FieldName="TranType" Caption="TransType"
                                VisibleIndex="1">
                                <CellStyle Wrap="False" CssClass="gridcellleft">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            ...
                            <dxwgv:GridViewDataTextColumn FieldName="Quantity" Caption="Qty" VisibleIndex="3">
                                <CellStyle Wrap="False" CssClass="gridcellleft">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
