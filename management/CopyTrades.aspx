<%@ page language="C#" autoeventwireup="true" inherits="management_CopyTrades, App_Web_1jeyysc_" %>
...
<head id="Head1">
    <title>Copy/Remove Trades For The Given Period</title>
...
//            alert('Generate For Remaining Bills...');
        ...
        if(obj=="5")
        {
            ...
            window.location = "../Reports/CopyTrades.aspx";
        }
          ...
          $get('UpdateProgress1').style.display = 'none'; 
            ...
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Copy/Remove Trades For The Given Period</span></strong></td>
