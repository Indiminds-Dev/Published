<%@ page language="C#" autoeventwireup="true" inherits="Management_NCL_ShortAllocation, App_Web_nhjs8cfd" %>
...
<head id="Head1" runat="server">
    <title>Create Batch For Reporting Short Allocation Of Collaterals To NSCCL (SA_TM)</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Batch For Reporting Short Allocation Of Collaterals To NSCCL</span></strong></td>
