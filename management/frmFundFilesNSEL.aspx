<%@ page language="C#" autoeventwireup="true" inherits="management_frmFundFilesNCDEX, App_Web_d1rqvttb" %>
...
<head id="Head1" runat="server">
    <title>Import NSEL-SPOT Fund Trades</title>
            ...
            <asp:Panel ID="Panelmain" runat="server" Visible="true" HorizontalAlign="Center">
                <table id="tbl_main" class="login" cellspacing="0" cellpadding="0" runat="server"
                    ...
                    <tr>
                        <td class="lt1">
                            <h5>
                                Imports NSEL-SPOT Fund Files</h5>
                        </td>
                    </tr>
                    <tr>
                        <td class="lt1">
                            <table class="width100per" cellspacing="0" cellpadding="0" style="height: 150px">
                                ...
                                <tr>
                                    <td align="left" style="width: 300px; height: 29px">
                                        NSEL_BKT01_CMCode_YYYYMMDD.CSV:
                                    </td>
                               ...
                               <%-- <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: left">
                                        ...
                                        <asp:DropDownList ID="ddlBank" runat="server" Width="188px">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr style="display: none">
                                         <td style="width: 297px; height: 44px; text-align: left;">
