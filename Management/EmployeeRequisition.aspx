<%@ page language="C#" autoeventwireup="true" inherits="management_EmployeeRequisition, App_Web_leuczwkw" enableeventvalidation="false" %>
...
<head>
    <title>Employee Requisition Page</title>
    <!--External Styles-->
    ...
    <style type="text/css">       
        ...
        .inputCheck{width:24px; height:25px; margin:-2px;}
        .labelCont{font-size:13px; margin-top:7px;}      
        .btnRight{margin-right:10px; float:right;} 
        .BtnPagingWidth{float:right; width:37%;}               
    </style>
    <!--- Accordin Style-->
    <style type="text/css">
        .AccordionTitle, .AccordionContent, .AccordionContainer {position:relative; }
        .AccordionTitle {margin-right:10px;height:20px;overflow:hidden;cursor:pointer;font-size:9pt; vertical-align:middle; -moz-user-select:none;}
        .AccordionContent {height:0px;overflow:auto;display:block;}      
    </style>
    
</head>
<body>
    <form id="frm_Employee_Requisition" runat="server">        
        <div id="Gmain">
            ...
            <div id="Row0" class="Row">
                <div id="Container1" class="container">
                    ...
                    <div id="C1_Row10" class="Row btnRight">
            ...
            <div id="Row1" class="Row">
                    ...
                    <div class="left pagingContent" style="vertical-align:bottom">
                            ...
                            <span class="textLeft">
                                <a id="A_LeftNav" runat="server" href="javascript:void(0);" onclick="OnLeftNav_Click()">
                                    <img src="../images/LeftNav.gif" align="middle" class="paging_nav" alt="" width="16" />
                                </a>
                            </span>
                ...
                <dxwgv:ASPxGridView ID="GrdEmployeeRequisition" runat="server" AutoGenerateColumns="False" KeyFieldName="ContactID" Width="970px"
                   ...
                   <ClientSideEvents SelectionChanged="OnGridSelectionChanged"  EndCallback="function(s, e){GrdEmployeeRequisition_EndCallBack();}" />                            
                    <SettingsBehavior AllowFocusedRow="True" AutoFilterRowInputDelay="100000" ConfirmDelete="True"
                    ...
                    <Columns>
                        <dxwgv:GridViewCommandColumn ShowSelectCheckbox="True" FixedStyle="Left" VisibleIndex="0" Width="15px" >
                           <%-- <HeaderTemplate>
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Srl." FieldName="SRLNO" FixedStyle="Left"
                            VisibleIndex="1" Width="20px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Name" FieldName="Name" FixedStyle="Left" VisibleIndex="2"
                            Width="150px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="EmpCode" FieldName="EmpCode" FixedStyle="Left"
                            VisibleIndex="3" Width="120px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <%--Start For Employee Log Detail visible Index [4-15]--%>
                        <dxwgv:GridViewDataTextColumn Caption="Requisition Type" FieldName="EmpLog_Type" FixedStyle="Left"
                            VisibleIndex="4" Width="150px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>                            
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Export" FieldName="EmpLog_IsExported" VisibleIndex="5" Width="150px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Exported By" FieldName="ExportedBy" VisibleIndex="6" Width="75px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Export Date" FieldName="EmpLog_ExportedDateTime" VisibleIndex="7" Width="75px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="First Authorized By" FieldName="Authorize1By" VisibleIndex="8" Width="150px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="First Authorized Date" FieldName="EmpLog_AuthorizeDateTime1" VisibleIndex="9" Width="150px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>  
                        <dxwgv:GridViewDataTextColumn Caption="Second Authorized By" FieldName="Authorize2By" VisibleIndex="10" Width="150px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Second Authorized Date" FieldName="EmpLog_AuthorizeDateTime2" VisibleIndex="11" Width="150px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>    
                        <dxwgv:GridViewDataTextColumn Caption="Third Authorized By" FieldName="Authorize3By" VisibleIndex="12" Width="150px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Third Authorized Date" FieldName="EmpLog_AuthorizeDateTime3" VisibleIndex="13" Width="150px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>    
                        <dxwgv:GridViewDataTextColumn Caption="Created By" FieldName="CreatedBy" VisibleIndex="14" Width="150px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Create Date" FieldName="EmpLog_CreateDateTime" VisibleIndex="15" Width="150px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>                          
                         <%--End For Employee Log Detail--%>
                        <dxwgv:GridViewDataTextColumn Caption="Father's Name" FieldName="FatherName" VisibleIndex="16"
                            Width="150px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="DOB" FieldName="DOB" VisibleIndex="17" Width="75px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="DOJ" FieldName="DOJ" VisibleIndex="18" Width="75px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="DOL" FieldName="DOL" VisibleIndex="19" Width="75px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Department" FieldName="Department" VisibleIndex="20"
                            Width="120px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Branch" FieldName="BranchName" VisibleIndex="21"
                            Width="75px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="CTC" FieldName="CTC" VisibleIndex="22" Width="75px">
                            <CellStyle CssClass="gridcellleft" HorizontalAlign="Right" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="ReportTo" FieldName="ReportTo" VisibleIndex="23"
                            Width="150px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Designation" FieldName="Designation" VisibleIndex="24"
                            Width="150px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Company" FieldName="Company" VisibleIndex="25"
                            Width="150px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="EmpType" FieldName="EmpType" VisibleIndex="26"
                            Width="120px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="EmailId(s)" FieldName="Email_Ids" VisibleIndex="27"
                            Width="150px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="PanCard" FieldName="PanCardNumber" VisibleIndex="29"
                            Width="75px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Address" FieldName="Address" VisibleIndex="30"
                            Width="200px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Ac[BankName][Branch][AcType]" FieldName="Bank"
                            VisibleIndex="31" Width="200px">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Emp CreatedBy" FieldName="CreatedBy" VisibleIndex="32">
                            <CellStyle CssClass="gridcellleft" Wrap="False">
                            </CellStyle>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="ContactID" FieldName="ContactID" Visible="False"
