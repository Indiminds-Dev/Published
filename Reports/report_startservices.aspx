<%@ page language="C#" autoeventwireup="true" inherits="Reports_report_startservices, App_Web_yvy99of_" %>
...
<tr>
                    <td class="EHEADER" style="text-align: center;">
                        <strong><span style="color: #000099">Start / Stop Services</span></strong>
                    </td>
                </tr></table>
...
<tr >
    ...
    <tr>--%>
        <td align="left" id="td_yes" runat="server">
            <asp:Button ID="btnYes" runat="server" CssClass="btn" Text="Start Service" Width="180px" OnClick="btnYes_Click" />
        </td>
        <td align="left" id="td_no" runat="server">
            <asp:Button ID="btnNo" runat="server" CssClass="btn" Text="Stop Service" Width="180px" OnClick="btnNo_Click" />
        </td>
