<%@ page language="C#" autoeventwireup="true" inherits="management_GenerateExchangeFee, App_Web_yxggcryg" %>
...
<head id="Head1">
    <title>Generate ESCA/Trdng/Clrng/Setlmnt Fees/Exposure Intrst</title>
...
//            alert('Generate For Remaining Bills...');
        ...
        if(obj=="5")
        {
            ...
            window.location = "../Reports/GenerateExchangeFee.aspx";
        }
          ...
          $get('UpdateProgress1').style.display = 'none'; 
            ...
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Generate ESCA/Trdng/Clrng/Setlmnt Fees/Exposure Intrst</span></strong></td>
