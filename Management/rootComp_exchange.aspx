<%@ page language="C#" autoeventwireup="true" inherits="management_rootComp_exchange, App_Web_ng-agpzn" %>
...
//        var Height='450px'
  ...
  function DeleteRow(keyValue)
    ...
    function FilterOff(obj)
    {
        ...
        if(obj=='EXA0000001' || obj=='EXI0000090')
        {
                                                    ...
                                                    <td>
                                                        <dxwgv:ASPxGridView ID="gridContract" ClientInstanceName="grid" Width="100%" KeyFieldName="exch_internalId"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <dxwgv:GridViewDataTextColumn VisibleIndex="1" FieldName="ExchangeName" Caption="Exchange Name">
                                                                    <CellStyle Wrap="True" CssClass="gridcellleft">
                                                                    </CellStyle>
                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                </dxwgv:GridViewDataTextColumn>
                                                                <dxwgv:GridViewDataTextColumn VisibleIndex="2" FieldName="SegmentName" Caption="Segment Name">
                                                                    <CellStyle Wrap="True" CssClass="gridcellleft">
                                                                    </CellStyle>
                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                </dxwgv:GridViewDataTextColumn>
                                                                <dxwgv:GridViewDataTextColumn VisibleIndex="2" FieldName="MemberShipType" Caption="Membership Type">
                                                                    <CellStyle Wrap="True" CssClass="gridcellleft">
                                                                    </CellStyle>
                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                </dxwgv:GridViewDataTextColumn>
                                                                <dxwgv:GridViewDataTextColumn VisibleIndex="2" FieldName="exch_sebiNo" Caption="SEBI No.">
                                                                    <CellStyle Wrap="True" CssClass="gridcellleft">
                                                                    </CellStyle>
                                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                                </dxwgv:GridViewDataTextColumn>
                                                                <dxwgv:GridViewDataTextColumn VisibleIndex="4">
                                                                    <DataItemTemplate>
                                                                        <a href="javascript:void(0);" onclick="OnAuthSigInfoClick('<%# Container.KeyValue %>')">
                                                                            Auth.Signatory</a>
                                                                    </DataItemTemplate>
                                                                                ...
                                                                                <PanelCollection>
                                                                                    <dxp:PanelContent runat="server">
                                                                                        <table class="TableMain100">
                                                                                            ...
                                                                                            <tr id="Trbroker">
                                                                                                <td class="gridcellleft">
                                                                                                    Inv Grievance Email id Of Broker
                                                                                                </td>
                                                                                            ...
                                                                                            <tr id="Trexchange">
                                                                                                <td class="gridcellleft">
                                                                                                    Inv Grievance Email id Of Exchange
                                                                                                </td>
                                                                                                <td class="gridcellleft" style="color: Red;">
