<%@ page language="C#" autoeventwireup="true" inherits="management_Print_AppointMentLetter, App_Web_alid8jfz" %>
...
<body onload="HideLoading();">
    <form id="form1" runat="server">
        <div id="Gmain">
            ...
            <dxwgv:ASPxGridView ID="GvEmployeeDtl" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="AuthorizeDateTime1" FieldName="AuthDateTime1"
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="AuthorizeDateTime2" FieldName="AuthDateTime2"
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="AuthorizeDateTime3" FieldName="AuthDateTime3"
                        VisibleIndex="13" Width="240px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Printed By" FieldName="ExportedUser" VisibleIndex="14"
                        Width="240px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Printed DateTime" FieldName="ExportedDateTime"
