<%@ page language="C#" autoeventwireup="true" inherits="management_OfflineClient_AuthorisedSignatories, App_Web__yen2upk" %>
    ...
    <div>
     <table class="TableMain100">
                ...
                <tr>
                    ...
                    <dxtc:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="7" ClientInstanceName="page" Font-Size="10px" >
            ...
            <dxtc:ASPxPageControl ID="ASPxPageControl2" runat="server" ActiveTabIndex="0" ClientInstanceName="page">
                                                <tabpages>
							                     <dxtc:TabPage Text="Adress">
                                                    <ContentCollection>
                                                    <dxw:ContentControl runat="server">                                  
  <dxwgv:ASPxGridView ID="AuthSignatory" runat="server" DataSourceID="AuthSignatoryDataSource" ClientInstanceName="gridAuthSignatory"   KeyFieldName="Id" AutoGenerateColumns="False" 
  OnCellEditorInitialize="AuthSignatoryGrid_CellEditorInitialize" Width="100%" Font-Size="10px">
                                                <Columns>
      <dxwgv:GridViewDataTextColumn FieldName="Id" Visible="False" VisibleIndex="0" Caption="Id">
                                ...
                                <dxe:ListEditItem Text="Third Holder" Value="13">
                                                    ...
                                                    <dxwgv:GridViewDataTextColumn FieldName="HolderIndicator" VisibleIndex="0" Caption="Holder Type">
                                                        <EditFormSettings Visible="False" />
                                                        <CellStyle CssClass="gridcellleft">
                                                        </CellStyle>
                                                    </dxwgv:GridViewDataTextColumn>
                                        
                                                    <dxwgv:GridViewDataTextColumn FieldName="SignatoryID" VisibleIndex="3" Caption="Signatory ID">
            ...
            <HeaderTemplate>
<a href="javascript:void(0);" onclick="gridAuthSignatory.AddNewRow();"><span style=" text-align:center;color: #000099;
                    text-decoration: underline">Add New</span> </a>
                                     ...
                                     <dxwgv:GridViewCommandColumn VisibleIndex="12" Visible="False">
                                                ...
                                                <SettingsText PopupEditFormCaption="Add/Modify Authorised Signatory" ConfirmDelete="Do You Really Want To Delete This Record ???" />
...
<dxw:ContentControl runat="server">
 ...
 <%-- <asp:TextBox ID="sessKey"  Width="900px"  TextMode="MultiLine" runat="server" ></asp:TextBox>--%>
    ...
    <asp:SqlDataSource ID="AuthSignatoryDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>" 
            SelectCommand="select NsdlOfflineAuthSignatory_ID as Id, 
case (NsdlOfflineAuthSignatory_HolderIndicator) 
when '11' then 'First Holder'
when '12' then 'Second Holder'
when '13' then 'Third Holder'
end
as HolderIndicator , NsdlOfflineAuthSignatory_SignatoryID  as  SignatoryID  ,  
NsdlOfflineAuthSignatory_CreateUser as  CreateUser, NsdlOfflineAuthSignatory_CreateDateTime  as  CreateDateTime From Trans_NSDLOfflineAuthSignatory where NsdlOfflineAuthSignatory_AccountID = @AccId" DeleteCommand="Delete_OfflineContactAuthSig"  DeleteCommandType="StoredProcedure" InsertCommand="Insert_OfflineContactAuthSig" UpdateCommand="update Trans_NSDLOfflineAuthSignatory set 
NsdlOfflineAuthSignatory_HolderIndicator  = @HolderIndicator , 
NsdlOfflineAuthSignatory_SignatoryID  = @SignatoryID   ,  

NsdlOfflineAuthSignatory_ModifyUser = @ModifyUser,  NsdlOfflineAuthSignatory_ModifyDateTime = getdate() where NsdlOfflineAuthSignatory_ID = @Id" InsertCommandType="StoredProcedure">
            <SelectParameters>
            ...
            <UpdateParameters>
                ...
                <asp:Parameter Name="SignatoryID" Type="string" />
...
<%--        <asp:SqlDataSource ID="AuthSignatoryDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>" ></asp:SqlDataSource>--%>
    </form>
</body>
</html>
