<%@ page language="C#" autoeventwireup="true" inherits="frm_BFXTrades, App_Web_rtil2eyr" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>BFX Trade</title>
                 ...
                 <tr>
                    ...
                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <td>
                                       <asp:DropDownList ID="ddlFileList" runat="server" Width="222px" AutoPostBack="True" Height="30px" OnSelectedIndexChanged="ddlFileList_SelectedIndexChanged">
                                            ...
                                            <asp:ListItem Value="1">CTCL Admin TXT File</asp:ListItem>
                                            <asp:ListItem Value="2">ArabGlobal TXT File</asp:ListItem>
                                            <asp:ListItem Value="3">CSV Files</asp:ListItem>
                                            <asp:ListItem Value="4">RTS Order File</asp:ListItem>
					    <asp:ListItem Value="5">RTS Combined Trade File</asp:ListItem>							
                                    ...
                                    <tr>
                                       <td>
                                            <asp:FileUpload ID="BFXTradeSelectFile" runat="server"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
