<%@ page language="C#" autoeventwireup="true" inherits="management_frmImportNsdlDISMaster, App_Web_5uqmplyf" %>
        ...
        <tbody>
            <tr>
                <td class="lt1" style="height: 40px">
                    <h5>
                        Imports NSDL DIS Master
                    </h5>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="width: auto; height: auto;">
                    <strong>This Routine Imports "DIS Master Download" file available from NSDL DPM System</strong>
                </td>
            </tr>
            <tr>
                                ...
                                <td class="lt">
                                    <table class="width100per" cellspacing="12" cellpadding="0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="lt" width="25%" style="text-align:right">
                                                Select File : 
                                                </td>
                                            ...
                                            <tr style="display: none">
                                                <td>
                                                    <asp:TextBox ID="TextBox1" runat="server" Width="272px">TempTable</asp:TextBox></td>
                                                <td>
                                                    <asp:TextBox ID="TextBox2" runat="server" Width="272px">Import/Table</asp:TextBox></td>
                                                <td>
                                                </td>
                                            </tr>
                                        </tbody>
