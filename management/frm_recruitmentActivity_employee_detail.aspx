<%@ page language="C#" autoeventwireup="true" inherits="management_frm_recruitmentActivity_employee_detail, App_Web_v5pngf_u" %>
                                    ...
                                    <td style="text-align: center; width: 100%;">
                                        <table>
                                            <tr>
                                                ...
                                                <td  class="gridcellleft">
                                                  <%--  <asp:TextBox ID="txtStartDate" runat="server" Font-Size="10px" TabIndex="2" Width="179px"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td  class="gridcellleft">
                                                    <asp:DropDownList ID="drpUserWork" runat="server" Width="203px" Font-Size="10px" TabIndex="3">
                                                    </asp:DropDownList></td>
                                                <td style="width:17px">
                                                </td>
                                                <td style="text-align: right">
                                                ...
                                                <td  class="gridcellleft">
                                                 <%--   <asp:TextBox ID="txtEndDate" runat="server" Font-Size="10px" TabIndex="4" Width="179px"></asp:TextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td  class="gridcellleft" >
                                                    <asp:TextBox ID="txtDesc" runat="server" Width="198px" Font-Size="10px" TabIndex="5" Height="35px" TextMode="MultiLine" ></asp:TextBox>&nbsp;
                                                    </td>
                                                <td style="width:17px">
                                                </td>
                                                <td style="text-align: right">
                                                ...
                                                <td  class="gridcellleft">
                                                    <asp:DropDownList ID="drpPriority" runat ="server" Width ="203px" Font-Size="10px" TabIndex="6">
                                            ...
                                            <tr>
                                                ...
                                                <td  class="gridcellleft"><asp:DropDownList ID="drpCompany" runat="server" Width="203px" Font-Size="10px" TabIndex="7">
                                                </asp:DropDownList></td>
                                                <td style="width:17px">
                                                </td>
                                                <td style="text-align: right">
                                                ...
                                                <td  class="gridcellleft"><asp:DropDownList ID="drpDepartment" runat="server" Width="203px" Font-Size="10px" TabIndex="8">
                                                </asp:DropDownList></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: right">
                                                ...
                                                <td  class="gridcellleft"><asp:DropDownList ID="drpBranch" runat="server" Width="203px" Font-Size="10px" TabIndex="9">
                                                </asp:DropDownList></td>
                                                <td style="width:17px">
                                                </td>
                                                <td style="text-align: right">
                                                ...
                                                <td  class="gridcellleft"><asp:DropDownList ID="drpJobResponsbility" runat="server" Width="203px" Font-Size="10px" TabIndex="10">
                                                </asp:DropDownList></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: right">
                                                ...
                                                <td  class="gridcellleft">
                                                    <asp:DropDownList ID="drpDesignation" Width="203px" Font-Size="10px" runat ="server" TabIndex="11" ></asp:DropDownList>
                                                </td>
                                                <td style="width:17px">
                                                </td>
                                                <td style="text-align: right">
                                                ...
                                                <td  class="gridcellleft">
                                                    <asp:TextBox ID="txtVacancies" runat="server" Width="200px" Font-Size="10px" TabIndex="12" Text="1"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: right">
                                                ...
                                                <td  class="gridcellleft"><asp:DropDownList ID="drpEducation" runat="server" Width="203px" Font-Size="10px" TabIndex="13">
                                                </asp:DropDownList></td>
                                                <td style="width:17px">
                                                </td>
                                                <td style="text-align: right">
                                                ...
                                                <td  class="gridcellleft">
                                                    <asp:DropDownList ID="drpProfessional" Width="203px" Font-Size="10px" runat ="server" TabIndex="14" ></asp:DropDownList></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: right">
                                                ...
                                                <td  class="gridcellleft">
                                                    <asp:TextBox ID="txtExp" runat="server" Width="200px" Font-Size="10px" TabIndex="15" Text="0"></asp:TextBox></td>
                                                <td style="width:17px">
                                                </td>
                                                <td style="text-align: right">
                                            ...
                                            <tr>
                                                ...
                                                <td  class="gridcellleft" style="text-align: center">
                                                    Min<asp:TextBox ID="txtMin" runat="server" Text="0" Width="66px" Font-Size="10px" TabIndex="17"></asp:TextBox>
                                                    &nbsp; &amp;&nbsp;&nbsp; Max<asp:TextBox ID="txtMax" runat="server" Text="0" Width="66px" Font-Size="10px" TabIndex="18" />
                                                </td>
                                                <td style="width:17px">
                                                </td>
                                                <td style="text-align: right">
                                                ...
                                                <td  class="gridcellleft">
                                                    Min<asp:TextBox Font-Size="10px" ID="txtMinAge" runat="server" Text="18" Width="50px" TabIndex="19"></asp:TextBox>
                                                    &nbsp; &amp; &nbsp;&nbsp; Max<asp:TextBox Font-Size="10px" ID="txtMaxAge" runat="server" Text="18" Width="50px" TabIndex="20" />Years
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td  class="gridcellleft">
                                                   <%-- <asp:TextBox ID="txtJoinDate" runat="server" Font-Size="10px" TabIndex="25" Width="179px"></asp:TextBox>
                                                ...
                                                <td  class="gridcellleft"><asp:DropDownList ID="drpIndustry" Width="203px" Font-Size="10px" runat ="server" TabIndex="26" >
                                                </asp:DropDownList></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: right">
                                                ...
                                                <td  class="gridcellleft" colspan="4">
                                                    <asp:TextBox ID="txtInstNote" runat="server" TextMode="MultiLine" Width="558px" Font-Size="10px" TabIndex="27" Height="96px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
