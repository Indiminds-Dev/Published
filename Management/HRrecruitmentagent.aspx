<%@ page language="C#" autoeventwireup="true" inherits="management_HRrecruitmentagent, App_Web_sjbhlkdr" %>
...
<head runat="server">
    ...
    function OnMoreInfoClick(keyValue) 
    {
        ...
        parent.OnMoreInfoClick(url,'Modify Agent Details','940px','450px','Y');
    }
    function callback()
    {
    ...
    function OnAddButtonClick() 
    {
        ...
        parent.OnMoreInfoClick(url,"Add Agent Details",'940px','450px',"Y");
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center">
                    <strong><span style="color: #000099">Recruitment Agents Details</span></strong></td>
            </tr>
            <tr>
                <td>
                    <table width="100%">
