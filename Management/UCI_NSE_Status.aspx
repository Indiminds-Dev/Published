<%@ page language="C#" autoeventwireup="true" inherits="Management_UCI_NSE_Status, App_Web_0payuukt" %>
...
<head id="Head1" runat="server">
    <title>UCI File For Aadhaar Updation Of Individual Clients</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Generate Batch File For Updation Of Client Status</span></strong></td>
       ...
       <table id="tab2" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                        ...
                        <tr> <td style="width: 175px">
                            <strong>Status Change Date From :</strong></td><td style="width: 200px">   <dxe:ASPxDateEdit ID="dtDate" runat="server" EditFormat="Custom" UseMaskBehavior="True"
