<%@ page language="C#" autoeventwireup="true" inherits="Reports_frm_ReportManualBRS, App_Web_91unyima" %>
                ...
                <tr valign="top">
                                    ...
                                    <table cellspacing="1" cellpadding="2" style="background-color: #B7CEEC; border: solid 1px  #ffffff"
                                        ...
                                        <tr id="Tr_BankDetail">
                                            <td class="gridcellleft">
                                                Bank Name :</td>
                                            <td>
                                                <asp:TextBox ID="txtBankName" runat="server" Width="300px" Font-Size="10px" onkeyup="ajax_showOptions(this,'SearchBankNameFromMainAccountForBrs',event,'Current')"></asp:TextBox>
                                            </td>
                    ...
                    <td>
                        <table  cellpadding="1" cellspacing="1" id="showFilter">
                            ...
                            <tr>
                                <td>
                                    <asp:ListBox ID="lstSlection" runat="server" Font-Size="10px" Height="120px" Width="340px">
                                    </asp:ListBox>
                                </td>
                            </tr>
                            <tr>
