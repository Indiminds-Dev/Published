<%@ page language="C#" autoeventwireup="true" inherits="management_frm_STRAClosingRates, App_Web_0jwcfgzk" %>
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports STRAITS' Closing Rates From "Openpositions_DDmmYY_AccountID.csv" Files</h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="lt brdr">
