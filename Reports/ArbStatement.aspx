<%@ page language="C#" autoeventwireup="true" inherits="Reports_ArbStatement, App_Web_chtr38ms" %>
...
//    New Work 08/09/2023    
    if(Obj=='5')////Client+Date Wise ARB PL Summary   
    {
        Hide('Tr_ForDate');
        Show('Tr_Period');
        Show('Tr_Cycle');
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Report Type :</td>
                                        <td>
                                            <asp:DropDownList ID="DdlRptType" runat="server" Width="250px" Font-Size="10px" onchange="FnReportType(this.value)">
                                                ...
                                                <%--New Work 08/09/2023--%>
                                                <asp:ListItem Value="5">Client+Date Wise ARB PL Summary</asp:ListItem>
                                                <%--End of New Work 08/09/2023--%>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Exchange</td>
                                        <td align="left">
                                            &nbsp;<asp:RadioButton ID="RdoExchange_ALL" runat="server" Checked="True" GroupName="RdbGroup_Exchange" onclick="fnArbExchange('ALL')" /></td>
