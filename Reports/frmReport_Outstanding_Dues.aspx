<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableeventvalidation="false" inherits="Reports_frmReport_Outstanding_Dues, App_Web_jaxycpk3" %>
        ...
        <table class="TableMain100" >
            <tr>
                <td class="EHEADER" style="text-align: center;">
                    <strong><span style="color: #000099">Outstanding Dues </span></strong>
                </td>
            </tr>
        </table>
                ...
                <tr id="TrAll">
                    <td style="text-align: left; vertical-align: top;">
                        <table cellspacing="1" cellpadding="2" style="background-color: #B7CEEC; border: solid 1px  #ffffff"
                            ...
                            <tr id="trSeg" runat="server" style="display:none;">
                                <td class="gridcellleft">
                                    Segment:
                                </td>
                            ...
                            <tr id="TrForGroup" style="display:none;">
                                <td class="gridcellleft">
                                    Group By:</td>
                                <td>
                                    <table>
                            ...
                            <tr id="TrForClient" style="display:none;">
                                <td class="gridcellleft">
                                    Client :</td>
                                <td>
                                    <table>
                            ...
                            <tr id="TrSett" runat="server" style="display:none;">
                                <td class="gridcellleft">
                                    Settlement No.:
                                </td>
                                <td style="text-align: left;">
                           ...
                           <%-- style="display:none;"--%>
                            ...
                            <tr id="tr_hdrall" style="display:none;">
                                <td colspan="2">
                                    <table>
                                        <tr>
                            ...
                            <tr id="MailTo" style="display:none;">
                                <td class="gridcellleft">
                                    Mail To:
                                </td>
                                <td class="gridcellleft">
                        ...
                        <tr>
                                ...
                                <td>
                                      ...
                                      <dxe:ASPxTextBox runat="server" ID="TxtDebitAmt" Text="100" Width="100px" onkeypress="return noNumbers(event)">
                                                   <%-- <MaskSettings Mask="<0..99999999g>.<00..99>" IncludeLiterals="DecimalSymbol" />--%>
                                                    <MaskSettings Mask="<0..99999999g>"  />
                             ...
                             <tr>
                                <td class="gridcellleft">
                                    Outstanding For More Than (Days) </td>
                                <td>
                                    
                                    
                                     <dxe:ASPxTextBox runat="server" ID="TxtOutstanding" Text="60" Width="100px" onkeypress="return noNumbers(event)">
                                                    <MaskSettings Mask="<0..99999999g>"  />
                                                    <ValidationSettings ErrorDisplayMode="None">
                                                    </ValidationSettings>
                                                </dxe:ASPxTextBox>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a id="A1" href="javascript:void(0);" onclick="btnRemovefromsubscriptionlist_click()">
                                                                <span style="color: #cc3300; text-decoration: underline; font-size: 8pt;">Remov
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                ...
                <tr id="TrBtn">
                    <td>
                        ...
                        <asp:Button ID="BtnGenerate" runat="server" CssClass="btnUpdate" Text="Generate"
                            Width="100px" OnClick="BtnGenerate_Click" /></td>
