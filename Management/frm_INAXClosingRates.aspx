<%@ page language="C#" autoeventwireup="true" inherits="management_frm_INAXClosingRates, App_Web_n3rnr3dz" %>
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports ADM's Closing Rates From "YYYYmmDDadatpos.csv" Files</h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="lt brdr">
