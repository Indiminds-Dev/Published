<%@ page language="C#" autoeventwireup="true" inherits="management_frmImportNsdlTransactions, App_Web_5uqmplyf" %>
        ...
        <tbody>
            <tr>
                <td class="lt1" style="height: 40px">
                    <h5>
                        Imports NSDL Transactions
                    </h5>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="width: auto; height: auto;">
                    <strong>This Routine Imports "NSDL Transactions" file available from NSDL DPM System</strong>
                </td>
            </tr>
            <tr>
