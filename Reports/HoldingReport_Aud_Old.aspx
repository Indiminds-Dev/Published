<%@ page language="C#" autoeventwireup="true" inherits="Reports_HoldingReport_Aud_Old, App_Web_7htzac9n" enableeventvalidation="false" %>
...
<head id="Head1">
    <title>Holding Report [Date-Wise Format]</title>
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                        <strong><span id="SpanHeader" style="color: #000099">Holding Statement [Date-Wise Format]
                        </span></strong>
                    </td>
