<%@ page language="C#" autoeventwireup="true" inherits="management_OutsourcingComp_Correspondence, App_Web_yxggcryg" %>
         ...
         gridPhone.GetEditor(&quot;phf_extension&quot;).SetVisible(true);
                                                            ...
                                                            <dxwgv:GridViewCommandColumn VisibleIndex="2">
                                                                ...
                                                                <HeaderTemplate>
                                                                    <%if (Session["PageAccess"].ToString().Trim() == "All" || Session["PageAccess"].ToString().Trim() == "Add" || Session["PageAccess"].ToString().Trim() == "DelAdd")
                                                              { %>
                                                                    <dxe:ASPxHyperLink ID="ASPxHyperLink1" runat="server" Text="Add New" ClientSideEvents-Click="function(s, e) {gridPhone.AddNewRow();}"
                                                                        Font-Size="10px" Font-Underline="true">
                                                                    </dxe:ASPxHyperLink>
                                                                    <%} %>
                                                                </HeaderTemplate>
         ...
         gridEmail.GetEditor(&quot;eml_website&quot;).SetVisible(false);
                                                            ...
                                                            <dxwgv:GridViewCommandColumn VisibleIndex="2">
                                                                ...
                                                                <HeaderTemplate>
                                                                    <%if (Session["PageAccess"].ToString().Trim() == "All" || Session["PageAccess"].ToString().Trim() == "Add" || Session["PageAccess"].ToString().Trim() == "DelAdd")
                                                              { %>
                                                                    <dxe:ASPxHyperLink ID="ASPxHyperLink1" runat="server" Text="Add New" ClientSideEvents-Click="function(s, e) {gridEmail.AddNewRow();}"
                                                                        Font-Size="10px" Font-Underline="true">
                                                                    </dxe:ASPxHyperLink>
                                                                    <%} %>
                                                                </HeaderTemplate>
