<%@ page language="C#" autoeventwireup="true" inherits="Management_DividendRatesMaster, App_Web_1jeyysc_" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    ...
    {
      var URL="DividendRates.aspx?id="+obj;
      editwin=dhtmlmodal.open("Editbox", "iframe", URL, "Add/Edit Duty Rates", "width=1100px,height=300px,center=0,resize=1,top=-1", "recal");                 
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" style="text-align: center;">
                        <strong><span style="color: #000099">Dividend Rates</span></strong>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        <dxwgv:ASPxGridView ID="grid" runat="server" AutoGenerateColumns="False"
                            KeyFieldName="DividendRates_ID" Width="1250px" OnRowDeleting="grid_RowDeleting"
                            ...
                            <Columns>
                                ...
                                <dxwgv:GridViewDataTextColumn FieldName="Date" Caption="Record Date" VisibleIndex="2" Width="20px">
                                ...
                                <dxwgv:GridViewDataTextColumn FieldName="Rate" Caption="Dividend Amount" VisibleIndex="4"  Width="20px">
                                    <CellStyle CssClass="gridcellleft" Wrap="False">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="" Caption="Modify" VisibleIndex="5"  Width="20px">
                                <DataItemTemplate>Click to Modify</DataItemTemplate>
                                    <CellStyle CssClass="gridcellleft" Wrap="False">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewCommandColumn VisibleIndex="6" Width="10%">
