<%@ page language="C#" autoeventwireup="true" inherits="management_ImportProvCloseRates, App_Web_yf04ozfw" %>
    ...
    <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 22px;">
                        <strong><span id="SpanHeader" style="color: #000099">Imports Provisional Closing Rates</span></strong>
                    </td>
                </tr></table>
            ...
            <tr>
                ...
                <td style="padding-left:4px" align=left>
                    <select id="cmbTrade" onchange="Javascript:ShowDate(this.value)" runat="server">
                        <option selected="selected">Provisional Rates File</option>
                    </select>
                </td>
            </tr>
