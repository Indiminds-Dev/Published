<%@ page language="C#" autoeventwireup="true" inherits="Reports_PoaAccountPayIN, App_Web_arnfzykg" %>
                    ...
                    <td style="width: 369px">
                        <table style="border: solid 1px blue">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtSettNo" Font-Size="10px" runat="server" onkeyup="FunSettNumber(this,'ShowClientScrip',event)"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="ddlSourceDp" Font-Size="10px" runat="server" Width="235px"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlTargetAc" Font-Size="10px" runat="server" Width="236px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlTransferType" Font-Size="10px" runat="server" Width="235px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtSlipNumber" Font-Size="10px" runat="server" Width="231px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td class="gridcellleft">
                                ...
                                <td>
                                    <dxe:ASPxDateEdit ID="DtTransferDate" runat="server" Font-Size="10px" Width="234px"
                                                ...
                                                <asp:GridView ID="grdPOAClient" runat="server" Width="100%" BorderColor="CornflowerBlue"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Transfer Qty">
                                                            ...
                                                            <HeaderStyle Wrap="False" HorizontalAlign="Left" Font-Bold="False"></HeaderStyle>
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtReceived" Font-Size="10px" Width="60px" runat="server" Text='<%# Eval("Received") %>'
