<%@ page language="C#" autoeventwireup="true" inherits="management_FXRateEntryRoot, App_Web_e81qjzgk" %>
...
//             }
             ...
             function OnAddNewButtonClick(obj)
             {
                ...
                var URL="FXRateEntryRootPopup.aspx?id="+obj + "&dt=" + currentDate + "";
                var GridParams="";
...
//                cPopUp_FXRate.Show();
                ...
                var URL="FXRateEntryRootPopup.aspx?id=Edit" + "&dt=" + ratedate + "&fcur=" + fromCurrency +"&tcur=" + toCurrency +"&rt=" + rate + "";
                var GridParams="";
                editwin=dhtmlmodal.open("Editbox", "iframe", URL, "Add/Edit FX Rates", "width=1100px,height=200px,center=1,resize=1,top=-1", "recal");
                editwin.onclose=function()
                 {
