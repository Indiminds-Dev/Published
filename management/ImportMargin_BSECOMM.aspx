<%@ page language="C#" autoeventwireup="true" inherits="management_ImportMargin_BSECOMM, App_Web_d1rqvttb" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>BSE-COMM Margin Files</title>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports BCX_MG01_TM_<memCode>_YYYYMMDD.csv Available through Extranet
                        </h5>
                    </td>
                </tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="gridcellleft">
                                            <span style="color: #000099; text-align: right">TM's Margin File</span></td>
