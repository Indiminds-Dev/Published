<%@ page language="C#" autoeventwireup="true" inherits="management_frmScriptIsin_MCXSXCM, App_Web_yq8u0p-o" %>
            ...
            <tbody>
                <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports Scrip Master [MCX-SX-EQ_SCRIP.csv] File
                        </h5>
                    </td>
                </tr>
                                                    ...
                                                    <td class="lt" >
                                                        ...
                                                        <table>
                                                         ...
                                                         <asp:Label id="lblMessage" runat="server" Width="270px"></asp:Label><br />
                                                           <asp:Label ID="Label2" runat="server" Font-Bold="True" Text=" Select MCX-SX-EQ_SCRIP.csv file"
                                                               Width="187px"></asp:Label>
                                                            </ContentTemplate>
                                                      
                                                      	 </asp:UpdatePanel>
                                                                    <strong>Files Avialable At : FTP Root path\Common\</strong></td>
                                                         </tr>
