<%@ page language="C#" autoeventwireup="true" inherits="management_InsuranceLife, App_Web_im-ehkhh" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    <form id="form1" runat="server">
        <table class="TableMain100" style="text-align: center;">
            <tr>
                <td class="EHEADER">
                    <strong><span style="color: #000099">Insurance Life</span></strong></td>
            </tr>
            <tr>
                <td>
                    <table width="100%">
                        ...
                        <Columns>
                            ...
                            <dxwgv:GridViewDataComboBoxColumn Caption="Insurance Plan Type" FieldName="IPlanType"
                                ...
                                <PropertiesComboBox DataSourceID="RiderPlanType" EnableIncrementalFiltering="True"
                                    TextField="insu_description" ValueField="insu_description" ValueType="System.String">
                                        ...
                                        <tr>
                                            <td style="width: 99%; text-align: center;">
                                                <dxtc:ASPxPageControl runat="server" ID="pageControl" Width="100%" ActiveTabIndex="0"
                                                    ClientInstanceName="tabs" TabIndex="1">
                                                    <TabPages>
        ...
        <asp:SqlDataSource ID="RiderName" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
            SelectCommand="SELECT LTRIM(RTRIM(insu_internalId)) as insu_internalId, insu_nameOfCompany FROM tbl_master_insurerName WHERE (insu_InsuranceCompType = 'Life Insurers') order by insu_nameOfCompany">
        </asp:SqlDataSource>
        <asp:SqlDataSource ID="RiderMain" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
            InsertCommand="InsuLifeInsert" InsertCommandType="StoredProcedure" SelectCommand="InsuLifeSelect"
            SelectCommandType="StoredProcedure" UpdateCommand="InsuLifeUpdate" UpdateCommandType="StoredProcedure"
