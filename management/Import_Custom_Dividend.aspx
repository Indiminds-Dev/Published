<%@ page language="C#" autoeventwireup="true" inherits="management_Import_Custom_Dividend, App_Web__yen2upk" %>
...
<head id="Head1" runat="server">
   ...
   <script type="text/javascript" src="../JSFUNCTION/GenericJScript.js"></script>
    <title>Import Dividend Rates From Custom CSV File</title>
                                                ...
                                                <table class="width100per" cellspacing="12" cellpadding="0">
                                                    <tbody>
                                                         ...
                                                         <tr>
                                                            ...
                                                            <%--<asp:HyperLink ID="HyperLink1" runat="server" ForeColor="Blue" Width="266px"  NavigateUrl="~/C:/SAMPLE_DIVIDEND_RATES.csv" Target="_blank">View File Format</asp:HyperLink>--%>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <div style="float:left">&nbsp;&nbsp;
                                                                ...
                                                                <dxe:aspxcombobox id="ComboReImpOrDel" runat="server" clientinstancename="cComboReImpOrDel" 
                                                                    ...
                                                                    width="75px">
                                                                    <items>
                                                                                <dxe:ListEditItem Value="G" Text="Import"></dxe:ListEditItem>
                                                                    </items>
