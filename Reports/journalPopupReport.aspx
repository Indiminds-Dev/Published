<%@ page language="C#" autoeventwireup="true" inherits="management_journalPopupReport, App_Web_xpx38is4" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="javascript:document.form1.ddlCompany.focus();">
