<%@ page language="C#" autoeventwireup="true" inherits="Reports_PositionFileSpanNSEFO, App_Web_cnvbs8pk" %>
...
<head id="Head1" runat="server">
    <title>Margin Calculation For NSE FO</title>
                ...
                <table border="1" width="100%">
                    <tr style="display: none">
                        <td style="height: 62px">
                            <asp:DropDownList ID="cmbclient" runat="server" AutoPostBack="True" Font-Size="10px"
                                Width="300px">
                                ...
                                <ContentTemplate>
                                    <table runat="server">
                                        <tr valign="top">
                                            ...
                                            <td style="height: 44px">
                                                <asp:DropDownList ID="cmbgroup" runat="server" AutoPostBack="True" Font-Size="10px"
