<%@ page language="C#" autoeventwireup="true" inherits="frm_UCXContracts, App_Web_g1t3n0jz" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Import UCX Contract</title>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td align="right" style="width: 278px; height: 22px">
                                            <asp:FileUpload ID="UCXSelectFile" runat="server" Height="20px"/>
                                        </td>
                                    </tr>
                                    <tr>
