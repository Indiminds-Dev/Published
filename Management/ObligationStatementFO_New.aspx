<%@ page language="C#" autoeventwireup="true" inherits="management_ObligationStatementFO_New, App_Web_gflohp-r" %>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DropDownList1" runat="server" Width="250px" Font-Size="10px">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <table width="100%" border="1">
                            <tr style="display: none;">
                                <td>
                                    ...
                                    <asp:DropDownList ID="cmbproduct" runat="server" Font-Size="10px" Width="300px" AutoPostBack="True">
                                    </asp:DropDownList>
                                </td>
                            </tr>
