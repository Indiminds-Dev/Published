<%@ page language="C#" autoeventwireup="true" inherits="management_CopyCloseRates_ARBE, App_Web_-k9nslwd" %>
...
<head id="Head1">
    <title>Create Close Rates Of Products Of This Segment In ARBE Segment For The Given Period</title>
...
//            alert('Generate For Remaining Bills...');
        ...
        if(obj=="5")
        {
            ...
            window.location = "../management/CopyCloseRates_ARBE.aspx";
        }
          ...
          $get('UpdateProgress1').style.display = 'none'; 
            ...
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Create Close Rates Of Products Of This Segment In ARBE Segment For The Given Period</span></strong></td>
                                    ...
                                    <table border="10" cellpadding="1" cellspacing="1">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" align="left">
                                                <asp:DropDownList ID="dllGenerate" runat="server" Width="220px" Font-Size="10px">
                                                    <asp:ListItem Value="G">Create/ReCreate For All Products</asp:ListItem>
                                                    <asp:ListItem Value="D">Create For Only Missing Products in ARBE</asp:ListItem>
                                                </asp:DropDownList></td>
                                        </tr>
                                    </table>
                                </td>
