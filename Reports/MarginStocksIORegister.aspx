<%@ page language="C#" autoeventwireup="true" inherits="Reports_MarginStocksIORegister, App_Web_arnfzykg" enableeventvalidation="false" %>
...
<head id="Head1">
    <title>Margin Stocks Inward/Outward Register </title>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ddlGeneration" runat="server" Width="100px" Font-Size="10px"
                                                                   ...
                                                                   <%--  <asp:ListItem Value="4">Export Excel</asp:ListItem>--%>
                                                                     <asp:ListItem Value="2">Export PDF</asp:ListItem>
                                                       ...
                                                       <table border="10" cellpadding="1" cellspacing="1">
                                                           <tr>
                                                               <td class="gridcellleft" bgcolor="#B7CEEC">
                                                                   Respective :</td>
                                                               <td>
                                                                   <asp:DropDownList ID="ddlEmailuserwise" runat="server" Width="100px" Font-Size="10px">
                                                                       <asp:ListItem Value="2">User</asp:ListItem>
                                                                   </asp:DropDownList></td>
                                                           </tr>
                                                       </table>
