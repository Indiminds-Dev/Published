<%@ page language="C#" autoeventwireup="true" inherits="Management_SPICEDirectRegistration, App_Web_bfdn6hbr" %>
...
<head id="Head1" runat="server">
    <title>Generate Batch File For POA/DDPI Client Registration [SPICE Direct]</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Batch File For SPICE-Direct Registration</span></strong></td>
