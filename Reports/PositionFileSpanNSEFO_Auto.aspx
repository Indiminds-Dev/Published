<%@ page language="C#" autoeventwireup="true" inherits="Reports_PositionFileSpanNSEFO_Auto, App_Web_jaxycpk3" %>
...
<head id="Head1" runat="server">
 ...
 <script language="javascript" type="text/javascript">
     ...
     function AfterGenerateClick_Load()///Call Into Page Load
     {
                        ...
                        <tr>
                         ...
                         <tr>
                                ...
                                <asp:Button ID="btnGenerate" runat="server" CssClass="btnUpdate" Height="20px" Text="Generate File"
                                      Width="101px" OnClick="btnGenerate_Click" OnClientClick="showProgress()" /> 
                            ...
                            <td>
                             ...
                             <asp:Button ID="BtnExport" runat="server" CssClass="btnUpdate" Height="20px" Text="Download File"
