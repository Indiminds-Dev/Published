<%@ page language="C#" autoeventwireup="true" inherits="management_frm_insurancecommission_ReceivableSetup, App_Web_0jwcfgzk" %>
...
<head runat="server">
    <title>Insurance Commission Receivable Setup</title>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function OnAddButtonClick()
        {
            ...
            else
            {
                ...
                var url='frm_insurancecommission_ReceivableSetup_AddEdit.aspx?id='+'ADD~'+txtI.value+'~'+txtN.value;
        ...
        function OnMoreInfoClick(obj)
        {
            var txtI=document.getElementById("txtInsuranceCompany_hidden");
            var txtN=document.getElementById("txtInsuranceCompany");
            var url='frm_insurancecommission_ReceivableSetup_AddEdit.aspx?id='+'EDIT~'+txtI.value+'~'+txtN.value+'~'+obj;
            parent.OnMoreInfoClick(url,'Add Insurance Commission Receivable','950px','450px','Y');
        }
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center;">
                    <span style="color: Blue"><strong>Insurance Commission Receivable Setup</strong></span>
                </td>
            </tr>
            <tr>
                <td>
                    <table cellspacing="0px">
                        <tr>
                            ...
                            <td>
                                &nbsp;&nbsp;&nbsp;<span class="Ecoheadtxt" style="color: Blue"><strong>Insurer Company:</strong></span>
                            </td>
                            <td class="gridcellleft">
            ...
            <tr>
                <td class="gridcellcenter">
                    <dxwgv:ASPxGridView ID="grdInsRecSetup" runat="server" AutoGenerateColumns="False"
                        KeyFieldName="InsCommissionMain_ID" Width="100%" ClientInstanceName="grid" OnCustomCallback="grdInsRecSetup_CustomCallback"
                        ...
                        <Columns>
                            <dxwgv:GridViewDataDateColumn Caption="From Date" FieldName="InsCommissionMain_DateFrom"
                                VisibleIndex="1">
                            ...
                            <dxwgv:GridViewDataDateColumn Caption="To Date" FieldName="InsCommissionMain_DateTo"
                                VisibleIndex="2">
                                <PropertiesDateEdit DisplayFormatString="{0:dd MMM yyyy}" EditFormat="Custom" EditFormatString="dd-MM-yyyy"
                                    UseMaskBehavior="True">
                                </PropertiesDateEdit>
                            ...
                            <dxwgv:GridViewDataTextColumn Caption="Insurer Company" FieldName="insurer"
                                VisibleIndex="0">
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                                <EditFormCaptionStyle HorizontalAlign="Right">
            ...
            <tr>
                <td>
                    <asp:SqlDataSource ID="DgrdInsRecSetup" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
                        SelectCommand="SELECT [InsCommissionMain_ID],(select RTRIM(LTRIM(insu_nameOfCompany)) from  tbl_master_insurerName where insu_internalId=[InsCommissionMain_InsurerID]) as insurer,[InsCommissionMain_DateFrom],[InsCommissionMain_DateTo] from [Config_InsCommissionMain] where [InsCommissionMain_CompanyID]=@InsCommissionMain_CompanyID and InsCommissionMain_InsurerID=@InsCommissionMain_InsurerID">
                    <SelectParameters>
                        <asp:SessionParameter Name="InsCommissionMain_CompanyID" SessionField="LastCompany" Type="string" />
                        <asp:Parameter Name="InsCommissionMain_InsurerID" Type="string" />
                    </SelectParameters>
                    </asp:SqlDataSource>
