<%@ page language="C#" debug="true" autoeventwireup="true" inherits="Reports_frmReport_NoTransOnlyHolding, App_Web_qrhyroaj" %>
                ...
                <table class="TableMain100">
                    ...
                    <tr id="tr_grid">
                        <td style="text-align: left; width: 995px; vertical-align: top;" id="FormGrid">
                            <dxwgv:ASPxGridView ID="GridReminder" ClientInstanceName="grid" runat="server" KeyFieldName="BenAccountNumber"
                                ...
                                <Columns>
                                    <dxwgv:GridViewDataTextColumn Caption="AccountNumber" FieldName="BenAccountNumber"
                                        ReadOnly="True" VisibleIndex="1">
                                        <EditFormSettings Visible="False" />
                                    </dxwgv:GridViewDataTextColumn>
                                    <dxwgv:GridViewDataTextColumn Caption="Name" FieldName="name1" ReadOnly="True" VisibleIndex="2">
                                        <EditFormSettings Visible="False" />
                                    </dxwgv:GridViewDataTextColumn>
                                    <dxwgv:GridViewDataTextColumn Caption="Address" FieldName="Address1" ReadOnly="True"
                                        VisibleIndex="3">
                                        <EditFormSettings Visible="False" />
                                    </dxwgv:GridViewDataTextColumn>
                                    <dxwgv:GridViewDataTextColumn Caption="Pin No" FieldName="PinNo" ReadOnly="True"
                                        VisibleIndex="4" Width="10%">
                                        <EditFormSettings Visible="False" />
                                    </dxwgv:GridViewDataTextColumn>
                                    <dxwgv:GridViewDataTextColumn Caption="Phone No" FieldName="PhoneNo" ReadOnly="True"
                                        VisibleIndex="5">
                                        <EditFormSettings Visible="False" />
                                    </dxwgv:GridViewDataTextColumn>
