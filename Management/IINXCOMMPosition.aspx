<%@ page language="C#" autoeventwireup="true" inherits="management_IINXCOMMPosition, App_Web_i8xxwgwk" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>IINX-COMM Final-Settlement Trades</title>
                ...
                <table id="tbl_main" class="login" cellspacing="0" cellpadding="0" width="470">
                    <tbody>
                        <tr>
                            <td class="lt1">
                                <h5>
                                    Imports Position Files To Generate Final Settlement Trades
                                </h5>
                            </td>
                        </tr>
                        <tr>
                                                                            ...
                                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                                <ContentTemplate>
                                                                                    <asp:DropDownList ID="ddlFileList" runat="server" Width="210px" AutoPostBack="True"
                                                                                        ...
                                                                                        <asp:ListItem Value="1">IINX-COMM_POSITION File</asp:ListItem>	
                                                                                    </asp:DropDownList><br />
