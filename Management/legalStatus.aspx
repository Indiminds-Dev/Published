<%@ page language="C#" autoeventwireup="true" inherits="management_legalStatus, App_Web_s3wzohpw" %>
...
<table  class="TableMain100">
    ...
    <tr>
        <td>
<dxwgv:ASPxGridView ID="LegalStatusGrid" ClientInstanceName="grid" runat="server" AutoGenerateColumns="False"
        ...
        <Columns>
            <dxwgv:GridViewDataTextColumn FieldName="lgl_id" ReadOnly="True" Visible="False"
                VisibleIndex="0">
                <EditFormSettings Visible="False" />
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataTextColumn Caption="Legal Status" FieldName="lgl_legalStatus"
            ...
            <dxwgv:GridViewCommandColumn VisibleIndex="1">
                ...
                <HeaderTemplate> <a href="javascript:void(0);" onclick="grid.AddNewRow()">
                      <span style="color: #000099; text-decoration: underline">Add New</span></a></HeaderTemplate>
