...
<%@ page language="C#" autoeventwireup="true" inherits="management_journalvoucherledgeredit, App_Web_sf8qvqgk" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <blink><b id="bLockIdicator" style="text-decoration:underline;width:100%;color:Red;"></b></blink>
             <!--Currency Setting-->
            <dxcp:ASPxCallbackPanel ID="CbpChoosenCurrency" runat="server" ClientInstanceName="cCbpChoosenCurrency" BackColor="Transparent" OnCallback="CbpChoosenCurrency_Callback">
            <PanelCollection>
                            ...
                            <tr>
                                <td style="font-weight: bold; text-align: left; text-decoration: underline; background-color: #b7ceec; width: 134px;" valign="top">
                                    ...
                                    <asp:TextBox ID="txtNarration1" Font-Names="Arial" runat="server" TextMode="MultiLine"
                                        Width="99%" Font-Size="10px" Height="16px" TabIndex="0"></asp:TextBox></td>
                            </tr>
                            <tr>
...
<HoverStyle BackColor="#8080FF" ForeColor="White"></HoverStyle>
                                    ...
                                    <table width="100%" border="1">
                                        <tr id="Tdebit" runat="server">
                                            ...
                                            <td style="width: 79px; text-align: left; height: 14px;" valign="top">
                                                <dxe:ASPxTextBox ID="txtTDebit" runat="server" Width="105px" ClientInstanceName="ctxtTDebit" HorizontalAlign="Right" Font-Size="10px">
                                                    <MaskSettings Mask="&lt;0..9999999999g&gt;.&lt;00..99&gt;"  IncludeLiterals="DecimalSymbol" />
                                                    <ValidationSettings ErrorDisplayMode="None">
                                                    </ValidationSettings>
                                                </dxe:ASPxTextBox>
                                            ...
                                            <td style="text-align: left; height: 14px;" valign="top">
                                                <dxe:ASPxTextBox ID="txtTCredit" runat="server" Width="105px" ClientInstanceName="ctxtTCredit" HorizontalAlign="Right" Font-Size="10px">
                                                    <MaskSettings Mask="&lt;0..9999999999g&gt;.&lt;00..99&gt;"  IncludeLiterals="DecimalSymbol" />
                                                    <ValidationSettings ErrorDisplayMode="None">
                                                    </ValidationSettings>
                                                </dxe:ASPxTextBox>
                        ...
                        <dxwgv:ASPxGridView ID="DetailsGrid" runat="server" AutoGenerateColumns="False" ClientInstanceName="cDetailsGrid"
                            ...
                            OnHtmlRowPrepared="DetailsGrid_HtmlRowPrepared" Font-Size="10px" OnCommandButtonInitialize="DetailsGrid_CommandButtonInitialize">
                            ...
                            <Columns>
                                <dxwgv:GridViewDataTextColumn FieldName="MainAccount1" Caption="Main Account" VisibleIndex="0" Width="25%">
                                    <CellStyle Wrap="False" CssClass="gridcellleft">
                                    </CellStyle>
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="SubAccount1" Caption="Sub Account" VisibleIndex="1" Width="40%">
                                    <CellStyle Wrap="False" CssClass="gridcellleft">
                                    </CellStyle>
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="WithDrawl" Caption="Debit" VisibleIndex="2" Width="10%">
                                    <CellStyle Wrap="False" CssClass="gridcellleft" HorizontalAlign="Right">
                                    </CellStyle>
                                </dxwgv:GridViewDataTextColumn>
                                 <dxwgv:GridViewDataTextColumn FieldName="Receipt" Caption="Credit" VisibleIndex="3" Width="10%">
                                    <CellStyle Wrap="False" CssClass="gridcellleft" HorizontalAlign="Right">
                                    </CellStyle>
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="CashReportID" Visible="False">
                                  </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="SubNarration" Visible="False">
                                </dxwgv:GridViewDataTextColumn>
                                ...
                                <EditForm>
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dxe:ASPxTextBox ID="txtdebit" runat="server" Font-Size="13px" Width="140px" ClientInstanceName="ctxtdebitE" Text='<%# Bind("WithDrawl") %>' 
                                            ...
                                            <td>
                                                <dxe:ASPxTextBox ID="txtcredit" runat="server" Width="145px" Font-Size="13px" ClientInstanceName="ctxtcreditE"
                                        ...
                                        <tr>
                                            <td style="font-weight: bold;font-size:10px;text-decoration: underline; height: 16px;" valign="top">
                                                Line Narration</td>
                                            <td  colspan="3">
                                                <asp:TextBox Font-Size="13px" Font-Names="Arial" ID="txtNarration1" runat="server" Text='<%# Bind("SubNarration") %>'
                            ...
                            <tr>
                                <td style="width: 100px; height: 178px">
                                    <dxwgv:ASPxGridView ID="GvJvSearch" runat="server" AutoGenerateColumns="False"
                                        ...
                                        OnCustomJSProperties="GvJvSearch_CustomJSProperties" Font-Size="10px" >
                                        ...
                                        <Columns>
                                            <dxwgv:GridViewDataTextColumn FieldName="JvID" Caption="Main Account" VisibleIndex="0" Visible="False">
                                                <CellStyle Wrap="False" CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="VoucherNumber" Caption="Jv Number" VisibleIndex="0"
                                                Width="20%">
                                                <CellStyle Wrap="False" CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="BranchNameCode" Caption="Branch" VisibleIndex="1"
                                                Width="20%">
                                                <CellStyle Wrap="False" CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="Narration" Caption="Narration" VisibleIndex="2"
                                                Width="60%">
                                                <CellStyle CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="IBRef" Visible="False" VisibleIndex="4">
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="WhichTypeItem" Visible="False" VisibleIndex="5">
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewCommandColumn VisibleIndex="3" Width="15%">
                                                <CustomButtons>
             ...
             <dxpc:ASPxPopupControl ID="SearchPopUp" runat="server" HeaderText="Filter" ClientInstanceName="cSearchPopUp">
                            <ContentCollection>
               ...
               <dxpc:ASPxPopupControl ID="MsgPopUp" runat="server" HeaderText="Notice" ClientInstanceName="cMsgPopUp" Width="387px" Left="200" ShowSizeGrip="False" Top="200" CloseAction="None" Modal="True">
                            <ContentCollection>
                                <dxpc:PopupControlContentControl runat="server">
                                    <table class="style1">
                                        <tr>
                ...
                <dxpc:ASPxPopupControl ID="DeleteMsgPopUp" runat="server" HeaderText="Notice" ClientInstanceName="cDeleteMsgPopUp" Width="387px" Left="200" ShowSizeGrip="False" Top="200">
                            <ContentCollection>
                                <dxpc:PopupControlContentControl runat="server">
                                    <table class="style1">
                                        <tr>
                         ...
                         <dxpc:ASPxPopupControl ID="FileUsedByPopUp" runat="server" HeaderText="Notice" ClientInstanceName="cFileUsedByPopUp" Width="387px" Left="200" ShowSizeGrip="False" Top="200">
                            <ContentCollection>
