<%@ page language="C#" autoeventwireup="true" inherits="Kra_KraAuthentication_ImageViewer, App_Web_l9bhfzmo" %>
...
//        alert(obj);
//    }     
    function imageanchorset(obj,docname,docerror,docerrorcode)
    {
        if (obj.split('~')[0]!='none')
        {
...
//                    HideShow('fileUpload1','S');
//                    GetObjectID('FU1').innerHTML=docname.split('~')[0];
//                    HideShow('divBtnFile1','S');          
                }
                else
                {
//                    HideShow('fileUpload1','H');  
//                    HideShow('divBtnFile1','H');   
                    GetObjectID('img1').src="../Kra/KRADOC/"+obj.split('~')[0];
                    GetObjectID('a1').href="../Kra/KRADOC/"+obj.split('~')[0];
                    GetObjectID('a1').title=docname.split('~')[0];
                    GetObjectID('S1').innerHTML=docname.split('~')[0];
            ...
            if (docerror=="0")
            {
                if ((docerrorcode.split('$')[0]=="err1") || (docerrorcode.split('$')[1]=="err1")|| (docerrorcode.split('$')[2]=="err1")|| (docerrorcode.split('$')[3]=="err1") || (docerrorcode.split('$')[4]=="err1") || (docerrorcode.split('$')[5]=="err1") || (docerrorcode.split('$')[6]=="err1")|| (docerrorcode.split('$')[7]=="err1")|| (docerrorcode.split('$')[8]=="err1"))
                {
                    GetObjectID('su1').style.display='none';
...
//                    HideShow('fileUpload2','S');
//                    HideShow('divBtnFile2','S');        
//                    GetObjectID('FU2').innerHTML=docname.split('~')[1];                                                           
                }
                else
                {
//                    HideShow('fileUpload2','H');
//                    HideShow('divBtnFile2','H');          
                ...
                if (docerror=="0")
                {
                    if ((docerrorcode.split('$')[0]=="err2") || (docerrorcode.split('$')[1]=="err2")|| (docerrorcode.split('$')[2]=="err2")|| (docerrorcode.split('$')[3]=="err2") || (docerrorcode.split('$')[4]=="err2") || (docerrorcode.split('$')[5]=="err2") || (docerrorcode.split('$')[6]=="err2")|| (docerrorcode.split('$')[7]=="err2")|| (docerrorcode.split('$')[8]=="err2"))
                    {
                        GetObjectID('su2').style.display='none';
            ...
            {                    
                ...
                if (docerror=="0")
                {
                    if ((docerrorcode.split('$')[0]=="err3") || (docerrorcode.split('$')[1]=="err3")|| (docerrorcode.split('$')[2]=="err3")|| (docerrorcode.split('$')[3]=="err3") || (docerrorcode.split('$')[4]=="err3") || (docerrorcode.split('$')[5]=="err3") || (docerrorcode.split('$')[6]=="err3")|| (docerrorcode.split('$')[7]=="err3")|| (docerrorcode.split('$')[8]=="err3"))
                    {
                        GetObjectID('su3').style.display='none';
            ...
            {                    
                ...
                if (docerror=="0")
                {
                    if ((docerrorcode.split('$')[0]=="err4") || (docerrorcode.split('$')[1]=="err4")|| (docerrorcode.split('$')[2]=="err4")|| (docerrorcode.split('$')[3]=="err4") || (docerrorcode.split('$')[4]=="err4") || (docerrorcode.split('$')[5]=="err4") || (docerrorcode.split('$')[6]=="err4") || (docerrorcode.split('$')[7]=="err4") || (docerrorcode.split('$')[8]=="err4"))
                    {
                        GetObjectID('su4').style.display='none';
            ...
            {                
                ...
                if (docerror=="0")
                {
                    if ((docerrorcode.split('$')[0]=="err5") || (docerrorcode.split('$')[1]=="err5")|| (docerrorcode.split('$')[2]=="err5")|| (docerrorcode.split('$')[3]=="err5") || (docerrorcode.split('$')[4]=="err5") || (docerrorcode.split('$')[5]=="err5") || (docerrorcode.split('$')[6]=="err5") || (docerrorcode.split('$')[7]=="err5") || (docerrorcode.split('$')[8]=="err5"))
                    {
                        GetObjectID('su5').style.display='none';
            ...
            if (obj.split('~')[5]!=undefined)
            {
                ...
                if (docerror=="0")
                {
                    if ((docerrorcode.split('$')[0]=="err6") || (docerrorcode.split('$')[1]=="err6")|| (docerrorcode.split('$')[2]=="err6")|| (docerrorcode.split('$')[3]=="err6") || (docerrorcode.split('$')[4]=="err6") || (docerrorcode.split('$')[5]=="err6") || (docerrorcode.split('$')[6]=="err6") || (docerrorcode.split('$')[7]=="err6") || (docerrorcode.split('$')[8]=="err6"))
                    {
                        GetObjectID('su6').style.display='none';
            ...
            if (obj.split('~')[6]!=undefined)
            {
                ...
                if (docerror=="0")
                {
                    if ((docerrorcode.split('$')[0]=="err7") || (docerrorcode.split('$')[1]=="err7")|| (docerrorcode.split('$')[2]=="err7")|| (docerrorcode.split('$')[3]=="err7") || (docerrorcode.split('$')[4]=="err7") || (docerrorcode.split('$')[5]=="err7") || (docerrorcode.split('$')[6]=="err7") || (docerrorcode.split('$')[7]=="err7") || (docerrorcode.split('$')[8]=="err7"))
                    {
                        GetObjectID('su7').style.display='none';
            ...
            if (obj.split('~')[7]!=undefined)
            {
                ...
                if (docerror=="0")
                {
                    if ((docerrorcode.split('$')[0]=="err8") || (docerrorcode.split('$')[1]=="err8")|| (docerrorcode.split('$')[2]=="err8")|| (docerrorcode.split('$')[3]=="err8") || (docerrorcode.split('$')[4]=="err8") || (docerrorcode.split('$')[5]=="err8") || (docerrorcode.split('$')[6]=="err8") || (docerrorcode.split('$')[7]=="err8") || (docerrorcode.split('$')[8]=="err8"))
                    {
                        GetObjectID('su8').style.display='none';
            ...
            if (obj.split('~')[8]!=undefined)
            {
                ...
                if (docerror=="0")
                {
                    if ((docerrorcode.split('$')[0]=="err9") || (docerrorcode.split('$')[1]=="err9")|| (docerrorcode.split('$')[2]=="err9")|| (docerrorcode.split('$')[3]=="err9") || (docerrorcode.split('$')[4]=="err9") || (docerrorcode.split('$')[5]=="err9") || (docerrorcode.split('$')[6]=="err9") || (docerrorcode.split('$')[7]=="err9") || (docerrorcode.split('$')[8]=="err9"))
                    {
                        GetObjectID('su9').style.display='none';
    ...
    function btnok_Click()
    {
        ...
        var counter1="";
//        alert(GetObjectID('err6').style.display);
//        alert(GetObjectID('su6').style.display);
     ...
     function CbpSuggestdocument_EndCallBack()
        {
            if ((cCbpSuggestdocument.cptotaldoc != null) && (cCbpSuggestdocument.cpverifieddoc != null))
            {
                ...
                if (GetObjectID('<%=B_cpverifieddoc.ClientID %>').innerHTML==GetObjectID('<%=B_cptotaldoc.ClientID %>').innerHTML)
                {
...
//            if(obj=="BtnFile1")
//            {
//                fPath=GetObjectID('FU1').innerHTML;
//                postedControl='fileUpload1';               
//            }
//            if(obj=="BtnFile2")
//            {
//                fPath=GetObjectID('FU2').innerHTML;
//                postedControl='fileUpload2';                
//            }
//            alert(fPath+"="+postedControl);
//            cCbpSuggestdocument.PerformCallback("ChangeImage~"+fPath+"~test");
//        } 
    </script>

    <style type="text/css">
        .imageBox {width: 180px; float:left; margin-left:100px; margin-bottom:10px;}
        .divImgWidth{width: 160px; float:left;}      
    </style>
</head>
<body style="margin: 0px 0px 0px 0px; background-color: ButtonFace">
    <form id="form1" runat="server">
        <div>
            <div style="margin-left: 20px; padding: 5px;" id="divmain">
                <div class="imageBox">
                    <div class="right">
                        <div>
                            <img id="su1" onclick="changevalueandpicture('su1')" alt="" src="../CentralData/Images/success.png"
                                title="Click To UnVerify" style="cursor: pointer;" height="18px" width="18px" />
                        </div>
                        <div>
                            <img id="err1" alt="" src="../CentralData/Images/error.png" onclick="changevalueandpicture('err1')"
                                title="Click To Verify" height="18px" style="cursor: pointer;" width="18px" />
                        </div>
                        <%--<div>
                            <input type="file" name="fileUpload1" id="fileUpload1" runat="server" />
                            <span id="FU1" style="display: none"></span>
                        </div>--%>
                    </div>
                    <%--<div id="divBtnFile1" class="right">
                        <dxe:ASPxButton ID="BtnFile1" runat="server" AutoPostBack="False" Text="Up" Font-Size="5pt">
                            <ClientSideEvents Click="function (s, e) {FileChange_Click(this);}" />
                            <Paddings Padding="0" />
                        </dxe:ASPxButton>
                    </div>--%>
                    <div class="divImgWidth" id="row1_col1">
                        <a id="a1">
                            <img id="img1" width="150px" height="100px" style="border: 1px solid Teal; float: left;"
                                alt="" />
                ...
                <div class="imageBox">
                    <div class="right">
                        <div>
                            <img id="su2" alt="" src="../CentralData/Images/success.png" style="cursor: pointer;"
                                onclick="changevalueandpicture('su2')" title="Click To UnVerify" height="18px"
                                width="18px" />
                        </div>
                        <div>
                            <img id="err2" alt="" src="../CentralData/Images/error.png" style="cursor: pointer;"
                                onclick="changevalueandpicture('err2')" title="Click To Verify" height="18px"
                                width="18px" />
                        </div>
                        <%--<div>
                            <input type="file" name="fileUpload2" id="fileUpload2" runat="server" />
                            <span id="FU2" style="display: none"></span>
                        </div>--%>
                    </div>
                    <%--<div id="divBtnFile2" class="right">
                        <dxe:ASPxButton ID="BtnFile2" runat="server" AutoPostBack="False" Text="Up" Font-Size="5pt">
                            <ClientSideEvents Click="function (s, e) {FileChange_Click(this);}" />
                            <Paddings Padding="0" />
                        </dxe:ASPxButton>
                    </div>--%>
                    <div class="divImgWidth" id="row1_col2">
                        <a id="a2">
                            <img id="img2" width="150px" height="100px" style="border: 1px solid Teal;" alt="" /><br />
                ...
                <div class="imageBox">
                    <div class="right">
                        <div>
                            <img id="su3" alt="" src="../CentralData/Images/success.png" style="cursor: pointer;"
                                onclick="changevalueandpicture('su3')" title="Click To UnVerify" height="18px"
                                width="18px" />
                        </div>
                        <div>
                            <img id="err3" alt="" src="../CentralData/Images/error.png" title="Click To Verify"
                                height="18px" style="cursor: pointer;" onclick="changevalueandpicture('err3')"
                                width="18px" />
                        </div>
                    </div>
                    <div id="row1_col3" class="divImgWidth">
                        <a id="a3">
                ...
                <div class="imageBox">
                    <div class="right">
                        <div>
                            <img id="su4" alt="" src="../CentralData/Images/success.png" title="Click To UnVerify"
                                height="18px" style="cursor: pointer;" onclick="changevalueandpicture('su4')"
                                width="18px" />
                        </div>
                        <div>
                            <img id="err4" alt="" src="../CentralData/Images/error.png" title="Click To Verify"
                                height="18px" style="cursor: pointer;" onclick="changevalueandpicture('err4')"
                                width="18px" />
                        </div>
                    </div>
                    <div class="divImgWidth" id="row2_col1">
                        <a id="a4">
                ...
                <div class="imageBox">
                    <div class="right">
                        <div>
                            <img id="su5" alt="" src="../CentralData/Images/success.png" title="Click To UnVerify"
                                height="18px" style="cursor: pointer;" onclick="changevalueandpicture('su5')"
                                width="18px" />
                        </div>
                        <div>
                            <img id="err5" alt="" src="../CentralData/Images/error.png" title="Click To Verify"
                                height="18px" style="cursor: pointer;" onclick="changevalueandpicture('err5')"
                                width="18px" />
                        </div>
                    </div>
                    <div class="divImgWidth" id="row2_col2">
                        <a id="a5">
                ...
                <div class="imageBox">
                    <div class="right">
                        <div>
                            <img id="su6" alt="" src="../CentralData/Images/success.png" title="Click To UnVerify"
                                height="18px" style="cursor: pointer;" onclick="changevalueandpicture('su6')"
                                width="18px" />
                        </div>
                        <div>
                            <img id="err6" alt="" src="../CentralData/Images/error.png" title="Click To Verify"
                                height="18px" style="cursor: pointer;" onclick="changevalueandpicture('err6')"
                                width="18px" />
                        </div>
                    </div>
                    <div id="row2_col3" class="divImgWidth">
                        <a id="a6">
                ...
                <div class="imageBox">
                    <div class="right">
                        <div>
                            <img id="su7" alt="" src="../CentralData/Images/success.png" style="cursor: pointer;"
                                onclick="changevalueandpicture('su7')" title="Click To UnVerify" height="18px"
                                width="18px" />
                        </div>
                        <div>
                            <img id="err7" alt="" src="../CentralData/Images/error.png" style="cursor: pointer;"
                                onclick="changevalueandpicture('err7')" title="Click To Verify" height="18px"
                                width="18px" />
                        </div>
                    </div>
                    <div id="row3_col1" class="divImgWidth">
                        <a id="a7">
                ...
                <div class="imageBox">
                    <div class="right">
                        <div>
                            <img id="su8" alt="" src="../CentralData/Images/success.png" style="cursor: pointer;"
                                onclick="changevalueandpicture('su8')" title="Click To UnVerify" height="18px"
                                width="18px" />
                        </div>
                        <div>
                            <img id="err8" alt="" src="../CentralData/Images/error.png" style="cursor: pointer;"
                                onclick="changevalueandpicture('err8')" title="Click To Verify" height="18px"
                                width="18px" />
                        </div>
                    </div>
                    <div class="divImgWidth" id="row3_col2">
                        <a id="a8">
                ...
                <div class="imageBox">
                    <div class="right">
                        <div>
                            <img id="su9" alt="" src="../CentralData/Images/success.png" title="Click To UnVerify"
                                height="18px" style="cursor: pointer;" onclick="changevalueandpicture('su9')"
                                width="18px" />
                        </div>
                        <div>
                            <img id="err9" alt="" src="../CentralData/Images/error.png" title="Click To Verify"
                                height="18px" style="cursor: pointer;" onclick="changevalueandpicture('err9')"
                                width="18px" />
                        </div>
                    </div>
                    <div id="row3_col3" class="divImgWidth">
                        <a id="a9">
            ...
            <div style="margin-left: 80px;">
                <div id="row4_col1" style="margin-left: 50px; margin-top: 10px; float: left">
                    <dxe:ASPxButton ID="btnok" runat="server" AutoPostBack="False" Text="Verification Done">
        ...
        <div id="row5_col1" class="Info" style="margin-left: 50px;">
            Before Verification Please Upload Missing Image !!
        </div>
        <br class="clear" />
        <%--<div id="row5_col2" class="Warning" style="margin-left: 355px;width:300px;">
            Please Delete unverified Image !!
        </div>
        <br class="clear" />--%>
                        ...
                        <PanelCollection>
                            <dxp:panelcontent runat="server">
                                <div style="font-weight: bold; color: black; background-color: gainsboro; border-right: silver thin solid;
                                    ...
                                    <br />
                                    <br />
                                    Verified Document : <b style="text-align: right" id="B_cpverifieddoc" runat="server">
                                    </b>
                                </div>
                                <br class="clear" />
                                <div>
                                    <div id="row3_col1pop" class="Warning">
                                        Some Document Not Verified. Do You want To Proceed ?
                                    </div>
