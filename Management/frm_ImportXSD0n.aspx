<%@ page language="C#" autoeventwireup="true" inherits="management_frm_ImportXSD0n, App_Web_zsukfi_p" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Stamp Duty Payable Statement of CDX Segment [X_SD0n]</title>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports NSE-CD's Trading Members' Stamp Duty Files [X_SD0n_memcode_DDmmYYYY.csv]
                        </h5>
                    </td>
                </tr>
