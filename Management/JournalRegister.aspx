<%@ page language="C#" autoeventwireup="true" inherits="management_JournalRegister, App_Web_ng-agpzn" %>
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="text-align: right" id="TrFilter">
                                <span style="font-weight: bold; color: Blue; cursor: pointer" onclick="javascript:ForFilter1();">
                                    Filter</span>
