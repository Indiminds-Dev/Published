<%@ page language="C#" autoeventwireup="true" inherits="management_ExchangeFee_DGCX, App_Web_akbpwr7y" %>
...
<head runat="server">
    ...
    function OnMoreInfoClick(keyValue) {
        ...
        var url = 'ExchangeTax_DGCX.aspx?id=' + keyValue;
    ...
    function OnAddButtonClick() 
    {
         ...
         var url = 'ExchangeTax_DGCX.aspx?id=' + 'ADD';
...
--%>               
             <dxwgv:GridViewDataTextColumn Caption="Group" FieldName="r" VisibleIndex="2" Width="15%">
                ...
                <dxwgv:GridViewDataTextColumn Caption="Rate" FieldName="ExchangeFee_Rate" VisibleIndex="7"
                    Width="4%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <dxwgv:GridViewDataTextColumn Caption="From Date" FieldName="ExchangeFee_DateFrom" VisibleIndex="10"
                    Width="6%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <dxwgv:GridViewDataTextColumn Caption="Untill Date" FieldName="ExchangeFee_DateTo" VisibleIndex="11"
                    Width="6%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
        ...
        <asp:SqlDataSource ID="ServiceTaxDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
            DeleteCommand="ExchangeFeeDG_delete" DeleteCommandType="StoredProcedure">
            <DeleteParameters>
