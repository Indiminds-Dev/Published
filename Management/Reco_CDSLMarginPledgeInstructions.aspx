<%@ page language="C#" autoeventwireup="true" inherits="management_Reco_CDSLMarginPledgeInstructions, App_Web_sggmuspu" %>
        ...
        <table id="tbl_main" class="login" cellspacing="0" cellpadding="0" width="410">
            <tbody>
                <tr>
                    <td class="lt1">
                        <h5>
                            Imports DP37 [Online Pledge Master Report] files available From CDSL"
                        </h5>
                    </td>
                </tr>
                <tr>
