<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReportRegSusClient, App_Web_1vatjdzx" %>
            ...
            <table width="100%">
                <tr>
                    <td class="gridcellleft">
                        <table id="tabMainFilter" cellspacing="1" cellpadding="2" style="background-color: #B7CEEC;
                            border: solid 1px  #ffffff; width: 500px" border="1">
                            <tr>
                                <td style="height: 28px; width: 125px" class="gridcellleft">
                                    Company :
                                </td>
                                <td colspan="2">
                                    <asp:TextBox ID="txtCompany" Width="220px" onkeyup="GetCompanies(this,'GenericAjaxList',this)"
                                ...
                                <td colspan="2">
                                    <table border="0">
                                        <tr>
                                            ...
                                            <td style="width: 70px">
                                                <asp:RadioButton ID="rdbSegSelected" runat="server" GroupName="s" onclick="Segment('b')" />
                                                Selected
                                            </td>
                                            <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxDateEdit ID="dtFrom" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                        Font-Size="10px" Width="108px" EditFormatString="dd-MM-yyyy" ClientInstanceName="dtFrom">
                                ...
                                <td>
                                    <dxe:ASPxDateEdit ID="dtTo" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                        Font-Size="10px" Width="108px" EditFormatString="dd-MM-yyyy" ClientInstanceName="dtTo">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="drpType" Width="100px" Font-Size="10px" runat="Server">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <table border="0" width="160px">
                                        <tr>
                                            <td>
                                                <asp:RadioButton ID="rbClientCategoryAll" runat="server" Checked="True" GroupName="cc"
                                                    onclick="ClientCat('a')" />
                                                All
                                            </td>
                                            <td>
                                                <asp:RadioButton ID="rbClientCategorySelected" runat="server" GroupName="cc" onclick="ClientCat('b')" />
                                                Selected
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <td colspan="2">
                                    <table border="0" width="160px">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:RadioButton ID="rbClientSelected" runat="server" GroupName="c" onclick="Clients('b')" />
                                                Selected
                                            </td>
                                        </tr>
                                    </table>
                ...
                <tr>
                    <td colspan="2" style="text-align: left; width: 100%; vertical-align: top;">
                        <%--<div id="divgrid" style="width:985px; overflow:scroll" >  --%>
                        <dxwgv:ASPxGridView ID="gridClients" KeyFieldName="clientid" Width="1280px" runat="Server"
                            ClientInstanceName="grid" OnCustomCallback="gridClients_CustomCallback">
                            <columns>
                                ...
                                <dxwgv:GridViewDataTextColumn  Caption="ClientName" FieldName="clientname" VisibleIndex="2">
                                </dxwgv:GridViewDataTextColumn>
                               
                                <dxwgv:GridViewDataTextColumn  Caption="UCC" FieldName="ucc" VisibleIndex="3">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn  Caption="Gender" FieldName="Gender" VisibleIndex="4">
                                </dxwgv:GridViewDataTextColumn>
                                 <dxwgv:GridViewDataTextColumn  Caption="D.O.B" FieldName="DOB" VisibleIndex="5">
                                </dxwgv:GridViewDataTextColumn>
                                  <dxwgv:GridViewDataTextColumn  Caption="Branch Name" FieldName="branchname" VisibleIndex="6">
                                </dxwgv:GridViewDataTextColumn>
                                  <dxwgv:GridViewDataTextColumn  Caption="Group Name" FieldName="groupname" VisibleIndex="7">
                                </dxwgv:GridViewDataTextColumn>
                                  <dxwgv:GridViewDataTextColumn  Caption="Phone" FieldName="phones" VisibleIndex="8">
                                </dxwgv:GridViewDataTextColumn>
                                  <dxwgv:GridViewDataTextColumn  Caption="Pan" FieldName="pancard" VisibleIndex="9">
                                </dxwgv:GridViewDataTextColumn>
                                  <dxwgv:GridViewDataTextColumn  Caption="Bank" FieldName="Bankdetails" VisibleIndex="10">
                                </dxwgv:GridViewDataTextColumn>
                                  <dxwgv:GridViewDataTextColumn  Caption="DPAccount" FieldName="DpAccount" VisibleIndex="11">
                                </dxwgv:GridViewDataTextColumn>
                                  <dxwgv:GridViewDataTextColumn  Caption="Email" FieldName="email" VisibleIndex="12">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Width="100px" Caption="Address" FieldName="address" VisibleIndex="13">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn  Caption="ContractDelvMode" FieldName="contractdeliverymode" VisibleIndex="14">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn  Caption="Legal Status" FieldName="LegalStatus" VisibleIndex="15">
                                </dxwgv:GridViewDataTextColumn>
                                 <dxwgv:GridViewDataTextColumn  Caption="Client Type" FieldName="ClientType" VisibleIndex="16">
                                </dxwgv:GridViewDataTextColumn>  
                                <dxwgv:GridViewDataTextColumn  Caption="Settlement Mode" FieldName="SettlementMode" VisibleIndex="17">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn  Caption="Contract Delivery Option" FieldName="DirectTMClient" VisibleIndex="18">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn  Caption="Relationship with TM/Dirc. of the TM" FieldName="RelationshipWithDirector" VisibleIndex="19">
                                </dxwgv:GridViewDataTextColumn>
                                 <dxwgv:GridViewDataTextColumn  Caption="Client hav. Other Acc With Same TM" FieldName="HasOtherAccount" VisibleIndex="20">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn  Caption="Spl Category" FieldName="SpecialCategory" VisibleIndex="21">
                                </dxwgv:GridViewDataTextColumn>
                                 <dxwgv:GridViewDataTextColumn  Caption="PEP" FieldName="pep" VisibleIndex="22">
                                </dxwgv:GridViewDataTextColumn>
                                 <dxwgv:GridViewDataTextColumn  Caption="Risk Category" FieldName="RiskCategory" VisibleIndex="23">
                                </dxwgv:GridViewDataTextColumn>
                                 <dxwgv:GridViewDataTextColumn  Caption="In Person Verf. Done" FieldName="InPersonVerificationDone" VisibleIndex="24">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn  Caption="Edu." FieldName="Education" VisibleIndex="25">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn  Caption="NSE-CM" FieldName="nsereg" VisibleIndex="26">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn  Caption="NSE-FO" FieldName="nforeg" VisibleIndex="27">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="NSE-CDX" FieldName="cdxreg" VisibleIndex="28">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="BSE-CM" FieldName="bsereg" VisibleIndex="29">
                                </dxwgv:GridViewDataTextColumn>
                                 <dxwgv:GridViewDataTextColumn Caption="BSE-FO" FieldName="bseforeg" VisibleIndex="30">
                                </dxwgv:GridViewDataTextColumn>
                                 <dxwgv:GridViewDataTextColumn Caption="MCXSX-CDX" FieldName="mcxcdxreg" VisibleIndex="31">
                                </dxwgv:GridViewDataTextColumn>
                                 <dxwgv:GridViewDataTextColumn Caption="MCX-COMM" FieldName="mcxcommreg" VisibleIndex="32">
                                </dxwgv:GridViewDataTextColumn>
                                 <dxwgv:GridViewDataTextColumn Caption="NCDEX-COMM" FieldName="ncdexcommreg" VisibleIndex="33">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="NMCE-COMM" FieldName="nmcereg" VisibleIndex="34">
                                </dxwgv:GridViewDataTextColumn>
                                 <dxwgv:GridViewDataTextColumn Caption="USE-CDX" FieldName="usecdxreg" VisibleIndex="35">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="ACCOUNTS" FieldName="accountsreg" VisibleIndex="36">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="NSEL-SPOT" FieldName="nselspotreg" VisibleIndex="37">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="MCXSX-CM" FieldName="mcxcmreg" VisibleIndex="38">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="MCXSX-FO" FieldName="mcxforeg" VisibleIndex="39">
                                 </dxwgv:GridViewDataTextColumn>                                 
                                <%-- ----- Added  BSE-CDX----------%>                                 
                                 <dxwgv:GridViewDataTextColumn Caption="BSE-CDX" FieldName="bsecdxreg" VisibleIndex="40">                                
                                </dxwgv:GridViewDataTextColumn>
                                 <%-- ----- Added  Contact Status and Income Range----------%>
                                 <dxwgv:GridViewDataTextColumn Caption="Contact Status" FieldName="ContactStatus" VisibleIndex="41">                                
                                </dxwgv:GridViewDataTextColumn>                                
                                 <dxwgv:GridViewDataTextColumn Caption="Income Range" FieldName="AnnualIncome" VisibleIndex="42">                                
                                </dxwgv:GridViewDataTextColumn>
