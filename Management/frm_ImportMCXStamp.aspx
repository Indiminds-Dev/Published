<%@ page language="C#" autoeventwireup="true" inherits="management_frm_ImportMCXStamp, App_Web_im-ehkhh" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Stamp Duty Payable Statement of MCX [MCX_StampDuty_memCode_YYYYMMDD.CSV]</title>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports Stamp Duty Files [MCX_StampDuty_memCode_YYYYMMDD.CSV OR StampDuty_MCXCCL_CO_0_TM_memcode_YYYYmmDD_F_nnnn.csv]
                        </h5>
                    </td>
                </tr>
