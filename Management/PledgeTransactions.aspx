<%@ page language="C#" autoeventwireup="true" inherits="management_PledgeTransactions, App_Web_lgnajdkn" %>
...
<head id="Head1">
    <title>Margin RePledge/UnPledge Transfers</title>
   ...
   function fngrouptype(obj)
   {
    ...
    function ChangeRowColor(rowID,rowNumber) 
      ...
      function fn_Releaseqty(textid,qty,txtvalue,releaseqty)
      {
            ...
            {
               alert('You Can RePledge/Release Maximum '+qty+' Share');
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Margin RePledge/RePledge Release Transfer</span></strong></td>
              ...
              <td class="EHEADER" width="15%" id="td_filter" style="height: 22px">
                ...
                <asp:DropDownList ID="ddlExport" Font-Size="Smaller" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlExport_SelectedIndexChanged">
                            <asp:ListItem Selected="True" Value="0">Export</asp:ListItem>
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlAccountType" Font-Size="10px" runat="server" Width="250px"
                                                ...
                                                <asp:ListItem Value="M">Re-Pledge</asp:ListItem>
                                                <asp:ListItem Value="O">Re-Pledge Release</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                </table>
