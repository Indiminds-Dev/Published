<%@ page language="C#" autoeventwireup="true" inherits="management_depPerticipent, App_Web_im-ehkhh" %>
    ...
    function Emailcheck(obj)
     {
        if(obj =='N')
        {
            if(obj !='B')
             {  
            alert("Transactions exists for this DP... Deletion disallowed!!");   
            obj='B';     
            }
        }
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" align="center">
                        <strong><span style="color: #000099">Depository Participants</span></strong></td>
                </tr>
                <tr>
                    <td>
                        <table width="100%">
                ...
                <tr>
                    <td>
                        <dxwgv:ASPxGridView ID="DepositoryGrid" ClientInstanceName="grid" runat="server"
                            AutoGenerateColumns="False" DataSourceID="perticipentdatasource" KeyFieldName="dp_cntId"
                            Width="100%" OnHtmlRowCreated="DepositoryGrid_HtmlRowCreated" OnCustomCallback="DepositoryGrid_CustomCallback"
                            OnCustomJSProperties="DepositoryGrid_CustomJSProperties" OnRowValidating="DepositoryGrid_RowValidating">
                            <Templates>
                                <EditForm>
							                     ...
							                     <dxtc:TabPage Text="Adress">
                                                    ...
                                                    <dxw:ContentControl runat="server">  
                                                                        <dxwgv:ASPxGridView runat="server" ID="AddressGrid" ClientInstanceName="Address"
                                                                            DataSourceID="DepositoryAddress" KeyFieldName="add_id" AutoGenerateColumns="False"
                                                                ...
                                                                <ContentCollection>
                                                                    <dxw:ContentControl runat="server"> 
                                                                        <dxwgv:ASPxGridView ID="PhoneFaxGrid" ClientInstanceName="phonefax" runat="server"
                                                                            AutoGenerateColumns="False" DataSourceID="DepositoryPhone" KeyFieldName="phf_id"
...
OnRowValidating="PhoneGrid_RowValidating">
                                                                ...
                                                                <ContentCollection>
                                                                    <dxw:ContentControl runat="server"> 
                                                                        <dxwgv:ASPxGridView ID="EmailGrid" ClientInstanceName="gridEmail" runat="server" AutoGenerateColumns="False"
                                                                            DataSourceID="DepositoryEmail" KeyFieldName="eml_id" Width="100%" OnBeforePerformDataSelect="AddressGrid_BeforePerformDataSelect" OnRowValidating="EmailGrid_RowValidating">
                                                                            <Templates>
                                                                                <EditForm>
                                                                                    <table style="width: 100%">
                                                                                        <tr>
    ...
    else
    {
         ...
         gridEmail.GetEditor(&quot;eml_website&quot;).SetVisible(false);
                            ...
                            <SettingsBehavior ConfirmDelete="True" ColumnResizeMode="NextColumn" AllowFocusedRow="True">
                            </SettingsBehavior>
                            <Styles>
                            ...
                            <Columns>
                                <dxwgv:GridViewDataTextColumn Visible="False" ReadOnly="True" VisibleIndex="0" FieldName="dp_Id">
                                    <EditFormSettings Visible="False"></EditFormSettings>
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="0" FieldName="dp_cntId">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn VisibleIndex="0" FieldName="dp_dpName" Width="25%"
                                    Caption="Depository Participant">
                                    <EditCellStyle Wrap="False" HorizontalAlign="Left">
                                    ...
                                    <PropertiesTextEdit Width="300px">
                                        <ValidationSettings SetFocusOnError="True" ErrorDisplayMode="ImageWithText" ErrorTextPosition="Bottom">
                                            <RequiredField IsRequired="True" ErrorText="Please Enter Depository Name"></RequiredField>
                                        </ValidationSettings>
                                    </PropertiesTextEdit>
                                    <EditFormCaptionStyle Wrap="False" HorizontalAlign="Right">
                                    </EditFormCaptionStyle>
                                ...
                                <dxwgv:GridViewDataTextColumn VisibleIndex="1" FieldName="dp_dpId" Width="25%" Caption="DpId">
                                    <EditCellStyle Wrap="False" HorizontalAlign="Left">
                                    </EditCellStyle>
                                    <PropertiesTextEdit Width="300px">
                                    </PropertiesTextEdit>
                                ...
                                <dxwgv:GridViewDataComboBoxColumn Visible="False" FieldName="dp_depositoryCode" Caption="Depository"
                                    VisibleIndex="1">
                                    <EditCellStyle Wrap="False" HorizontalAlign="Left">
                                    </EditCellStyle>
                                    <PropertiesComboBox Width="300px" ValueType="System.String" TextField="de_depositoryCode"
                                        ValueField="de_internalid" EnableIncrementalFiltering="True" EnableSynchronization="False"
                                        DataSourceID="DepositorySelect">
                                    </PropertiesComboBox>
                                ...
                                <dxwgv:GridViewCommandColumn VisibleIndex="3">
                                   ...
                                   <%-- <DeleteButton Visible="True">
                                    ...
                                    <EditButton Visible="True">
                                     ...
                                     <dxwgv:GridViewDataTextColumn VisibleIndex="7" Width="60px" Caption="Details">
                                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                        <DataItemTemplate>
                                          ...
                                          <dxwgv:GridViewDataTextColumn VisibleIndex="3" Width="60px" Caption="Details">
                                                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                        <DataItemTemplate>
                                                            <a href="javascript:void(0);"  onclick="DeleteRow('<%# Container.KeyValue %>')">Delete</a>                                                   
                                                        </DataItemTemplate>
                            ...
                            <SettingsText PopupEditFormCaption="Add/Modify Depository Participant"></SettingsText>
	...
	Emailcheck(s.cpHeight);
            ...
            <%--===================================================== Master Grid ================================================================--%>
            <%--======================================================== End Of Master Grid ============================================================--%>
            <%--=========================================================  Master Grid Data Source =========================================================--%>
            <asp:SqlDataSource ID="perticipentdatasource" runat="server" ConnectionString="<%$ ConnectionStrings:CRMConnectionString %>"
                InsertCommand="DepositoryInsert" InsertCommandType="StoredProcedure" SelectCommand="DepositorySelect"
                SelectCommandType="StoredProcedure" UpdateCommand="DepositoryUpdate" UpdateCommandType="StoredProcedure">
                <%-- <DeleteParameters>
                    <asp:Parameter Name="dp_cntId" Type="string" />
                </DeleteParameters>--%>
                <UpdateParameters>
                    <asp:Parameter Name="dp_cntId" Type="String" />
                    <asp:Parameter Name="dp_dpName" Type="String" />
                    <asp:Parameter Name="dp_dpId" Type="String" />
                    <asp:Parameter Name="dp_depositoryCode" Type="String" />
            ...
            <%--====================================================== DEPOSITORY SELECT =======================================================--%>
            <asp:SqlDataSource ID="DepositorySelect" runat="server" ConnectionString="<%$ ConnectionStrings:CRMConnectionString%>"
                SelectCommand="SELECT [de_internalid], [de_depositoryCode]  FROM  [tbl_master_depository] order by [de_depositoryCode]">
            </asp:SqlDataSource>
            <%--==========================================================================================================================--%>
            <%--========================================================== Address Data Source ========================================--%>
            <asp:SqlDataSource runat="server" ID="DepositoryAddress" SelectCommand="select DISTINCT  tbl_master_address.add_id AS add_id,tbl_master_address.add_entity As add_entity,tbl_master_address.add_cntId As add_cntId, tbl_master_address.add_addressType AS add_addressType,
                ...
                <InsertParameters>
                    <asp:SessionParameter SessionField="KeyVal_InternalID" Type="String" Name="dp_cntId">
            ...
            <asp:SqlDataSource ID="DepositoryPhone" runat="server" ConflictDetection="CompareAllValues"
                ...
                InsertCommand="INSERT INTO [tbl_master_phonefax] ([phf_cntId],[phf_entity],[phf_type], [phf_countryCode], [phf_areaCode], [phf_phoneNumber], [phf_extension],[CreateDate],[CreateUser]) VALUES (@dp_cntId,'DP',@phf_type, @phf_countryCode, @phf_areaCode, @phf_phoneNumber, @phf_extension,getdate(),@CreateUserPhone)"
                OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [tbl_master_phonefax] where [phf_cntId]=@dp_cntId"
            ...
            <%--=================================================================== Email Data Source =============================================--%>
            <asp:SqlDataSource ID="DepositoryEmail" runat="server" ConflictDetection="CompareAllValues"
                ...
                InsertCommand="INSERT INTO [tbl_master_email] ([eml_cntId],[eml_entity],[eml_type], [eml_email], [eml_website],[CreateDate],[CreateUser]) VALUES (@dp_cntId,'DP',@eml_type, @eml_email, @eml_website,getdate(),@CreateUserEmail)"
                OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [tbl_master_email] where [eml_cntId]=@dp_cntId "
