<%@ page language="C#" autoeventwireup="true" inherits="management_CopyFxRates_Root, App_Web_2wstwz9u" %>
...
<head id="Head1">
    <title>Copy/Remove FX Rates in ROOT Segment For The Given Period</title>
...
//            alert('Generate For Remaining Bills...');
        ...
        if(obj=="5")
        {
            ...
            window.location = "../Reports/CopyFxRates_Root.aspx";
        }
          ...
          $get('UpdateProgress1').style.display = 'none'; 
            ...
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Copy/Remove FX Rates in ROOT Segment For The Given Period</span></strong></td>
