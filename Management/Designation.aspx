<%@ page language="C#" autoeventwireup="true" inherits="management_Designation, App_Web_sggmuspu" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    <form id="form1" runat="server">
        <table class="TableMain100">
            ...
            <tr>
                <td>
                    <dxwgv:ASPxGridView ID="DesigGrid" runat="server" AutoGenerateColumns="False" DataSourceID="designation"
                        ...
                        <Columns>
                            <dxwgv:GridViewDataTextColumn Visible="False" ReadOnly="True" VisibleIndex="0" FieldName="deg_id">
                                <EditFormSettings Visible="False"></EditFormSettings>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn VisibleIndex="0" FieldName="deg_designation" Width="80%"
                                Caption="Designation">
                                <PropertiesTextEdit Width="300px">
                                    <ValidationSettings SetFocusOnError="True" ErrorTextPosition="Bottom" ErrorDisplayMode="ImageWithText">
                                        <RequiredField IsRequired="True" ErrorText="Please Enter Designation"></RequiredField>
                                    </ValidationSettings>
                                </PropertiesTextEdit>
                        ...
                        <SettingsText PopupEditFormCaption="Add/Modify Designation" />
        ...
        <asp:SqlDataSource ID="designation" runat="server" ConflictDetection="CompareAllValues"
            ConnectionString="<%$ ConnectionStrings:CRMConnectionString %>" DeleteCommand="DELETE FROM [tbl_master_designation] WHERE [deg_id] = @original_deg_id"
            InsertCommand="INSERT INTO [tbl_master_designation] ([deg_designation], [CreateDate], [CreateUser]) VALUES (@deg_designation, getdate(), @CreateUser)"
            OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT [deg_id],[deg_designation] FROM [tbl_master_designation]"
            UpdateCommand="UPDATE [tbl_master_designation] SET [deg_designation] = @deg_designation,[LastModifyDate]=getdate(),[LastModifyUser]=@CreateUser WHERE [deg_id] = @original_deg_id">
            <DeleteParameters>
