<%@ page language="C#" autoeventwireup="true" inherits="management_frm_NSECOMMMargin, App_Web_i8xxwgwk" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>NSE-COMM Margin Files</title>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports O_MG13_MemberCode_DDMMYYYY.LIS Available through Extranet
                        </h5>
                    </td>
                </tr>
