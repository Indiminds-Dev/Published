<%@ page language="C#" autoeventwireup="true" inherits="management_frm_MCXClosingRates, App_Web_rilo-itm" %>
                                ...
                                <tbody>
                                 <tr>
                                        <td class="gridcellleft" colspan=2>
                                            <asp:Label ID="Label1" runat="server" Text="EXP : MS_YYYYMMDD.CSV" Width="335px"></asp:Label></td>
