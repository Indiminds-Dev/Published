<%@ page language="C#" autoeventwireup="true" inherits="Reports_dailymrgnrprttoclient_CM, App_Web_tuwtz_6w" %>
...
<head id="Head1">
    <title>Daily Margin Reporting To Clients</title>
    ...
    function Reload() {
         ...
         window.location = "../reports/dailymrgnrprttoclient_CM.aspx"
    }
    function keyVal(obj)
     {
        ...
        if(obj=='rbPrint')
            {
                ...
                document.getElementById('tr_cheader').style.display = 'inline';
                document.getElementById('tr_cfooter').style.display = 'inline';
           ...
           if(obj=='rbScreen')
            {
                ...
                document.getElementById('tr_cheader').style.display = 'none';
                document.getElementById('tr_cfooter').style.display = 'none';
            }
            if(obj=='rdbmail')
            {
                Hide('td_btnshow');
                                    ...
                                    <table border="10" cellpadding="1" cellspacing="1">
                                        ...
                                        <tr>
                                            <td class="gridcellleft" bgcolor="#B7CEEC">
                                                Segment :</td>
                                            <td>
                                                <asp:RadioButton ID="rdbSegmentAll" runat="server" Checked="True" GroupName="a" onclick="Segment('a')" />All CMs
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="gridcellleft" bgcolor="#B7CEEC">
                                            ...
                                            <td colspan="5">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td id="Td4" class="gridcellleft" bgcolor="#B7CEEC">
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <asp:RadioButton ID="rbPrint" runat="server" GroupName="f" 
                                                                            onclick="RBShowHide(this.value)"  />Print</td>
                                                                    <td id="tr_printlogo">
                                                  ...
                                                  <%-------------  Custom Header -------------%>
                                                    ...
                                                    <tr id="tr_cheader" style="display:none;">
                                                    <td colspan="2">
                                                    ...
                                                    <tr id="tr_cfooter" style="display:none;">
                                                    <td colspan="2">
