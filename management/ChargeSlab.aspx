<%@ page language="C#" autoeventwireup="true" inherits="management_ChargeSlab, App_Web_nidspgif" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
  ...
  function OnMoreInfoClick(keyValue)
   {
     ...
     parent.OnMoreInfoClick(url,"Edit Charge Slab Details",'940px','450px',"Y");
     ...
     function OnAddButtonClick() 
    {
        ...
        parent.OnMoreInfoClick(url,"Add Charge Slab Details",'940px','450px',"Y"); 
  ...
  <table class="TableMain100">
   ...
   <dxwgv:ASPxGridView ID="SlabGrid" runat="server"  KeyFieldName="OtherChargeSlab_ID"
...
<LastPageButton Visible="True"></LastPageButton>
        ...
        <Columns>
<dxwgv:GridViewDataTextColumn Visible="False" VisibleIndex="0" FieldName="OtherChargeSlab_ID" Caption="ID">
...
<dxwgv:GridViewDataTextColumn VisibleIndex="0" FieldName="OtherChargeSlab_Code" Width="10%" Caption="Code">
<CellStyle CssClass="gridcellleft"></CellStyle>
...
<dxwgv:GridViewDataTextColumn VisibleIndex="1" FieldName="OtherChargeSlab_Type" Width="15%" Caption="Type">
<CellStyle CssClass="gridcellleft"></CellStyle>
...
<dxwgv:GridViewDataTextColumn VisibleIndex="2" FieldName="OtherChargeSlab_MinRange" Width="15%" Caption="Min">
<CellStyle CssClass="gridcellleft"></CellStyle>
...
<dxwgv:GridViewDataTextColumn VisibleIndex="3" FieldName="OtherChargeSlab_MaxRange" Width="15%" Caption="Max">
<CellStyle CssClass="gridcellleft"></CellStyle>
...
<dxwgv:GridViewDataTextColumn VisibleIndex="4" FieldName="OtherChargeSlab_FlatRate" Width="10%" Caption="Flat Rate">
<CellStyle CssClass="gridcellleft"></CellStyle>
...
<dxwgv:GridViewDataTextColumn VisibleIndex="5" FieldName="OtherChargeSlab_MinCharge" Width="10%" Caption="Min. Charge">
<CellStyle CssClass="gridcellleft"></CellStyle>
...
<dxwgv:GridViewDataTextColumn VisibleIndex="6" FieldName="OtherChargeSlab_Rate" Width="10%" Caption="Rate">
<CellStyle CssClass="gridcellleft"></CellStyle>
...
<DeleteButton Visible="True"></DeleteButton>
  ...
  <asp:SqlDataSource ID="SlabDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
