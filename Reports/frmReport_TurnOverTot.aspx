<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReport_TurnOverTot, App_Web_hnkxxmul" %>
                                    ...
                                    <table border="10" cellpadding="1" cellspacing="1">
                                        <tr>
                                            <td class="gridcellleft" bgcolor="#B7CEEC">
                                                Report View :</td>
                                            <td>
                                                <asp:DropDownList ID="DdlrptViewClient" runat="server" Width="250px" Font-Size="10px"
                                    ...
                                    <table border="10" cellpadding="1" cellspacing="1">
                                        <tr>
                                            <td class="gridcellleft" bgcolor="#B7CEEC">
                                                Report View :</td>
                                            <td>
                                                <asp:DropDownList ID="DdlrptViewExchange" runat="server" Width="250px" Font-Size="10px"
