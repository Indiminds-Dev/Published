<%@ page language="C#" autoeventwireup="true" inherits="Management_BillPrintingNseFo_New, App_Web_im-ehkhh" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function fnAlert(obj) {
            ...
            if (obj == "5") {
                ...
                window.location = "../Management/BillPrintingNseFo_New.aspx";
            }
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE">
    ...
    <div>
        <asp:ScriptManager ID="ScriptManager1" runat="server" AsyncPostBackTimeout="9999"
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Billing</span></strong>
                </td>
            </tr>
        </table>
        <table class="TableMain100">
