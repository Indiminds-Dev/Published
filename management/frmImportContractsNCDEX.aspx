<%@ page language="C#" autoeventwireup="true" inherits="management_frmImportContractsNCDEX, App_Web_6_wayyot" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Import NCDEX Contracts</title>
     ...
     <asp:Panel ID="Panelmain" runat="server" Visible="true" HorizontalAlign="Center">
                <table id="tbl_main" class="login" cellspacing="0" cellpadding="0" width="410"
                    ...
                    <tbody>
                        <tr>
                            <td class="EHEADER">
                                <span style="color: blue"><strong>NCDEX Contracts</strong></span></td>
                        </tr>
                        <tr>
                            <td class="lt">
