<%@ page language="C#" autoeventwireup="true" inherits="Reports_EnterTransactionCommCurrency, App_Web_krnt_rtp" %>
                        ...
                        <tr>
                            ...
                            <td>
                                <dxe:ASPxDateEdit ID="dtTransaction" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                    Font-Size="10px" Width="108px" ClientInstanceName="dtTransaction" TabIndex="0">
                            ...
                            <td>
                                <dxe:ASPxDateEdit ID="dtExecution" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                    Font-Size="10px" Width="108px" ClientInstanceName="dtExecution" TabIndex="0">
                                    <DropDownButton Text="For">
                                    </DropDownButton>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtClientName" TabIndex="0" runat="server" Font-Size="10px" Width="250px" onkeyup="ajax_showOptions(this,'ShowClientFORMarginStocks',event,'Clients')"></asp:TextBox>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtExchange" TabIndex="0" runat="server" Font-Size="10px" Width="250px" Enabled="false"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtProduct" TabIndex="0" runat="server" Font-Size="10px" Width="155px"
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtICIN" runat="server" TabIndex="0" Font-Size="10px" Width="155px" onkeyup="Fn_ISIN(this,'ShowClientFORMarginStocks',event)"></asp:TextBox>
                                        </td>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Delivery Mode :
                                        </td>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:DropDownList ID="ddlClientSourceIncoming" TabIndex="0" runat="server" Font-Size="10px" Width="250px" OnSelectedIndexChanged="ddlClientSourceIncoming_SelectedIndexChanged"  AutoPostBack="true">
                                                    ...
                                                    <td>
                                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <asp:DropDownList ID="ddlSAccount" TabIndex="0" runat="server" Font-Size="10px" Width="300px">
                                                                </asp:DropDownList>
                                                            </ContentTemplate>
                                                            <Triggers>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlClientTargetIncoming" TabIndex="0" runat="server" Font-Size="10px" Width="250px">
                                            </asp:DropDownList></td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlClientSourceOutgoing" TabIndex="0" runat="server" Font-Size="10px" Width="250px">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:DropDownList ID="ddlClientTargetOutgoing" TabIndex="0" runat="server" Font-Size="10px" Width="250px"  AutoPostBack="true" OnSelectedIndexChanged="ddlClientTargetOutgoing_SelectedIndexChanged">
                                                            <%---<asp:ListItem Value="MH">Margin/Holdback A/C</asp:ListItem>--%>
                                                            <asp:ListItem Value="C">Client A/C</asp:ListItem>
                                                            <%---<asp:ListItem Value="Own">Own A/C</asp:ListItem>--%>
                                                        </asp:DropDownList></td>
                                                    <td>
                                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <asp:DropDownList ID="ddlTAccount" TabIndex="0" runat="server" Font-Size="10px" Width="300px">
                                                                </asp:DropDownList>
                                                            </ContentTemplate>
                                                            <Triggers>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlMarketIncoming" TabIndex="0" runat="server" Font-Size="10px"
                                                Width="250px">
                                            </asp:DropDownList></td>
                                    </tr>
                                </table>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlMarketOutgoing" TabIndex="0" runat="server" Font-Size="10px"
                                                Width="250px">
                                            </asp:DropDownList></td>
                                    </tr>
                                </table>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td id="TrSett2">
                                            <asp:TextBox ID="txtSettNumber" TabIndex="0" runat="server" Font-Size="10px" Width="155px" onkeyup="InterSettlementFunc(this,'InterSettlementForDeliveryPosition',event,'SettSource')"></asp:TextBox>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtSlipNumber" TabIndex="0" runat="server" Font-Size="10px" Width="155px"></asp:TextBox>
                                        </td>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Quantity :
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtQuantity" TabIndex="0" runat="server" Onkeypress="return isNumberKey(event)" Font-Size="10px" Width="155px"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtRemarks" runat="server" TabIndex="0" Font-Size="10px" Width="700px" Height="90px"
