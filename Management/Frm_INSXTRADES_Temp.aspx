<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_INSXTRADES, App_Web_bfdn6hbr" %>
   ...
   <script language="javascript" type="text/javascript">
    ...
    function PageLoad()
    {
       ...
       //File Format to Import By Default
        Span_FileFormat.innerText="File Name : sap_ta_dd-MM-yyyy.csv";
    }
    ...
    function OnComboChooseFileIndexChange()
    {
        ...
        if(SelectedValue==0)
            ...
            Span_FileFormat.innerText="File Name : sap_op_dd-MM-yyyy.csv";
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports SAPIEN's sap_ta_DD-MM-YYYY	.csv Trade Files
                                </h5>
                            </td>
                        </tr>
                        <tr>
