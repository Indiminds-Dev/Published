<%@ page language="C#" autoeventwireup="true" inherits="management_ICEXContracts_iframe, App_Web_cvaj-tqf" %>
            ...
            <asp:Panel ID="Panelmain" runat="server" Visible="true" HorizontalAlign="Center">
                <table id="tbl_main" class="login" cellspacing="0" cellpadding="0" width="410px"
                    ...
                    <tbody>
                        <tr>
                            <td class="EHEADER">
                                <span style="color: Blue"><strong>ICEX Contracts</strong></span></td>
                        </tr>
                        <tr>
                            <td class="lt">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="right" style="width: 278px">
                                                <asp:FileUpload ID="ICXSelectFile" runat="server" Width="272px" Height="21px" />
                                            </td>
                                        </tr>
                                        <tr>
