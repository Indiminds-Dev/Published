<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="management_frontendexports_best, App_Web_g1t3n0jz" %>
...
<head id="Head1">
    <title>Front-End Exports For BEST</title>
...
//                 End of New Work 04/08/2022                 
            ...
            function setparam()
            {
                 document.getElementById('DDLformat').setvalue='BEST';
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 22px;">
                        <strong><span id="SpanHeader" style="color: #000099">Front-End Exports For BEST</span></strong>
                    </td>
