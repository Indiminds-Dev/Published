<%@ page language="C#" autoeventwireup="true" inherits="Reports_NetPosition_MTM, App_Web_yvy99of_" %>
...
//                New Work 14/06/2022
                ...
                var isChecked = document.getElementById("chkrawprint").checked;
                if (isChecked)
                    document.getElementById("chkrawprint").checked = false;
//                End of New Work 14/06/2022
            }
            if(obj=='1')
            {
                Hide('td_show');
...
//                New Work 14/06/2022
                ...
                if(document.getElementById('ddlrptview').value=='1' || document.getElementById('ddlrptview').value=='3')
                    {
                        Hide('Tr_ChkClientColumn');
                        var isChecked = document.getElementById("chkrawprint").checked;
                        if (isChecked)
            ...
            <table class="TableMain100">
                <tr>
                    ...
                    <td class="EHEADER"  id="tr_filter" style="height: 22px">
                        <a href="javascript:void(0);" onclick="NORECORD(10);"><span style="color: Blue; text-decoration: underline;
                ...
                <tr valign="top">
                    <td>
                        <table>
                                                ...
                                                <table border="10" cellpadding="1" cellspacing="1">
                                                    <tr>
                                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                                            Report View :</td>
                                                        <td>
                                                            <asp:DropDownList ID="ddlrptview" runat="server" Width="200px" Font-Size="10px" onchange="fn_ddlrptchange(this.value)">
                                                            ...
                                                            <table border="10" cellpadding="1" cellspacing="1">
                                                                <tr>
                                                                    <td class="gridcellleft" bgcolor="#B7CEEC">
                                                                        View By :</td>
                                                                    <td>
                                                                        <asp:DropDownList ID="ddlviewby" runat="server" Width="120px" Font-Size="10px" onchange="fnddlview(this.value)">
                                                                            <asp:ListItem Value="1">Client</asp:ListItem>
                                                                            <%--New Work--%>
                                                                            <%--<asp:ListItem Value="2">Broker</asp:ListItem>--%>
                                                                            <asp:ListItem Value="2">Broker/Custodians</asp:ListItem>
                                                                            <%--End of New Work--%>
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <table border="10" cellpadding="1" cellspacing="1">
                                                            <tr>
                                                                ...
                                                                <td colspan="2" style="text-align: left" valign="top">
                                                                    <asp:DropDownList ID="ddlNetMktValue" runat="server" Width="100px" Font-Size="10px" onchange="OnConsiderChange(this.value)">
                                                ...
                                                <table id="showFilter" border="10" cellpadding="1" cellspacing="1">
                                                    <tr>
                                                        <td class="gridcellleft">
                                                            ...
                                                            <asp:DropDownList ID="cmbsearchOption" runat="server" Font-Size="11px" Width="120px"
                                                                Enabled="false">
                                                                <asp:ListItem>Clients</asp:ListItem>
                                                                <%--New Work--%>
                                                                <%--<asp:ListItem>Broker</asp:ListItem>--%>
                                                                <asp:ListItem>Broker/Custodians</asp:ListItem>
                                                                <%--End of New Work--%>
                                ...
                                <td class="gridcellleft">
                                    <table border="10" cellpadding="1" cellspacing="1">
                                        <tr>
                                            ...
                                            <td class="gridcellleft" bgcolor="#B7CEEC">
                                                <asp:CheckBox ID="ChkActiveCurrency" Checked="false" runat="server" onclick="selecttion()" />
                                                        ...
                                                        <td>
                                                            <div style="overflow: auto; border: 1px black solid; scrollbar-base-color: #C0C0C0">
                                                                <asp:CheckBoxList ID="chktfilter" runat="server" RepeatDirection="Horizontal" Width="600px"
                                                                    ...
                                                                    <asp:ListItem Value="Exp/Dlv" Selected="True">Exp/Dlv</asp:ListItem>
                            ...
                            <td>
                            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                             <asp:CheckBox ID="Chk_Consolidate" runat="server" />Consolidate Position For Branch/Group
                            ...
                            <tr id="Tr_ExposureInBuyPosition">
                                <td class="gridcellleft">
                                    <table border="10" cellpadding="1" cellspacing="1">
                                        <tr>
                                            <td class="gridcellleft" bgcolor="#B7CEEC">
                                                Consider Exposure In Buy Position
                                            </td>
                                            <td>
                                                <table>
                                                    <tr>
                                    ...
                                    <table border="10" cellpadding="1" cellspacing="1">
                                        ...
                                        <%------------------ Show Quantity Start ----------------------------%>
                                         ...
                                         <tr id="Tr_Quantity">
                                            ...
                                            <td>
                                                <asp:DropDownList ID="DdlQuantity" runat="server" Width="100px" Font-Size="10px">
                                                    <asp:ListItem Value="1">Price Unit</asp:ListItem>
                                                    <asp:ListItem Value="2">Lots</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        ...
                                        <ContentTemplate>
                                            <table id="Table1" runat="server">
                                                <tr valign="top">
                                                    ...
                                                    <td style="height: 44px">
                                                        <asp:DropDownList ID="DdlRecord" runat="server" Font-Size="10px" Width="300px" AutoPostBack="True"
