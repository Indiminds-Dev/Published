<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReport_TransactionSingleClientNSDL, App_Web_krnt_rtp" %>
                                                                  ...
                                                                  <tr>
                                                                    <td class="gridcellleft" style="vertical-align: top; text-align: left" id="TdFilter1">
                                                                        <span id="spanal2">
                                                                            ...
                                                                            <asp:DropDownList ID="cmbsearch" runat="server" Width="70px" Font-Size="10px">
                                        ...
                                        <tr>
                                            ...
                                            <td id="tdrbSettlment">
                                                <dxe:ASPxRadioButtonList ID="rbSettlement" runat="server" SelectedIndex="0" ItemSpacing="10px"
                                                    RepeatDirection="Horizontal" TextWrap="False" Font-Size="10px" ClientInstanceName="radioSettlement">
                                                    <Items>
                                                        <dxe:ListEditItem Text="All" Value="A" />
                                                        <dxe:ListEditItem Text="Specific" Value="S" />
                                                    </Items>
