<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReport_CommissionPaybleReport, App_Web_arnfzykg" %>
...
<body onload="javascript:document.form1.cmbReportType.focus();" style="margin: 0px 0px 0px 0px;
    background-color: #DDECFE">
                    ...
                    <table>
                        <tr style="display: none;">
                            ...
                            <td class="gridcellleft" colspan="2">
                                <asp:DropDownList ID="cmbReportType" runat="server" Font-Size="10px" TabIndex="1">
                        ...
                        <tr style="display: none;">
                            ...
                            <td class="gridcellleft">
                                <asp:DropDownList ID="drpPolicyStatus" runat="server" Width="179px" Font-Size="10px"
                                    TabIndex="11">
                        ...
                        <ContentTemplate>
                            <asp:Panel ID="Panel1" runat="server" Height="100%" Width="990px" ScrollBars="Horizontal">
                                <%--                                <asp:GridView ID="grdCashBankBook" runat="server" Width="100%" BorderColor="CornflowerBlue"
                                    ...
                                    OnSorting="grdCashBankBook_Sorting" Font-Size="10px" EmptyDataText="No Data Found!"
                                    ...
                                    <Columns>
                                         ...
                                         <asp:TemplateField HeaderText="Associates">
                                            ...
                                            <ItemTemplate>
                                                <asp:Label ID="lblAssociates" runat="server" Font-Size="10px" Text='<%# Eval("Associates")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                          <asp:TemplateField HeaderText="Sales Rep.">
                                            ...
                                            <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblSalesRep" runat="server" Font-Size="10px" Text='<%# Eval("SalesRep")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="SubBroker">
                                            ...
                                            <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblSubBroker" runat="server" Font-Size="10px" Text='<%# Eval("SubBroker")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                           ...
                                           <asp:TemplateField HeaderText="TeleCaller">
                                            ...
                                            <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblTeleCaller" runat="server" Font-Size="10px" Text='<%# Eval("TeleCaller")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                          ...
                                          <asp:TemplateField HeaderText="Payble Commission">
                                            ...
                                            <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblCommission" runat="server" Font-Size="10px" Text='<%# Eval("BaseCommission")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         ...
                                         <asp:TemplateField HeaderText="branch" SortExpression="branch">
                                            ...
                                            <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblbranch" runat="server" Font-Size="10px" Text='<%# Eval("branch")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                            ...
                                            <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblCustomer" runat="server" Font-Size="10px" Text='<%# Eval("Customer")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                            ...
                                            <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lbltransDateF" runat="server" Font-Size="10px" Text='<%# Eval("transDateF")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                           <asp:TemplateField HeaderText="policy" SortExpression="policy">
                                            ...
                                            <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblpolicy" runat="server" Font-Size="10px" Text='<%# Eval("policy")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                           <asp:TemplateField HeaderText="mode" SortExpression="mode">
                                            ...
                                            <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblmode" runat="server" Font-Size="10px" Text='<%# Eval("mode")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="premiumAmt">
                                            ...
                                            <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblpremiumAmt" runat="server" Font-Size="10px" Text='<%# Eval("premiumAmt")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Issue Date" SortExpression="issueDate">
                                            ...
                                            <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblissueDateF" runat="server" Font-Size="10px" Text='<%# Eval("issueDateF")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Status" SortExpression="policy">
                                            ...
                                            <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblpolicy" runat="server" Font-Size="10px" Text='<%# Eval("status")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
                                <%--<asp:TemplateField HeaderText="WAPI">
                                            ...
                                            <HeaderStyle Wrap="False" HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                                <asp:Label ID="lblWAPI" runat="server" Font-Size="10px" Text='<%# Eval("WAPI")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
                                <%--                                       
                                    </Columns>
                                    ...
                                    <RowStyle BackColor="White" ForeColor="#330099" BorderColor="#BFD3EE" BorderStyle="Double"
                                        BorderWidth="1px" Font-Size="10px"></RowStyle>
                                ...
                                <dxwgv:aspxgridview id="grdCashBankBook" runat="server" width="100%" clientinstancename="grid"
...
<Header SortingImageSpacing="5px" ImageSpacing="5px"></Header>
                                        ...
                                        <Columns>
<dxwgv:GridViewDataTextColumn VisibleIndex="0" FieldName="Associates" Caption="Associates">
...
<dxwgv:GridViewDataTextColumn VisibleIndex="2" FieldName="SalesRep" Caption="Sales Representative">
<Settings AutoFilterCondition="Contains" FilterMode="DisplayText"></Settings>

<CellStyle CssClass="gridcellleft"></CellStyle>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataTextColumn UnboundType="Integer" VisibleIndex="3" FieldName="SubBroker" Caption="Sub Broker">
<Settings AllowAutoFilter="False"></Settings>

<CellStyle HorizontalAlign="Right" CssClass="gridcellleft"></CellStyle>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataTextColumn UnboundType="Integer" VisibleIndex="4" FieldName="TeleCaller" Caption="Tele Caller">
<Settings AllowAutoFilter="False"></Settings>

<CellStyle HorizontalAlign="Right" CssClass="gridcellleft"></CellStyle>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataTextColumn VisibleIndex="5" FieldName="branch" Caption="Branch">
<Settings AllowAutoFilter="False"></Settings>

<CellStyle HorizontalAlign="Right" CssClass="gridcellleft"></CellStyle>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataTextColumn  VisibleIndex="6" FieldName="policy" Caption="Policy">
<Settings AllowAutoFilter="False"></Settings>

<CellStyle HorizontalAlign="Right" CssClass="gridcellleft"></CellStyle>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataTextColumn  VisibleIndex="7" FieldName="mode" Caption="Transaction Mode">
<Settings AllowAutoFilter="False"></Settings>

<CellStyle HorizontalAlign="Right" CssClass="gridcellleft"></CellStyle>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataTextColumn  VisibleIndex="8" FieldName="premiumAmt" Caption="Premium Amount">
<Settings AllowAutoFilter="False"></Settings>

<CellStyle HorizontalAlign="Right" CssClass="gridcellleft"></CellStyle>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataTextColumn VisibleIndex="9" FieldName="issueDateF" Caption="Issue Date">
<Settings AllowAutoFilter="False"></Settings>

<CellStyle HorizontalAlign="Right" CssClass="gridcellleft"></CellStyle>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataTextColumn VisibleIndex="10" FieldName="BaseCommission" Caption="Payble Commission">
<Settings AllowAutoFilter="False"></Settings>
...
<CellStyle HorizontalAlign="Right" CssClass="gridcellleft"></CellStyle>
                                        ...
                                        <TotalSummary>
<dxwgv:ASPxSummaryItem FieldName="BaseCommission" DisplayFormat="#,##,###.00" Tag="Total Holding Value" ShowInGroupFooterColumn="BaseCommission" ShowInColumn="BaseCommission" SummaryType="Sum"></dxwgv:ASPxSummaryItem>
</TotalSummary>
