<%@ page language="C#" autoeventwireup="true" inherits="management_contractmodification, App_Web_g1t3n0jz" %>
...
<head id="Head1">
    <title>Contract No. Modification</title>
   ...
   function fngrouptype(obj)
   {
    ...
    function Show(obj)
     ...
     function NoRecord(obj)
     {
        ...
        {
            alert('Cancel Contract No. Successfully');  
        }
        height();
     }
     function Display()
           ...
           <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 22px;">
                        <strong><span id="SpanHeader" style="color: #000099">ContractNote Number Modification</span></strong>
                    </td>
                            ...
                            <asp:GridView ID="grdcontract" runat="server" Width="100%" BorderColor="CornflowerBlue"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Date">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lbldate" runat="server" Text='<%# Eval("TradeDate")%>' CssClass="gridstyleheight1"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Sett No." >
                                        <ItemStyle Wrap="False" BorderWidth="1px" HorizontalAlign="Center"></ItemStyle>
                                        <HeaderStyle HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                        <ItemTemplate>
                                            <asp:Label ID="lblSETTTYPE" runat="server" Text='<%# Eval("SETTTYPE")%>' CssClass="gridstyleheight1"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Status" >
                                        ...
                                        <HeaderStyle HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                        <ItemTemplate>
                                            <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("Status")%>' CssClass="gridstyleheight1"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Select">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblContractNotesid" runat="server" Visible="false" Text='<%#Eval("ContractNotes_id")%>'></asp:Label>
                                            <asp:Label ID="lblContractNoteno" runat="server" Visible="false" Text='<%#Eval("ContractNotes_Number")%>'></asp:Label>
                    ...
                    <table>
                        <tr>
                            <td>
                                Reason :</td>
                            <td>
                                <asp:TextBox ID="txtreason" Width="250px" Font-Size="10px" runat="server" TextMode="MultiLine"></asp:TextBox></td>
