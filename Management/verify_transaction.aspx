<%@ page language="C#" autoeventwireup="true" inherits="management_verify_transaction, App_Web_6yanuau_" maintainscrollpositiononpostback="true" enableeventvalidation="false" %>
                                                ...
                                                <asp:GridView ID="offlineGrid" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Edit">
                                                            <ItemTemplate>
                                                                <a href="javascript:void(0);" onclick="OnMoreInfoClick('<%# Eval("id") %>','<%# Eval("trantype")%>')">
                                                                    More Info...</a>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
