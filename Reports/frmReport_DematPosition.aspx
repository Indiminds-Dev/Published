<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReport_DematPosition, App_Web_xpx38is4" %>
                                            ...
                                            <td valign="top">
                                                <table border="10" cellpadding="1" cellspacing="1">
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="DdlExchange" Font-Size="10px" runat="server" Width="100px">
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td valign="top">
                                                <table border="10" cellpadding="1" cellspacing="1">
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="DdlSearchBy" runat="server" Width="100px" Font-Size="10px"
                                    ...
                                    <table border="10" cellpadding="1" cellspacing="1">
                                        <tr>
                                            <td class="gridcellleft" bgcolor="#B7CEEC">
                                                Send Email :</td>
                                            <td>
                                                <asp:DropDownList ID="DdlSendEmail" runat="server" Width="200px" Font-Size="10px"
