<%@ page language="C#" autoeventwireup="true" inherits="management_LiborRatePopup, App_Web_vvdfezxa" %>
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" style="text-align: center;">
                        <strong><span style="color: #000099">ADD/Edit Libor Rates</span></strong>
                    </td>
                </tr>
            </table>
                            ...
                            <tr>
                                ...
                                <td style="width: 2px; ">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorFromCurrency" runat="server" ControlToValidate="txtFromCurrency"
                                        ErrorMessage="Please Select Currency" ValidationGroup="a">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <tr>
                                ...
                                <td style="width: 2px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorFXRate" runat="server" ControlToValidate="txtFXRate"
                                        ErrorMessage="Please Insert Libor Rate" ValidationGroup="a">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                        </table>                
                    </td>                
