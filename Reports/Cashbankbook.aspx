<%@ page language="C#" autoeventwireup="true" inherits="Reports_Cashbankbook, App_Web_xpx38is4" %>
    ...
    <form id="form1" runat="server">
        <div>
                                    ...
                                    <div id="divsegment">
                                        ...
                                        <div class="frmleftContent">
                                            <dxe:ASPxRadioButtonList ID="rdbSgment" runat="server" SelectedIndex="0" ItemSpacing="10px"
                                                RepeatDirection="Horizontal" TextWrap="False" Font-Size="10px" ClientInstanceName="crbsegment"
                                                TabIndex="0">
                                                <Items>
            ...
            <table id="Tblfooter">
                ...
                <tr>
                    <td>
                        <dxwgv:ASPxGridView ID="gridasset" runat="server" AutoGenerateColumns="False" KeyFieldName="IDfinal"
                            ...
                            <Columns>
                                <dxwgv:GridViewDataTextColumn FieldName="TrDate" Caption="Tr.Date" VisibleIndex="0" Width="8%">
                                    <CellStyle CssClass="gridcellleft" Wrap="False">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="ValueDate" Caption="Value Date" VisibleIndex="1" Width="6%">
                                    <CellStyle CssClass="gridcellleft" Wrap="False">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="TransactionReferenceID" Caption="Voucher No"
                                    VisibleIndex="2" Width="6%">
                                    <CellStyle CssClass="gridcellleft" Wrap="False">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="Narration" Caption="Description" VisibleIndex="3" Width="17%">
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="AccountName" FieldName="AccountName" VisibleIndex="4" Width="16%">
                                    <CellStyle CssClass="gridcellleft" Wrap="default">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="Inst.Number" FieldName="InstrumentNumber"
                                    VisibleIndex="5" Width="6%">
                                    <CellStyle CssClass="gridcellleft" Wrap="False">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="Inst.Date" FieldName="Instrumentdate" VisibleIndex="6" Width="6%">
                                    <CellStyle CssClass="gridcellleft" Wrap="False">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="AmmountDr" Caption="Dr(Receipt)" VisibleIndex="7"
                                    Width="10%">
                                ...
                                <dxwgv:GridViewDataTextColumn FieldName="AmmountCr" Caption="Cr(Payment)" VisibleIndex="8"
                                    Width="10%">
                                    <CellStyle CssClass="gridcellleft" Wrap="False" HorizontalAlign="Right">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="right" />
                                ...
                                <dxwgv:GridViewDataTextColumn FieldName="FinalClosing" Caption="Closing" VisibleIndex="9"
                                    Width="10%">
                                    <CellStyle CssClass="gridcellleft" Wrap="False" HorizontalAlign="Right">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="right" />
                                ...
                                <dxwgv:GridViewDataTextColumn FieldName="CompanyID" Visible="False" Caption="Closing"
                                    VisibleIndex="11">
                                    <CellStyle CssClass="gridcellleft" Wrap="False" HorizontalAlign="Right">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="MainID" Visible="False" Caption="Closing"
                                    VisibleIndex="12">
                                    <CellStyle CssClass="gridcellleft" Wrap="False" HorizontalAlign="Right">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="SubID" Visible="False" Caption="Closing"
                                    VisibleIndex="13">
                                    <CellStyle CssClass="gridcellleft" Wrap="False" HorizontalAlign="Right">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Left" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="TransactionReferenceID" Visible="False"
                            ...
                            <%--<TotalSummary>
                                <dxwgv:ASPxSummaryItem FieldName="FinalClosing" ShowInColumn="FinalClosing" DisplayFormat="00,00,00.00"
                                    SummaryType="None" />
                            </TotalSummary>--%>
