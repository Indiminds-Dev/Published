<%@ page language="C#" autoeventwireup="true" inherits="management_frmDPNetworthStatement, App_Web_amufh4kc" %>
    ...
    <table class="TableMain100">
        ...
        <table id="tabFilter" border="0">
         ...
         <table width="100%">
            <tr>
                <td>
                    <dxwgv:ASPxGridView ID="gridStatement" runat="server" Width="100%" ClientInstanceName="grid"
                                        ...
                                        <Columns>
                                            <dxwgv:GridViewDataTextColumn FieldName="HolderName" Caption="Name" VisibleIndex="0">
                                            ...
                                            <dxwgv:GridViewDataTextColumn FieldName="BenAcc" Caption="Account No"
                                                VisibleIndex="1">
                                                <Settings FilterMode="DisplayText" AutoFilterCondition="Contains"></Settings>
                                                <CellStyle CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="TRADINGUCC" Caption="Trading Ucc"
                                                VisibleIndex="2">
                                                <Settings FilterMode="DisplayText" AutoFilterCondition="Contains"></Settings>
                                                <CellStyle CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="AccountType" 
                                                Caption="Account Type" VisibleIndex="3">
                                                <Settings AllowAutoFilter="False"></Settings>
                                                <CellStyle HorizontalAlign="Left" CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="Phone"
                                                Caption="Phone No" VisibleIndex="4">
                                                <Settings AllowAutoFilter="False"></Settings>
                                                <CellStyle HorizontalAlign="Right" CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn PropertiesTextEdit-DisplayFormatString="#,##,###.000" FieldName="CURRENTBALANCE"
                                                Caption="Current Balance" VisibleIndex="5">
                                                <Settings AllowAutoFilter="False"></Settings>
                                                <CellStyle HorizontalAlign="Right" CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn PropertiesTextEdit-DisplayFormatString="#,##,###.00" FieldName="VALUE"
                                                Caption="Value" VisibleIndex="6">
                                                <Settings AllowAutoFilter="False"></Settings>
                                                <CellStyle HorizontalAlign="Right" CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                             <dxwgv:GridViewDataTextColumn FieldName="branch"
                                                Caption="Branch" VisibleIndex="7">
                                                <Settings AllowAutoFilter="False"></Settings>
                                                <CellStyle HorizontalAlign="Left" CssClass="gridcellleft">
                                                </CellStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                             <dxwgv:GridViewDataTextColumn FieldName="group"
                                        ...
                                        <TotalSummary>
                                            <dxwgv:ASPxSummaryItem FieldName="VALUE" ShowInColumn="Value" ShowInGroupFooterColumn="Value"
