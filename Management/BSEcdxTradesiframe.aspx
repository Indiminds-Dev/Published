<%@ page language="C#" autoeventwireup="true" inherits="management_Tradesiframe, App_Web_8qixh_8w" %>
                ...
                <table id="tbl_main" class="login" cellspacing="0" cellpadding="0" width="410">
                    <tbody>
                        <tr>
                            <td class="lt1">
                                <h5>
                                    Imports BSE-CDX TRADES Files</h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="lt brdr">
                                                ...
                                                <table class="width100per" cellspacing="12" cellpadding="0">
                                                    <tbody>
                                                        <tr>
                                                         ...
                                                         <tr>
                                                            <td class="lt">
                                                                <asp:Label ID="Label1" runat="server" Font-Size="XX-Small" Font-Names="Arial"
                                                                            ...
                                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                                <ContentTemplate>
                                                                                    <asp:DropDownList ID="ddlFileList" runat="server" Width="222px" AutoPostBack="True"
                                                                                        ...
                                                                                        <asp:ListItem Value="2">Bolt+</asp:ListItem>
                                                                                        <asp:ListItem Value="3">RTS File</asp:ListItem>
                                                                                        <asp:ListItem Value="4">Flash Trade CSV</asp:ListItem>
                                                                                        <asp:ListItem Value="5">Odin TradesView TXT</asp:ListItem>
                                                                                        <asp:ListItem Value="6">Flash Admin Trade CSV</asp:ListItem>
                                                                                        <asp:ListItem Value="7">NOW/BEST Trade TXT</asp:ListItem>
                                                                                        <asp:ListItem Value="8">Greek TXT</asp:ListItem>
                                                                                        <asp:ListItem Value="9">Influx Trade TXT</asp:ListItem>
                                                                                        <asp:ListItem Value="10">Odin TXT Files</asp:ListItem>
                                                                                        <asp:ListItem Value="11">ATIN/A-One CSV Files</asp:ListItem>
                                                                                        <asp:ListItem Value="12">uTrade TXT Files</asp:ListItem>
                                                                                        </asp:DropDownList><br />
