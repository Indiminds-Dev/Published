<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableeventvalidation="false" inherits="Reports_frmReport_IFrameLedgerView, App_Web_icax4mdl" %>
...
//     New Work 12/01/2023
     ...
     {
         document.getElementById("TrDWB").style.display='inline';
         Page_Load();
         height();
     }
     ...
     {
         Page_Load();
         document.getElementById("TrDWB").style.display='none';         
         height();
     }
//     End of New Work 12/01/2023
        ...
        window.parent.SignOff();
         ...
         function keyVal(obj)
         {
            ...
            if(obj1[1]=='None')
            {
                ...
                //New Work
                document.getElementById('TrForBroker').style.display='none';
                document.getElementById('TrForCustodians').style.display='none';
                //End of New Work
//                New Work 27/06/2024
                document.getElementById('TrForInvestors').style.display='none';
                document.getElementById('TrForFM').style.display='none';
//                End of New Work 27/06/2024
                 //-- For Email 
...
//                  End of New Work 12/01/2023
                ...
                else
                {
                    ...
                    //New Work
                    document.getElementById('TrForBroker').style.display='inline';
                    document.getElementById('TrForCustodians').style.display='inline';
                    //End of New Work
//                    New Work 27/06/2024
                    document.getElementById('TrForInvestors').style.display='inline';
                    document.getElementById('TrForFM').style.display='inline';
//                    End of New Work 27/06/2024
                    document.getElementById('TrSubAccount').style.display='none';
                          //-- For Email 
...
//                  End of New Work 12/01/2023
        ...
        function ShowHide(obj)
        {
            ...
            //New Work
            else if(AcVal.value=='5')
                document.getElementById('spanshow').innerText='Broker Settlement A/c';
           else if(AcVal.value=='6')
            document.getElementById('spanshow').innerText='Custodians Settlement A/c';
            
           document.getElementById('spanshow4').innerText=document.getElementById('hdnActiveCurrency').value;
            //End of New Work
            height();
        }
        function ForFilter()
...
//        New Work 27/06/2024
        ...
        {
            var AcVal=document.getElementById('ddlAccountTypeIP').value;
...
//        End of New Work 27/06/2024
           ...
           //  document.getElementById('BtnAllOtherAccount').style.display='none';
             
             document.getElementById('TrType').style.display='inline';
             document.getElementById('TrSett').style.display='inline';
            
                //New Work
                if(AcVal=='0' || AcVal=='1' || AcVal=='2')
                {
                    document.getElementById('TdAc').style.display='none';
                    document.getElementById('TdAc1').style.display='none';
                    document.getElementById('TrSubAccount').style.display='none';                
...
//            New Work 27/06/2024
            ...
            if(segmentname=="InvestPool")
            {
                document.getElementById('TdAccTypes').style.display='none';
                document.getElementById('TdAccTypesIP').style.display='inline';                
                document.getElementById('TrForClient').style.display='none';
                document.getElementById('TrForInvestors').style.display='inline';
                document.getElementById('TrForFM').style.display='none';
            }
            ...
            {
                document.getElementById('TdAccTypes').style.display='inline';
                document.getElementById('TdAccTypesIP').style.display='none';
                document.getElementById('TrForClient').style.display='inline';
                document.getElementById('TrForInvestors').style.display='none';
                document.getElementById('TrForFM').style.display='none';
            }
//            End of New Work 27/06/2024
            ChangeAccountType();
            fn_ddllistType(document.getElementById('ddllistType').value);
            //End of New Work            
            height();            
        }
...
//                btn.click();
        ...
        function SegSelected(obj)
        {
            ...
            {
                document.getElementById('cmbsearchOption').value='Broker';
                document.getElementById('spanSub').style.display="none";
                document.getElementById('spanall').style.display="none";
                document.getElementById('span2').style.display="inline";
                document.getElementById('Button1').disabled=true;
            ...
            else if(obj=='Custodians')
            {
                document.getElementById('cmbsearchOption').value='Custodians';
                document.getElementById('spanSub').style.display="none";
                document.getElementById('spanall').style.display="none";
                document.getElementById('span2').style.display="inline";
                document.getElementById('Button1').disabled=true;
            ...
            //End of New Work
//            New Work 27/06/2024
            else if(obj=='Investors')
            {
                document.getElementById('cmbsearchOption').value='Investors';
                document.getElementById('spanSub').style.display="none";
                document.getElementById('spanall').style.display="none";
                document.getElementById('span2').style.display="inline";
                document.getElementById('Button1').disabled=true;
            ...
            else if(obj=='Fund Managers')
            {
                document.getElementById('cmbsearchOption').value='Fund Managers';
                document.getElementById('spanSub').style.display="none";
                document.getElementById('spanall').style.display="none";
                document.getElementById('span2').style.display="inline";
                document.getElementById('Button1').disabled=true;
...
//            New Work 27/06/2024
//            if(cmb.value=='Clients' || cmb.value=='Branch' || cmb.value=='Group' || cmb.value=='Settlement' || cmb.value=='Employee' || cmb.value=='Broker' || cmb.value=='Custodians')
            if(cmb.value=='Clients' || cmb.value=='Branch' || cmb.value=='Group' || cmb.value=='Settlement' || cmb.value=='Employee' || cmb.value=='Broker' || cmb.value=='Custodians' || cmb.value=='Investors' || cmb.value=='Fund Managers')
//            End of New Work 27/06/2024
            //End of New Work
            {
...
//              New Work 27/06/2024
              ...
              if(segmentname=="InvestPool")
              {
                var docVal=document.getElementById('ddlAccountTypeIP').value
                if(docVal=='0')
                    Mainvalue="'SYSTM60001'";
                else if(docVal=='1')
                    Mainvalue="'SYSTM60003'";
                else if(docVal=='2')
                    Mainvalue="'SYSTM60002'";
                else if(docVal=='3')
                  {
...
//              End of New Work 27/06/2024
                 ...
                 //New Work
                    ...
                    Mainvalue="'SYSTM00057'";
                 else if(docVal=='6')
                    Mainvalue="'SYSTM00157'";
//             New Work 27/06/2024
             }
//             End of New Work 27/06/2024
             //End of New Work
...
//            New Work 27/06/2024
//            if(document.getElementById('cmbsearchOption').value=="Clients" || document.getElementById('cmbsearchOption').value=="Broker" || document.getElementById('cmbsearchOption').value=="Custodians")
            if(document.getElementById('cmbsearchOption').value=="Clients" || document.getElementById('cmbsearchOption').value=="Broker" || document.getElementById('cmbsearchOption').value=="Custodians" || document.getElementById('cmbsearchOption').value=="Investors" || document.getElementById('cmbsearchOption').value=="Fund Managers")
//            End of New Work 27/06/2024
            //End of New Work
            {
...
//            }
            ...
            if(Data[0]=='Broker')
            {
                document.getElementById('HdnBroker').value=Data[1];
            }
            if(Data[0]=='Custodians')
            {
                document.getElementById('HdnCustodians').value=Data[1];
            }
            //End of New Work
//            New Work 27/06/2024
            if(Data[0]=='Investors')
            {
                document.getElementById('HdnInvestors').value=Data[1];
            }
            if(Data[0]=='Fund Managers')
            {
                document.getElementById('HdnFM').value=Data[1];
            }
//            End of New Work 27/06/2024
...
//    var vType = document.getElementById('ddlAccountType').value;
    ...
    if(segmentname=="InvestPool")
    {
        var vType = document.getElementById('ddlAccountTypeIP').value;
    }
    else
    {
        var vType = document.getElementById('ddlAccountType').value;
...
//    End of New Work 27/06/2024
    ...
    if (vType == '4') {
        document.getElementById('btnPrint').style.display = 'none';
        document.getElementById('BtnAllOtherAccount').style.display = 'inline';
    }
    else {
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <table class="TableMain100">
                            ...
                            <tr>
                                ...
                                <%--End of New Work 27/06/2024--%>
                                    <asp:DropDownList ID="ddlAccountType" runat="server" Width="154px" Font-Size="10px">
                                        ...
                                        <%--New Work--%>
                                        <asp:ListItem Value="5">Broker Settlement A/c</asp:ListItem>
                                        <asp:ListItem Value="6">Custodians Settlement A/c</asp:ListItem>
                                        <%--End of New Work--%>
                                        <%--New Work 27/06/2024--%>
                                ...
                                <%--New Work 27/06/2024--%>
                                <td id="TdAccTypesIP">
                                    <asp:DropDownList ID="ddlAccountTypeIP" runat="server" Width="154px" Font-Size="10px">
                                        <asp:ListItem Value="0">Investors Trading A/c</asp:ListItem>
                                        <asp:ListItem Value="1">IFS Ledger</asp:ListItem>
                                        <asp:ListItem Value="2">Fund Managers A/c</asp:ListItem>
                                        <asp:ListItem Value="3">Other Account</asp:ListItem>
                                        <asp:ListItem Value="4">All Accounts</asp:ListItem>
                                        <%--End of New Work 27/06/2024--%>
                                    </asp:DropDownList>
                            ...
                            <tr id="TrForBroker">
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:RadioButton ID="rdbBrokerALL" runat="server" Checked="True" GroupName="br1"
                                                    onclick="SegAll('Broker')" /></td>
                                            <td>
                                                All Broker</td>
                                            <td>
                                                <asp:RadioButton ID="rdbBrokerSelected" runat="server" GroupName="br1" onclick="SegSelected('Broker')" /></td>
                                            <td>
                                                Selected Broker</td>
                                        </tr>
                                    </table>
                            ...
                            <tr id="TrForCustodians">
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:RadioButton ID="rdbCustodiansALL" runat="server" Checked="True" GroupName="cu1"
                                                    onclick="SegAll('Custodians')" /></td>
                                            <td>
                                                All Custodians</td>
                                            <td>
                                                <asp:RadioButton ID="rdbCustodiansSelected" runat="server" GroupName="cu1" onclick="SegSelected('Custodians')" /></td>
                                            <td>
                                                Selected Custodians</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            ...
                            <tr id="TrForInvestors">
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:RadioButton ID="rdbInvestorsALL" runat="server" Checked="True" GroupName="inv"
                                                    onclick="SegAll('Investors')" /></td>
                                            <td>
                                                All Investors</td>
                                            <td>
                                                <asp:RadioButton ID="rdbInvestorsSelected" runat="server" GroupName="inv" onclick="SegSelected('Investors')" /></td>
                                            <td>
                                                Selected Investors</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr id="TrForFM">
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:RadioButton ID="rdbFMALL" runat="server" Checked="True" GroupName="fm"
                                                    onclick="SegAll('Fund Managers')" /></td>
                                            <td>
                                                All Fund Managers</td>
                                            <td>
                                                <asp:RadioButton ID="rdbFMSelected" runat="server" GroupName="fm" onclick="SegSelected('Fund Managers')" /></td>
                                            <td>
                                                Selected Fund Managers</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <table>
                                        ...
                                        <tr id="TrDWB">
                                            <td>
                                                <asp:RadioButton ID="radDateWiseBreak" runat="server" onclick="DateVoucher('b')" GroupName="d" />
                                            </td>
                                            <td>
                                                Date Wise Position Breakup
                                            </td>
                                        </tr>
                                        <%--End of New Work 12/01/2023--%>
                                    </table>
                                        ...
                                        <tr>
                                            <td style="width: 110px">
                                                <dxe:ASPxDateEdit ID="dtFrom" runat="server" ClientInstanceName="dtFrom" EditFormat="Custom"
                                                    UseMaskBehavior="True" Font-Size="10px" Width="108px" DateOnError="Today">
                                            ...
                                            <td style="width: 110px">
                                                <dxe:ASPxDateEdit ID="dtTo" runat="server" ClientInstanceName="dtTo" EditFormat="Custom"
                                                    UseMaskBehavior="True" Font-Size="10px" Width="98px" DateOnError="Today">
                                        ...
                                        <tr>
                                            ...
                                            <td id="tdHeader" runat="server">
                                                <asp:TextBox ID="txtHeader" runat="server" Width="279px" Font-Size="10px" 
                                                    ...
                                                    <%--FunHeaderFooter(this,'GetHeaderFooter',event,'H')--%>
                                                    
                                                      <%--<asp:TextBox ID="TextBox1" runat="server" Width="279px" Font-Size="10px" 
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            ...
                                                            <asp:DropDownList ID="cmbsearchOption" runat="server" Font-Size="11px" Width="70px"
                                                                ...
                                                                <%--End of New Work--%>
                                                                <%--New Work 27/06/2024--%>
                                                                <asp:ListItem>Investors</asp:ListItem>
                                                                <asp:ListItem>Fund Managers</asp:ListItem>
                                                                <%--End of New Work 27/06/2024--%>
                                                            </asp:DropDownList>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:DropDownList ID="cmbclientsPager" runat="server" CssClass="normaltxt" Width="200px"
                                                            Font-Size="10px" ValidationGroup="a" AutoPostBack="True" onchange="selecttion()"
                ...
                <tr id="TrBtn">
                    <td>
                        <asp:Button ID="Button1" runat="server" Text="Show" CssClass="btnUpdate" Width="100px"
                        ...
                        <asp:Button ID="BtnGenerate" runat="server" CssClass="btnUpdate" Text="Generate"
                            Width="100px" OnClick="BtnGenerate_Click" />
                            
                            <asp:Button ID="BtnAllOtherAccount" runat="server" CssClass="btnUpdate" Text="Print All Other Account"
                            Width="200px" onclick="BtnAllOtherAccount_Click"  />
                ...
                <tr>
                    <td colspan="2" id="showDetail">
                        ...
                        <span id="spanshow2" style="color: Blue; font-weight: bold">Period :</span>&nbsp;&nbsp;
                        <span id="spanshow3"></span>&nbsp;&nbsp;&nbsp;&nbsp;
                        <span id="spanshow4" style="color: Red; font-weight: bold"></span>
                    </td>
                </tr>
                    ...
                    <td colspan="2">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <%--OnDataBinding="grdCashBankBook_DataBinding"--%>
                        ...
                        <%--New Work--%>
                        <asp:HiddenField ID="HdnBroker" runat="Server" />
                        <asp:HiddenField ID="HdnCustodians" runat="Server" />
                        <%--End of New Work--%>
                        <%--New Work--%>
                        <asp:HiddenField ID="HdnInvestors" runat="Server" />
                        <asp:HiddenField ID="HdnFM" runat="Server" />
                        <%--End of New Work--%>
                    </td>
                </tr>
                <tr>
