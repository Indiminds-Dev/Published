<%@ page language="C#" autoeventwireup="true" inherits="management_frmObligationStatement, App_Web_hnfc-rlk" %>
                                            ...
                                            <tbody>
                                                  ...
                                                  <tr>
                                                   ...
                                                   <%-- <td>
                                                    <table cellspacing="0" cellpadding="0">
                                                       ...
                                                       <tr>
                                                            <td>
                                                                <asp:Button ID="btnCompare" runat="server" Text="Compare File" CssClass="btn" OnClick="btnCompare_Click" Width="84px" />
                                                            </td>
                                                      </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="lt" colspan="2" style="height: 22px; text-align: center">
                                                        <asp:Label ID="Label1" runat="server" Text="Label" Width="523px" Visible="False"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right" valign="middle" colspan="2">
                                                        <asp:GridView ID="gvCompare" runat="server" Width="567px" style="background-color: #ffcccc">
