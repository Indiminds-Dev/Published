<%@ page language="C#" autoeventwireup="true" inherits="management_RMSFee, App_Web_sjbhlkdr" %>
...
<head runat="server">
    ...
    function OnMoreInfoClick(keyValue)
    {
        ...
        var url = 'RMSFeeAdd.aspx?id=' + keyValue;
    ...
    function OnAddButtonClick() 
    {
         ...
         var url = 'RMSFeeAdd.aspx?id=' + 'ADD';
         parent.OnMoreInfoClick(url,"Add RMS Fee Details",'940px','450px',"Y");
    ...
    <form id="form1" runat="server">
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center;">
                    <strong><span style="color: #000099">RMS Fee Details</span></strong>
                </td>
            </tr>
            <tr>
                <td align="right">
        ...
        <dxwgv:ASPxGridView ID="ServiceTaxGrid" runat="server" KeyFieldName="ServTax_ID"
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataTextColumn FieldName="RMSFee_SrvTax" Caption="Tax " VisibleIndex="3"
                    Width="8%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <dxwgv:GridViewDataTextColumn Caption="Charge To" FieldName="RMSFee_ApplicableFor" VisibleIndex="4"
                    Width="6%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <dxwgv:GridViewDataTextColumn Caption="Slab" FieldName="RMSFee_Slab"
                    ...
                    <dxwgv:GridViewDataTextColumn FieldName="RMSFee_Amount" Caption="Amount" VisibleIndex="6"
                    Width="7%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
            ...
            <SettingsText PopupEditFormCaption="Add/ Modify RMS Fee" 
                GroupPanel="RMS Fee " />
        ...
        <asp:SqlDataSource ID="ServiceTaxDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
            DeleteCommand="RMSFee_Delete" DeleteCommandType="StoredProcedure">
            <DeleteParameters>
