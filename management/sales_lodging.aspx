<%@ page language="C#" autoeventwireup="true" inherits="management_sales_lodging, App_Web__yen2upk" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" runat="server">
    ...
    <div>
        ...
        <tr>
            <td>
                <dxtc:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="3" ClientInstanceName="page"  Font-Size="10px"><TabPages>
                            ...
                            <dxw:ContentControl runat="server">
                                <dxwgv:ASPxGridView ID="gridLodging" ClientInstanceName="grid" DataSourceID="SqlLodging" runat="server" KeyFieldName="expnd_internalId"  Width="100%" AutoGenerateColumns="False" OnInitNewRow="gridLodging_InitNewRow">
                                    <Columns>
                                        ...
                                        <dxwgv:GridViewDataComboBoxColumn Caption="Lodging Type" FieldName="expnd_LodgingType"
                                            VisibleIndex="0">
                                            <PropertiesComboBox ValueType="System.String">
                                                <Items>
                                                    <dxe:ListEditItem Text="Budget " Value="Budget">
                                                    </dxe:ListEditItem>
                                                    <dxe:ListEditItem Text="Hotel – Luxury " Value="Hotel – Luxury">
                                                    </dxe:ListEditItem>
                                                    <dxe:ListEditItem Text="Service apartments " Value="Service apartments">
                                                    </dxe:ListEditItem>
                                                    <dxe:ListEditItem Text="Guest house " Value="Guest house">
                                                    </dxe:ListEditItem>
                                        ...
                                        <dxwgv:GridViewDataDateColumn FieldName="expnd_LodgingDateFrom" Visible="False" VisibleIndex="0">
                                        ...
                                        <dxwgv:GridViewDataTextColumn FieldName="expnd_LodgingDateFrom1" Caption="From"  VisibleIndex="1">
                                            <EditFormSettings Visible="False"/>
                                            <CellStyle CssClass="gridcellleft">
                                            </CellStyle>
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataDateColumn FieldName="expnd_LodgingDateTo" Visible="False" VisibleIndex="0">
                                            <PropertiesDateEdit DisplayFormatString="" EditFormat="Custom" EditFormatString="dd-MM-yyyy">
                                            </PropertiesDateEdit>
                                        ...
                                        <dxwgv:GridViewDataTextColumn FieldName="expnd_LodgingDateTo1" Caption="To" VisibleIndex="2">
                                            <EditFormSettings Visible="False"/>
                                            <CellStyle CssClass="gridcellleft">
                                            </CellStyle>
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn FieldName="expnd_LodgingExpnseAmount" Caption="Amount" VisibleIndex="3">
                                        ...
                                        <dxwgv:GridViewDataTextColumn FieldName="expnd_LodgingRefNo" Caption="Reference No" VisibleIndex="4">
                                    ...
                                    <SettingsText PopupEditFormCaption="Add/Modify Lodging" ConfirmDelete="Are You Want To Delete This Record ???" />
