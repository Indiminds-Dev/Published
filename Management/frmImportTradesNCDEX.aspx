<%@ page language="C#" autoeventwireup="true" inherits="management_frmImportTradesNCDEX, App_Web_nhjs8cfd" %>
    ...
    <asp:Panel ID="Panelmain" runat="server" Visible="true" HorizontalAlign="Center">
                <table id="tbl_main" class="login" cellspacing="0" cellpadding="0" width="410"
                    ...
                    <tbody>
                        <tr>
                            <td class="EHEADER">
                                <span style="color: blue"><strong>NCDEX Trades</strong></span></td>
                        </tr>
                        <tr>
                            <td class="lt">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                         <asp:DropDownList ID="ddlFileList" runat="server" Width="222px" AutoPostBack="True" Height="30px" OnSelectedIndexChanged="ddlFileList_SelectedIndexChanged">
                                            ...
                                            <asp:ListItem Value="3">ODIN TXT File (New Format)</asp:ListItem>
                                            <asp:ListItem Value="4">Combined RTS File</asp:ListItem>
                                            <asp:ListItem Value="5">NextTrade TXT File</asp:ListItem>
                                            <asp:ListItem Value="6">NCDEX TXT File</asp:ListItem>
                                        </asp:DropDownList><br />
