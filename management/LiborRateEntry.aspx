<%@ page language="C#" autoeventwireup="true" inherits="management_LiborRateEntry, App_Web_udicbieo" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    ...
    function PopulateGrid(obj)
 {
   ...
   cGridFXMR.PerformCallback(obj);
    ...
    {
      var URL="LiborRatePopup.aspx?id="+obj;
      editwin=dhtmlmodal.open("Editbox", "iframe", URL, "Add/Edit Libor Rates", "width=1100px,height=200px,center=1,resize=1,top=-1", "recal");                 
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" style="text-align: center;">
                        <strong><span style="color: #000099">Libor Rates</span></strong>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>
                        ...
                        <dxwgv:ASPxGridView ID="GridFXMR" runat="server" AutoGenerateColumns="False"
                            KeyFieldName="Libor_ID" Width="100%" OnRowDeleting="GridFXMR_RowDeleting"
                            ...
                            <Columns>
                                ...
                                <dxwgv:GridViewDataTextColumn FieldName="From_Currency" Caption="Currency" Width="15%" VisibleIndex="3">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                
                                 <dxwgv:GridViewDataTextColumn FieldName="Libor_Rate" Caption="Libor Rate" Width="12%" VisibleIndex="5">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                ...
                                <dxwgv:GridViewDataTextColumn FieldName="change" Caption="Modify" Width="15%" VisibleIndex="7">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
