<%@ page language="C#" autoeventwireup="true" inherits="management_IINXCOMMMargin, App_Web_leuczwkw" %>
        ...
        <asp:Panel ID="Panelmain" runat="server" HorizontalAlign="Center" Style="z-index: 100;
            ...
            <table id="tbl_main" cellpadding="0" cellspacing="0" class="login" width="410" style="border: solid 1px blue">
                <tbody>
                    <tr>
                        <td class="EHEADER">
                            <span style="color: blue"><strong>IINX Margin</strong></span></td>
                    </tr>
                    <tr>
                        <td class="lt">
                            <table cellpadding="0" cellspacing="12" class="TableMain100">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:FileUpload ID="IINXCOMMMarginSelectFile" runat="server" Height="21px" Width="272px" />
                                        </td>
                                    </tr>
