<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReportComTradeRegisteriframe, App_Web_qrhyroaj" enableeventvalidation="false" %>
                        ...
                        <table border="10" cellpadding="1" cellspacing="1">
                            ...
                            <tr>
                                ...
                                <td style="display: none;" id="td_terminaltxt">
                                    <asp:TextBox runat="server" Width="100px" Font-Size="10px" ID="txtTerminal" onkeyup="fnTerminalCTCLcallajax(this,'chkfn',event,'TERMINALID')"></asp:TextBox>
