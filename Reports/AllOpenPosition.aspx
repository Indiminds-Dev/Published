<%@ page language="C#" autoeventwireup="true" inherits="Reports_AllOpenPosition, App_Web_nres-wbk" %>
...
<head id="Head1" runat="server">
    <title>All Open Position Products Across Segments For Creating Provisional Close Rates</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">All Open Position Products Across Segments For Creating Provisional Close Rates</span></strong></td>
