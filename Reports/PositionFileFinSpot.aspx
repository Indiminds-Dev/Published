<%@ page language="C#" autoeventwireup="true" inherits="Reports_PositionFileFinSpot, App_Web_-n9yptcr" %>
...
<head id="Head1" runat="server">
    <title>Position File For FinSpot RMS System</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Position File For FinSpot RMS System</span></strong></td>
