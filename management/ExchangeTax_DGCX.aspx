<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="management_ExchangeTax_DGCX, App_Web__yen2upk" %>
                                ...
                                <td style="text-align: center">
                                    <table style="border: solid 1px blue; width: auto">
                                       ...
                                       <%-- ----- Row 1-------%>
                                        ...
                                        <tr id="tr_1">
                                            <td class="Ecoheadtxt" style="text-align: left; width: 41%;">
                                                <dxe:ASPxLabel runat="server" Text="AssetType:" ID="ASPxLabel37">
                                                </dxe:ASPxLabel>
                                            ...
                                            <td style="text-align: left; width: 30%;" class="Ecoheadtxt">
                                               ...
                                               <asp:DropDownList runat="server" Width="300px" ID="ddlAssetType">
                                                    <asp:ListItem Value="ANY">ANY</asp:ListItem>
                                                    <asp:ListItem Value="BASE METALS">BASE METALS</asp:ListItem>
                                                    <asp:ListItem Value="CURRENCIES">CURRENCIES</asp:ListItem>
                                                    <asp:ListItem Value="ENERGY">ENERGY</asp:ListItem>
                                                    <asp:ListItem Value="EQUITIES">EQUITIES [Stocks]</asp:ListItem>
                                                    <asp:ListItem Value="PRECIOUS METALS">PRECIOUS METALS</asp:ListItem>
                                                    <asp:ListItem Value="PRECIOUS METALS [Shariah Compliant]">PRECIOUS METALS [Shariah Compliant]</asp:ListItem>
                                        ...
                                        <%---------Row 2 ---------%>
                                         ...
                                         <tr id="tr_2">
                                            <td class="Ecoheadtxt" style="text-align: left; width: 41%;">
                                                <dxe:ASPxLabel runat="server" Text="Instr.Type:" ID="ASPxLabel17">
                                                </dxe:ASPxLabel>
                                            ...
                                            <td style="text-align: left; width: 30%;" class="Ecoheadtxt">
                                               ...
                                               <asp:DropDownList runat="server" Width="180px" ID="ddlProductType">
                                                    <asp:ListItem Value="0">Any</asp:ListItem>
                                                    <asp:ListItem Value="1">Futures</asp:ListItem>
                                                    <asp:ListItem Value="2">Options</asp:ListItem>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               ...
                                               <tr>
                                               <td>
                                                <asp:TextBox ID="TxtProduct" runat="server" onkeyup="FunCallAjaxList(this,event,'Product')"  Width="290px" ></asp:TextBox>
