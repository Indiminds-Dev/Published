<%@ page language="C#" autoeventwireup="true" inherits="management_splittradescom, App_Web_e81qjzgk" %>
...
<script type="text/javascript" src="../JSFUNCTION/ajaxList.js"></script>
  ...
  function Show(obj)
    ...
    function OnMoreInfoClick(KeyValue)
        {
         var url="splittradespopupcomm.aspx?id="+KeyValue;
         var header='Split Trades For '+document.getElementById('txtClient').value;
          parent.OnMoreInfoClick(url,header,'900px','450px',"Y");
         ...
         <table><tr><td id="td_grid">
                                <dxwgv:ASPxGridView ID="grdSplittrades" runat="server" ClientInstanceName="grid"
                                    ...
                                    <Columns>
                                        ...
                                        <dxwgv:GridViewDataTextColumn Caption="Flag" FieldName="Flag" VisibleIndex="1">
                                            <CellStyle CssClass="gridcellleft">
                                            </CellStyle>
                                            <EditFormCaptionStyle HorizontalAlign="Right" Wrap="False">
                                            </EditFormCaptionStyle>
                                         ...
                                         <dxwgv:GridViewDataTextColumn Caption="Scrip" FieldName="instrument" VisibleIndex="2">
                                            <CellStyle CssClass="gridcellleft">
                                            </CellStyle>
                                        ...
                                        <dxwgv:GridViewDataTextColumn Caption="Category" FieldName="tradecategory" VisibleIndex="3">
                                            <CellStyle CssClass="gridcellleft">
                                            </CellStyle>
                                            <EditFormCaptionStyle HorizontalAlign="Right" Wrap="False">
                                            </EditFormCaptionStyle>
                                        ...
                                        <dxwgv:GridViewDataTextColumn Caption="Qty" FieldName="UnitPriceQuantity" VisibleIndex="4">
                                          ...
                                          <dxwgv:GridViewDataTextColumn Caption="Lot" FieldName="Lot" VisibleIndex="5">
                                            <CellStyle CssClass="gridcellleft" HorizontalAlign="Right">
                                            </CellStyle>
                                            <EditFormCaptionStyle HorizontalAlign="Right" Wrap="False">
                                            </EditFormCaptionStyle>
