<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReport_Security, App_Web_eozuxu2i" %>
                    ...
                    <td style="text-align: left; vertical-align: top;">
                        <table border="0">
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxDateEdit ID="DtFrom" runat="server" Font-Size="10px" Width="189px" EditFormat="Custom"
                                ...
                                <td>
                                    <dxe:ASPxDateEdit ID="dtTo" runat="server" Font-Size="10px" Width="189px" EditFormat="Custom"
                                        EditFormatString="dd-MM-yyyy" UseMaskBehavior="True">
                                        <ButtonStyle Width="13px">
                                        </ButtonStyle>
                            ...
                            <tr id="TrSett">
                                ...
                                <td id="TrSettlement">
                                    <asp:TextBox ID="txtSettlement" runat="server" onkeyup="FunSettNumber(this,'ShowClientScrip',event)"
                                        Font-Size="10px" Width="184px"></asp:TextBox><asp:HiddenField ID="txtSettlement_hidden"
                                            runat="server" />
                                </td>
                            </tr>
                            <tr id="TrFor">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlReportType" runat="server" Font-Size="10px" Width="208px">
