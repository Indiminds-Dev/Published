<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReport_IframeSubsidiaryTrial, App_Web_x3w6ygwt" %>
                                ...
                                <td style="width: 774px">
                                    <table cellspacing="1" cellpadding="2" style="background-color: #B7CEEC; border: solid 1px  #ffffff"
                                                        ...
                                                        <td>
                                                            <div id="divCredit">
                                                                <asp:RadioButton ID="rdCredit" runat="server" GroupName="k" /><asp:Label ID="Label2"
                                                                    runat="server" Text="Only Credit"></asp:Label></div>
                                                        </td>
                                                        <td>
                                                            <div id="divDrCrBoth">
                                                                <asp:RadioButton ID="rdBoth" runat="server" GroupName="k" Checked="true" /><asp:Label
                                                                    ID="Label3" runat="server" Text="Both"></asp:Label></div>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr id="TrConsolidateAccounts" Style="display:none" onclick="chkConsolidateAccounts_Click()">
                                         ...
                                         <%--------------------- For Branch / Group Wise Consolidate  Start --------------------%>
                                        
                                        <tr id="Tr1" >
                                            <td colspan="2">
                                                <asp:CheckBox ID="Chk_GroupBranchConsolidate" runat="server" />
                                                Show Consolidated Balance for Group/Branch
                                            </td>
                                        </tr>
                                        
                                        
                                          <%--------------------- For Branch / Group Wise Consolidate  End --------------------%>
                                    ...
                                    <table id="Table_SegWise_Col_SubTrail" style="border-right: #ffffff 1px solid; border-top: #ffffff 1px solid;
                                        ...
                                        <tr id="Tr_TDay_Consolidate_Balance" style="display: none">
                                            ...
                                            <td>
                                                Show T-Day Net Balance Separately</td>
                                            <td>
                                                <asp:CheckBox ID="Chk_ConsolidateBal" runat="server" /></td>
                                            <td>
                                                Consolidate Balances Branch/Group Wise</td>
                                        </tr>
                                        <tr id="divReportBy">
                                            <td>
                                                Report By :
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="cmbclientsPager" runat="server" CssClass="normaltxt" Width="300px"
                                                Font-Size="10px" ValidationGroup="a" AutoPostBack="True" OnSelectedIndexChanged="cmbclientsPager_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </td>
                                        <td>
