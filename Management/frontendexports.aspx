<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="management_frontendexports, App_Web_psdiigfa" %>
...
//                 End of New Work 04/08/2022
            ...
            function setparam()
            {
                 document.getElementById('DDLformat').setvalue='NOW';
            ...
            function insert()
            {
                ...
                optn.text = "Client Information Addition"; 
                optn.value = "1";
                new2.add(optn);
                optn8.text = "Client Information Addition - Suspending Client (As On Date )"; 
                optn8.value = "2";
                new2.add(optn8);
                optn2.text = "Investor Client Addition/Modification"; 
                optn2.value = "0";
                new2.add(optn2);
                optn3.text = "RMS Limit"; 
                optn3.value = "3";
                new2.add(optn3);
                optn4.text = "Holding With Collateral Quantity"; 
                optn4.value = "4";
                new2.add(optn4);
                optn5.text = "Client Segment Enabled"; 
                optn5.value = "8";
                new2.add(optn5);
                optn6.text = "Client Products Enabled"; 
                optn6.value = "9";
                new2.add(optn6);
                optn7.text = "Investor Client Segment Enabling"; 
                optn7.value = "10";
                new2.add(optn7);
            }
            function remove()
          ...
          $get('UpdateProgress1').style.display = 'none'; 
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 22px;">
                        <strong><span id="SpanHeader" style="color: #000099">Front-End Exports</span></strong>
                    </td>
            ...
            <table border="1">
                <tr valign="top" id="Tr1">
                    ...
                    <td>
                        <asp:DropDownList ID="DDLformat" runat="server" Width="150px" Font-Size="10px" onchange="Fn_DDLformat(this.value)">
                            <asp:ListItem Value="NOW">NOW</asp:ListItem>
                            <asp:ListItem Value="ODIN">Protector</asp:ListItem>
                            <asp:ListItem Value="NCM">NEAT Client Master</asp:ListItem>
                            <asp:ListItem Value="Odinfront">ODIN Front End</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr valign="top" id="Tr2">
                    ...
                    <td>
                        <asp:DropDownList ID="DDLexport" runat="server" Width="250px" Font-Size="10px" onchange="Fn_DDLexport(this.value)">
                            <asp:ListItem Value="1">Client Information Addition</asp:ListItem>
                            <asp:ListItem Value="2">Client Information Addition - Suspending Client (As On Date )</asp:ListItem>
                            <asp:ListItem Value="0">Investor Client Addition/Modification</asp:ListItem>
                            <asp:ListItem Value="3">RMS Limit</asp:ListItem>
                            <asp:ListItem Value="4">Holding With Collateral Quantity</asp:ListItem>
                            <asp:ListItem Value="8">Client Segment Enabled</asp:ListItem>
                            <asp:ListItem Value="9">Client Products Enabled</asp:ListItem>
                            <asp:ListItem Value="10">Investor Client Segment Enabling</asp:ListItem>
                                        ...
                                        <tr id="tr_evaluationmethod">
                                            ...
                                            <td>
                                                <asp:DropDownList ID="DDLMethod" runat="server" Width="100px" Font-Size="10px">
                                                    ...
                                                    <asp:ListItem Value="1">LTP</asp:ListItem>
                                                </asp:DropDownList></td>
                                        </tr>
                                        <tr id="tr_chkproduct">
                                            <td style="vertical-align: top; height: 11px; background-color: #b7ceec; text-align: left">
