<%@ page language="C#" autoeventwireup="true" inherits="management_Custodian_general, App_Web_lgnajdkn" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="TableMain100">
                <tr>
                    <td>
                        <dxtc:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="0" Width="100%" ClientInstanceName="page" Font-Size="10px">
                            <TabPages>
                                                        ...
                                                        <table>
                                                            <tr>
                                                                ...
                                                                <td style="text-align: left; width: 225px;">
                                                                    <asp:TextBox ID="txtName" runat="server" Width="160px" Font-Size="10px"></asp:TextBox>
                                                                </td>
                                                                <td style="width: 83px" class="EcoheadCon_">
                                                                    Short Name :
                                                                </td>
                                                                <td style="text-align: left; width: 202px;">
                                                                     <asp:TextBox ID="txtShortname" runat="server" Width="160px" Font-Size="10px"></asp:TextBox>
                                                                </td>
                                                                <td style="width: 84px" class="EcoheadCon_">
                                                                    SEBI No :
                                                                </td>
                                                                <td>
                                                                     <asp:TextBox ID="txtSebiNo" runat="server" Width="160px" Font-Size="10px"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="EcoheadCon_" style="width: 55px">
                                                                ...
                                                                <td style="text-align: left; width: 225px;">
                                                                     <asp:TextBox ID="txtMapin" runat="server" Width="160px" Font-Size="10px"></asp:TextBox>
                                                                </td>
                                                                <td style="width: 83px" class="EcoheadCon_">
                                                                    Pan No :
                                                                </td>
                                                                <td style="text-align: left; width: 202px;">
                                                                     <asp:TextBox ID="txtPanNo" runat="server" Width="160px" Font-Size="10px"></asp:TextBox>
                                                                </td>
                                                                <td style="width: 84px" >
