<%@ page language="C#" autoeventwireup="true" inherits="management_Import_BSEScripsMap, App_Web_cvaj-tqf" %>
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports NSE Clearings' "BSE_Scrip_Series_Mapping_DDMMYYYY.csv" files available at '/common/clearing' folder of FTP Server </h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="lt brdr">
