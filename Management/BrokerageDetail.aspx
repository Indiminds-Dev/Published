<%@ page language="C#" autoeventwireup="true" inherits="management_BrokerageDetail, App_Web_gflohp-r" %>
                                    ...
                                    <td>
                                        <table style="width:90%; z-index:101" border="1">
                                          ...
                                          <td  style="width: 30%;" id="tddllm" runat="server">
                                             <dxe:ASPxComboBox runat="server" ID="ddlmarketseg" width="125px"    EnableSynchronization="False" EnableIncrementalFiltering="True">
                                                <Items>
                                                  <dxe:ListEditItem Text="All" Value="1">
                                                    ...
                                                    <dxe:ListEditItem Text="Physical[F&O Sgmnt]" Value="4">
                                                  </dxe:ListEditItem>
                                                  <dxe:ListEditItem Text="SLBM Segment" Value="5">
                                                  </dxe:ListEditItem>
                                          ...
                                          <td style="text-align:left;">
                                           ...
                                           <tr id="tr5" runat="server">
                                            ...
                                            <td  style="width: 20%; background-color: #b7ceec;">
                                                Actual Amount</td>
                                                <td   style="width: 30%;" >
                                                <dxe:ASPxTextBox runat="server" id="txtactamt" onkeypress="return noNumbers(event)" Width="125px">
                                                <ValidationSettings ErrorDisplayMode="None"></ValidationSettings>
                                                </dxe:ASPxTextBox>
                                            </td>
