<%@ page language="C#" enableeventvalidation="false" autoeventwireup="true" inherits="Reports_StampReports, App_Web_u73waeqe" %>
...
<head id="Head1">
    <title>Stamp Duty Reports</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Stamp Duty Reports</span></strong></td>
