<%@ page language="C#" autoeventwireup="true" inherits="management_dailyvariframe_MCXSX, App_Web_6_wayyot" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>MCXSX- Daily VAR Rate File</title>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports MCX-SX-EQ_VAR_PointInTime_RunNumber-IorE.csv Available through FTP's COMMON Folder
                        </h5>
                    </td>
                </tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="gridcellleft">
                                            <span style="color: #000099; text-align: right">VaR File</span></td>
