<%@ page language="C#" autoeventwireup="true" inherits="management_BSE_UCCUpload, App_Web_akbpwr7y" %>
                         ...
                         <tr>
                               ...
                               <tr>
                                ...
                                <td class="gridcellleft">
                                    <table>
                                        <tr>
                                            <td>
                                                <dxe:ASPxDateEdit ID="txtAgreDate" runat="server" EditFormat="Custom" UseMaskBehavior="True" Width="250px">
                            ...
                            <tr>
                                ...
                                <td class="gridcellleft">
                                    <table>
                                        <tr>
                                            <td>
                                                <dxe:ASPxDateEdit ID="txtFromDate" runat="server" EditFormat="Custom" UseMaskBehavior="True" Width="250px">
                                                    <ButtonStyle Width="13px">
                                                    </ButtonStyle>
                                                    <DropDownButton Text="From Date">
                                                    </DropDownButton>
                            ...
                            <tr>
                                ...
                                <td class="gridcellleft">
                                    ...
                                    <asp:TextBox ID="txtBatch" runat="server" Width="250px"  MaxLength="11" ></asp:TextBox>
