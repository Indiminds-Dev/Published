<%@ page language="C#" autoeventwireup="true" inherits="management_frmFundFilesNCDEX, App_Web_i8xxwgwk" %>
...
//        aa=(aa.getYear()+"-"+(aa.getMonth()+1)+"-"+aa.getDate());
    ...
    {
       // var fu = document.getElementById('BK01File');
        //document.getElementById('BK01File').value = "";

        var fil = document.getElementById('BK01File');
        fil.select(); 
            ...
            <asp:Panel ID="Panelmain" runat="server" Visible="true" HorizontalAlign="Center">
                <table id="tbl_main" class="login" cellspacing="0" cellpadding="0" runat="server"
                    ...
                    <tr>
                        <td class="lt1">
                            <h5>
                                Imports NCDEX Fund Files</h5>
                        </td>
                    </tr>
                    <tr>
                        <td class="lt1">
                            <table class="width100per" cellspacing="0" cellpadding="0" style="height: 150px" id="TABLE1" >
                                <tr>
                                ...
                                <tr>
                                    <td align="left" style="padding-left: 2px; height: 37px">
                                        <dxe:ASPxComboBox id="ComboFileType" runat="server" ClientInstanceName="cComboFileType"
                                            EnableIncrementalFiltering="True" Font-Size="Small" SelectedIndex="0" ValueType="System.String"
                                            Width="170px">
                                            <items>
                                                <dxe:ListEditItem Text="BKO1 File" Value="1"></dxe:ListEditItem>
                                                <dxe:ListEditItem Text="BKO2 File" Value="2"></dxe:ListEditItem>
                                                </items>
                                            <dropdownbutton text="Select FileType"></dropdownbutton>
                                            <clientsideevents selectedindexchanged="function(s,e){OnFileTypeChange()}"></clientsideevents>
                                        </dxe:ASPxComboBox>
                                    </td>
                                    <td align="left" style="padding-left: 4px; height: 37px">
                                        <asp:FileUpload ID="BK01File" runat="server" Width="272px" Height="21px" />   
                                    </td>
                               ...
                               <%-- <tr>
                                    ...
                                    <td align="left">
                                        <asp:FileUpload ID="BK02File" runat="server" Width="272px" Height="21px" />
                                    </td>
                                </tr>--%>
                                <tr>
                                    <td style="text-align: left; padding-left: 4px; height: 22px;">
                                    Bank Name:
                                    </td>
                                    <td style="text-align: left; padding-left: 4px; height: 22px;">
                                        <%--<asp:TextBox ID="txtBank" runat="server" Width="293px"></asp:TextBox>--%>
