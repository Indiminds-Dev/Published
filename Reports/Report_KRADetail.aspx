<%@ page language="C#" autoeventwireup="true" inherits="Reports_PositionFileProtectorCM, App_Web_yvy99of_" %>
...
<head id="Head1" runat="server">
    <title>Position File For Protector/Odin</title>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE">
      ...
      <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <div>
         ...
         <asp:Panel ID="pnlExport" runat="server" Visible="false">
             <asp:Button ID="btnExport"  runat="server" Height="20px" Text="Export to Excel" OnClick="btnExport_Click"  /><br /> <br />
         </asp:Panel>
   ...
   <asp:UpdatePanel ID="upnlData" runat="server">
    ...
    <div id="dvGrid" style="font-size:small; display:none; padding-left:5px;">
           <a onclick="ShowHideDiv('b');" style="color:Green;"><u>Show Search Panel</u></a> <br /><br />
