<%@ page language="C#" autoeventwireup="true" inherits="Reports_PositionFileINPX, App_Web_hnkxxmul" %>
...
<head id="Head1" runat="server">
    <title>Position File For RMS</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Position File For RMS</span></strong></td>
