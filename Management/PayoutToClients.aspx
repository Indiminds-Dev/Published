<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="management_PayoutToClients, App_Web_0payuukt" %>
...
<head id="Head1">
 ...
 <script language="javascript" type="text/javascript">
    ...
    function FunCallAjaxList(objID,objEvent,ObjType)
    {
        ...
        else if(ObjType=="Stocksof")
        {
             strQuery_Table = "Master_Settlements";
             strQuery_FieldName = "distinct top 10 RTRIM(settlements_Number)+RTRIM(settlements_TypeSuffix)+'  ' + REPLACE(CONVERT(VARCHAR(9), settlements_StartDateTime, 6), ' ', '-') AS [DD-Mon-YY],RTRIM(settlements_Number)+RTRIM(settlements_TypeSuffix)";
             strQuery_WhereClause = " settlements_exchangesegmentid='<%=Session["ExchangeSegmentID"]%>' and   (RTRIM(settlements_Number)+RTRIM(settlements_TypeSuffix)) like (\'%RequestLetter%') ";
        ...
        {   
            ...
            else if(document.getElementById('cmbsearchOption').value=="ScripsExchange")
            {
               ...
               strQuery_FieldName = "top 10 isnull(rtrim(Equity_TickerSymbol),'')+' ['+isnull(rtrim(Equity_Series),isnull(Equity_TickerCode,''))+']' ,Equity_SeriesID";
      ...
      function clientselectionfinal()
      {
       ...
       { 
        ...
        function onmousovertooltip(Client,ProfileName,ToDeliverValue,GiveShareValue,Sys1LedgerBaln,Sys1UnClearBaln,Sys1EffectBaln,Sys2LedgerBaln,Sys2UnClearBaln,Sys2EffectBaln,Sys3LedgerBaln,Sys3UnClearBaln,Sys3EffectBaln,MrgnHldbkValue,MrgnHldbkValueWithHaircut,MrgnHldbkEffectBaln,PurchaseValue,PurchaseWithHaircut,PurchaseEffectBaln,SalesValue,SalesWithHaircut,SalesEffectBaln,TotalValue,TotalMiddle,TotalEffectBaln,AppMargin,AppMarginWithmarkUp,AppMarginEffectBaln,NetWorth)
        {
             ...
             stringhtml+='<tr><td >Trading A/c [+DP Debit] :</td><td align=\"right\">'+Sys1LedgerBaln+'</td><td align=\"right\">'+Sys1UnClearBaln+'</td><td align=\"right\">'+Sys1EffectBaln+'</td></tr>';
        ...
        function Fn_CallAjax(objID,ObjClientType,objCriteria,objEvent)
        {
...
//            if(ObjClientType  =="Retail")
//            {
//                strQuery_Table = "(Select distinct rtrim(replace(dp_dpname,char(160),''))+' ['+rtrim(dpd_clientid)+']' +'['+rtrim(dpd_accounttype)+']' as Acname,dpd_id as DpId,Case When dpd_accounttype='Default' Then 0 Else 3 End As TxtColor,dpd_accounttype    From tbl_master_contactdpdetails,tbl_master_depositoryparticipants Where dpd_CNTID='" + objCriteria + "' and dpd_dpcode=dp_dpid Union All Select distinct rtrim(Dpaccounts_Shortname),Dpaccounts_id,Case When rtrim(Dpaccounts_AccountType)='[MRGIN]' Then 1 Else 2 End As TxtColor,'' From Master_Dpaccounts Where Dpaccounts_AccountType in ('[MRGIN]','[HOLDBK]','[PLCUSA]') and DPACCounts_CompanyID='<%=Session["LastCompany"]%>') as Kk";
//                strQuery_FieldName = "distinct Acname,'TxtColor~'+Cast(DpId as Varchar)+'~'+Cast(TxtColor as Varchar)";
//                strQuery_WhereClause = " (Acname Like (\'RequestLetter%') or DpId like (\'RequestLetter%') Or dpd_accounttype Like (\'RequestLetter%'))";
//            }
            if(ObjClientType  =="Pro Trading")
            {
                strQuery_Table = "Master_Dpaccounts";
                strQuery_FieldName = "distinct rtrim(Dpaccounts_Shortname) as Acname,'TxtColor~'+Cast(Dpaccounts_id as Varchar)+'~0' as DpId";
                strQuery_WhereClause = " Dpaccounts_AccountType='[Own]' and DPACCounts_CompanyID='<%=Session["LastCompany"]%>' and (RTRIM(Dpaccounts_Shortname) Like (\'RequestLetter%') or Dpaccounts_id like (\'RequestLetter%'))";
            }
            else
            {
                strQuery_Table = "(Select distinct rtrim(replace(dp_dpname,char(160),''))+' ['+rtrim(dpd_clientid)+']' +'['+rtrim(dpd_accounttype)+']' as Acname,dpd_id as DpId,Case When dpd_accounttype='Default' Then 0 Else 3 End As TxtColor,dpd_accounttype From tbl_master_contactdpdetails,tbl_master_depositoryparticipants Where dpd_CNTID='" + objCriteria + "' and dpd_dpcode=dp_dpid Union All Select distinct rtrim(Dpaccounts_Shortname),Dpaccounts_id,Case When rtrim(Dpaccounts_AccountType)='[MRGIN]' Then 1 Else 2 End As TxtColor,'' From Master_Dpaccounts Where Dpaccounts_AccountType in ('[MRGIN]','[HOLDBK]','[PLCUSA]') and DPACCounts_CompanyID='<%=Session["LastCompany"]%>' and isnull(DpAccounts_IsClosed,'N')<>'C') as Kk";
                strQuery_FieldName = "distinct Acname,'TxtColor~'+Cast(DpId as Varchar)+'~'+Cast(TxtColor as Varchar)";
                strQuery_WhereClause = " (Acname Like (\'RequestLetter%') or DpId like (\'RequestLetter%') Or dpd_accounttype Like (\'RequestLetter%'))"; 
            }
            ObjID1 = objID;
        ...
        function fnDelvacChng(obj)
        {
             ...
             {
                 Show('tdBtnGenFile2'); 
                 Hide('tdBtnProcessing2');
                 Show('tdBtnGenFile1'); 
                 Hide('tdBtnProcessing1');
                 Show('trPool'); 
             }
             else
             {
                Hide('tdBtnGenFile2'); 
                Show('tdBtnProcessing2'); 
                Hide('tdBtnGenFile1'); 
                Show('tdBtnProcessing1');
                Hide('trPool');   
             }
        }
        
        function OnCheckedShowHide()
        {
            if(cCbImprtAll.GetChecked()== true)
            {    
                Hide('trMain'); 
                Show('tdBtnGenAll');
                Show('tdSelectPool');
                Show('tdTxtSelectPool');     
            }
            else
            {
                Show('trMain'); 
    ...
    <div>
                ...
                <td>
                    <table>
                            ...
                            <td class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtStocks" runat="server" Font-Size="10px" onkeyup="FunCallAjaxList(this,event,'Stocksof')"
                            ...
                            <td class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlDeliverAc" Font-Size="10px" runat="server" Width="250px" onchange="fnDelvacChng(this.value)">
                        ...
                        <tr>
                            <td colspan="3">
                                <table>
                                <tr id="trPool" style="display:none">
                                 <td style="padding-left: 8px; margin-left: 10px; width: 730px;">
                                   <table border="10" cellpadding="1" cellspacing="1">
                                        <tr valign="top">
                                            <td  class="gridcellleft" style="padding-left: 5px;width:200px; margin-left: 10px;">
                                                <dxe:ASPxCheckBox ID="CbImprtAll" runat="server" ClientInstanceName="cCbImprtAll"
                                                    ToolTip="Click to Recieve All in a Specific Pool Account" Text="Recieve All in a Specific Pool Account" ForeColor="Black">
                                                    <Border BorderColor="Transparent" />
                                                    <ClientSideEvents CheckedChanged="function(s, e) {OnCheckedShowHide();Height('350','350');}" />
                                                </dxe:ASPxCheckBox>
                                            </td>
                                            <td id="tdSelectPool" bgcolor="#B7CEEC"  style="display:none;width:120px">
                                             Select Pool Acccount:
                                            </td>
                                            <td id="tdTxtSelectPool" style="display:none">
                                                <asp:DropDownList ID="ddlSpecificAcc" Font-Size="10px" runat="server" Width="250px" >
                                                </asp:DropDownList>
                                            </td>
                                            <td id="tdBtnGenAll" style="width:105px;display:none">
                                                <asp:Button ID="BtnGenAll" runat="server" CssClass="btnUpdate" Height="20px" Text="Generate File"
                                                 Width="101px" OnClick="BtnGenAll_Click"  />
                                    ...
                                    <tr id="trMain">
                                        <td class="gridcellleft" valign="top" style="width: 536px" >
                                            <table border="10" cellpadding="1" cellspacing="1">
                                                <tr>
                                                    <td class="gridcellleft" bgcolor="#B7CEEC">
                                                        Group By</td>
                                                        ...
                                                        <table border="10" cellpadding="1" cellspacing="1">
                                                            <tr valign="top">
                                                                <td class="gridcellleft" bgcolor="#B7CEEC" style="height: 38px">
                                                                    Transfer Date :</td>
                                                                <td id="td_dtto" class="gridcellleft" style="height: 38px">
                                                                    <dxe:ASPxDateEdit ID="DtTransferDate" runat="server" EditFormat="Custom" UseMaskBehavior="True" EditFormatString="dd-MM-yyyy"
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <table border="10" cellpadding="1" cellspacing="1">
                                                            <tr valign="top">
                                                                <td class="gridcellleft" bgcolor="#B7CEEC">
                                                                    Consider Transfer Type :</td>
                                                                <td>
                                                                    <asp:DropDownList ID="DdlTransferType" runat="server" Width="120px" Font-Size="10px">
                                                                        <asp:ListItem Value="ALL">ALL</asp:ListItem>
                                                                        <asp:ListItem Value="HoldBack">Only HoldBack</asp:ListItem>
                                                                         <asp:ListItem Value="Margin">Only Margin</asp:ListItem>
                                                                          <asp:ListItem Value="Clients">Only Clients</asp:ListItem>
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    ...
                                                    <td colspan="2">
                                                        <table border="10" cellpadding="1" cellspacing="1">
                                                            <tr valign="top">
                                                                <td class="gridcellleft" bgcolor="#B7CEEC">
                                                                    <asp:CheckBox ID="ChkOffMkt" runat="server" />
                                                                    Consider Only Off Market Position
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td class="gridcellleft" style="vertical-align: top; text-align: right; height: 21px;"
                                                                    id="TdFilter">
                                                                    <asp:TextBox ID="txtSelectionID" runat="server" Font-Size="12px" Width="150px" onkeyup="FunCallAjaxList(this,event,'Other')"></asp:TextBox>
       ...
       <tr style="height:30px;"><td></td></tr>
            <tr>
             ...
             <tr style="height:30px;"><td></td></tr> 
            <tr >
                <td id="tdBtnProcessing1" style="width:20%">
                ...
                <td id="tdBtnGenFile1" style="width:20%;display:none">
                    <asp:Button ID="btnGenerateFile1" runat="server" Text="Generate File" CssClass="btnUpdate"
                    Height="25px" Width="147px" OnClick="btnGenFile1_Click"/>
                </td>
            </tr>
            <tr>
                <td id="tdResult">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Account Name">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:TextBox ID="txtForAcId" Visible="false" runat="server" Text='<%# Eval("ForAcId")%>'></asp:TextBox>
                       ...
                       <Triggers>
                         ...
                         <%--<Triggers>
                            <asp:AsyncPostBackTrigger ControlID="BtnGenAll" EventName="Click" />      
                         </Triggers>--%>
                    </asp:UpdatePanel>
                </td>
            </tr>
            <tr>
                <td id="tdBtnProcessing2" style="width:20%">
                ...
                <td id="tdBtnGenFile2" style="width:20%;display:none">
                    <asp:Button ID="btnGenerateFile2" runat="server" Text="Generate File" CssClass="btnUpdate"
                    Height="25px" Width="147px" OnClick="btnGenFile2_Click"/>
                </td>
            </tr>
        </table>
