<%@ page language="C#" autoeventwireup="true" inherits="Reports_SettlementTrialCOMM, App_Web_x3w6ygwt" %>
                                    ...
                                    <table border="10" cellpadding="1" cellspacing="1">
                                        <tr>
                                            ...
                                            <td class="gridcellleft" bgcolor="#B7CEEC">
                                                Report View :</td>
                                            <td>
                                                <asp:DropDownList ID="dllrptview" runat="server" Width="150px" Font-Size="10px">
