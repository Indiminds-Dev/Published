<%@ page language="C#" autoeventwireup="true" inherits="management_FXCMRatePopup, App_Web_e158i_8t" %>
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" style="text-align: center;">
                        <strong><span style="color: #000099">ADD/Edit FX Conversion Margin Rates Mapping</span></strong>
                    </td>
                </tr>
            </table>
                            ...
                            <tr>
                                ...
                                <td style="width: 2px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorFXRate" runat="server" ControlToValidate="txtFXRate"
                                        ErrorMessage="Please Insert FX Margin Rate" ValidationGroup="a">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                        </table>                
                    </td>                
