<%@ page language="C#" autoeventwireup="true" inherits="management_targetSetUpEmployee, App_Web_yxggcryg" %>
   ...
   <tr>  <td class="EHEADER" style="text-align:center;" >
    ...
    <tr>
        <td style="text-align: left" id="TdGrid">
            <dxwgv:ASPxGridView ID="gridBranch" runat="server" ClientInstanceName="grid"   Width="100%" OnCustomCallback="gridBranch_CustomCallback">
                <Columns>                                
                     <dxwgv:GridViewDataTextColumn FieldName="Name" Caption="Name" VisibleIndex="0">
                          <CellStyle CssClass="gridcellleft">
                          </CellStyle>
                     </dxwgv:GridViewDataTextColumn>
                     <dxwgv:GridViewDataTextColumn FieldName="tgt_descripition" Caption="Target Name" VisibleIndex="1">
                          <CellStyle CssClass="gridcellleft">
                          </CellStyle>
                     </dxwgv:GridViewDataTextColumn>
                     <dxwgv:GridViewDataTextColumn FieldName="ApplicableDate" Caption="ApplicableDate" VisibleIndex="2">
                          <CellStyle CssClass="gridcellleft">
                          </CellStyle>
                     </dxwgv:GridViewDataTextColumn>
            ...
            <input id="btnNew" type="button" value="New" class="btnUpdate" style="width: 69px" onclick="btnNew_Click()"/>
        </td>
    </tr>
    <tr>
        <td id="TdInsert" align="center">
            <asp:Panel ID="PnlInsert" runat="server" BorderColor="white" Width="50%" BorderWidth="1px">
                <table class="TableMain100">
                    ...
                    <tr>
                        <td colspan="2">
                            <input id="BtnSave" type="button" value="Save" class="btnUpdate" style="width: 62px" onclick="BtnSave_Click()"/>
                            <input id="BtnCancel" type="button" value="Cancel" class="btnUpdate" style="width: 62px" onclick="BtnCancel_Click()"/>
                        </td>
                    </tr>
                    <tr>
