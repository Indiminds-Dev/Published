<%@ page language="C#" autoeventwireup="true" inherits="management_frm_NSCCLMarginCDX, App_Web_gflohp-r" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>NSCCL's Margin Payable Statement For Clearing Members [X_MG11]</title>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports NSCCL's Margin Payable Statement for a Clearing Member [X_MG11_MemberCode_DDMMYYYY.LIS]
                        </h5>
                    </td>
                </tr>
