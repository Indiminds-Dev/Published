<%@ page language="C#" autoeventwireup="true" inherits="management_DailyPrmMTMJV, App_Web_e158i_8t" %>
    ...
    <div>
        <div id="Div_header" style="width: 89%">
            <div id="Div_headername" class="EHEADER" style="width: 97.5%;text-align :center">
                <strong><span id="SpanHeader" style="color: #000099; font-size: small; font-family: Tahoma,Arial, Helvetica, sans-serif;">Generate Daily Open Position Options Premium And Future MTM Journals</span></strong>
            </div>
