<%@ page language="C#" autoeventwireup="true" inherits="Reports_OpenPositionAnalysis_COMMCDX, App_Web_7htzac9n" %>
...
<head>
    <title>COMM_CDX Open Position Analysis</title>
                    ...
                    <div id="dvMainFilter" class="frmContent" style="width: 528px">
                        ...
                        <div id="dvGroupBy">
                            ...
                            <div class="left">
                                ...
                                <div id="dvBranch" class="frmleftContent" style="width: 125px; padding-top: 3px;
                                    font-size: 12px;">
                                ...
                                <div id="dvGroup" class="left" style="display: none;">
                                    ...
                                    <div id="dvGroupTypeByAllSelect" class="frmleftContent" style="display: none; width: 125px;
                                        font-size: 12px">
