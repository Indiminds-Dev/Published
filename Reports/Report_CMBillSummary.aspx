<%@ page language="C#" autoeventwireup="true" inherits="Reports_Report_CMBillSummary, App_Web_1vatjdzx" %>
                ...
                function OnSuccess(response) {
                    ...
                    CMBillSummary.each(function() {
                        ...
                        if (filterData[15] == 'N') {
                            ...
                            $("td", row).eq(i).html((cCMBillSummary.find("SBC").text()).length == 0 ? '&nbsp;' : (cCMBillSummary.find("SBC").text()).search("-") != -1 ? '<span style="color:red">(' + (cCMBillSummary.find("SBC").text()).substr(1, ((cCMBillSummary.find("SBC").text()).length - 1)) + ')</span>' : cCMBillSummary.find("SBC").text());
                            i = i + 1;
                        }
                        ...
                        if (filterData[16] == 'N') {
                            ...
                            $("td", row).eq(i).html((cCMBillSummary.find("KKC").text()).length == 0 ? '&nbsp;' : (cCMBillSummary.find("KKC").text()).search("-") != -1 ? '<span style="color:red">(' + (cCMBillSummary.find("KKC").text()).substr(1, ((cCMBillSummary.find("KKC").text()).length - 1)) + ')</span>' : cCMBillSummary.find("KKC").text());
                            i = i + 1;
                        }
                        ...
                        if (filterData[17] == 'N') {
                            ...
                            $("td", row).eq(i).html((cCMBillSummary.find("UnrealizedStamp").text()).length == 0 ? '&nbsp;' : (cCMBillSummary.find("UnrealizedStamp").text()).search("-") != -1 ? '<span style="color:red">(' + (cCMBillSummary.find("UnrealizedStamp").text()).substr(1, ((cCMBillSummary.find("UnrealizedStamp").text()).length - 1)) + ')</span>' : cCMBillSummary.find("UnrealizedStamp").text());
                            i = i + 1;
                        }
            ...
            <div id="divTotHeaderCMBillSummary" style="width: 1800px;">
                <div style="width: 100%">
                    ...
                    <%------------------------- SBC / KKC Start ----------------------------------------%>
                     ...
                     <div id="totHeaderSBC" runat="server" class="left cellTotHeader">
                        <b>Tot SBC</b>
                    </div>
                    
                     <div id="totHeaderKKC" runat="server" class="left cellTotHeader">
                        <b>Tot KKC</b>
                    </div>
                   ...
                   <%-- ------------------------- SBC / KKC End ---------------------------------------------%>
                    ...
                    <%------------------------- Unrealized Stamp Start ----------------------------------------%>

                    <div id="totHeaderUnrealizedStamp" runat="server" class="left cellTotHeader">
                        <b>Tot UnrealizedStamp</b>
                    </div>
                    
                    <%------------------------- Unrealized Stamp End ----------------------------------------%>
                ...
                <div style="width: 100%">
                    ...
                    <%---------------- SBC/KKC/ServiceTax On Sebi Start------------------%>
                    
                    
                      <div id="footerTotSBC" runat="server" class="left cellTotal">
                        <span class="right">
                            <%=TotSBC%>
                        </span>
                     </div>
                     
                      <div id="footerTotKKC" runat="server" class="left cellTotal">
                        <span class="right">
                            <%=TotKKC%>
                        </span>
                     </div>
                   <%-- ------------------- SBC/KKC/ServiceTax On Sebi End---------------------------------------------%>
                    
                    <div id="footerTotUnrealizedStamp" runat="server" class="left cellTotal">
                        <span class="right">
                            <%=TotUnrealizedStamp%>
                        </span>
                    </div>
                ...
                <div class="Box_Detail">
                    <asp:GridView ID="gvwCMBillSummary" AutoGenerateColumns="false" Width="100%" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TranCharge" HeaderText="TrChrg" />
                            ...
                            <asp:BoundField DataField="StampDuty" HeaderText="Stamp" />
                            ...
                            <asp:BoundField DataField="SebiFee" HeaderText="Sebi" />
                            ...
                            <asp:BoundField DataField="ServTax" HeaderText="GST" />
                            ...
                            <asp:BoundField DataField="NetBillAmount" HeaderText="NetBill" />
                            ...
                            <asp:BoundField DataField="TotalBrokerage" HeaderText="Brokerage" />
                            ...
                            <asp:BoundField DataField="UnrealizedServTax" HeaderText="UnrlzdGST" />
                            ...
                            <asp:BoundField DataField="UnrealizedSTT" HeaderText="UnrlzdSTT" />
                           ...
                           <%-- ------------------------------- SBC/KKC Start---------------------------------------------%>
                            ...
                            <asp:BoundField DataField="SBC" HeaderText="SBC" />
                             <asp:BoundField DataField="KKC" HeaderText="KKC" />
                              
                           
                           
                          <%-- -------------------------------- SBC/KKC End----------------------------------------------------%>
                            
                            <asp:BoundField DataField="UnrealizedStamp" HeaderText="UnrlzdStamp" />
