<%@ page language="C#" enableeventvalidation="false" autoeventwireup="true" inherits="Reports_ContractNote, App_Web_rjq8jf2h" %>
...
<head id="Head1">
    <title>Contract Notes/Annexure Printing </title>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE">
   ...
   { 
                                ...
                                <td class="gridcellleft">
                                    <table border="10" cellpadding="1" cellspacing="1">
                                        <tr>
                                            ...
                                            <td class="gridcellleft">
                                                <asp:DropDownList ID="ddlselection" runat="server" Width="200px" Font-Size="10px"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dxe:ASPxDateEdit ID="dtFromDate" runat="server" EditFormat="Custom" EditFormatString="dd-MM-yyyy" UseMaskBehavior="True"
                                                    Font-Size="10px" Width="108px" ClientInstanceName="cdtFromDate">
                                                    <DropDownButton>
                                                    </DropDownButton>
                                            ...
                                            <td id="td_date" runat="server">
                                                <dxe:ASPxDateEdit ID="dtToDate" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                    Font-Size="10px" Width="108px" ClientInstanceName="cdtToDate">
                                                    <DropDownButton>
                                                    </DropDownButton>
                                            ...
                                            <td id="Td_Range" style="display: none;">
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtFromNo" runat="server" Font-Size="10px" Onkeypress="return isNumberKey(event)"
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtToNo" runat="server" Font-Size="10px" Height="12px" Onkeypress="return isNumberKey(event)"
                            ...
                            <tr>
                                    ...
                                    <table border="10" cellpadding="1" cellspacing="1">
                                        <tr id="ptype">
                                            <td class="gridcellleft" bgcolor="#B7CEEC">
                                                Print Type :</td>
                                            <td id="td_cnt1">
                                                <asp:DropDownList ID="DdlPrintType" runat="server" Width="220px" Font-Size="10px"
                                            ...
                                            <td id="td_cnt2">
                                                <asp:DropDownList ID="DdlPrintType1" runat="server" Width="250px" Font-Size="10px"
                                                    onchange="FnPrintType(this.value)">
                                            ...
                                            <td id="td_cnt3">
                                                <asp:DropDownList ID="DdlPrintType2" runat="server" Width="220px" Font-Size="10px"
                                                    onchange="FnPrintType(this.value)">
                               ...
                               <%-------------  Custom Header -------------%>
                                        ...
                                        <tr id="tr_ftrall" >
                                            ...
                                            <td id="tdfooter" >
                                                <asp:TextBox ID="txtFooter" runat="server" Width="279px" Font-Size="10px" 
                                                    onkeyup="ajax_showOptions(this,'GetHeaderFooter',event,'F')" 
                                                    ></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <td class="gridcellleft">
                                    <table border="10" cellspacing="1" cellpadding="1">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlOutputtype" runat="server" Width="250px" Font-Size="10px"
                                ...
                                <td class="gridcellleft">
                                    <table border="10" cellpadding="1" cellspacing="1">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlfordos" runat="server" Width="220px" Font-Size="10px">
                                ...
                                <td class="gridcellleft">
                                    <table border="10" cellpadding="1" cellspacing="1">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlLocation" Font-Size="10px" runat="server">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                    </table>
        ...
        <dxpc:ASPxPopupControl ID="Popup_ContractNoteDetails" runat="server" ClientInstanceName="cPopup_ContractNoteDetails"
            ...
            Width="400px">
            <ContentCollection>
                <dxpc:PopupControlContentControl ID="popupcontentctrl" runat="server">
                    <dxcp:ASPxCallbackPanel ID="cbpPopupContractnotePane" runat="server" ClientInstanceName="ccbpPopupContractnotePane"
                        BackColor="White" OnCallback="CbpSuggestISIN_Callback">
                        <PanelCollection>
                            <dxp:panelcontent ID="panelcontentbegin" runat="server">
                                <br />
                                <br />
                                <div style="font-weight: bold; color: black; background-color: gainsboro; border-right: silver thin solid;
                                    border-top: silver thin solid; border-left: silver thin solid; border-bottom: silver thin solid;">
