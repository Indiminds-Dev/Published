<%@ page language="C#" autoeventwireup="true" inherits="Management_NCL_InternalShortage, App_Web_snhbal_j" %>
...
<head id="Head1" runat="server">
    <title>Create Batch For Reporting Internal Shortage Of Clients For Auction (CM_SA)</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Batch For Reporting Internal Shortage Of Clients For Auction to NCL (CM_SA)</span></strong></td>
