<%@ page language="C#" autoeventwireup="true" inherits="management_frm_INFXClosingRates, App_Web_nidspgif" %>
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports FCStone's Closing Rates From "YYYYMMDD_poscsv.csv" Files</h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="lt brdr">
