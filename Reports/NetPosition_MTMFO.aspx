<%@ page language="C#" autoeventwireup="true" inherits="Reports_NetPosition_MTMFO, App_Web_cnvbs8pk" %>
                    ...
                    <table>
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td id="td_dtfor" >
                                            <dxe:ASPxDateEdit ID="dtfor" runat="server" EditFormat="Custom" UseMaskBehavior="True" 
                                                Font-Size="10px" Width="108px" ClientInstanceName="dtfor" OnValueChanged="dtfor_DateChanged" AutoPostBack="True">
                                        ...
                                        <td id="td_dtto">
                                            <dxe:ASPxDateEdit ID="dtto" runat="server" EditFormat="Custom" UseMaskBehavior="True" 
                                                Font-Size="10px" Width="108px" ClientInstanceName="dtto" OnValueChanged="dtto_DateChanged" AutoPostBack="True" >
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td >
                                            <table border="10" cellpadding="1" cellspacing="1">
                                                <tr>
                                                    <td bgcolor="#B7CEEC" style="height: 21px">
                                                        Instrument Type :</td>
                                                    <td colspan="2" style="text-align: left; height: 21px;" valign="top">
                                                        <asp:DropDownList ID="cmbinstrutype" runat="server" Font-Size="10px" AutoPostBack="True"
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" style="text-align: left" valign="top">
                                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <asp:DropDownList ID="cmbexpiry" runat="server" Font-Size="10px">
                                                                </asp:DropDownList>
                                                            </ContentTemplate>
                                                            <Triggers>
                        ...
                        <tr id="Tr_Option">
                         ...
                         <tr id="tr_filtercolumns">
                                    ...
                                    <td>
                                      <asp:CheckBox ID="Chk_Consolidate" runat="server" />Show Consolidate Branch / Group 
                        ...
                        <tr id="Tr_ExposureInBuyPosition">
 						  ...
 						  <td class="gridcellleft" bgcolor="#B7CEEC">
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlExposure" runat="server" Font-Size="10px">
                                    ...
                                    <tr id="tr_excel">
                                        ...
                                        <td>
                                            <asp:DropDownList ID="cmbExport" runat="server" AutoPostBack="True" Font-Size="10px"
                                                ...
                                                <asp:ListItem Value="MC">Send Mail To Clients</asp:ListItem>
                                                 <asp:ListItem Value="MG">Send Mail To Groups/Branch</asp:ListItem>
