<%@ page language="C#" autoeventwireup="true" inherits="management_frm_NomineeRegistration, App_Web_0jwcfgzk" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    ...
    <div>
      ...
      <table width="100%">
        <tr>
            <td align="center">
                    <dxwgv:ASPxGridView ID="grdNominees" runat="server" AutoGenerateColumns="False"
                    ...
                    <dxe:ASPxDateEdit ID="dtDOBMinor" ClientInstanceName="dtDOBMinor" runat="server" EditFormat="Custom" UseMaskBehavior="true" EditFormatString="dd-MM-yyyy"
                       ...
                       <asp:Label ID="lblDOBMinor" Text='<%#Bind("dobminor") %>' runat="Server" Visible="false"></asp:Label>
                        ...
                        <Columns>
                            ...
                            <dxwgv:GridViewDataTextColumn Width="150px" Caption="Nominee Name" FieldName="Name"  VisibleIndex="1">
                               
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                                <EditFormSettings Visible="False" VisibleIndex="7"></EditFormSettings>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Width="150px" Caption="Registration No"  FieldName="RegNo" VisibleIndex="2">
                                
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                                <EditFormSettings Visible="False" VisibleIndex="9"></EditFormSettings>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Width="150px" Caption="Ben ID" FieldName="BenID" VisibleIndex="3">
                               
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                                <EditFormSettings Visible="False" VisibleIndex="11"></EditFormSettings>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Width="150px" Caption="Name" FieldName="BenAccName"  VisibleIndex="4">
                               
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                               <EditFormSettings Visible="false" />
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Width="150px" Caption="Registration Date" FieldName="RegDateShow" VisibleIndex="5">                                
                                <CellStyle CssClass="gridcellleft">
                                </CellStyle>
                            ...
                            <dxwgv:GridViewCommandColumn Width="100px" VisibleIndex="6" Caption="Edit">
                            ...
                            <dxwgv:GridViewDataTextColumn Width="100px" VisibleIndex="7">
                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                <DataItemTemplate>
