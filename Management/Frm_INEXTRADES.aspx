<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_INEXTRADES, App_Web_dw8rtpla" %>
   ...
   <script language="javascript" type="text/javascript">
    ...
    function PageLoad()
    {
       ...
       //File Format to Import By Default
        Span_FileFormat.innerText="File Name : EDF's Prelim/Final csv Files";
    }
    ...
    function OnComboChooseFileIndexChange()
    {
        ...
        if(SelectedValue==0)
            ...
            Span_FileFormat.innerText="File Name : EDF's Position CSV Files";
