<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="Reports_DeliveryProcessing, App_Web_wttsrqio" %>
                    ...
                    <td style="text-align: left; vertical-align: top;">
                        <table border="0">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlType" Font-Size="10px" runat="server" onchange="TypeChange(this.value)"
                                        Width="210px">
                            ...
                            <tr id="TrInterSeg">
                                ...
                                <td colspan="2">
                                    <dxe:ASPxDateEdit ID="dtPayindate" runat="server" Font-Size="10px" Width="206px"
                            ...
                            <tr id="TrOffSetSettlement">
                                ...
                                <td style="text-align: left;" colspan="2">
                                    <asp:TextBox ID="txtTargetSettOff" Font-Size="10px" runat="server" onkeyup="FunSettNumber(this,'ShowClientScrip',event)"
                            ...
                            <tr id="TrOffSetSettlementSource">
                                ...
                                <td style="text-align: left;" colspan="2">
                                    <asp:TextBox ID="txtSourceSettOff" Font-Size="10px" runat="server" onkeyup="FunSettNumber(this,'ShowClientScrip',event)"
                                        Width="206px"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxDateEdit ID="DtTransferDate" runat="server" Font-Size="10px" Width="206px"
                                        EditFormat="Custom" EditFormatString="dd-MM-yyyy" UseMaskBehavior="True">
                                        <ButtonStyle Width="13px">
                                        </ButtonStyle>
                                    </dxe:ASPxDateEdit>
                            ...
                            <tr id="TrInterSettSourceAcc">
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="ddlSourceAccount" Font-Size="10px" runat="server" Width="310px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr id="TrInterSettTargetAcc">
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="ddlTargetAccount" Font-Size="10px" runat="server" Width="310px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr id="TrMrktPayINPool">
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="ddlPoolAC" Font-Size="10px" runat="server" 
                                        Width="210px">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr id="TrMrktPayINPool1">
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="ddlPayInType" Font-Size="10px" runat="server" Width="210px">
                            ...
                            <tr id="TrCliPayout3">
                                ...
                                <td style="text-align: left;" colspan="2">
                                    <asp:TextBox ID="txtSettlementNumber" Font-Size="10px" runat="server" onkeyup="FunSettNumber(this,'ShowClientScrip',event)"
                                        Width="206px"></asp:TextBox>
                             ...
                             <tr id="TrMrgnHoldback">
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="drpMarginHoldbackAccount" Font-Size="10px" runat="server" Width="210px">                                        
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr id="TrOwnAccount">
                                ...
                                <td colspan="2">
                                    <asp:DropDownList ID="drpOwnAccount" Font-Size="10px" runat="server" Width="210px">                                        
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr id="TrButton">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td id="TrExport" style="text-align: right">
                                                <asp:DropDownList ID="ddlExport" runat="server" AutoPostBack="True" Font-Size="10px"
                                                ...
                                                <asp:GridView ID="grdDematProcessing" runat="server" Width="100%" BorderColor="CornflowerBlue"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Deliverable">
                                                            ...
                                                            <HeaderStyle Wrap="False" HorizontalAlign="Left" Font-Bold="False"></HeaderStyle>
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtStock" Font-Size="10px" Width="60px" runat="server" Text='<%# Eval("Stock") %>'
                                                        ...
                                                        <asp:TemplateField HeaderText="Deliver To" Visible="false">
                                                            ...
                                                            <HeaderStyle Wrap="False" HorizontalAlign="Left" Font-Bold="False"></HeaderStyle>
                                                            <ItemTemplate>
                                                                <asp:DropDownList Font-Size="10px" ID="ddlDeliverTo" SelectedValue='<%# Eval("AccType")%>'
                                                                    runat="server">
                                                        ...
                                                        <asp:TemplateField HeaderText="AccountName">
                                                            ...
                                                            <HeaderStyle Wrap="False" HorizontalAlign="Left" Font-Bold="False"></HeaderStyle>
                                                            <ItemTemplate>
                                                                <asp:DropDownList Font-Size="10px" ID="ddlAccountName" runat="server" Width="250px">
                                                                </asp:DropDownList>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                ...
                                                <asp:GridView ID="GrdInterSegment" runat="server" Width="100%" BorderColor="CornflowerBlue"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="AdJustment">
                                                            ...
                                                            <HeaderStyle Wrap="False" HorizontalAlign="Left" Font-Bold="False"></HeaderStyle>
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtAdjst" Font-Size="10px" Width="60px" runat="server" Text='<%# Eval("AddJust") %>'
                                                                    onKeyUp="javascript:checkNumber(this);"></asp:TextBox>
                                                ...
                                                <asp:GridView ID="GrdMarketPayIN" runat="server" Width="100%" BorderColor="CornflowerBlue"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Deliverable">
                                                            ...
                                                            <HeaderStyle Wrap="False" HorizontalAlign="Left" Font-Bold="False"></HeaderStyle>
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtDeliverable" Font-Size="10px" Width="60px" runat="server" Text='<%# Eval("Deliverable") %>'
                                                                    onKeyUp="javascript:checkNumber(this);"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField Visible="False">
                                                ...
                                                <asp:GridView ID="grdPayInOwnAcc" runat="server" Width="100%" BorderColor="CornflowerBlue"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="To Transferable">
                                                            ...
                                                            <HeaderStyle Wrap="False" HorizontalAlign="Left" Font-Bold="False"></HeaderStyle>
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtTransferable" Font-Size="10px" Width="60px" runat="server" Text='<%# Eval("Transferable") %>'
                                                                    onKeyUp="javascript:checkNumber(this);"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
