<%@ page language="C#" autoeventwireup="true" inherits="management_frm_ImportBSECMStamp, App_Web_lgnajdkn" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Stamp Duty Payable Statement of BSE-CM for OFS/BB [MBRSTD_OTB_TM_TmCode_DDMMYY.CSV]</title>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports BSE-CM's Trading Members' Stamp Duty Files For OFS/BB [MBRSTD_OTB_TM_TmCode_DDMMYY.CSV]
                        </h5>
                    </td>
                </tr>
