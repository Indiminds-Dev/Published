<%@ page language="C#" autoeventwireup="true" inherits="management_Tradesiframe, App_Web_yxggcryg" %>
                ...
                <table id="tbl_main" class="login" cellspacing="0" cellpadding="0" width="410">
                    <tbody>
                        <tr>
                            <td class="lt1">
                                <h5>
                                    Imports BSE-FO TRADES Files</h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="lt brdr">
                                                                            ...
                                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                                <ContentTemplate>
                                                                                    <asp:DropDownList ID="ddlFileList" runat="server" Width="222px" AutoPostBack="True"
                                                                                        ...
                                                                                        <asp:ListItem Value="2">Fow Txt</asp:ListItem>
                                                                                        <asp:ListItem Value="3">Dload Format</asp:ListItem>
                                                                                        <asp:ListItem Value="4">Odin-Single Terminal</asp:ListItem>
											                                            <asp:ListItem Value="5">Odin-All Terminals</asp:ListItem>
											                                            <asp:ListItem Value="6">Final CSV [LocationID Wise]</asp:ListItem>
                                                                                        <asp:ListItem Value="7">Symphony Txt</asp:ListItem>
                                                                                        <asp:ListItem Value="8">Other Algo OR UDiFF Formats</asp:ListItem>
                                                                                        </asp:DropDownList><br />
