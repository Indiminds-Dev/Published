<%@ page language="C#" autoeventwireup="true" inherits="management_Export_DeliveryTrades, App_Web_alid8jfz" %>
...
<head id="Head1" runat="server">
    <title>Export Delivery Trades Of Clients</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Export Delivery Trades Of Clients</span></strong></td>
