<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="management_Trade_Processingiframe, App_Web_x5xbqja1" %>
    ...
    function PageLoad()///Call Into Page Load
            {
                ...
                if(exchangesegmnet=="2" || exchangesegmnet=="5" || exchangesegmnet=="20")
                   Hide('Tr_SettlementType');
                else{
                    Show('Tr_SettlementType');
   ...
   function ALERTSTATUS(obj,obj1)
        {
          ...
          if (obj=='12')
               {
                ...
                if (obj=='13')
               {
                    alert('Trade Processed Successfully !!'+'\n'+'Brokerage Setup Missing For Certain Clients/or Certain Clients Could Not Be Identified !!');
                    if (obj1>'0')
                    {
                         htmlbtngenerate();
                    }
          ...
          if (obj=='14')
               {
                    alert('Trade Processed Successfully !!'+'\n'+'Brokerage Setup Missing For Certain Clients/or Products Could Not Be Found !!');
                    if (obj1>'0')
                    {
                         htmlbtngenerate();
                    }
          ...
          if (obj=='15')
               {
                    alert('Trade Processed Successfully !!'+'\n'+'Brokerage Setup Missing For Certain Clients!!');
                    if (obj1>'0')
                    {
                         htmlbtngenerate();
                    }
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Settlement Type :</td>
                                        <td>
                                            <asp:RadioButton ID="RdSettTypeAll" runat="server" Checked="True" GroupName="c" />
                                            All
                                        </td>
                                        <td>
                                            <asp:RadioButton ID="RdSettTypeCurrent" runat="server" GroupName="c" />
                                            Current [ <span id="litSettTypeMain" runat="server" style="color: Maroon"></span>
                                            ]
                                        </td>
                                    </tr>
                                </table>
