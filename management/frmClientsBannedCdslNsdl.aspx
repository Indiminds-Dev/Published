<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmClientsBannedCdslNsdl, App_Web_cvaj-tqf" %>
...
//        alert('Hi');
    ...
    function OpenLink(CntID)
    {
        ...
        parent.OnMoreInfoClick(url,'Details For'+CntID,'940px','550px,resize=0','N');
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" style="text-align: center;">
                        <strong><span style="color: #000099">Banned Entities</span></strong>
                    </td>
                </tr>
            </table>
            ...
            <td style="text-align:left; width:145px">
                 <table>
                        ...
                        <dxe:ASPxComboBox id="ddlSlipType" runat="server" ClientInstanceName="SlipType" EnableIncrementalFiltering="True"
                            EnableSynchronization="False" SelectedIndex="4" tabIndex="4" ValueType="System.String"
