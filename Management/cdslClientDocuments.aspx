<%@ page language="C#" autoeventwireup="true" inherits="management_cdslClientDocuments, App_Web_bfdn6hbr" %>
...
<head id="Head1" runat="server">
    <title>CDSL Client Document</title>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
  ...
  function SignOff()
    ...
    function Show()
    {
        var url = "frmAddDocuments.aspx?id=cdslClientDocuments.aspx&id1=CDSL Clients&AcType=Add";
    ...
    {
       var url = 'frmAddDocuments.aspx?id=cdslClientDocuments.aspx&id1=CDSL Clients&AcType=Edit&docid='+KeyValue;
        popup.SetContentUrl(url);
       // alert (url);
        popup.Show();
    }
