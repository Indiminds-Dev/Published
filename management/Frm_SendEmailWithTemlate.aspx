<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_SendEmailWithTemlate, App_Web_yf04ozfw" validaterequest="false" %>
                    ...
                    <td valign="top">
                        <table style="margin: 0px 0px 0px 0px; background-color: #B7CEEC;" width="500px"
                            ...
                            <td class="gridcellleft">
                             ...
                             <td class="gridcellleft"> <asp:DropDownList ID="cmbGenerate" runat="server" Width="80px" Font-Size="10px" onchange="ChangeType(this.value)"
                                                    TabIndex="2">
