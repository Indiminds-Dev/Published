<%@ page language="C#" autoeventwireup="true" inherits="management_vat, App_Web_sjbhlkdr" %>
                            ...
                            <tr>
                                <td style="text-align: center">
                                    <table style="border: solid 1px blue; width: auto">
                                        ...
                                        <tr>
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Vat Rate:" ID="ASPxLabel3">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left" class="Ecoheadtxt">
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="VAT.Cess2:" ID="ASPxLabel5">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left" class="Ecoheadtxt">
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="VAT.Cess1:" ID="ASPxLabel4">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left" class="Ecoheadtxt">
                                      ...
                                      <%--  -------------- For Swachh Bharat Start  ----------------%>
                                         ...
                                         <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="VAT.Cess3:" ID="ASPxLabel8">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left" class="Ecoheadtxt">
                                      ...
                                      <%--   -------------For Swachh Bharat End ----------%>
                                        ...
                                        <tr>
                                         ...
                                         <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="VAT.Cess4:" ID="ASPxLabel9">
                                                </dxe:ASPxLabel>
                                            </td>
