<%@ page language="C#" autoeventwireup="true" inherits="management_frm_ImportSD0n, App_Web_0payuukt" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Margin Payable Statement of F&O CM[F_MG11]</title>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports NSE-CM's Trading Members' Stamp Duty Files [C_SD0n_memcode_DDmmYYYY.csv OR StampDuty_NCL_CM_0_CM_memcode_YYYYMMDD_F_0000.csv UDiFF Files]
                        </h5>
                    </td>
                </tr>
