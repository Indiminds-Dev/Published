<%@ page language="C#" autoeventwireup="true" inherits="Reports_CFStatement, App_Web_w8tpuxyq" %>
...
<head id="Head1">
    <title>CF Charge Statement</title>
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Report Type :</td>
                                        <td>
                                            <asp:DropDownList ID="DdlRptType" runat="server" Width="250px" Font-Size="10px" onchange="fn_ReportType(this.value)">
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Report View :</td> 
                                        <td>
                                            <asp:DropDownList ID="DLLCFRptView" runat="server" Width="250px" Font-Size="10px">
                                ...
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Report View :</td> 
                                        <td>
                                            <asp:DropDownList ID="DLLMTMRptView" runat="server" Width="250px" Font-Size="10px">
