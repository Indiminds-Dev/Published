<%@ page language="C#" autoeventwireup="true" inherits="management_frm_attendance_PD_calculation, App_Web_bfdn6hbr" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Attendane PD calculation</title>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <asp:SqlDataSource ID="dataCompany" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
                            SelectCommand="SELECT [cmp_internalid], [cmp_Name] FROM [tbl_master_company] ORDER BY [cmp_Name]">
                        </asp:SqlDataSource>
                        <asp:SqlDataSource ID="databranch" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
                            SelectCommand="SELECT [branch_id], [branch_description] FROM [tbl_master_branch] ORDER BY [branch_description]">
                        </asp:SqlDataSource>
                        <asp:SqlDataSource ID="dataYear" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
                            SelectCommand="select year(getdate()) as yer union all select year(dateadd(yy,-1,getdate())) as yer">
                        </asp:SqlDataSource>
                    </td>
                </tr>
            </table>
