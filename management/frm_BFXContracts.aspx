<%@ page language="C#" autoeventwireup="true" inherits="frm_BFXContracts, App_Web_6_wayyot" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Import BFX Contract</title>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td align="right" style="width: 278px; height: 22px">
                                            <asp:FileUpload ID="BFXSelectFile" runat="server" Height="20px"/>
                                        </td>
                                    </tr>
                                    <tr>
