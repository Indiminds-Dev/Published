<%@ page language="C#" autoeventwireup="true" inherits="DP_CDSL_User_BL_CDSL_AuthorizeDPAccount, App_Web_f9t-z9uf" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    <form id="form1" runat="server" autocomplete="off">
        <div id="MainFull">
            ...
            <div id="Row3" class="Row" style="width: 995px;">
                ...
                <div id="Row5" class="Row">
                    <dxwgv:ASPxGridView ID="GvAuthRecord" ClientInstanceName="cGvAuthRecord" runat="server"
                        KeyFieldName="CdslOfflineAccount_ID" AutoGenerateColumns="False" Width="995px" 
                        ...
                        <Columns>
                            ...
                            <dxwgv:GridViewDataTextColumn Caption="Application No" FieldName="CdslOfflineAccount_ApplicationNumber" VisibleIndex="1"
                                Width="75px">
                            ...
                            <dxwgv:GridViewDataColumn FieldName="Clientname" Caption="Customer Name" VisibleIndex="2"
                                Width="75px">
                            </dxwgv:GridViewDataColumn>
                            <dxwgv:GridViewDataColumn FieldName="verifieduser" Caption="Vrfy User" VisibleIndex="3"
                                Width="75px">
                            </dxwgv:GridViewDataColumn>
                            <dxwgv:GridViewDataColumn FieldName="verifieddate" Caption="Vrfy Date" VisibleIndex="4"
                                Width="75px">
                            </dxwgv:GridViewDataColumn>
                            <dxwgv:GridViewDataColumn FieldName="authorisedby" Caption="Authorized By" VisibleIndex="5"
                                Width="200px">
                                <CellStyle Wrap="False">
                                </CellStyle>
                            </dxwgv:GridViewDataColumn>
                            <dxwgv:GridViewDataColumn FieldName="Status" Caption="Auth.Status" VisibleIndex="6"
                                Width="50px" SortOrder="descending">
                                <CellStyle Wrap="False">
                                </CellStyle>
                            </dxwgv:GridViewDataColumn>
                            <dxwgv:GridViewDataColumn FieldName="Pending" Caption="Pend.Auth." VisibleIndex="7"
                                Width="50px">
                                <CellStyle Wrap="False">
                                </CellStyle>
                            </dxwgv:GridViewDataColumn>
                            <dxwgv:GridViewDataColumn FieldName="CdslOfflineAccount_BatchNumber" Caption="Batch No." VisibleIndex="8"
                                Width="50px">
                                <CellStyle Wrap="False">
                                </CellStyle>
                            </dxwgv:GridViewDataColumn>
            ...
            <br class="clear"/>
            <br class="clear"/>
            <div id="rowaddition" class="Error">
                Please Configure How Many No Of CDSL Authorization will Persist. By Using 
                <a href="#" onclick="openpage('')" style="color:Blue;text-decoration:underline;">Global Settings</a> !!
            </div>
            <br class="clear"/>
        </div>
    </form>
