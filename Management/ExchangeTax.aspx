<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="management_ExchangeTax, App_Web_gflohp-r" %>
...
//             }
    ...
    function FunCallAjaxList(objID, objEvent, ObjType) {
        ...
        strQuery_FieldName = "distinct top 10 Currency_Name +' ['+isnull(ltrim(rtrim(Currency_AlphaCode)),'')+']' AS loginid,Currency_ID user_id";
        strQuery_WhereClause = " ( Currency_Name like (\'%RequestLetter%') or ltrim(rtrim(Currency_AlphaCode)) like (\'%RequestLetter%'))";
        //End of New Work 25/02/2022        
    }
    ...
    function OnTaxChanged(ddltaxapp) {
        ...
        if (text == "2") {
            ...
            //New Work 25/02/2022
            document.getElementById("tr_TradeAmt").style.display = "none";
            //End of New Work 25/02/2022
            ...
            document.getElementById("tr_ddlcalculatedOn").style.display = "inline";
            //New Work 25/02/2022
            document.getElementById("tr_TradeAmt").style.display = "inline";
            //End of New Work 25/02/2022
                                ...
                                <td style="text-align: center">
                                    <table style="border: solid 1px blue; width: auto">
                                       ...
                                       <%-- ----- Row 1-------%>
                                          ...
                                          <tr id="tr_4">
                                            ...
                                            <td style="text-align: left; width: 30%;" class="Ecoheadtxt">
                                              ...
                                              <dxe:ASPxTextBox runat="server" ID="TxtFeeRate" onkeypress="return noNumbers(event)"
                                                    Width="130px">
                                                    <MaskSettings Mask="&lt;0..99g&gt;.&lt;00..99999999&gt;" />
                                          ...
                                          <tr id="tr_5">
                                            ...
                                            <td id="td_Min_v" style="text-align: left" class="Ecoheadtxt">
                                             ...
                                             <td id="td2" class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Max Amt/Unit:" ID="ASPxLabel32">
                                                </dxe:ASPxLabel>
                                            </td>
                                        ...
                                        <%--New Work 25/02/2022--%>
                                          <tr id="tr_TradeAmt">
                                             <td id="td_TradeMin_l" class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Min Amt/Trade:" ID="ASPxLabel6">
                                                </dxe:ASPxLabel>
                                             </td>
                                            
                                            <td id="td_TradeMin_v" style="text-align: left" class="Ecoheadtxt">                                               
                                                <dxe:ASPxTextBox runat="server" Width="100px"  ID="TxtMinTradeAmount" onkeypress="return noNumbers(event)">
                                                    <MaskSettings Mask="&lt;0..99g&gt;.&lt;00..999999&gt;" />
                                                    <ValidationSettings ErrorDisplayMode="None">
                                                    </ValidationSettings>
                                                </dxe:ASPxTextBox>                                               
                                             ...
                                             <td id="td_TradeMax_l" class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Max Amt/Trade:" ID="ASPxLabel7">
                                                </dxe:ASPxLabel>
                                             </td>
                                            
                                            <td id="td_TradeMax_v" style="text-align: left" class="Ecoheadtxt">                                               
                                                <dxe:ASPxTextBox runat="server" ID="TxtMaxTradeAmount" Width="100px" onkeypress="return noNumbers(event)">
                                                    <MaskSettings Mask="&lt;0..99g&gt;.&lt;00..999999&gt;" />
                                                    <ValidationSettings ErrorDisplayMode="None">
                                                    </ValidationSettings>
                                                </dxe:ASPxTextBox>                                               
                                ...
                                <td colspan="1" class="Ecoheadtxt" style="text-align: left; width: 148%;">
                                        ...
                                        <tr>
                                            <td class="Ecoheadtxt" colspan="6" style="text-align: center">
                                                <asp:Button ID="Button1" runat="server" Text="Save" CssClass="btnUpdate" OnClick="Button1_Click" AccessKey="S">
                                                </asp:Button>
                                            </td>
                                        </tr>
                                    </table>
