<%@ page language="C#" autoeventwireup="true" inherits="management_BrkCharges_dgcx, App_Web_n2fxndvz" %>
...
function disp_prompt(name)
    ...
    //alert (name);
           if ( name == "tab0")
        {
         ...
         //alert (h);
         document.location.href="BrkMain_dgcx.aspx?id="+h; 
         //alert (h);
        }
        else if ( name == "tab1")
        {
          //document.location.href="BrkCharges_dgcx.aspx"; 
        }
    }
