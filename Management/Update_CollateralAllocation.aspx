<%@ page language="C#" autoeventwireup="true" inherits="management_Update_CollateralAllocation, App_Web_mzqu16me" %>
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports NSE Clearings' "MemCode_ALLOC_DDMMYYYY.Snn" files and update ErrorCodes for earlier uploaded batches for Collateral Allocation </h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="lt brdr">
