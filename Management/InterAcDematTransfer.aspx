<%@ page language="C#" autoeventwireup="true" inherits="management_InterAcDematTransfer, App_Web_i8xxwgwk" %>
...
<head id="Head1">
    <title>Inter Account Demat Transfer</title>
                    ...
                    if(document.getElementById('ddlGroup').value=="0")
                    {
                        if(document.getElementById('rdbranchAll').checked==true)
                        ...
                        else
                           {
                              if(AccountType == '[Own]')
                              {
                                 cmbVal='ClientsBranch'+'~'+'ProSelected'+'~'+document.getElementById('HiddenField_Branch').value;
                              }
                              else
                              {
                   ...
                   if(document.getElementById('rdddlgrouptypeAll').checked==true)
                       {
                           if(AccountType == '[Own]')
                           {
                             cmbVal='ClientsGroup'+'~'+'ProALL'+'~'+document.getElementById('ddlgrouptype').value;
                           }
                           else
                           {
                       ...
                       {   if(AccountType == '[Own]')
                           {
                             cmbVal='ClientsGroup'+'~'+'ProSelected'+'~'+document.getElementById('HiddenField_Group').value;
                           }
                           else
                           {
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Inter Account Demat Transfer</span></strong></td>
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlAccountType" Font-Size="10px" runat="server" Width="250px"
                                                ...
                                                <asp:ListItem Value="M">Margin/HoldBack</asp:ListItem>
                                                <asp:ListItem Value="O">Own</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                </table>
