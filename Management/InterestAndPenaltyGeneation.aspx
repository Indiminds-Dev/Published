<%@ page language="C#" autoeventwireup="true" inherits="management_InterestAndPenaltyGeneation, App_Web_zsukfi_p" %>
                                    ...
                                    <tr>
                                        ...
                                        <td class="gridcellleft">
                                            <dxe:ASPxDateEdit ID="DtFrom" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                Font-Size="10px" Width="108px" ClientInstanceName="cDtFrom" TabIndex="0">
                                        ...
                                        <td class="gridcellleft">
                                            ...
                                            <dxe:ASPxDateEdit ID="DtTo" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                Font-Size="10px" Width="108px" ClientInstanceName="cDtTo" TabIndex="0">
                                    ...
                                    <tr >
                                        <td>
                                            <table border="10" cellpadding="1" cellspacing="1">
                                                        ...
                                                        <table>
                                                            <tr>
                                                                <td class="gridcellleft" bgcolor="#B7CEEC">
                                                                    Group By</td>
                                                                <td>
                                                                    <asp:DropDownList ID="ddlGroup" TabIndex="0" runat="server" Width="100px" Font-Size="10px"
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                                                                    <ContentTemplate>
                                                                                        <asp:DropDownList ID="ddlgrouptype" TabIndex="0" runat="server" Font-Size="10px"
                                                    ...
                                                    <td >
                                                        <table border="10" cellpadding="1" cellspacing="1">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <dxe:ASPxTextBox ID="txtRate" runat="server" HorizontalAlign="Right" Width="100px">
                                             ...
                                             <tr><td><table border="10" cellpadding="1" cellspacing="1"><tr>     <td class="gridcellleft" bgcolor="#B7CEEC">
                                                                    Generate For Interest Amount >
                                                                </td>
                                                                <td>Rs/-</td>
                                                                <td>
                                                    ...
                                                    <td>
                                                        <table border="10" cellpadding="1" cellspacing="1">
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <dxe:ASPxTextBox ID="txtNoOfDayInYear" runat="server" HorizontalAlign="Right" Width="100px">
                            ...
                            <td class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DdlServiceTax" runat="server" Width="100px" Font-Size="10px">
                            ...
                            <td>
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="DdlBalanceType" runat="server" Width="120px" Font-Size="10px">
                ...
                <td class="gridcellleft">
                    <table border="10" cellpadding="1" cellspacing="1">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="TxtNarration" runat="server" Width="600px" Height="30px" Font-Size="10px" TextMode="MultiLine"></asp:TextBox>
                            </td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr><td class="gridcellleft"> <table border="10" cellpadding="1" cellspacing="1">
                        <tr>
                            <td class="gridcellleft" bgcolor="#B7CEEC">
                                Report View :
                            </td>
                            <td>
                                <asp:DropDownList ID="DdlRptView" runat="server" Width="120px" Font-Size="10px">
                         ...
                         <tr>
                            <td class="gridcellleft" bgcolor="#B7CEEC">
                             ...
                             <td>
                                 <asp:DropDownList ID="ddlCalculateOn" runat="server" Width="120px" Font-Size="10px">
