<%@ page language="C#" autoeventwireup="true" inherits="Reports_PortfolioPerformanceFO_New, App_Web_-n9yptcr" %>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td id="Td_ExpiryDate" class="gridcellleft">
                                                                    <dxe:ASPxDateEdit ID="DtExpiry" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                                        Font-Size="10px" Width="108px" ClientInstanceName="DtExpiry">
