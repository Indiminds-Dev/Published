<%@ page language="C#" autoeventwireup="true" inherits="management_FXRateEntryRootPopup, App_Web_zsukfi_p" %>
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" style="text-align: center;">
                        <strong><span style="color: #000099">ADD/Edit FX Rates</span></strong>
                    </td>
                </tr>
            </table>
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="width: 110px;">
                                    <asp:TextBox ID="txtFXRate" runat="server" Width="205px" onkeypress="return noNumbers(event)"></asp:TextBox>
                                </td>
                                <td style="width: 2px;">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorFXRate" runat="server" ControlToValidate="txtFXRate"
                                        ErrorMessage="Please Insert FX Rate" ValidationGroup="a">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                        </table>                
                    </td>                
                        ...
                        <table>
                            <tr>
                                ...
                                <td align="right" id="td_yes" runat="server" style="width: 40px;">
                                    <asp:Button ID="btnSave" runat="server" CssClass="btn" Text="Save" Width="120px" Height="27px" OnClick="btnSave_Click" AccessKey="S"
                                        ValidationGroup="a" />
                                </td>
                                <td style="width: 20px;">
                                    &nbsp;
                                ...
                                <td align="right" id="td_no" runat="server" style="width: 40px;">
                                    <asp:Button ID="btnCancel" runat="server" CssClass="btn" Text="Cancel" Width="120px" Height="27px" AccessKey="C"
