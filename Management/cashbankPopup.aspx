<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="management_cashbankPopup, App_Web_vvdfezxa" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE"  onload="javascript:document.form1.cmbType.focus();"> 
                            ...
                            <tr id="">
                                ...
                                <td style="text-align: left;">
                                    <dxe:ASPxDateEdit ID="dteDate" runat="server" EditFormat="Custom" ClientInstanceName="dteDate"
                                        UseMaskBehavior="True" Font-Size="10px" Width="100px" TabIndex="2">
                                ...
                                <td style="text-align: left;">
                                    <asp:DropDownList ID="cmbCompany" runat="server" DataSourceID="dsCompany" DataTextField="CashBank_CompanyName" 
                                        DataValueField="CashBank_CompanyID" Width="353px" Font-Size="10px" AutoPostBack="True"
                                ...
                                <td style="text-align: left;">
                                    <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="cmbSegment" runat="server" Width="100px" OnChange="javascript:SegSelect(this);" Font-Size="10px" TabIndex="4">
                                            </asp:DropDownList>
                                        </ContentTemplate>
                                        <Triggers>
                            ...
                            <tr id="trBankCashType">
                                ...
                                <td style="text-align: left;" id="tdBankAccountNo1">
                                    <asp:DropDownList ID="cmbBranch" runat="server" DataSourceID="dsBranch" DataTextField="BANKBRANCH_NAME"
                                        DataValueField="BANKBRANCH_ID" Width="150px" Font-Size="10px" TabIndex="5">
                                    </asp:DropDownList>
                                </td>
                                ...
                                <td style="text-align: left;" id="tdcb1">
                                    <asp:DropDownList ID="cmbCashBankAc" runat="server" DataSourceID="MainAccount" DataTextField="MainAccount_Name"  OnChange="javascript:BankChange();"
                                        DataValueField="CashBank_MainAccountID" Width="353px" Font-Size="10px" TabIndex="6" AutoPostBack="True" OnSelectedIndexChanged="cmbCashBankAc_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </td>
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtSettlementNo" runat="server" Width="100px" Font-Size="10px" TabIndex="7"></asp:TextBox>&nbsp;
                                </td>
                            </tr>
                                    ...
                                    <table cellpadding="0px" cellspacing="0px">
                                        <tr>
                                            ...
                                            <td style="text-align: right;">
                                                <asp:Label ID="ASPxcurrBankBalance" runat="server" Font-Size="10px" Width="100px"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="text-align: right;" id="td14">
                                                <asp:Label ID="ASPxcurrentAcBalance" runat="server" Font-Size="10px" Width="100px"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                            ...
                                            <asp:GridView ID="grdAdd" runat="server" DataKeyNames="CashReportID" CssClass="gridcellleft"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="MainAccount">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtEditMainAccount" TabIndex="8" Font-Size="10px" Text='<%# Eval("MainAccount1") %>' Width="180px" onkeyup="CallMainAccount(this,'MainAccount',event)"
                                                                runat="server"></asp:TextBox>
                                                           <asp:HiddenField ID="txtEditMainAccount_hidden" runat="server" Value='<%# Eval("CashBank_MainAccountID") %>' />                                                              
                                                        </EditItemTemplate>
                                                        <FooterTemplate>
                                                            <asp:TextBox ID="txtMainAccount" TabIndex="8" Font-Size="10px" Width="180px" onkeyup="CallMainAccount(this,'MainAccount',event)"
                                                                runat="server"></asp:TextBox>
                                                    ...
                                                    <asp:TemplateField HeaderText="SubAccount">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtEditSubAccount" TabIndex="9" Font-Size="10px" Text='<%# Eval("SubAccount1") %>' Width="180px" onkeyup="CallSubAccount(this,'SubAccountMod',event)"
                                                                runat="server"></asp:TextBox>
                                                            <asp:HiddenField ID="txtEditSubAccount_hidden" runat="server" Value='<%# Eval("SubAccountID") %>'/>                                                             
                                                        </EditItemTemplate>
                                                        <FooterTemplate>
                                                            <asp:TextBox ID="txtSubAccount" TabIndex="9" Font-Size="10px" Width="180px" onkeyup="CallSubAccount(this,'SubAccountMod',event)" onblur="AcBalance()"
                                                                runat="server"></asp:TextBox>
                                                    ...
                                                    <asp:TemplateField HeaderText="Inst. Type">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:DropDownList ID="ddlEditInstType" Font-Size="10px" SelectedValue='<%# Eval("CashBank_InstrumentType") %>' OnChange="javascript:OnInstmentTypeChange(this);" runat="server" Width="65px"
                                                                TabIndex="11">
                                                        ...
                                                        <FooterTemplate>
                                                            <asp:DropDownList ID="ddlInstType" Font-Size="10px" runat="server" OnChange="javascript:OnInstmentTypeChange(this);"
                                                    ...
                                                    <asp:TemplateField HeaderText="Inst No">
                                                        ...
                                                        <EditItemTemplate>
                                                            <asp:TextBox ID="txtEditInstNumber" Font-Size="10px" TabIndex="16" Width="60px" runat="server"
                                                                Text='<%# Eval("CashBank_InstrumentNumber") %>'></asp:TextBox>
                                                        </EditItemTemplate>
                                                        <FooterTemplate>
                                                            <asp:TextBox ID="txtInstNo" runat="server" Font-Size="10px" TabIndex="16" Width="60px"></asp:TextBox>
                                                        </FooterTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Date">
                                                        ...
                                                        <FooterTemplate>
                                                            <dxe:ASPxDateEdit ID="dtAspxDate" runat="server" EditFormat="Custom" TabIndex="17" ClientInstanceName="dtAspxDate"
                                                                UseMaskBehavior="True" Font-Size="10px" Width="80px" EditFormatString="dd MMMM yyyy">
                                                                <ButtonStyle Width="13px">
                                                                </ButtonStyle>
                                                    ...
                                                    <asp:TemplateField HeaderText="Payment">
                                                        ...
                                                        <EditItemTemplate>
                                                           <%-- <asp:TextBox ID="txtEditWithdraw" TabIndex="18" Font-Size="10px" onkeyup="testDetails(this);"
                                                        ...
                                                        <FooterTemplate>
                                                            <%--<asp:TextBox ID="txtWithdraw" runat="server" TabIndex="18" Font-Size="10px" onkeyup="testDetails(this);"
                                                    ...
                                                    <asp:TemplateField HeaderText="Receipt">
                                                        ...
                                                        <EditItemTemplate>
                                                            <%--<asp:TextBox ID="txtEditRecpt" runat="server" Font-Size="10px" TabIndex="19" onkeyup="testDetails(this);"
                                                        ...
                                                        <FooterTemplate>
                                                            <%--<asp:TextBox ID="txtReceipt" runat="server" Font-Size="10px" TabIndex="19" onkeyup="testDetails(this);"
                                                                onkeypress="return AllowNumericOnly(this);" Width="85px"></asp:TextBox>--%>
                                                    ...
                                                    <asp:TemplateField Visible="False">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblID" runat="server" Font-Size="10px" Text='<%# Eval("CashReportID") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                       ...
                                       <tr id="trCustomerBank" style="display: none">
                                        ...
                                        <tr id="trIssuingBank"  style="display: none">
                                            ...
                                            <td style="text-align: left;" colspan="3">
                                                <asp:TextBox ID="txtIssuingBank" runat="server" Font-Size="10px" TabIndex="12" Width="365px"></asp:TextBox>
                                        ...
                                        <tr id="trDetails"  style="display: none">
                                            ...
                                            <td style="text-align: left;" id="trDetails2">
                                                <asp:DropDownList ID="cmbPayee" runat="server" Width="366px" Font-Size="10px" TabIndex="14">                                        
                                                </asp:DropDownList>
                                            </td>
