<%@ page language="C#" autoeventwireup="true" inherits="management_Remove_ExpiryProductsPLData, App_Web_itibbj7j" %>
...
<head>
    <title>Remove Pulled Expiry Products PL Data</title>
...
//                End of New Work 01/09/2023
      ...
      {
        alert(obj);
        window.location="../management/Remove_ExpiryProductsPLData.aspx";
      } 
      ...
      function Refresh()
      {
       ...
       function RemoveButtonClickStart()
       {
...
//      alert(document.getElementById('HiddenField_Client').value+'3');
       ...
       function RemoveButtonClickEnd()
       {
        Reset();
        alert("Remove expiry date data process done!!!");
       }
    </script>
        ...
        <div>
            <div class="TableMain100">
                <div class="EHEADER" style="text-align: center;">
                    <strong><span style="color: #000099">Remove Pulled Expiry Products PL Data</span></strong>
                </div>
            </div>
            <br class="clear" />
                ...
                <div id="divPageFilter" style="width: 995px;">
                    ...
                    <div id="dvMainFilter" class="frmContent" style="width: 528px">
                        ...
                        <div id="divExport">
                            ...
                            <div class="frmleftContent">
                                <dxcp:ASPxCallbackPanel ID="CbpSheetName" runat="server" ClientInstanceName="cCbpRemove"
                                    BackColor="White" OnCallback="CbpRemove_Callback">
                                    <PanelCollection>
                                        <dxp:panelcontent runat="server">
                                            <dxe:ASPxButton ID="BtnRemove" runat="server" AutoPostBack="False" Text="Remove"
                                                Width="85px">
                                                <clientsideevents click="RemoveButtonClickStart" />
                                            </dxe:ASPxButton>
                                        </dxp:panelcontent>
                                    </PanelCollection>
                                    <ClientSideEvents BeginCallback="RemoveButtonClickStart" EndCallback="RemoveButtonClickEnd" />
