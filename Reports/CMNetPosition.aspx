<%@ page language="C#" autoeventwireup="true" inherits="Reports_CMNetPosition, App_Web_rjq8jf2h" %>
...
<head id="Head1">
 ...
 <script language="javascript" type="text/javascript">
   ...
   function height()
    ...
    function ifscreenthengroupby(obj)
    {
        if(obj=='screen')
        {
                ...
                //New Work
                else if(document.getElementById('ddlGroup').value=="4")///////Broker wise
                {
                    document.getElementById('rdbranchclientSelected').checked=true;
                    document.getElementById('rdbranchclientAll').checked=false;
                    document.getElementById('rdbranchclientAll').disabled=true;
                ...
                else if(document.getElementById('ddlGroup').value=="5")///////Custodians wise
                {
                    document.getElementById('rdbranchclientSelected').checked=true;
                    document.getElementById('rdbranchclientAll').checked=false;
                    document.getElementById('rdbranchclientAll').disabled=true;
   ...
   function  fnddlGroup(obj)
   {
        ...
        if(obj=="0" || obj=="2" || obj=="3" || obj=="4" || obj=="5")
        //End of New Work
        {
            if(obj=="3")
                fn_Clients();
                                                            ...
                                                            <tr id="tr_grpselection">
                                                                ...
                                                                <td>
                                                                    <asp:DropDownList ID="ddlGroup" runat="server" Width="100px" Font-Size="10px" onchange="fnddlGroup(this.value)">
                                                                        ...
                                                                        <%--New Work--%>
                                                                        <asp:ListItem Value="5">Custodians</asp:ListItem>
                                                                        <%--End of New Work--%>
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td id="td_branch">
                                    ...
                                    <tr id="tr_mail">
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddloptionformail" runat="server" Width="100px" Font-Size="10px"
                                                ...
                                                <%--New Work--%>
                                                <asp:ListItem Value="0">Custodians</asp:ListItem>
                                                <%--End of New Work--%>
                                            </asp:DropDownList></td>
                                    </tr>
                                    <tr id="tr_excel">
