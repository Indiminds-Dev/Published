<%@ page language="C#" autoeventwireup="true" inherits="frm_UCXTRADES, App_Web_6yanuau_" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>UCX-COMM Trade</title>
                                ...
                                <tbody>
                                 <tr>
                                    ...
                                    <td align="left" colspan="2"  valign="middle">
                                        <asp:Label ID="Label1" runat="server">EG: UCX_TRCM_MEMBERCODE_YYYYMMDD.CSV</asp:Label></td>
                                    </tr>
                                    <tr>
                                       
                                        <td>
                                            <asp:FileUpload ID="UCXTradeSelectFile" runat="server" Height="21px" Width="272px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
