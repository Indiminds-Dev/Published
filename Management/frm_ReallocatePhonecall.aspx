w<%@ page language="C#" autoeventwireup="true" inherits="management_frm_ReallocatePhonecall, App_Web_gflohp-r" %>
...
<body>
    ...
    <div>
        ...
        <table class="TableMain">
            <tr>
                <td class="Ecoheadtxt" style="width: 22%">
                    Activity Type :&nbsp;</td>
            ...
            <tr>
                <td class="Ecoheadtxt" style="width: 22%">
                    Description :</td>
                <td style="width: 175px">
                    <asp:TextBox ID="txtDesc" TextMode ="MultiLine" Rows ="2" runat ="server" ForeColor="blue" Font-Size="10px"></asp:TextBox>
                </td>
                <td class="Ecoheadtxt" style="width: 15%">
                    Priority :</td>
                <td style="width: 177px">
            ...
            <tr>
                <td colspan="5">
                    <table class="TableMain100">
                        <tr>
                            <td class="Ecoheadtxt" style="width: 22%">
                                 Instruction Notes :</td>
                            <td class="Ecoheadtxt" style="text-align: left">
                                <asp:TextBox ID="txtInstNote" runat ="server" TextMode ="MultiLine" Rows="5" Width="187px" ForeColor="blue" Font-Size="10px"></asp:TextBox></td>
                        </tr>
                    </table>
                </td>
            </tr>
    ...
    <table class="TableMain">
        <tr>
            <td class="Ecoheadtxt" style="width: 21%; text-align: left">
                No. of Contact Alloted if no item select
            </td>
            <td class="Ecoheadtxt" style="text-align: left">
