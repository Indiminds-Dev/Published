<%@ page language="C#" autoeventwireup="true" inherits="management_RollingContracts, App_Web_leuczwkw" %>
...
<body>
    <form id="form1" runat="server">
           ...
           <table class="TableMain100" border="0" width="100%">
            ...
            <table class="TableMain100">
                ...
                <tr>
                    <td>
                        <dxwgv:ASPxGridView ID="gridRollingContracts" runat="server" ClientInstanceName="grid"
	...
	ShowHeight(s.cpHeight)
                            ...
                            <Columns>
                                <dxwgv:GridViewDataTextColumn Caption="ExchangeName" FieldName="Exchange_name" VisibleIndex="0">
                                    <CellStyle CssClass="gridcellleft">
                                    </CellStyle>
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="ProductsName" FieldName="Products_Name"
                                    VisibleIndex="1">
                                    <CellStyle CssClass="gridcellleft">
                                    </CellStyle>
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="ProductsShortName" FieldName="Products_ShortName"
                                    VisibleIndex="2">
                                    <CellStyle CssClass="gridcellleft">
                                    </CellStyle>
                                </dxwgv:GridViewDataTextColumn>
