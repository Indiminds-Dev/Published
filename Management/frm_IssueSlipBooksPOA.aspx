<%@ page language="C#" autoeventwireup="true" inherits="management_frm_IssueSlipBooksPOA, App_Web_s3wzohpw" %>
        ...
        <tr>
            <td align="left" class="gridcellleft" colspan="2" style="height: 39px" valign="top" >
                            ...
                            <tr>
                             ...
                             <td  style="width: 40px">
                                 <asp:TextBox ID="txtSeries" runat="server"  MaxLength="2" onkeypress="return AllowCharacterOnly(this);"
