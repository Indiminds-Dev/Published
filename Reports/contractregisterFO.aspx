<%@ page language="C#" autoeventwireup="true" inherits="Reports_contractregisterFO, App_Web_wt4jql-z" %>
                                ...
                                <asp:GridView ID="grdContractRegister" runat="server"  BorderColor="CornflowerBlue"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Sebi Fee" SortExpression="ContractNotes_SEBIFee">
                                         ...
                                         <asp:TemplateField HeaderText="Clearing Charge" SortExpression="ContractNotes_DeliveryCharges">
                                            <ItemStyle  Wrap="false"  BorderWidth="1px" HorizontalAlign="Right"  ></ItemStyle>
                                            <HeaderStyle HorizontalAlign="Center" Wrap="false" Font-Bold="False" 
                                                ></HeaderStyle>
                                            <ItemTemplate>
                                         ...
                                         <asp:TemplateField HeaderText="IPFT Charge" SortExpression="ContractNotes_OtherCharges">
                                            <ItemStyle  Wrap="false"  BorderWidth="1px" HorizontalAlign="Right"  ></ItemStyle>
                                            <HeaderStyle HorizontalAlign="Center" Wrap="false" Font-Bold="False" 
                                                ></HeaderStyle>
                                            <ItemTemplate>
                                      ...
                                      <%--  ------------------------RMS Fee End----------------------------%>
                                        ...
                                        <asp:TemplateField HeaderText="SrvTax/CGST" SortExpression="TotalTax_Sorting">
                                         ...
                                         <%-- ------------------- Swachh Bharat Cess Start ----------------------------------%>
                                          ...
                                          <asp:TemplateField HeaderText="SBCess/SGST" SortExpression="TotalTax_Sorting">
                                            <ItemStyle  Wrap="false"  BorderWidth="1px" HorizontalAlign="Right"  ></ItemStyle>
                                            <HeaderStyle HorizontalAlign="Center" Wrap="false" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
