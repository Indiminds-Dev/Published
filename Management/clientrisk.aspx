<%@ page language="C#" autoeventwireup="true" inherits="management_clientrisk, App_Web_fxnvzv_8" enableeventvalidation="false" %>
    ...
    else
    {
        ...
        function FnPopUp(Clientid,RptType,Segment)
        {
            ...
            if(RptType=='UnClear')
            {
               ...
               parent.OnMoreInfoClick(URL,header,'600px','300px','N');
            }
            ...
            {
               header='Appl. Margin'; 
               parent.OnMoreInfoClick(URL,header,'500px','300px','N');
            }
                            ...
                            <td class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="DdlValuationMethod" runat="server" Width="100px" Font-Size="10px">
                        ...
                        <tr>
                            <td class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        <td class="gridcellleft" bgcolor="#B7CEEC">
                                            Show Client With Shortage
                                            <br />
                                            More Than :</td>
                                        <td>
                                            <asp:DropDownList ID="DdlShortageMoreThanType" runat="server" Width="80px" Font-Size="10px" onchange="fnShortageMoreThanType(this.value)">
