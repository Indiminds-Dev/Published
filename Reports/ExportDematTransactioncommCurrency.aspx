<%@ page language="C#" autoeventwireup="true" inherits="Reports_ExportDematTransactioncommCurrency, App_Web_cnvbs8pk" %>
...
<head id="Head1">
    <title>Export Demat Transactions </title>
                            ...
                            <td class="gridcellleft">
                                <table border="10" cellpadding="1" cellspacing="1">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="ddlAccount" Font-Size="10px" runat="server" Width="250px" onchange="FnAccount(this.value)">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td class="gridcellleft">
                                            <dxe:ASPxDateEdit ID="DtTransactionDate" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                Font-Size="10px" Width="108px" ClientInstanceName="DtTransactionDate">
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td class="gridcellleft">
                                            <dxe:ASPxDateEdit ID="DtExecutionDate" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                                Font-Size="10px" Width="108px" ClientInstanceName="DtExecutionDate">
                                                <dropdownbutton text="For">
                                    </dropdownbutton>
                                            </dxe:ASPxDateEdit>
                                        </td>
