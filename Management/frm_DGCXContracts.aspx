<%@ page language="C#" autoeventwireup="true" inherits="management_frm_DGCXContracts, App_Web_g1t3n0jz" %>
    ...
    <form id="form1" runat="server">
     <div>
        <asp:Panel ID="Panelmain" runat="server" HorizontalAlign="Center" Style="z-index: 100;
            ...
            <table id="tbl_main" cellpadding="0" cellspacing="0" class="login" width="610">
                <tbody>
               <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports DGCXContracts
                        </h5>
                    </td>
                </tr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td align="right" style="width: 278px">
                                            <asp:FileUpload ID="DGCXSelectFile" runat="server" Height="21px" Width="572px" />
                                        </td>
                                    </tr>
                                    <tr>
