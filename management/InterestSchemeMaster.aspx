<%@ page language="C#" autoeventwireup="true" inherits="Management_InterestSchemeMaster, App_Web_cvaj-tqf" %>
...
<body style="background-color:#DDECFE;">
    ...
    <div id="content" >
       ...
       <div style="font-size:small;">
        ...
        <dxcp:ASPxCallbackPanel ID="cbpnlTest" runat="server" ClientInstanceName="ccbpnlTest"   OnCallback="CallBack">
