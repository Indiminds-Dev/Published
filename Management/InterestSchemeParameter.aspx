<%@ page language="C#" autoeventwireup="true" inherits="Management_InterestSchemeParameter, App_Web_2wstwz9u" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head id="Head1" runat="server">
    <title>Untitled Page</title>
     <style type="text/css">
	   .radioButtonList { list-style:none; margin: 0; padding: 4px;}
	   .radioButtonList.horizontal li { display: inline; padding: 4px;}
...
<body style="background-color:#DDECFE;">
    <form id="form1" runat="server" style="background-color:#DDECFE;">
        <table width="100%">
              <col width="67%">
                <col width="33%">
            <tr>
                    ...
                    <table border="1" style="border-collapse: collapse; background-color:#B7CEEC;" width="100%">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:TextBox runat="server" TabIndex="18" Width="120px" ID="txtfromdate" Visible="False"></asp:TextBox>
                                <asp:Image runat="server" ImageUrl="~/images/calendar.jpg" ID="Image1" Visible="False">
                                </asp:Image>
                                <dxe:ASPxDateEdit runat="server" TabIndex="0" UseMaskBehavior="True" DateOnError="Today" EditFormat="Custom" Width="130px" ID="txtDateFrom">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <%--<asp:TextBox ID="txtMainAc" runat="server" Width="320px" TabIndex="0" Visible="false" onkeyup="CallMainAccount(this,'GenericAjaxList',event);">--%>
                                <asp:TextBox ID="txtMainAc" runat="server" Width="320px" TabIndex="0" onkeyup="CallMainAccount(this,'GenericAjaxList',event);">
                                </asp:TextBox><br /><span id="spnMainAc" style="color:Red;"></span>
                            ...
                            <td align="left">
                                ...
                                <br /><span id="spnSubAc" style="color:Red;"></span>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtSTMainAc" runat="server" TabIndex="0" Width="320px" onkeyup="CallSTMainAccount(this,'GenericAjaxList',event)"
                                  ></asp:TextBox>
                                  <br /><span id="spnSTMainAc" style="color:Red;"></span>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtSTSubAc" runat="server" TabIndex="0" Width="320px" onkeyup="CallSTSubAccount(this,'GenericAjaxList',event)"
                                  ></asp:TextBox> <span id="spnSTSubAc" style="color:Red;"></span>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <br /><span id="spnTDSMainAc" style="color:Red;"></span>
                            ...
                            <td align="left">
                                ...
                                <br /><span id="spnTDSSubAc" style="color:Red;"></span>
        ...
        <div id="divDetailsPopUp" style="background-color: #B7CEEC; height: 230px; left: 481px; position: absolute;
            top: 25px; width: 800px; left: 90px; z-index: 75; display: none; padding-bottom: 10px;">
            <div style="background-color:Black; height: 12px; font-size: small; color: White; font-weight:bold;
                padding-bottom: 27px; padding-left: 2px;">
                ...
                <div style="background-color:#B7CEEC; color: Black; padding-left: 0px;">
                    ...
                    <table border="5" style="border-collapse:collapse; background-color:#B7CEEC;" width="97%">
                     ...
                     <%--<asp:Label ID="lblBlankDetailMessage" runat="server" Text="" EnableViewState="false"></asp:Label>--%>
                       <div style="height:200px; padding-top:10px; overflow-y:scroll; background-color:#B7CEEC; background-color:#B7CEEC;">
