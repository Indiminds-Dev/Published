<%@ page language="C#" autoeventwireup="true" inherits="Reports_DeliveryHoldingCommCurrency, App_Web_hnkxxmul" %>
...
<head id="Head1" runat="server">
    <title>Delivery Holding Report  </title>
                          ...
                          <tr>
                              ...
                              <td>
                                  <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                      <ContentTemplate>
                                          <asp:DropDownList ID="ddlDPAc" TabIndex="0" runat="server" Font-Size="10px" Width="300px">
                                          </asp:DropDownList>
                                      </ContentTemplate>
                                      <Triggers>
                            ...
                            <tr valign="top">
                                ...
                                <td class="gridcellleft">
                                    <dxe:ASPxDateEdit ID="dtasondate" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                        Font-Size="10px" Width="150px" ClientInstanceName="dtto">
