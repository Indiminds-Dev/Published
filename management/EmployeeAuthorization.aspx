<%@ page language="C#" autoeventwireup="true" inherits="management_EmployeeAuthorisation, App_Web_yf04ozfw" %>
...
<head runat="server">
    ...
    <style type="text/css">
        .divHeight{height:26px;}
        .btnRight{margin-right:10px; float:right;}  
        .paddingContnt{ padding-bottom:4px; padding-top:4px;}   
    </style>
...
<body onload="HideLoading();">
    ...
    <div id="Gmain">
         <div id="Div_header" class="Header">
             &nbsp;Authorize Requisition For Appt. Letter/I-Card/V-Card&nbsp;</div>
        ...
        <div id="Row1_Column1" class="LFloat_Content divHeight" style="width: 20%;">
          ...
          <div id="Row1_Column2" class="LFloat_Content divHeight" style="width: 20%;">
             ...
             <div id="Row1_Column5" class="LFloat_Content divHeight" style="width: 20%">
          ...
          <div id="Row1_Column3" class="LFloat_Row BtnLeft divHeight" style="width: 86px;float:right" >
        ...
        <div id="Container2" class="paging textLeft">
            <div class="right" >
                ...
                <div id="ShowFilter" style="width: 69px;float:left">
                    <a href="javascript:ShowHideFilter('s');"><span style="color: #000099; text-decoration: underline;font-size:12px">
                                                    Show Filter</span></a>
                </div>
               
                <div id="ShowAllRecords" style="width: 72px;float:left">
                    <a href="javascript:ShowHideFilter('All');"><span style="color: #000099; text-decoration: underline;font-size:12px;">
                        All Records</span></a>
                 </div>
        ...
        <dxwgv:ASPxGridView ID="GvEmployeeDtl" runat="server" AutoGenerateColumns="False" Settings-ShowHorizontalScrollBar="true"
            ...
            <ClientSideEvents EndCallback="function(s, e){GvEmployeeDtl_EndCallBack();}"
             ...
             <SettingsBehavior AllowFocusedRow="True" AutoFilterRowInputDelay="100000" AllowMultiSelection="True" />
            <Styles>
            ...
            <Columns>
                <dxwgv:GridViewCommandColumn FixedStyle="Left" ShowSelectCheckbox="True" VisibleIndex="0"
                    Width="15px">
                </dxwgv:GridViewCommandColumn>
               <dxwgv:GridViewDataTextColumn Caption="Name" FieldName="Name" VisibleIndex="1" Width="130px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="EmpCode" FieldName="EmpCode" VisibleIndex="2"
                        Width="90px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Branch" FieldName="BranchName" VisibleIndex="4"
                        Width="100px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="CTC" FieldName="CTC" VisibleIndex="5" Width="80px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px" HorizontalAlign="Right">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Designation" FieldName="Designation" VisibleIndex="6"
                        Width="170px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Company" FieldName="Company" VisibleIndex="7"
                        Width="160px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="AuthorizeUser1" FieldName="AuthUser1" VisibleIndex="8"
                        Width="180px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="AuthorizeDateTime1" FieldName="AuthDateTime1" VisibleIndex="9"
                        Width="140px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="AuthorizeUser2" FieldName="AuthUser2" VisibleIndex="10"
                        Width="180px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="AuthorizeDateTime2" FieldName="AuthDateTime2" VisibleIndex="11"
                        Width="140px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="AuthorizeUser3" FieldName="AuthUser3" VisibleIndex="12"
                        Width="180px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="AuthorizeDateTime3" FieldName="AuthDateTime3" VisibleIndex="13"
                        Width="240px">
                        <CellStyle CssClass="gridcellleft" Font-Size="11px">
                        </CellStyle>
                    </dxwgv:GridViewDataTextColumn>
