<%@ page language="C#" autoeventwireup="true" inherits="management_GenerateTMTransfers, App_Web_0jwcfgzk" %>
...
<head id="Head1">
    <title>Transfer TM Clients Obligation To TM's Account</title>
...
//            alert('Generate For Remaining Bills...');
        ...
        if(obj=="5")
        {
            ...
            window.location = "../Reports/GenerateTMTransfers.aspx";
        }
          ...
          $get('UpdateProgress1').style.display = 'none'; 
            ...
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">TM Client Obligation Transfer</span></strong></td>
