<%@ page language="C#" autoeventwireup="true" inherits="management_ObligationStatementFO, App_Web_x5xbqja1" %>
                ...
                <tr>
                    ...
                    <td class="EHEADER" width="25%" id="f" style="height: 20px">
                        <a href="javascript:void(0);" onclick="filter();"><span style="color: Blue; text-decoration: underline;
                            font-size: 8pt; font-weight: bold">Filter</span></a> || <a href="javascript:void(0);"
                                onclick="Sendmail();"><span style="color: Blue; text-decoration: underline; font-size: 8pt;
                                    font-weight: bold">Send Email</span></a>
                    </td>
                </tr>
            </table>
                            ...
                            <ContentTemplate>
                                <table id="brokerFilter" runat="server">
                                    <tr valign="top">
                                        ...
                                        <td style="height: 44px">
                                            <asp:DropDownList ID="cmbgroup" runat="server" Font-Size="10px" Width="300px" onchange="btndisplay()">
                                            </asp:DropDownList>
                                        </td>
                                        <td style="height: 44px">
