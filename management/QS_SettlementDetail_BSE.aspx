<%@ page language="C#" autoeventwireup="true" inherits="Management_QS_SettlementDetail_BSE, App_Web_n2fxndvz" %>
...
<head id="Head1" runat="server">
    <title>Export Batch File For "Submission of UCC wise Settlement Detail"</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Export Batch File For "Submission of UCC wise Settlement Detail"</span></strong></td>
