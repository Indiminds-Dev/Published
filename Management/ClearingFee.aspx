<%@ page language="C#" autoeventwireup="true" inherits="management_ClearingFee, App_Web_yq8u0p-o" %>
...
<head runat="server">
    ...
    function OnMoreInfoClick(keyValue) {
        ...
        var url = 'ClearingTax.aspx?id=' + keyValue;
    ...
    function OnAddButtonClick() 
    {
         ...
         var url = 'ClearingTax.aspx?id=' + 'ADD';
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center;">
                    <strong><span style="color: #000099">Clearing Fee</span></strong>
                </td>
            </tr>
            <tr>
                <td align="right">
...
--%>               
             <dxwgv:GridViewDataTextColumn Caption="Group" FieldName="r" VisibleIndex="2" Width="20%">
                ...
                <dxwgv:GridViewDataTextColumn Caption="Rate" FieldName="ClearingFee_Rate" VisibleIndex="5"
                    Width="4%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <dxwgv:GridViewDataTextColumn Caption="From Date" FieldName="ClearingFee_DateFrom" VisibleIndex="8"
                    Width="6%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
                ...
                <dxwgv:GridViewDataTextColumn Caption="Untill Date" FieldName="ClearingFee_DateTo" VisibleIndex="9"
                    Width="6%">
                    <CellStyle CssClass="gridcellleft">
                    </CellStyle>
                    <EditFormCaptionStyle HorizontalAlign="Right">
            ...
            <SettingsText PopupEditFormCaption="Add/ Modify " GroupPanel="Clearing Fee" />
        ...
        <asp:SqlDataSource ID="ServiceTaxDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:crmConnectionString %>"
            DeleteCommand="ClearingFee_delete" DeleteCommandType="StoredProcedure">
            <DeleteParameters>
