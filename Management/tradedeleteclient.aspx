<%@ page language="C#" autoeventwireup="true" inherits="management_tradedeleteclient, App_Web_e81qjzgk" %>
                                    ...
                                    <td class="gridcellleft">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlTYPE" Enabled="false" runat="server" Width="150px" Font-Size="10px" onchange="fn_expla(this.value)">
                                                        <asp:ListItem Value="1">All Trades</asp:ListItem>
                                                        <asp:ListItem Value="2">Unidentified Trade</asp:ListItem>
