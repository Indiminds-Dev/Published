<%@ page language="C#" autoeventwireup="true" inherits="management_CorporateActionAdjForDividend, App_Web_dw8rtpla" %>
...
<head id="Head1">
    <title>Extra-Ordinary Dividend Adjustment</title>
   ...
   function AlertGenerate()
    {        
       FnGetDateStore();
           ...
           var answer = confirm ("You have opted To "+document.getElementById('dllGenerate').value+" Corp-Action Adjustment Trades for "+document.getElementById("txtAsset").value+" as of "+document.getElementById('HiddenField_GetDateStore').value+" . Are You Sure You Want To Proceed?");
            if (answer==true)
            {
                var answer1 = confirm ("You have opted To "+document.getElementById('dllGenerate').value+" Corp-Action Adjustment Trades for "+document.getElementById("txtAsset").value+" as of "+document.getElementById('HiddenField_GetDateStore').value+" . Are You Really Sure You Want To Proceed?");
                if(answer1==true)
                {
                    var answer2 = confirm ("You have opted To "+document.getElementById('dllGenerate').value+" Corp-Action Adjustment Trades for "+document.getElementById("txtAsset").value+" as of "+document.getElementById('HiddenField_GetDateStore').value+" . Are You Really Sure You Want To Proceed?");
                    if(answer2==true)
                    {
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" style="text-align: center;">
                    <strong><span style="color: #000099">Extra-Ordinary Dividend Adjustment</span></strong>
                </td>
            </tr>
        </table>
                ...
                <td class="gridcellleft">
                    <table width="100%" style="border: solid 1px Black" border="0" cellpadding="0">
                        <tr>
                            ...
                            <td style="color: Red;">
                                Please run the entire day end process of the Previous Working Day of Ex-Date before proceeding with this adjustment routine
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td class="gridcellleft">
                    <table border="10" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtAsset" runat="server" Width="250px" onkeyup="FunCallAjaxList(this,event)"
            ...
            <tr>
                <td class="gridcellleft">
                    <table border="10" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="gridcellleft" bgcolor="#b7ceec">
                                Dividend Amount (To Adjust) :
                            </td>
                            <td>
                                <dxe:ASPxTextBox ID="txtAdjFact" runat="server" HorizontalAlign="Right" Width="100px">
                                  <masksettings mask="&lt;0..9999999999g&gt;.&lt;00..999999&gt;" includeliterals="DecimalSymbol" />
                                    <validationsettings errordisplaymode="None">
                                                     </validationsettings>
                                </dxe:ASPxTextBox>
                            </td>
                            <td class="gridcellleft"><b>[</b>&nbsp;Please Refer the relevant Exchange Circular to this effect&nbsp;<b>]</b></td>
                        </tr>
                    </table>
                </td>
            </tr>
                ...
                <td class="gridcellleft">
                    <table border="10" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td>
                                <dxe:ASPxDateEdit ID="DtExDate" runat="server" EditFormat="Custom" UseMaskBehavior="True"
                                    Font-Size="10px" Width="108px" ClientInstanceName="DtExDate">
