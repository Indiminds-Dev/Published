<%@ page language="C#" autoeventwireup="true" inherits="management_frm_attendance_employeeWise, App_Web_zsukfi_p" %>
...
<head runat="server">
    <title>Attendance Employee Wise</title>
            ...
            <tr>
                <td>
                    <table>
                        <tr>
                            <td>
                                <dxe:ASPxComboBox ID="cmbCompany" runat="server" Font-Size="10px" ValueType="System.String"
                                    Font-Bold="False" EnableIncrementalFiltering="true" ClientInstanceName="company">
                            ...
                            <td class="gridcellleft" style="width: 50px">
                                <dxe:ASPxComboBox ID="cmbBranch" runat="server" ValueType="System.String" Width="130px"
                                    Font-Size="10px" EnableIncrementalFiltering="True" EnableTheming="False" Height="10px"
                                    Font-Overline="False" ClientInstanceName="branch">
                                    <buttonstyle width="13px">
                                    </buttonstyle>
                            ...
                            <td style="width: 81px; text-align: left">
                                <dxe:ASPxDateEdit ID="cmbFromdate" runat="server" DateOnError="Today" EditFormat="Custom"
                                    Font-Size="10px" Width="131px" UseMaskBehavior="True" NullText="From Date">
                                    <buttonstyle width="13px">
                                    </buttonstyle>
                            ...
                            <td style="width: 81px; text-align: left">
                                <dxe:ASPxDateEdit ID="cmbDate" runat="server" DateOnError="Today" EditFormat="Custom"
                                    Font-Size="10px" Width="131px" UseMaskBehavior="True" NullText="To Date">
                                    <buttonstyle width="13px">
                                    </buttonstyle>
