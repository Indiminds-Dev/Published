<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_INPXTRADES, App_Web_amufh4kc" %>
                                        ...
                                        <td style="width: 100px">
                                            <dxe:ASPxComboBox ID="ComboChooseFile" runat="server" ClientInstanceName="cComboChooseFile"
                                                ...
                                                <Items>
                                                    ...
                                                    <dxe:ListEditItem Value="1" Text="AOne Trade Files"></dxe:ListEditItem>
                                                    <dxe:ListEditItem Value="2" Text="Opening Trades From POS Files"></dxe:ListEditItem>
                                                </Items>
