<%@ page language="C#" autoeventwireup="true" inherits="management_frmOfflineBatch_Cdsl, App_Web_njtlujlb" %>
...
<head runat="server">
    <title>Import CDSL Offline Batch</title>
        ...
        <asp:Panel ID="Panelmain" runat="server" Visible="true" HorizontalAlign="Center">
                <table id="tbl_main" class="login" cellspacing="0" cellpadding="0" width="410"
                    ...
                    <tbody>
                        <tr>
                            <td class="EHEADER">
                                <span style="color: blue"><strong> CDSL Offline Batch</strong></span></td>
                        </tr>
                        <tr>
                            <td class="lt">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="right" style="width: 278px" colspan="2" >
                                                <asp:FileUpload ID="CDSLSelectFile" runat="server" Width="272px" Height="21px" />
                                            </td>
                                        </tr>
                                         <tr>
                                               <td colspan="2">
