<%@ page language="C#" autoeventwireup="true" inherits="management_frm_UOMConversion, App_Web_gflohp-r" %>
    ...
    function PopulateGrid(obj)
 {
   ...
   grid.PerformCallback(obj);
    ...
    function Changestatus(obj)
    {
      ...
      editwin=dhtmlmodal.open("Editbox", "iframe", URL, "Add/Edit Conversion Multiplier", "width=995px,height=300px,center=0,resize=1,top=-1", "recal");                 
                ...
                <tr>
                    <td>
                        <dxwgv:ASPxGridView ID="grdDocuments" runat="server" AutoGenerateColumns="False"
                            KeyFieldName="tmpconversion_id" Width="98%" OnRowDeleting="grdDocuments_RowDeleting" ClientInstanceName="grid"
                            ...
                            <Columns>
                                <dxwgv:GridViewDataTextColumn FieldName="tmpconversion_id" ReadOnly="True" VisibleIndex="0"
                                    Visible="false">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="tmpconversion_fromuomname" Caption="From Conversion Name" Width="25%" ReadOnly="True"
                                    VisibleIndex="0">
                                    <CellStyle HorizontalAlign="left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="tmpconversion_touomname" Caption="To Conversion Name" Width="25%"
                                    VisibleIndex="1" Visible="true">
                                    <CellStyle HorizontalAlign="left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="tmpconversion_multiplier" Caption="Converted Multipier" Width="25%"
                                    VisibleIndex="2">
                                    <CellStyle HorizontalAlign="left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                               ...
                               <dxwgv:GridViewDataTextColumn FieldName="change" Caption="Change Combination" Width="15%" VisibleIndex="3">
                                    <CellStyle HorizontalAlign="left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
