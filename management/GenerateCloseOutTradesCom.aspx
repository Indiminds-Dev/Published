<%@ page language="C#" autoeventwireup="true" inherits="management_GenerateCloseOutTradesCom, App_Web_alid8jfz" %>
...
<head id="Head1" runat="server">
    <title>Arbitrage Close Out Trades (Process)</title>
          ...
          $get('UpdateProgress1').style.display = 'none'; 
            ...
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Arbitrage Close Out Trades (Process)</span></strong></td>
