<%@ page language="C#" autoeventwireup="true" inherits="management_OfferLetter_VarifyCandidate, App_Web_x5xbqja1" %>
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" style="text-align: center;">
                        <strong><span style="color: #000099">Verify Offer Letter</span></strong>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <%--    <div style="width:970px;overflow:scroll;">--%>
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <dxwgv:ASPxGridView ID="GridMessage" ClientInstanceName="grid" runat="server" Width="980px"
...
<dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="11" FieldName="VarifyUser" Caption="Verified By">
<EditFormSettings Visible="False"></EditFormSettings>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataTextColumn ReadOnly="True" VisibleIndex="12" FieldName="VaryfyDate" Caption="Verify Date">
<EditFormSettings Visible="False"></EditFormSettings>
</dxwgv:GridViewDataTextColumn>
...
<DataItemTemplate>
                                     ...
                                     <a href="javascript:void(0);" onclick="OnMoreInfoClick('<%# Container.KeyValue %>')">
                                                <span style="color:Maroon;width:30px;" >More Info</span></a> &nbsp;&nbsp; &nbsp;&nbsp;  <a href="javascript:void(0);" onclick="OnMoreAccessCick('<%# Container.KeyValue %>')">
                                                        <span style="color:Maroon;width:30px;" >Verify</span></a> &nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" onclick="DeleteRow('<%# Container.KeyValue %>')">
                                                   <span style="color:Maroon;width:30px;" > Delete</span></a>
                                            <%} %>
