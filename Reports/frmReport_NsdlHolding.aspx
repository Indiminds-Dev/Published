<%@ page language="C#" autoeventwireup="true" inherits="Reports_frmReport_NsdlHolding, App_Web_rvnctcoh" enableeventvalidation="false" %>
            ...
            <div class="left">
                <div id="filter" class="frmContent left" style="width: 500px;">
                    ...
                    <div id="tdSettlementLabel">
                        ...
                        <div id="tdrbSettlement" class="frmleftContent" style="width: 125px; padding-top: 3px;
                            font-size: 12px;">
                    ...
                    <div id="divReportView">
                        ...
                        <div class="frmleftContent" style="width: 160px; padding-top: 3px; font-size: 12px;">
                    ...
                    <div id="divCalHoldingValue">
                        <div class="frmleftContent" style="width: 22px; padding-top: 3px; font-size: 12px;">
                            <asp:CheckBox ID="chkCalHoldingValue" Checked="true" runat="Server" />
                        </div>
                        <div class="frmleftContent" style="width: 210px; line-height: 20px">
                    ...
                    <div id="div2">
                        <div class="frmleftContent" style="width: 22px; padding-top: 3px; font-size: 12px;">
                            <asp:CheckBox ID="chkShowUCC" Checked="false" runat="Server" />
                        </div>
                        <div class="frmleftContent" style="width: 210px; line-height: 20px">
                            <asp:Label ID="Label2" runat="server" Text="Show UCC"></asp:Label>
                        </div>
                    </div>
            ...
            <ContentTemplate>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td width="10%" bgcolor="white">
                                <%--Mobile:--%>
                                <asp:Label ID="lblMobile" runat="server" Font-Bold="True" Text="Label"></asp:Label>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div style="background-color: white" id="griddiv" runat="server">
                    <dxwgv:ASPxGridView ID="gridHolding" runat="server" Width="100%" ClientInstanceName="grid"
                        ...
                        <Columns>
                            <dxwgv:GridViewDataTextColumn FieldName="NsdlHolding_ISIN" Caption="ISIN No." VisibleIndex="0">
                            ...
                            <dxwgv:GridViewDataTextColumn FieldName="CmpName" Caption="ISIN Name" VisibleIndex="1"
                                Width="80">
                                <Settings FilterMode="DisplayText" AutoFilterCondition="Contains"></Settings>
                            ...
                            <dxwgv:GridViewDataTextColumn FieldName="NsdlHolding_SettlementNumber" Caption="SettlementID"
                                VisibleIndex="2">
                                <Settings FilterMode="DisplayText" AutoFilterCondition="Contains"></Settings>
                                <CellStyle CssClass="gridcellleft" Wrap="False">
                                </CellStyle>
                            ...
                            <dxwgv:GridViewDataTextColumn FieldName="Total" UnboundType="Integer" Caption="Current Balance"
                                VisibleIndex="4">
                            ...
                            <dxwgv:GridViewDataTextColumn FieldName="Free" UnboundType="Integer" Caption="Free"
                                VisibleIndex="5">
                                <Settings AllowAutoFilter="False"></Settings>
                                <CellStyle HorizontalAlign="Right" CssClass="gridcellleft" Wrap="False">
                                </CellStyle>
                            ...
                            <dxwgv:GridViewDataTextColumn FieldName="Pledged" UnboundType="Integer" Caption="Pledged/Blocked"
                                VisibleIndex="6">
                                <PropertiesTextEdit DisplayFormatString="#.###">
                                </PropertiesTextEdit>
                                <Settings AllowAutoFilter="False"></Settings>
                            ...
                            <dxwgv:GridViewDataTextColumn FieldName="Remat" UnboundType="Integer" Caption="Pending Remat"
                                VisibleIndex="7">
                                <Settings AllowAutoFilter="False"></Settings>
                                <CellStyle HorizontalAlign="Right" CssClass="gridcellleft" Wrap="False">
                                </CellStyle>
                            ...
                            <dxwgv:GridViewDataTextColumn FieldName="Demat" UnboundType="Integer" Caption="Pending Demat"
                                VisibleIndex="8">
                                <Settings AllowAutoFilter="False"></Settings>
                                <CellStyle HorizontalAlign="Right" CssClass="gridcellleft" Wrap="False">
                                </CellStyle>
                            ...
                            <dxwgv:GridViewDataTextColumn FieldName="Rate" Caption="Rate" VisibleIndex="9">
                                <Settings AllowAutoFilter="False"></Settings>
                                <CellStyle HorizontalAlign="Right" CssClass="gridcellleft" Wrap="False">
                                </CellStyle>
                            ...
                            <dxwgv:GridViewDataTextColumn FieldName="Rate_Date" Caption="Rate Date" VisibleIndex="10">
                                <Settings AllowAutoFilter="False"></Settings>
                                <CellStyle HorizontalAlign="Left" CssClass="gridcellleft" Wrap="False">
                                </CellStyle>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn FieldName="ISINValue" Caption="Value" VisibleIndex="11">
                                <Settings AllowAutoFilter="False"></Settings>
                                <CellStyle HorizontalAlign="Right" CssClass="gridcellleft" Wrap="False">
                                </CellStyle>
                        ...
                        <TotalSummary>
                            <dxwgv:ASPxSummaryItem FieldName="Total" ShowInColumn="Current Balance" ShowInGroupFooterColumn="Current Balance"
                                SummaryType="Sum" DisplayFormat="#,##,###.##" />
                            <dxwgv:ASPxSummaryItem FieldName="Free" ShowInColumn="Free" ShowInGroupFooterColumn="Free"
                                SummaryType="Sum" DisplayFormat="#,##,###.##" />
                            <dxwgv:ASPxSummaryItem FieldName="Pledged" ShowInColumn="Pledged/Blocked" ShowInGroupFooterColumn="Pledged/Blocked"
                                SummaryType="Sum" DisplayFormat="#,##,###.##" />
                            <dxwgv:ASPxSummaryItem FieldName="Remat" ShowInColumn="Pending Remat" ShowInGroupFooterColumn="Pending Remat"
                                SummaryType="Sum" DisplayFormat="#,##,###.##" />
                            <dxwgv:ASPxSummaryItem FieldName="Demat" ShowInColumn="Pending Demat" ShowInGroupFooterColumn="Pending Demat"
                                SummaryType="Sum" DisplayFormat="#,##,###.##" />
