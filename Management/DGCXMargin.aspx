<%@ page language="C#" autoeventwireup="true" inherits="management_DGCXMargin, App_Web_jdrimxnc" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>DGCX Margin</title>
...
<body>
    ...
    <div>
        <asp:Panel ID="Panelmain" runat="server" HorizontalAlign="Center" Style="z-index: 100;
            ...
            <table id="tbl_main" cellpadding="0" cellspacing="0" class="login" width="610" style="border: solid 1px blue">
                <tbody>
                    <tr>
                        <td class="EHEADER">
                            <span style="color: blue"><strong>DGCX Margin</strong></span></td>
                    </tr>
                    <tr>
                        <td class="lt">
                                ...
                                <tbody>
                                    <tr>
                                        <td align="right" style="width: 278px">
                                            <asp:FileUpload ID="DGCXMarginSelectFile" runat="server" Height="21px" Width="572px" />
                                        </td>
                                    </tr>
                                    <tr>
