<%@ control language="C#" autoeventwireup="true" inherits="Headermain, App_Web_psdiigfa" %>
...
<script type="text/javascript" language="javascript">
    ...
    {
        //alert(URL);
//        var IFRAME=document.getElementById("IFRAME_ForAllPages");
//        alert(IFRAME);
        //parent.IFRAME_ForAllPages.location=URL;
        parent.menuCall(URL);
    }
</script>
                        ...
                        <td colspan="2" style="height: 50px; padding-bottom: 5; padding-left: 5; padding-bottom: 5;
                            ...
                            <table style="width: 100%;" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    ...
                                    <%--<td style="width:150px; vertical-align:middle;background-color:#FFFFFF; border-top:solid 1px #4B6CA1; border-bottom:solid 1px #4b6ca1;"><img src="../images/logo.jpg" width="261" height="61" alt="A" /></td>--%>
                                    <td style="width: 100px; vertical-align: middle; background-color: #FFFFFF;">
                                        <img src="../images/logo.jpg" width="261" height="61" alt="A" /></td>
                                                        ...
                                                        <table id="tblSegment" runat="server">
                                                            ...
                                                            <tr>
                                                                <td class="gridcelleft"  style="text-align: left" colspan="2">
                                                                    ...
                                                                    <span style="color: #ff9966">|</span>
                                                                    <asp:Label ID="lblfundPayeeDate" runat="server" Font-Size="10px" ForeColor="Navy" Font-Bold="True"></asp:Label>
                                                                </td>
