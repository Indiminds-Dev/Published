<%@ page language="C#" autoeventwireup="true" inherits="management_DGCXCOMMPosition, App_Web_ng-agpzn" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>DGCX Final-Settlement Trades</title>
    ...
    <form id="form1" runat="server">
        <div align="center">
            <asp:Panel ID="Panelmain" runat="server" Visible="true">
                <table id="tbl_main" class="login" cellspacing="0" cellpadding="0" width="470">
                    <tbody>
                        <tr>
                            <td class="lt1">
                                <h5>
                                    Imports Position Files To Compare BO Positions and Generate Final Settlement Trades when present
                                </h5>
                            </td>
                        </tr>
                        <tr>
                                                        ...
                                                        <tr>
                                                            <td class="lt">
                                                                <table>
                                                                            ...
                                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                                                <ContentTemplate>
                                                                                    <asp:DropDownList ID="ddlFileList" runat="server" Width="210px" AutoPostBack="True"
                                                                                        ...
                                                                                        <asp:ListItem Value="1">DGCX_POSITION File</asp:ListItem>	
                                                                                    </asp:DropDownList><br />
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="lblMismatchMsg" runat="server" Font-Size="10px" Font-Names="Arial"
                                                                    Font-Bold="True" ForeColor="blue" />
                                                                            <asp:LinkButton ID="lnkMismatch" Font-Underline="true" runat="server" Font-Size="XX-Small" Font-Names="Arial" Font-Bold="True" ForeColor="Blue" OnClick="lnkMismatch_Click">BO Position not tallying with the Exchange File. Click to View the Differences</asp:LinkButton>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="lblFinalSett" runat="server" Font-Size="11px" Font-Names="Arial"
                                                                    Font-Bold="True" ForeColor="blue" />
                                                                            <asp:LinkButton ID="lnkFinalSett" runat="server" Font-Underline="true" Font-Size="XX-Small" Font-Names="Arial" Font-Bold="True" ForeColor="Blue" OnClick="lnkFinalSett_Click" >Final Settlement Trades Imported! Click to View Trade Summary</asp:LinkButton>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
