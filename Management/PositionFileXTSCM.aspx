<%@ page language="C#" autoeventwireup="true" inherits="Reports_PositionFileXTSCM, App_Web_im-ehkhh" %>
...
<head id="Head1" runat="server">
    <title>Position File For XTS</title>
        ...
        <table class="TableMain100">
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Position File For XTS</span></strong></td>
