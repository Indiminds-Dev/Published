<%@ page language="C#" autoeventwireup="true" inherits="management_edit_verification, App_Web_gflohp-r" maintainscrollpositiononpostback="true" %>
    ...
    <form id="form1" runat="server" autocomplete="Off">
        ...
        <asp:ScriptManager id="ScriptManager1" runat="server">
            ...
            <table style="width: 860px; height: 59px">
                <tr>
                    <td colspan="3" style="font-size: 10pt; color: #996600; text-align: left">
                        &nbsp; &nbsp;Client id:&nbsp;
                    ...
                    <div align="center">
                        <table id="Table2" border="0" style="width: 90%; background-color: #ddecfe">
                            ...
                            <tr id="TrCostPrice">
                                ...
                                <td style="text-align: left">
                                    &nbsp;<asp:TextBox ID="TextBox3" runat="server" TabIndex="11" Width="250px"></asp:TextBox></td>
                                <td style="text-align: left">
                                </td>
                                <td style="text-align: left">
                                    &nbsp;</td>
                            ...
                            <tr>
                                <td style="text-align: left">
                        DPID<asp:TextBox ID="txtdpid3" runat="server" ReadOnly="True" Width="50px"></asp:TextBox></td>
