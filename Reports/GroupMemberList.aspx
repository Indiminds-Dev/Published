<%@ page language="C#" autoeventwireup="true" inherits="Reports_GroupMemberList, App_Web_hnkxxmul" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="TableMain100">
                ...
                <tr>
                    <td>
                        <dxwgv:ASPxGridView ID="GroupMembers" runat="server" AutoGenerateColumns="False"
                            ...
                            <columns>
                                <dxwgv:GridViewDataTextColumn FieldName="grp_id" ReadOnly="True" VisibleIndex="0"
                                    Visible="true" Caption="Group ID">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dxwgv:GridViewDataTextColumn>
                                 <dxwgv:GridViewDataTextColumn FieldName="GroupName" caption="Group Name" ReadOnly="True" VisibleIndex="0">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dxwgv:GridViewDataTextColumn>
                                
                                  <dxwgv:GridViewDataTextColumn FieldName="grp_groupType" caption="group Type" ReadOnly="True" VisibleIndex="0" width="100px">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dxwgv:GridViewDataTextColumn>
                                
                                <dxwgv:GridViewDataTextColumn FieldName="MembersName" caption="Members Name" ReadOnly="True" VisibleIndex="0">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dxwgv:GridViewDataTextColumn>
                                 <dxwgv:GridViewDataTextColumn FieldName="Cnt_UCC" caption="Code" ReadOnly="True" VisibleIndex="0" width="70px">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="branch_desc"  caption="Branch Name" VisibleIndex="1">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn FieldName="branch_Code" caption="Branch Code" ReadOnly="True" VisibleIndex="2" width="60px">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dxwgv:GridViewDataTextColumn>
