<%@ page language="C#" autoeventwireup="true" inherits="management_AssetMap, App_Web_d3reltht" %>
...
<body style="margin: 0px 0px 0px 0px; background-color: #DDECFE" onload="clearPreloadPage()">
    ...
    function PopulateGrid(obj)
 {
   ...
   grid.PerformCallback(obj);
    ...
    {
      var URL="Assetmapping.aspx?id="+obj;
                        ...
                        <dxwgv:ASPxGridView ID="gridasset" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                               ...
                               <%-- //------------------------------------------%>
                                 ...
                                 <dxwgv:GridViewDataTextColumn FieldName="AssetMap_RTSCode" Caption="RTS/AOne/CQG/ATIN"
                                     VisibleIndex="6">
                                    <CellStyle CssClass="gridcellleft" Wrap="False">
                                                            </CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                  ...
                                  <dxwgv:GridViewDataTextColumn FieldName="AssetMap_XCode" Caption="XTrader/PAT"
                                     VisibleIndex="7">
                                    <CellStyle CssClass="gridcellleft" Wrap="False">
                                                            </CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                               ...
                               <%-- //----------------------------------------------%>
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="TradingLot" FieldName="Tradlotuom" VisibleIndex="8">
                                 <CellStyle CssClass="gridcellleft" Wrap="False">
                                                            </CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                
                                <dxwgv:GridViewDataTextColumn Caption="QLot" FieldName="Qlotuom" VisibleIndex="9">
                                 <CellStyle CssClass="gridcellleft" Wrap="False">
                                                            </CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="Currency" FieldName="Qcurrency" VisibleIndex="10">
                                 <CellStyle CssClass="gridcellleft" Wrap="False">
                                                            </CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                <%--New Work--%>
                                <dxwgv:GridViewDataTextColumn FieldName="AssetMap_AarnaCode" Caption="Aarna"
                                     VisibleIndex="11">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                
                                <dxwgv:GridViewDataTextColumn FieldName="AssetMap_BerkCode" Caption="Berk"
                                     VisibleIndex="12">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                
                                <dxwgv:GridViewDataTextColumn FieldName="AssetMap_PhillipCode" Caption="Phillip"
                                     VisibleIndex="13">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                
                                <dxwgv:GridViewDataTextColumn FieldName="AssetMap_DGCXCode" Caption="DGCX"
                                     VisibleIndex="14">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                
                                <dxwgv:GridViewDataTextColumn FieldName="AssetMap_OrientCode" Caption="Orient"
                                     VisibleIndex="15">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                
                                <dxwgv:GridViewDataTextColumn FieldName="AssetMap_BPICode" Caption="BPI"
                                     VisibleIndex="16">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                
                                <dxwgv:GridViewDataTextColumn FieldName="AssetMap_EDFCode" Caption="EDF"
                                     VisibleIndex="17">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                
                                <dxwgv:GridViewDataTextColumn FieldName="AssetMap_NseFOCode" Caption="NseFO"
                                     VisibleIndex="18">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                
                                <dxwgv:GridViewDataTextColumn FieldName="AssetMap_NseCDCode" Caption="NseCD"
                                     VisibleIndex="19">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                
                                <dxwgv:GridViewDataTextColumn FieldName="AssetMap_MCXCode" Caption="MCX"
                                     VisibleIndex="20">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>                                
                                ...
                                <%--New Work 13Feb2023--%>
                                <dxwgv:GridViewDataTextColumn FieldName="AssetMap_KGICode" Caption="KGI"
                                     VisibleIndex="21">
                                    <CellStyle CssClass="gridcellleft" Wrap="False"></CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>                                
                                ...
                                <dxwgv:GridViewDataTextColumn FieldName="change" Caption="Modify" 
                                    VisibleIndex="22">
                                    <CellStyle CssClass="gridcellleft" Wrap="False">
                                                            </CellStyle>
                                    <HeaderStyle HorizontalAlign="left" />
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewCommandColumn VisibleIndex="23" Width="10%">
