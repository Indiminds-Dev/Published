<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="management_TradeIncentiveTax, App_Web_jdrimxnc" %>
                            ...
                            <tr>
                                <td style="text-align: center">
                                    <table style="border: solid 1px blue; width: auto">
                                        <tr>
                                            <td class="Ecoheadtxt" style="text-align: left; width: 38%;">
                                                <dxe:ASPxLabel ID="lbl6" runat="server" Width="40px" Text="Group:">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td class="Ecoheadtxt" style="text-align: left;">
                                                <asp:TextBox ID="txtGroup" Width="309px" runat="server" Font-Size="11px"></asp:TextBox>&nbsp;
                                                <asp:TextBox ID="txtGroup_hidden" runat="server" Width="14px" Style="display: none"></asp:TextBox></td>
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Company Name:" Width="90px" ID="ASPxLabel1">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left; width: 78%;" class="Ecoheadtxt">
                                            ...
                                            <td class="Ecoheadtxt" id="tdlevelsegment" runat="server" style="width: 80%">
                                       ...
                                       <%-- ----- Row 1-----
                                        ...
                                        <tr id="tr_1">
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Narration For Billing:" ID="ASPxLabel3">
                                                </dxe:ASPxLabel>
                                            </td>
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Revenue Account [Main]:" ID="ASPxLabel5">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left" class="Ecoheadtxt">
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Revenue Account [Sub]:" ID="ASPxLabel4">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left" class="Ecoheadtxt">
                                        ...
                                        -----------Row 2 ------- --%>
                                         ...
                                         <tr id="tr_2">
                                            <td class="Ecoheadtxt" style="text-align: left; width: 38%;">
                                                <dxe:ASPxLabel runat="server" Text="Product Type:" ID="ASPxLabel17">
                                                </dxe:ASPxLabel>
                                        ...
                                        <%------------ Row 3 --------%>
                                          ...
                                          <tr id="tr_3">
                                            <td class="Ecoheadtxt" style="text-align: left; width: 38%; height: 25px;">
                                                <dxe:ASPxLabel runat="server" Text="Exchange:" ID="ASPxLabel19">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left; height: 25px;" class="Ecoheadtxt">
                                              
                                               <asp:TextBox ID="TxtExchange" runat="server" onkeyup="FunCallAjaxList(this,event,'Exchange')"  Width="284px" ></asp:TextBox>
                                            ...
                                            <td style="text-align: left; width: 78%; height: 25px;" class="Ecoheadtxt">
                                            
                                                <asp:DropDownList runat="server" Width="129px" ID="ddlTradeType">
                                                    <asp:ListItem Value="0">Any</asp:ListItem>
                                                    <asp:ListItem Value="1">Active</asp:ListItem>
                                                    <asp:ListItem Value="2">Passive</asp:ListItem>
                                                    <asp:ListItem Value="3">OpenPosition</asp:ListItem>
                                                    
                                                </asp:DropDownList>
                                               
                                            </td>
                                            <td class="Ecoheadtxt" style="text-align: left; width: 80%; height: 25px;">
                                                <dxe:ASPxLabel runat="server" Text="Transaction Type:" ID="ASPxLabel21" Width="131px">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left; height: 25px;" class="Ecoheadtxt">
                                               
                                                <asp:DropDownList runat="server" Width="118px" ID="ddlTransactionType">
                                                    <asp:ListItem Value="0">Any</asp:ListItem>
                                         ...
                                         <%------------ Row 4 --------%>
                                          ...
                                          <tr id="tr_4">
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left; width: 80%;">
                                                <dxe:ASPxLabel runat="server" Text="Calculated On:" ID="ASPxLabel25" Width="120px">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left" class="Ecoheadtxt">
                                               ...
                                               <td id="tr_ddlcalculatedOn">
                                                ...
                                                <asp:DropDownList runat="server" Width="129px" ID="ddlcalculatedOn">
                                                    ...
                                                    <asp:ListItem Value="2">Per Trade</asp:ListItem>         
                                          ...
                                          <tr id="tr_5">
                                            <td id="td_Decimal_l" class="Ecoheadtxt" style="text-align: left; width: 38%;">
                                                <dxe:ASPxLabel runat="server" Text="Decimals:" ID="ASPxLabel26">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td id="td_Decimal_v" style="text-align: left" class="Ecoheadtxt">
                                            ...
                                            <td id="td_round_l" class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Round Off Pattern:" ID="ASPxLabel27">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td id="td_round_v" style="text-align: left; width: 78%;" class="Ecoheadtxt">
                                            ...
                                            <tr>
                                             ...
                                             <td id="td_Min_l" class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Min Amount/Unit:" ID="ASPxLabel28">
                                                </dxe:ASPxLabel>
                                            </td>
                                            ...
                                            <td id="td_Min_v" style="text-align: left" class="Ecoheadtxt">
                                             ...
                                             <td id="td2" class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="Max Amount/Unit:" ID="ASPxLabel32">
                                                </dxe:ASPxLabel>
                                            </td>
                                         ...
                                         <%------------ Row 6 --------%>
                                          ...
                                          <tr id="tr_6">
                                            <td class="Ecoheadtxt" style="text-align: left; width: 38%;">
                                                <dxe:ASPxLabel runat="server" Text="Fee Currency:" ID="ASPxLabel29">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left" class="Ecoheadtxt">
                                            ...
                                            <td class="Ecoheadtxt" style="text-align: left">
                                                <dxe:ASPxLabel runat="server" Text="ServTax/GST Applicable:" ID="ASPxLabel30">
                                                </dxe:ASPxLabel>
                                            </td>
                                            <td style="text-align: left; width: 78%;" class="Ecoheadtxt">
                                             ...
                                             <td id="td1" class="Ecoheadtxt" style="text-align: left; width: 80%;">
                                ...
                                <td colspan="1" class="Ecoheadtxt" style="text-align: left">
                                </td>
                                </tr>
