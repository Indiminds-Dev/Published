<%@ page language="C#" autoeventwireup="true" inherits="Reports_SettlementTrialNSEFO, App_Web_tuwtz_6w" %>
            ...
            <table class="TableMain100">
                <tr>
                    ...
                    <td class="EHEADER" width="15%" id="Tr_Filter" style="height: 22px">
                        <a href="javascript:void(0);" onclick="FnAlert('8');"><span style="color: Blue; text-decoration: underline;
                                        ...
                                        <tr>
                                            ...
                                            <td class="gridcellleft" bgcolor="#B7CEEC">
                                              ...
                                              <td>
                                                ...
                                                <asp:DropDownList ID="dllrptview" runat="server" Width="150px" Font-Size="10px" onchange="dllrptview_ChangeValue(this.value)">
