<%@ page language="C#" autoeventwireup="true" inherits="management_frm_ProfitLossStatement, App_Web_yf04ozfw" %>
                        ...
                        <tr>
                            ...
                            <td id="TdSelect" style="visibility: hidden">
                                <table>
                                    <tr>
                                        <td>
                                            <asp:ListBox ID="lstSegment" runat="server" Font-Size="10px" Height="90px" Width="253px">
                                            </asp:ListBox></td>
                                        <td>
            ...
            <tr>
                <td colspan="4">
                    <div id="MainContainer" runat="server" class="TableMain100" style="border: solid 1px blue;
                        text-align: center" visible="true">
                    </div>
                </td>
            </tr>
        </table>
