<%@ page language="C#" autoeventwireup="true" inherits="management_BrokerageChargesMemberList, App_Web_ng-agpzn" %>
    ...
    <form id="form1" runat="server">
        <div>        
            <table class="TableMain100">
                ...
                <tr>
                    <td>
                        <dxwgv:ASPxGridView ID="GroupMembers" runat="server" AutoGenerateColumns="False"  datasourceid="chargegroupDataSource"
                            ...
                            <columns>
                                <dxwgv:GridViewDataTextColumn FieldName="ID" ReadOnly="True" VisibleIndex="0"
                                   ...
                                   <dxwgv:GridViewDataTextColumn FieldName="BrokerageGroupName" caption="Charge Group Name" ReadOnly="True" VisibleIndex="0">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dxwgv:GridViewDataTextColumn>
                                  ...
                                  <dxwgv:GridViewDataTextColumn FieldName="GroupCode" caption="Charge Group Code" ReadOnly="True" VisibleIndex="0">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dxwgv:GridViewDataTextColumn>
                                
                                <dxwgv:GridViewDataTextColumn FieldName="CustomerName" caption="Members Name" ReadOnly="True" VisibleIndex="0">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dxwgv:GridViewDataTextColumn>
                                 <dxwgv:GridViewDataTextColumn FieldName="Code" caption="Code" ReadOnly="True" VisibleIndex="0">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dxwgv:GridViewDataTextColumn>
                                ...
                                <dxwgv:GridViewDataTextColumn FieldName="UntilDate" caption="Until Date" ReadOnly="True" VisibleIndex="2">
                                    <CellStyle HorizontalAlign="Left">
                                    </CellStyle>
                                    <HeaderStyle HorizontalAlign="Center" />
                                </dxwgv:GridViewDataTextColumn>
