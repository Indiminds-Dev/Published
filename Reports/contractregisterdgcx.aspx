<%@ page language="C#" autoeventwireup="true" inherits="Reports_contractregisterdgcx, App_Web__-dtd0z2" %>
                             ...
                             <div id="divgrid"  runat="Server" >  
                                <asp:GridView ID="grdContractRegister" runat="server"  BorderColor="CornflowerBlue"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="TradeFee" SortExpression="ContractNotes_TransactionCharges_Sorting">
                                            <ItemStyle Wrap="false" BorderWidth="1px" HorizontalAlign="Right"></ItemStyle>
                                            <HeaderStyle HorizontalAlign="Center" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
                                            ...
                                            <FooterTemplate>
                                                <asp:Label ID="lbltrancharge_sum" runat="server" Text='<%# Eval("tradefee")%>'
                                                    ForeColor="white"></asp:Label>
                                            </FooterTemplate>
                                            <FooterStyle HorizontalAlign="Right" VerticalAlign="Top" Font-Bold="True" ForeColor="White" />
                                        </asp:TemplateField>
                                        
                                        <asp:TemplateField HeaderText="ESCA Fee" SortExpression="ContractNotes_SEBIFee">
                                            <ItemStyle  Wrap="false"  BorderWidth="1px" HorizontalAlign="Right"  ></ItemStyle>
                                         ...
                                         <asp:TemplateField HeaderText="Clearing Fee" SortExpression="ContractNotes_DeliveryCharges">
                                            <ItemStyle  Wrap="false"  BorderWidth="1px" HorizontalAlign="Right"  ></ItemStyle>
                                            <HeaderStyle HorizontalAlign="Center" Wrap="false" Font-Bold="False" 
                                                ></HeaderStyle>
                                            <ItemTemplate>
                                       ...
                                       <%-- ------------------- RMS Fee Start ----------------------------------%>
                                          ...
                                          <asp:TemplateField HeaderText="Settlement Fee" SortExpression="TotalRMS_Sorting">
                                            <ItemStyle  Wrap="false"  BorderWidth="1px" HorizontalAlign="Right"  ></ItemStyle>
                                      ...
                                      <%--  ------------------------RMS Fee End----------------------------%>
                                        ...
                                        <asp:TemplateField HeaderText="Total VAT" SortExpression="TotalTax_Sorting">
                                            <ItemStyle Wrap="false" BorderWidth="1px" HorizontalAlign="Right"></ItemStyle>
                                            <HeaderStyle HorizontalAlign="Center" Wrap="false" Font-Bold="False"></HeaderStyle>
                                            <ItemTemplate>
