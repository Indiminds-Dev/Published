<%@ page language="C#" autoeventwireup="true" inherits="management_PLSharingSlabPopup, App_Web_alid8jfz" %>
             ...
             <table border="10" cellpadding="1" cellspacing="1">
              <tr>
                    <td class="gridcellleft" bgcolor="#B7CEEC">
                        Slab Type:</td>
                    <td>
                        <asp:DropDownList ID="DdlSlabType" runat="server" Width="100px" Font-Size="10px">
