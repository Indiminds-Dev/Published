<%@ page language="C#" autoeventwireup="true" inherits="management_GenerateDerivedPrices, App_Web_nidspgif" %>
...
<head id="Head1">
    <title>Generate Derived Prices For Products</title>
...
//            alert('Generate For Remaining Bills...');
        ...
        if(obj=="5")
        {
            ...
            window.location = "../Management/GenerateDerivedPrices.aspx";
        }
          ...
          $get('UpdateProgress1').style.display = 'none'; 
            ...
            <tr>
                <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                    <strong><span id="SpanHeader" style="color: #000099">Derived Prices</span></strong></td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" align="left">
                                                <asp:DropDownList ID="dllGenerate" runat="server" Width="200px" Font-Size="10px">
                                                    <asp:ListItem Value="G">Generate Derived Price</asp:ListItem>
                                                    <asp:ListItem Value="D">Revert To Original</asp:ListItem>
                                                </asp:DropDownList></td>
                                        </tr>
                                    </table>
                                </td>
