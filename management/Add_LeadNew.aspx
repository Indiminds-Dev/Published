<%@ page language="C#" autoeventwireup="true" inherits="management_Add_LeadNew, App_Web_akbpwr7y" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="TableMain100">
                ...
                <tr>
                    <td class="mylabel1" >
                        No. of Contact Alloted if no item select :<asp:TextBox ID="txtNoCont" Text="0" runat="server"
                        ...
                        <asp:Panel ID="pnlSearchCriteria" Width="100%" Visible="false" runat="server">
                            <table class="TableMain100">
                                <tr>
                                    ...
                                    <td colspan="2">
                                        &nbsp;<asp:TextBox ID="txtCon3" runat="server" Height="19px" Width="133px"></asp:TextBox></td>
                                </tr>
                                <tr>
                                    <td class="mylabel1">
                                        Created User :</td>
                                    ...
                                    <td class="mylabel1" colspan="3" style="border: solid 1px white">
                                        <table>
                                            <tr>
                                                ...
                                                <td class="mylabel1" style="height: 37px">
                                                    To :
                                                </td>
                                                <td valign="middle" style="height: 37px">
                                ...
                                <tr>
                                    <td class="mylabel1" style="height: 24px">
                                        Source Type :
                                    </td>
