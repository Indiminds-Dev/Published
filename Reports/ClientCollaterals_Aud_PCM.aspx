<%@ page language="C#" autoeventwireup="true" inherits="Reports_ClientCollaterals_Aud_PCM, App_Web_wt4jql-z" enableeventvalidation="false" %>
...
//            window.frameElement.width = document.body.scrollwidth;
  ...
  function FnCorpAc(obj)
  {
    ...
    function OnMoreInfoClick()
    {
        ...
        var url ="../GenericRoutines/Batch/GenericBatchMaintenance.aspx?FileType=ClientCollaterals&SqlWhere="+SqlWhere;
        parent.OnMoreInfoClick(url,"Holding Statement Batch Detail",'1150px','480px',"Y");
    }
    
    //New Work 09/05/2024
    function OnMoreInfoAudClick(KeyValue)
    {
     var url="ClientCollaterals_Aud_PCMpopup.aspx?id="+KeyValue;
//     var header='Split Trades For '+document.getElementById('txtClient').value;
    var header='Client Collaterals Allocation ';
      parent.OnMoreInfoClick(url,header,'1010px','450px',"Y");   
    }
    ...
    function GnrcCallBackPanel_Methods(WhichCall)
    {
        ...
        //New Work 09/05/2024
        cBatchDownload.SetEnabled(false);
        //End of New Work 09/05/2024
    ...
    function GnrcCallBackPanel_EndCallBack()
    {
        ...
        //New Work 09/05/2024
        cBatchDownload.SetEnabled(true);
        //End of New Work 09/05/2024
        if(cGnrcCallBackPanel.cpIsSpData!=undefined)
        {
            ...
            //New Work 09/05/2024
            else if(cGnrcCallBackPanel.cpIsSpData=="DownloadBatch")
                GetObjectID('btnBatchExport').click();
            //End of New Work 09/05/2024
            else 
        ...
        //New Work 09/05/2024
        if(cGnrcCallBackPanel.cpIsSpData=='Retention amounts found for clients. Please proceed to Allot Retention Reason Codes.')
        {
            btncheck();
            Show("Td_Refersh");
            Show("Td_DnBatch");
        ...
        if(cGnrcCallBackPanel.cpIsSpData=="DownloadBatch")
        {
            Hide('td_grid');
            Hide("Td_Refersh");
            Hide("Td_DnBatch");
   ...
   { 
            ...
            <table class="TableMain100">
                <tr>
                    <td class="EHEADER" colspan="0" style="text-align: center; height: 20px;">
                        <strong><span id="SpanHeader" style="color: #000099">Client Wise Collateral Report For PCM
                        </span></strong>
                    </td>
            ...
            <tr>
                ...
                <td>
                    <dxe:ASPxComboBox ID="CmbGenerate" runat="server" ClientInstanceName="cCmbGenerate"
                        ...
                        Width="200px">
                        <Items>
                            <dxe:ListEditItem Text="Detail working - Funds" Value="1" />
                            <dxe:ListEditItem Text="Detail Working - Collaterals" Value="2" />
                            <dxe:ListEditItem Text="Export Report" Value="3" />
                            <dxe:ListEditItem Text="Export Batch" Value="4" />
                            <dxe:ListEditItem Text="Export Report [Effective 20Jan2023]" Value="5" />
                            <dxe:ListEditItem Text="Export Batch [Effective 20Jan2023]" Value="6" />
                        </Items>
                ...
                <td id="Td_Batch" style="display: none">
                    <table>
                        <tr>
                            ...
                            <%--New Work 09/05/2024--%>
                            <td id="Td_DnBatch">
                                <dxe:ASPxButton ID="Abtn_BatchDownload" runat="server" AutoPostBack="False" ClientInstanceName="cBatchDownload"
                                    Text="Download Batch">
                                    <ClientSideEvents Click="function(s,e){GnrcCallBackPanel_Methods('DownloadBatch');}" />
                                </dxe:ASPxButton>
                            </td>
                            
                            <td id="Td_Refersh" class="gridcellleft"  colspan="4"> <input id="btn_show" type="button" value="Refresh" onclick="btncheck()" class="btnUpdate" visible="false" style="height:23px;width:101px;"/></td>
                            <%--End of New Work 09/05/2024--%>
                        </tr>
                        <tr>
       ...
       <div>
            <table>
                <tr>
                    <td id="td_grid">
                        <dxwgv:ASPxGridView ID="grdClientCollateralsAud" runat="server" ClientInstanceName="grid"
                            KeyFieldName="CCRetentionReason_ID" Width="100%" AutoGenerateColumns="False" OnCustomCallback="grdClientCollateralsAud_CustomCallback">
                           ...
                           <SettingsPager NumericButtonCount="20" Visible="False" Mode="ShowAllRecords">
                            ...
                            <Columns>
                                <dxwgv:GridViewDataTextColumn Caption="CCRetentionReason_ID" FieldName="CCRetentionReason_ID"
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="Client Code" FieldName="ClientCode" VisibleIndex="1">
                                    <CellStyle CssClass="gridcellleft">
                                    </CellStyle>
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="Retained by TM" FieldName="RetainedbyTM" VisibleIndex="2">
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="Reason Code TM" FieldName="ReasonCodeTM" VisibleIndex="3">
                                    <CellStyle CssClass="gridcellleft">
                                    </CellStyle>
                                    <EditFormCaptionStyle HorizontalAlign="Left" Wrap="False">
                                    </EditFormCaptionStyle>
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="Ret By CM" FieldName="RetByCM" VisibleIndex="4">
                                    <CellStyle CssClass="gridcellleft" HorizontalAlign="Right">
                                    </CellStyle>
                                    <EditFormCaptionStyle HorizontalAlign="Right" Wrap="False">
                                    </EditFormCaptionStyle>
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="Reason Code CM" FieldName="ReasonCodeCM" VisibleIndex="5">
                                    <CellStyle CssClass="gridcellleft">
                                    </CellStyle>
                                    <EditFormCaptionStyle HorizontalAlign="Left" Wrap="False">
                                    </EditFormCaptionStyle>
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="RC09 Notes" FieldName="RC09Notes" VisibleIndex="6">
                                    <CellStyle CssClass="gridcellleft">
                                    </CellStyle>
                                    <EditFormCaptionStyle HorizontalAlign="Left" Wrap="False">
                                    </EditFormCaptionStyle>
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="Update" Width="5%" VisibleIndex="7">
                                    <DataItemTemplate>
                                        <%--<a href="#" onclick="OnMoreInfoAudClick('<%# Container.KeyValue %>','<%# Eval("ClientName") %>')">Assign--%>
                                        <a href="#" onclick="OnMoreInfoAudClick('<%# Container.KeyValue %>')">Assign
                                    </DataItemTemplate>
                                </dxwgv:GridViewDataTextColumn>
                            </Columns>
