<%@ page language="C#" autoeventwireup="true" inherits="management_frm_AddInterviews, App_Web_5zwtjf_c" %>
                    ...
                    <td style="text-align: center; width: 100%;">
                        <table style="border: solid 2px white">
                            <tr>
                                ...
                                <td class="gridcellleft">
                                    <asp:TextBox ID="txtName" runat="server" Width="200px" Font-Size="10px" ValidationGroup="a"
                                ...
                                <td class="gridcellleft">
                                    <asp:DropDownList ID="drpIntInOrganisation" Width="203px" Font-Size="10px" runat="server"
                                        TabIndex="1">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="gridcellleft">
                                    <asp:TextBox ID="txtInterviewDate" runat="server" Font-Size="10px" ReadOnly="true"
                                ...
                                <td class="gridcellleft">
                                    <asp:DropDownList ID="drpInterestInPosition" runat="server" Width="203px" Font-Size="10px"
                                        TabIndex="2">
                                    </asp:DropDownList></td>
                            </tr>
                            <tr>
                                ...
                                <td class="gridcellleft">
                                    <asp:TextBox ID="txtInterviewPlace" runat="server" Width="200px" Font-Size="10px"
                                        ReadOnly="true"></asp:TextBox>
                                </td>
                                <td style="width: 17px">
                                </td>
                                ...
                                <td class="gridcellleft">
                                    <asp:DropDownList ID="drpCarretGoals" Width="203px" Font-Size="10px" runat="server"
                                        TabIndex="3">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="gridcellleft">
                                    <asp:TextBox ID="txtInterViewer" runat="server" Font-Size="10px" ReadOnly="true"
                                ...
                                <td class="gridcellleft">
                                    <asp:DropDownList ID="drpProblemSolvingSkills" Width="203px" Font-Size="10px" runat="server"
                                        TabIndex="4">
                                    </asp:DropDownList></td>
                            </tr>
                            <tr>
                                ...
                                <td class="gridcellleft">
                                    <asp:DropDownList ID="drpCommunicationSkills" Width="203px" Font-Size="10px" runat="server"
                                        TabIndex="5">
                                    </asp:DropDownList></td>
                                <td style="width: 17px">
                                </td>
                                ...
                                <td class="gridcellleft">
                                    <asp:DropDownList ID="drpLeadershipSkills" Width="203px" Font-Size="10px" runat="server"
                                        TabIndex="6">
                                    </asp:DropDownList></td>
                            </tr>
                            <tr>
                                ...
                                <td class="gridcellleft">
                                    <asp:DropDownList ID="drpPersonality" Width="203px" Font-Size="10px" runat="server"
                                        TabIndex="7">
                                    </asp:DropDownList>
                                </td>
                                <td style="width: 17px">
                                ...
                                <td class="gridcellleft">
                                    <asp:DropDownList ID="drpJobKnowledge" Width="203px" Font-Size="10px" runat="server"
                                        TabIndex="8">
                                    </asp:DropDownList></td>
                            </tr>
                            <tr>
                                ...
                                <td class="gridcellleft">
                                    <asp:DropDownList ID="drpSalesOrientationApproach" Width="203px" Font-Size="10px"
                                ...
                                <td class="gridcellleft">
                                    <asp:DropDownList ID="drpInterviewOutcome" Width="203px" Font-Size="10px" runat="server"
                                        TabIndex="10">
                            ...
                            <tr>
                                ...
                                <td class="gridcellleft" colspan="4">
                                    <asp:TextBox ID="txtRemarks" runat="server" TextMode="MultiLine" Width="99%" Font-Size="10px"
                                ...
                                <td style="width: 100%;" colspan="5">
                                    <asp:Panel ID="pnlSelected" runat="server" Width="100%">
                                        <table style="width: 100%;">
                                            <tr>
                                                <td colspan="5" style="background-color: #92cfff">
                                                ...
                                                <td>
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td class="gridcellleft">
                                                                <asp:TextBox ID="txtApprovedCTC" Text="0" runat="server" Width="200px" Font-Size="10px"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="gridcellleft" colspan="4">
                                                                <asp:TextBox ID="txtEliminationReason" TabIndex="18" TextMode="MultiLine" runat="server"
                                                                    Rows="5" Width="99%" Height="50px" Font-Size="10px"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
