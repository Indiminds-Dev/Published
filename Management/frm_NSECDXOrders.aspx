<%@ page language="C#" autoeventwireup="true" inherits="management_frm_NSECDXOrders, App_Web_zsukfi_p" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>NSE-CD Order Logs</title>
                ...
                <tbody>
                 <tr>
                    <td class="lt1" style="height: 22px">
                        <h5>
                            Imports NSE-CDX Order Logs [CD_ORD_LOG_DDmmYYYY_mmmmm.CSV]
                        </h5>
                    </td>
                </tr>
