<%@ page language="C#" autoeventwireup="true" inherits="management_Frm_INBXTRADES, App_Web_v5pngf_u" %>
                    ...
                    <tbody>
                        <tr>
                            <td class="lt1" style="height: 22px">
                                <h5>
                                    Imports Berkley's 'Trade.Csv' Files
                                </h5>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td style="width: 100px">
                                            <dxe:ASPxComboBox ID="ComboChooseFile" runat="server" ClientInstanceName="cComboChooseFile"
                                                ...
                                                <Items>
                                                    <dxe:ListEditItem Value="0" Text="From Broker's csv Files"></dxe:ListEditItem>
